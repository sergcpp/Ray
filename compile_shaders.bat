...
third-party\spirv\win32\glslangValidator -V --target-env spirv1.3 internal/shaders/shade_hits.comp.glsl -DPRIMARY=1 -o internal/shaders/shade_primary_hits.comp.spv
if %errorlevel% neq 0 exit /b %errorlevel%
call third-party\spirv\win32\spirv-opt.bat internal/shaders/shade_primary_hits.comp.spv -o internal/shaders/shade_primary_hits.comp.spv
third-party\spirv\win32\bin2c -o internal/shaders/shade_primary_hits.comp.inl internal/shaders/shade_primary_hits.comp.spv

third-party\spirv\win32\glslangValidator -V --target-env spirv1.3 internal/shaders/trace_shadow.comp.glsl -DHWRT=0 -o internal/shaders/trace_shadow_swrt.comp.spv
if %errorlevel% neq 0 exit /b %errorlevel%
call third-party\spirv\win32\spirv-opt.bat internal/shaders/trace_shadow_swrt.comp.spv -o internal/shaders/trace_shadow_swrt.comp.spv
third-party\spirv\win32\bin2c -o internal/shaders/trace_shadow_swrt.comp.inl internal/shaders/trace_shadow_swrt.comp.spv

third-party\spirv\win32\glslangValidator -V --target-env spirv1.4 --glsl-version 460 internal/shaders/trace_shadow.comp.glsl -DHWRT=1 -o internal/shaders/trace_shadow_hwrt.comp.spv
if %errorlevel% neq 0 exit /b %errorlevel%
call third-party\spirv\win32\spirv-opt.bat internal/shaders/trace_shadow_hwrt.comp.spv -o internal/shaders/trace_shadow_hwrt.comp.spv
third-party\spirv\win32\bin2c -o internal/shaders/trace_shadow_hwrt.comp.inl internal/shaders/trace_shadow_hwrt.comp.spv

third-party\spirv\win32\glslangValidator -V --target-env spirv1.3 internal/shaders/shade_hits.comp.glsl -DPRIMARY=0 -o internal/shaders/shade_secondary_hits.comp.spv
if %errorlevel% neq 0 exit /b %errorlevel%
call third-party\spirv\win32\spirv-opt.bat internal/shaders/shade_secondary_hits.comp.spv -o internal/shaders/shade_secondary_hits.comp.spv
third-party\spirv\win32\bin2c -o internal/shaders/shade_secondary_hits.comp.inl internal/shaders/shade_secondary_hits.comp.spv
