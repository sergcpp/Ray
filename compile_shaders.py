...
def main():
    ...
    # Convolution
    compile_shader_async(src_name="convolution.comp.glsl", spv_name="convolution_Img_3_32_fp32.comp.spv", defines="-DIMG_INPUT1=1 -DIN_CHANNELS1=3 -DOUT_CHANNELS=32 -DHDR_TRANSFER1=1")
    ...
    compile_shader_async(src_name="convolution.comp.glsl", spv_name="convolution_Img_6_32_fp32.comp.spv", defines="-DIMG_INPUT1=1 -DIMG_INPUT2=1 -DIN_CHANNELS1=6 -DOUT_CHANNELS=32 -DHDR_TRANSFER1=1")
    ...
    compile_shader_async(src_name="convolution.comp.glsl", spv_name="convolution_Img_9_32_fp32.comp.spv", defines="-DIMG_INPUT1=1 -DIMG_INPUT2=1 -DIMG_INPUT3=1 -DIN_CHANNELS1=9 -DOUT_CHANNELS=32 -DHDR_TRANSFER1=1 -DPOS_NORMALIZE3=1")
    ...
    compile_shader_async(src_name="convolution.comp.glsl", spv_name="convolution_32_32_Downsample_fp32.comp.spv", defines="-DBUF_INPUT1=1 -DIN_CHANNELS1=32 -DOUT_CHANNELS=32 -DDOWNSAMPLE=1")
    ...
    compile_shader_async(src_name="convolution.comp.glsl", spv_name="convolution_32_48_Downsample_fp32.comp.spv", defines="-DBUF_INPUT1=1 -DIN_CHANNELS1=32 -DOUT_CHANNELS=48 -DDOWNSAMPLE=1")
    ...
    compile_shader_async(src_name="convolution.comp.glsl", spv_name="convolution_48_64_Downsample_fp32.comp.spv", defines="-DBUF_INPUT1=1 -DIN_CHANNELS1=48 -DOUT_CHANNELS=64 -DDOWNSAMPLE=1")
    ...
    compile_shader_async(src_name="convolution.comp.glsl", spv_name="convolution_64_80_Downsample_fp32.comp.spv", defines="-DBUF_INPUT1=1 -DIN_CHANNELS1=64 -DOUT_CHANNELS=80 -DDOWNSAMPLE=1")
    ...
    compile_shader_async(src_name="convolution.comp.glsl", spv_name="convolution_64_64_fp32.comp.spv", defines="-DBUF_INPUT1=1 -DIN_CHANNELS1=64 -DOUT_CHANNELS=64")
    ...
    compile_shader_async(src_name="convolution.comp.glsl", spv_name="convolution_64_32_fp32.comp.spv", defines="-DBUF_INPUT1=1 -DIN_CHANNELS1=64 -DOUT_CHANNELS=32")
    ...
    compile_shader_async(src_name="convolution.comp.glsl", spv_name="convolution_80_96_fp32.comp.spv", defines="-DBUF_INPUT1=1 -DIN_CHANNELS1=80 -DOUT_CHANNELS=96")
    ...
    compile_shader_async(src_name="convolution.comp.glsl", spv_name="convolution_96_96_fp32.comp.spv", defines="-DBUF_INPUT1=1 -DIN_CHANNELS1=96 -DOUT_CHANNELS=96")
    ...
    compile_shader_async(src_name="convolution.comp.glsl", spv_name="convolution_112_112_fp32.comp.spv", defines="-DBUF_INPUT1=1 -DIN_CHANNELS1=112 -DOUT_CHANNELS=112")
    ...
    compile_shader_async(src_name="convolution.comp.glsl", spv_name="convolution_32_3_img_fp32.comp.spv", defines="-DBUF_INPUT1=1 -DIN_CHANNELS1=32 -DOUT_CHANNELS=3 -DOUT_IMG=1 -DHDR_TRANSFER1=1 -DTONEMAP=1")
    ...
    compile_shader_async(src_name="convolution.comp.glsl", spv_name="convolution_concat_96_64_112_fp32.comp.spv", defines="-DBUF_INPUT1=1 -DIN_CHANNELS1=96 -DUPSCALE1=1 -DBUF_INPUT2=1 -DIN_CHANNELS2=64 -DOUT_CHANNELS=112")
    ...
    compile_shader_async(src_name="convolution.comp.glsl", spv_name="convolution_concat_112_48_96_fp32.comp.spv", defines="-DBUF_INPUT1=1 -DIN_CHANNELS1=112 -DUPSCALE1=1 -DBUF_INPUT2=1 -DIN_CHANNELS2=48 -DOUT_CHANNELS=96")
    ...
    compile_shader_async(src_name="convolution.comp.glsl", spv_name="convolution_concat_96_32_64_fp32.comp.spv", defines="-DBUF_INPUT1=1 -DIN_CHANNELS1=96 -DUPSCALE1=1 -DBUF_INPUT2=1 -DIN_CHANNELS2=32 -DOUT_CHANNELS=64")
    ...
    compile_shader_async(src_name="convolution.comp.glsl", spv_name="convolution_concat_64_3_64_fp32.comp.spv", defines="-DBUF_INPUT1=1 -DIN_CHANNELS1=64 -DUPSCALE1=1 -DIMG_INPUT2=1 -DIN_CHANNELS2=3 -DOUT_CHANNELS=64 -DHDR_TRANSFER2=1")
    ...
    compile_shader_async(src_name="convolution.comp.glsl", spv_name="convolution_concat_64_6_64_fp32.comp.spv", defines="-DBUF_INPUT1=1 -DIN_CHANNELS1=64 -DUPSCALE1=1 -DIMG_INPUT2=1 -DIMG_INPUT3=1 -DIN_CHANNELS2=6 -DOUT_CHANNELS=64 -DHDR_TRANSFER2=1")
    ...
    compile_shader_async(src_name="convolution.comp.glsl", spv_name="convolution_concat_64_9_64_fp32.comp.spv", defines="-DBUF_INPUT1=1 -DIN_CHANNELS1=64 -DUPSCALE1=1 -DIMG_INPUT2=1 -DIMG_INPUT3=1 -DIMG_INPUT4=1 -DIN_CHANNELS2=9 -DOUT_CHANNELS=64 -DHDR_TRANSFER2=1 -DPOS_NORMALIZE4=1")
