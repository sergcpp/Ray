...
template bool Traverse_MacroTree_WithStack_AnyHit<RayPacketSize>(
    ...
    const transform_t *transforms, const tri_accel_t *tris, const tri_mat_data_t *materials,
    const uint32_t *tri_indices, hit_data_t<RayPacketSize> &inter);
template bool Traverse_MicroTree_WithStack_ClosestHit<RayPacketSize>(const ray_data_t<RayPacketSize> &r,
...
template ray_data_t<RayPacketSize> TransformRay<RayPacketSize>(const ray_data_t<RayPacketSize> &r,
                                                                 const float *xform);
template void TransformNormal<RayPacketSize>(const simd_fvec<RayPacketSize> n[3], const float *inv_xform,
                                             simd_fvec<RayPacketSize> out_n[3]);
template void TransformUVs<RayPacketSize>(const simd_fvec<RayPacketSize> _uvs[2], float sx, float sy,
...
template void IntersectAreaLights<RayPacketSize>(const ray_data_t<RayPacketSize> &r,
                                                 const simd_ivec<RayPacketSize> &ray_mask, const light_t lights[],
