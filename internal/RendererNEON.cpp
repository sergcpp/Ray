...
template void SampleNearest<RayPacketSize>(const Ref::TextureStorageBase *atlases[], const texture_t &t,
...
template void SampleBilinear<RayPacketSize>(const Ref::TextureStorageBase *atlases[], const texture_t &t,
                                            const simd_fvec<RayPacketSize> uvs[2], const simd_ivec<RayPacketSize> &lod,
                                            const simd_ivec<RayPacketSize> &mask, simd_fvec<RayPacketSize> out_rgba[4]);
template void SampleBilinear<RayPacketSize>(const Ref::TextureStorageBase &atlas, const simd_fvec<RayPacketSize> uvs[2],
                                            const simd_ivec<RayPacketSize> &page, const simd_ivec<RayPacketSize> &mask,
                                            simd_fvec<RayPacketSize> out_rgba[4]);
template void SampleTrilinear<RayPacketSize>(const Ref::TextureStorageBase *atlases[], const texture_t &t,
                                             const simd_fvec<RayPacketSize> uvs[2], const simd_fvec<RayPacketSize> &lod,
                                             const simd_ivec<RayPacketSize> &mask,
                                             simd_fvec<RayPacketSize> out_rgba[4]);
template void SampleAnisotropic<RayPacketSize>(const Ref::TextureStorageBase *atlases[], const texture_t &t,
...
template void ShadeSurface<RayPacketSize>(const simd_ivec<RayPacketSize> &index, const pass_info_t &pi,
                                          ...
                                          uint32_t node_index, const Ref::TextureStorageBase *tex_atlases[],
                                          simd_fvec<RayPacketSize> out_rgba[4],
