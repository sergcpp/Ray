...
template bool Traverse_MicroTree_WithStack_ClosestHit<RayPacketSize>(const float ro[3], const float rd[3],
...
template int Traverse_MicroTree_WithStack_AnyHit<RayPacketSize>(const float ro[3], const float rd[3],
                                                                const mbvh_node_t *mnodes, uint32_t node_index,
                                                                const mtri_accel_t *mtris,
