...
bool Ray::Dx::RenderPass::Init(Context *ctx, Span<const RenderTargetInfo> _color_rts, RenderTargetInfo _depth_rt,
                               ILog *log) {
    Destroy();
...
bool Ray::Dx::RenderPass::Setup(Context *ctx, Span<const RenderTarget> _color_rts, const RenderTarget _depth_rt,
                                ILog *log) {
...
bool Ray::Dx::RenderPass::Setup(Context *ctx, Span<const RenderTargetInfo> _color_rts, RenderTargetInfo _depth_rt,
                                ILog *log) {
