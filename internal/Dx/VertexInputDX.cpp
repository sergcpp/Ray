...
Ray::Dx::VertexInput &Ray::Dx::VertexInput::operator=(VertexInput &&rhs) noexcept = default;

/*void Ray::Dx::VertexInput::BindBuffers(VkCommandBuffer cmd_buf, const uint32_t index_offset,
...
void Ray::Dx::VertexInput::FillVKDescriptions(SmallVectorImpl<VkVertexInputBindingDescription> &out_bindings,
...
bool Ray::Dx::VertexInput::Setup(Span<const VtxAttribDesc> _attribs, const BufHandle &_elem_buf) {
