...
ray::ref::Scene2::Scene2() : texture_atlas_(MAX_TEXTURE_SIZE, MAX_TEXTURE_SIZE) {
...
void ray::ref::Scene2::GetEnvironment(environment_desc_t &env) {
...
void ray::ref::Scene2::SetEnvironment(const environment_desc_t &env) {
...
uint32_t ray::ref::Scene2::AddTexture(const tex_desc_t &_t) {
...
uint32_t ray::ref::Scene2::AddMaterial(const mat_desc_t &m) {
    material_t mat;
...
uint32_t ray::ref::Scene2::AddMesh(const mesh_desc_t &_m) {
...
void ray::ref::Scene2::RemoveMesh(uint32_t i) {
...
uint32_t ray::ref::Scene2::AddMeshInstance(uint32_t mesh_index, const float *xform) {
...
void ray::ref::Scene2::SetMeshInstanceTransform(uint32_t mi_index, const float *xform) {
...
void ray::ref::Scene2::RemoveMeshInstance(uint32_t i) {
    mesh_instances_.erase(mesh_instances_.begin() + i);

    RebuildMacroBVH();
}

void ray::ref::Scene2::RemoveNodes(uint32_t node_index, uint32_t node_count) {
...
void ray::ref::Scene2::RebuildMacroBVH() {
    using namespace math;
