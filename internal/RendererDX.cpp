...
Ray::Dx::Renderer::Renderer(const settings_t &s, ILog *log) {
    ...
    sh_shade_primary_b_ =
        Shader{"Shade (Primary) B", ctx_.get(),
               Inflate(use_bindless_ ? Span<const uint8_t>{internal_shaders_output_shade_primary_bindless_b_comp_cso}
                                     : Span<const uint8_t>{internal_shaders_output_shade_primary_atlas_b_comp_cso}),
               eShaderType::Comp, log};
    sh_shade_primary_n_ =
        Shader{"Shade (Primary) N", ctx_.get(),
               Inflate(use_bindless_ ? Span<const uint8_t>{internal_shaders_output_shade_primary_bindless_n_comp_cso}
                                     : Span<const uint8_t>{internal_shaders_output_shade_primary_atlas_n_comp_cso}),
               eShaderType::Comp, log};
    sh_shade_primary_bn_ =
        Shader{"Shade (Primary) BN", ctx_.get(),
               Inflate(use_bindless_ ? Span<const uint8_t>{internal_shaders_output_shade_primary_bindless_bn_comp_cso}
                                     : Span<const uint8_t>{internal_shaders_output_shade_primary_atlas_bn_comp_cso}),
               eShaderType::Comp, log};
    sh_shade_secondary_ =
    ...
    sh_mix_incremental_b_ = Shader{"Mix Incremental B", ctx_.get(),
                                   Inflate(internal_shaders_output_mix_incremental_b_comp_cso), eShaderType::Comp, log};
    sh_mix_incremental_n_ = Shader{"Mix Incremental N", ctx_.get(),
                                   Inflate(internal_shaders_output_mix_incremental_n_comp_cso), eShaderType::Comp, log};
    sh_mix_incremental_bn_ =
        Shader{"Mix Incremental BN", ctx_.get(), Inflate(internal_shaders_output_mix_incremental_bn_comp_cso),
               eShaderType::Comp, log};
...
bool Ray::Dx::Renderer::InitUNetPipelines() {
    ...
    sh_convolution_32_32_Downsample_ =
        Shader{"Convolution 32 32 Downsample", ctx_.get(),
               select_unpack_shader(internal_shaders_output_convolution_32_32_Downsample_fp32_comp_cso,
    ...
    sh_convolution_32_48_Downsample_ =
        Shader{"Convolution 32 48 Downsample", ctx_.get(),
               select_unpack_shader(internal_shaders_output_convolution_32_48_Downsample_fp32_comp_cso,
    ...
    sh_convolution_48_64_Downsample_ =
        Shader{"Convolution 48 64 Downsample", ctx_.get(),
               select_unpack_shader(internal_shaders_output_convolution_48_64_Downsample_fp32_comp_cso,
    ...
    sh_convolution_64_80_Downsample_ =
        Shader{"Convolution 64 80 Downsample", ctx_.get(),
               select_unpack_shader(internal_shaders_output_convolution_64_80_Downsample_fp32_comp_cso,
    ...
    sh_convolution_concat_96_64_112_ =
        Shader{"Convolution Concat 96 64 112", ctx_.get(),
               select_unpack_shader(internal_shaders_output_convolution_concat_96_64_112_fp32_comp_cso,
    ...
    sh_convolution_concat_112_48_96_ =
        Shader{"Convolution Concat 112 48 96", ctx_.get(),
               select_unpack_shader(internal_shaders_output_convolution_concat_112_48_96_fp32_comp_cso,
    ...
    sh_convolution_concat_96_32_64_ =
        Shader{"Convolution Concat 96 32 64", ctx_.get(),
               select_unpack_shader(internal_shaders_output_convolution_concat_96_32_64_fp32_comp_cso,
    ...
    sh_convolution_concat_64_3_64_ =
        Shader{"Convolution Concat 64 3 64", ctx_.get(),
               select_unpack_shader(internal_shaders_output_convolution_concat_64_3_64_fp32_comp_cso,
    ...
    sh_convolution_concat_64_6_64_ =
        Shader{"Convolution Concat 64 6 64", ctx_.get(),
               select_unpack_shader(internal_shaders_output_convolution_concat_64_6_64_fp32_comp_cso,
    ...
    sh_convolution_concat_64_9_64_ =
        Shader{"Convolution Concat 64 9 64", ctx_.get(),
               select_unpack_shader(internal_shaders_output_convolution_concat_64_9_64_fp32_comp_cso,
    ...
    sh_convolution_32_3_img_ = Shader{"Convolution 32 3 Img", ctx_.get(),
                                      select_unpack_shader(internal_shaders_output_convolution_32_3_img_fp32_comp_cso,
