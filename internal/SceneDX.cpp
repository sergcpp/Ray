...
void Ray::Dx::Scene::GetEnvironment(environment_desc_t &env) {
...
void Ray::Dx::Scene::SetEnvironment(const environment_desc_t &env) {
    std::unique_lock<std::shared_timed_mutex> lock(mtx_);
...
void Ray::Dx::Scene::WriteTextureMips(const color_t<T, N> data[], const int _res[2], const int mip_count,
...
template void Ray::Dx::Scene::WriteTextureMips<uint8_t, 1>(const color_t<uint8_t, 1> data[], const int _res[2],
                                                           int mip_count, bool compress, uint8_t out_data[],
                                                           uint32_t out_size[16]);
template void Ray::Dx::Scene::WriteTextureMips<uint8_t, 2>(const color_t<uint8_t, 2> data[], const int _res[2],
                                                           int mip_count, bool compress, uint8_t out_data[],
                                                           uint32_t out_size[16]);
template void Ray::Dx::Scene::WriteTextureMips<uint8_t, 3>(const color_t<uint8_t, 3> data[], const int _res[2],
                                                           int mip_count, bool compress, uint8_t out_data[],
                                                           uint32_t out_size[16]);
template void Ray::Dx::Scene::WriteTextureMips<uint8_t, 4>(const color_t<uint8_t, 4> data[], const int _res[2],
                                                           int mip_count, bool compress, uint8_t out_data[],
                                                           uint32_t out_size[16]);

Ray::MaterialHandle Ray::Dx::Scene::AddMaterial_nolock(const shading_node_desc_t &m) {
    material_t mat = {};
...
Ray::MaterialHandle Ray::Dx::Scene::AddMaterial(const principled_mat_desc_t &m) {
    material_t main_mat = {};
...
Ray::MeshHandle Ray::Dx::Scene::AddMesh(const mesh_desc_t &_m) {
...
void Ray::Dx::Scene::RemoveMesh(MeshHandle) {
    std::unique_lock<std::shared_timed_mutex> lock(mtx_);
    // TODO!!!
}

Ray::LightHandle Ray::Dx::Scene::AddLight(const directional_light_desc_t &_l) {
    light_t l = {};
...
Ray::LightHandle Ray::Dx::Scene::AddLight(const sphere_light_desc_t &_l) {
    light_t l = {};
...
Ray::LightHandle Ray::Dx::Scene::AddLight(const spot_light_desc_t &_l) {
    light_t l = {};
...
Ray::LightHandle Ray::Dx::Scene::AddLight(const rect_light_desc_t &_l, const float *xform) {
    light_t l = {};
...
Ray::LightHandle Ray::Dx::Scene::AddLight(const disk_light_desc_t &_l, const float *xform) {
    light_t l = {};
...
Ray::LightHandle Ray::Dx::Scene::AddLight(const line_light_desc_t &_l, const float *xform) {
    light_t l = {};
...
void Ray::Dx::Scene::RemoveLight_nolock(const LightHandle i) {
...
Ray::MeshInstanceHandle Ray::Dx::Scene::AddMeshInstance(const MeshHandle mesh, const float *xform) {
    std::unique_lock<std::shared_timed_mutex> lock(mtx_);
...
void Ray::Dx::Scene::SetMeshInstanceTransform_nolock(const MeshInstanceHandle mi_handle, const float *xform) {
    transform_t tr = {};
...
void Ray::Dx::Scene::RemoveMeshInstance(MeshInstanceHandle) {
    // TODO!!
}

void Ray::Dx::Scene::Finalize() {
    std::unique_lock<std::shared_timed_mutex> lock(mtx_);
...
void Ray::Dx::Scene::RebuildTLAS_nolock() {
...
void Ray::Dx::Scene::PrepareEnvMapQTree_nolock() {
