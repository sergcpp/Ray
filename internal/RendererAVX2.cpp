...
template void SortRays_CPU<RayPacketSize>(ray_packet_t<RayPacketSize> *rays, simd_ivec<RayPacketSize> *ray_masks,
...
template void SortRays_GPU<RayPacketSize>(ray_packet_t<RayPacketSize> *rays, simd_ivec<RayPacketSize> *ray_masks,
                                          int &secondary_rays_count, const float root_min[3], const float cell_size[3],
...
template bool Traverse_MacroTree_Stackless_CPU<RayPacketSize>(
...
template bool Traverse_MicroTree_Stackless_CPU<RayPacketSize>(const ray_packet_t<RayPacketSize> &r,
