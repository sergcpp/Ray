...
// Sample Texture
simd_fvec4 SampleNearest(const TexStorageBase *textures[], uint32_t index, const simd_fvec2 &uvs, int lod);
simd_fvec4 SampleBilinear(const TexStorageBase *textures[], uint32_t index, const simd_fvec2 &uvs, int lod);
simd_fvec4 SampleBilinear(const TexStorageBase &storage, uint32_t tex, const simd_fvec2 &iuvs, int lod);
simd_fvec4 SampleTrilinear(const TexStorageBase *textures[], uint32_t index, const simd_fvec2 &uvs, float lod);
simd_fvec4 SampleAnisotropic(const TexStorageBase *textures[], uint32_t index, const simd_fvec2 &uvs,
...
float ComputeVisibility(const float p[3], const float d[3], float dist, float rand_val, int rand_hash2,
                        const scene_data_t &sc, uint32_t node_index, const TexStorageBase *textures[]);
...
void SampleLightSource(const simd_fvec4 &P, const scene_data_t &sc, const TexStorageBase *textures[],
...
Ray::pixel_color_t ShadeSurface(int px_index, const pass_info_t &pi, const hit_data_t &inter, const ray_data_t &ray,
                                ...
                                const TexStorageBase *textures[], ray_data_t *out_secondary_rays,
