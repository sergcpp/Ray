...
void Ray::Dx::Renderer::kernel_GeneratePrimaryRays(CommandBuffer cmd_buf, const camera_t &cam, const int hi,
...
#endif
void Ray::Dx::Renderer::kernel_IntersectAreaLights(CommandBuffer cmd_buf, const scene_data_t &sc_data,
...
void Ray::Dx::Renderer::kernel_PrepareIndirArgs(CommandBuffer cmd_buf, const Buffer &inout_counters,
...
void Ray::Dx::Renderer::kernel_MixIncremental(CommandBuffer cmd_buf, const float main_mix_factor,
...
void Ray::Dx::Renderer::kernel_Postprocess(CommandBuffer cmd_buf, const Texture2D &img0_buf, const float img0_weight,
...
void Ray::Dx::Renderer::kernel_FilterVariance(CommandBuffer cmd_buf, const Texture2D &img_buf, const rect_t &rect,
...
void Ray::Dx::Renderer::kernel_NLMFilter(CommandBuffer cmd_buf, const Texture2D &img_buf, const Texture2D &var_buf,
...
void Ray::Dx::Renderer::kernel_Convolution(CommandBuffer cmd_buf, int in_channels, int out_channels,
...
void Ray::Dx::Renderer::kernel_ConvolutionConcat(CommandBuffer cmd_buf, int in_channels1, int in_channels2,
