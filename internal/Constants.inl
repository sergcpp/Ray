...
const uint HASH_GRID_POSITION_BIT_COUNT = 17u;
const uint HASH_GRID_POSITION_BIT_MASK = (1u << HASH_GRID_POSITION_BIT_COUNT) - 1;
const uint HASH_GRID_LEVEL_BIT_COUNT = 10u;
const uint HASH_GRID_LEVEL_BIT_MASK = (1u << HASH_GRID_LEVEL_BIT_COUNT) - 1;
const uint HASH_GRID_NORMAL_BIT_COUNT = 3u;
const uint HASH_GRID_NORMAL_BIT_MASK = (1u << HASH_GRID_NORMAL_BIT_COUNT) - 1;
const uint HASH_GRID_HASH_MAP_BUCKET_SIZE = 16u;
const uint HASH_GRID_INVALID_CACHE_ENTRY = 0xFFFFFFFFu;
const uint HASH_GRID_LEVEL_BIAS = 2u;
const uint HASH_GRID_INVALID_HASH_KEY = 0u;
const bool HASH_GRID_USE_NORMALS = true;
const float HASH_GRID_POSITION_BIAS = 0.0001f;
const float HASH_GRID_NORMAL_BIAS = 0.001f;

//
// Radiance caching
//
const uint RAD_CACHE_SAMPLE_COUNT_THRESHOLD = 2u;
const uint RAD_CACHE_PROPAGATION_DEPTH = 4u;
const float RAD_CACHE_RADIANCE_SCALE = 1e3f;
const uint RAD_CACHE_FRAME_COUNTER_BIT_OFFSET = 0;
const uint RAD_CACHE_FRAME_COUNTER_BIT_COUNT = 16u;
const uint RAD_CACHE_FRAME_COUNTER_BIT_MASK = ((1u << RAD_CACHE_FRAME_COUNTER_BIT_COUNT) - 1u);
const uint RAD_CACHE_STALE_COUNTER_BIT_OFFSET = RAD_CACHE_FRAME_COUNTER_BIT_COUNT;
const uint RAD_CACHE_STALE_COUNTER_BIT_COUNT = 16u;
const uint RAD_CACHE_STALE_COUNTER_BIT_MASK = ((1u << RAD_CACHE_STALE_COUNTER_BIT_COUNT) - 1u);
const float RAD_CACHE_GRID_LOGARITHM_BASE = 2.0f;
const bool RAD_CACHE_FILTER_ADJACENT_LEVELS = true;

const uint RAD_CACHE_LINEAR_PROBE_WINDOW = 8;

const uint RAD_CACHE_ACCUMULATION_FRAME_COUNT = 32;
const uint RAD_CACHE_STALE_FRAME_COUNT = 64;
...
const int SKY_PRE_ATMOSPHERE_SAMPLE_COUNT = 16;
