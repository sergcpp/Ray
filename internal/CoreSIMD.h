...
const int RayPacketDimX = 16;
const int RayPacketDimY = 16;
...
/*bool IntersectTris(const ray_packet_t &r, const __m128i ray_mask, const tri_accel_t *tris, uint32_t num_tris, uint32_t obj_index, hit_data_t &out_inter);
bool IntersectTris(const ray_packet_t &r, const __m128i ray_mask, const tri_accel_t *tris, const uint32_t *indices, uint32_t num_tris, uint32_t obj_index, hit_data_t &out_inter);
