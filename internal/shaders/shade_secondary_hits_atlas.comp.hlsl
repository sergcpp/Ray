...
RWByteAddressBuffer _8684 : register(u1, space0);
ByteAddressBuffer _8767 : register(t5, space0);
ByteAddressBuffer _8793 : register(t4, space0);
ByteAddressBuffer _8897 : register(t8, space0);
...
float2 TransformUV(float2 _uv, atlas_texture_t t, int mip_level)
{
    ...
    return mad(frac(_uv), size, float2(float(_9028[mip_level] & 65535u), float((_9031[mip_level] >> uint(16)) & 65535u))) + 1.0f.xx;
}
...
float4 SampleBilinear(uint index, float2 uvs, int lod, bool maybe_YCoCg, bool maybe_SRGB)
{
    ...
    _9036[2] = _985.page[2];
    _9036[3] = _985.page[3];
    uint _9072[14] = { _985.pos[0], _985.pos[1], _985.pos[2], _985.pos[3], _985.pos[4], _985.pos[5], _985.pos[6], _985.pos[7], _985.pos[8], _985.pos[9], _985.pos[10], _985.pos[11], _985.pos[12], _985.pos[13] };
    atlas_texture_t _9042 = { _985.size, _985.atlas, _9036, _9072 };
    uint _1055 = _985.atlas;
    float4 res = g_atlases[NonUniformResourceIndex(_1055)].SampleLevel(_g_atlases_sampler[NonUniformResourceIndex(_1055)], float3(TransformUV(uvs, _9042, lod) * 0.000118371215648949146270751953125f.xx, float((_9036[lod / 4] >> uint((lod % 4) * 8)) & 255u)), 0.0f);
    bool _1070;
    if (maybe_YCoCg)
    {
        _1070 = _985.atlas == 4u;
    ...
    if (_1089)
    {
        ...
        float4 _10057 = res;
        _10057.x = _1095.x;
        float4 _10059 = _10057;
        _10059.y = _1095.y;
        float4 _10061 = _10059;
        _10061.z = _1095.z;
        res = _10061;
    }
    return res;
...
float3 ensure_valid_reflection(float3 Ng, float3 I, float3 N)
{
    ...
    do
    {
        ...
        if (_1469 && _1475)
        {
            float _10365 = (-0.5f) / _1429;
            float param_1 = mad(_10365, _1453, 1.0f);
            float _1485 = safe_sqrtf(param_1);
            float param_2 = _1454;
            float _1488 = safe_sqrtf(param_2);
            float2 _1489 = float2(_1485, _1488);
            float param_3 = mad(_10365, _1460, 1.0f);
            float _1494 = safe_sqrtf(param_3);
            float param_4 = _1461;
            float _1497 = safe_sqrtf(param_4);
            float2 _1498 = float2(_1494, _1497);
            float _10367 = -_1417;
            float _1514 = mad(2.0f * mad(_1485, _1413, _1488 * _1417), _1488, _10367);
            float _1530 = mad(2.0f * mad(_1494, _1413, _1497 * _1417), _1497, _10367);
        ...
        _8909 = (_1409 * N_new.x) + (Ng * N_new.y);
        break;
    } while(false);
    return _8909;
}
...
float3 MapToCone(float r1, float r2, float3 N, float radius)
{
    ...
    do
    {
        ...
        _8934 = (N + (param * ((radius * r) * cos(theta)))) + (param_1 * ((radius * r) * sin(theta)));
        break;
    } while(false);
    return _8934;
}
...
float4 Sample_EnvQTree(float y_rotation, Texture2D<float4> qtree_tex, SamplerState _qtree_tex_sampler, int qtree_levels, float rand, float rx, float ry)
{
    ...
    while (lod >= 0)
    {
        ...
        else
        {
            ...
            partial = _764;
            float2 _10044 = origin;
            _10044.x = origin.x + _step;
            origin = _10044;
        ...
        {
            float2 _10047 = origin;
            _10047.y = origin.y + _step;
            origin = _10047;
            _sample = (_sample - boundary) / (1.0f - boundary);
            index |= 2;
        }
...
void SampleLightSource(float3 P, float2 sample_off, inout light_sample_t ls)
{
    ...
    if (_3300 == 0u)
    {
        ...
        float3 _10124 = sampled_dir;
        float3 _3380 = ((param * _10124.x) + (param_1 * _10124.y)) + (_3337 * _10124.z);
        sampled_dir = _3380;
            ...
            if (_3300 == 4u)
            {
                ...
                if ((_3266.type_and_param0.w & 128u) != 0u)
                {
                    ...
                    if (_3651 != 4294967295u)
                    {
                        ...
                        uint _9227[14] = { _3659.pos[0], _3659.pos[1], _3659.pos[2], _3659.pos[3], _3659.pos[4], _3659.pos[5], _3659.pos[6], _3659.pos[7], _3659.pos[8], _3659.pos[9], _3659.pos[10], _3659.pos[11], _3659.pos[12], _3659.pos[13] };
                        uint _9198[4] = { _3659.page[0], _3659.page[1], _3659.page[2], _3659.page[3] };
                        atlas_texture_t _9108 = { _3659.size, _3659.atlas, _9198, _9227 };
                        float param_6 = _3223_g_params.env_rotation;
                        env_col *= SampleLatlong_RGBE(_9108, ls.L, param_6);
                    }
                    ls.col *= env_col;
                }
            }
                ...
                if (_3300 == 5u)
                {
                    ...
                    if ((_3266.type_and_param0.w & 128u) != 0u)
                    {
                        ...
                        if (_3889 != 4294967295u)
                        {
                            ...
                            uint _9265[14] = { _3896.pos[0], _3896.pos[1], _3896.pos[2], _3896.pos[3], _3896.pos[4], _3896.pos[5], _3896.pos[6], _3896.pos[7], _3896.pos[8], _3896.pos[9], _3896.pos[10], _3896.pos[11], _3896.pos[12], _3896.pos[13] };
                            uint _9236[4] = { _3896.page[0], _3896.page[1], _3896.page[2], _3896.page[3] };
                            atlas_texture_t _9117 = { _3896.size, _3896.atlas, _9236, _9265 };
                            float param_7 = _3223_g_params.env_rotation;
                            env_col_1 *= SampleLatlong_RGBE(_9117, ls.L, param_7);
                        }
                        ls.col *= env_col_1;
                    }
                }
                    ...
                    if (_3300 == 3u)
                    {
                        ...
                        if ((_3266.type_and_param0.w & 128u) != 0u)
                        {
                            ...
                            if (_4088 != 4294967295u)
                            {
                                ...
                                uint _9303[14] = { _4095.pos[0], _4095.pos[1], _4095.pos[2], _4095.pos[3], _4095.pos[4], _4095.pos[5], _4095.pos[6], _4095.pos[7], _4095.pos[8], _4095.pos[9], _4095.pos[10], _4095.pos[11], _4095.pos[12], _4095.pos[13] };
                                uint _9274[4] = { _4095.page[0], _4095.page[1], _4095.page[2], _4095.page[3] };
                                atlas_texture_t _9126 = { _4095.size, _4095.atlas, _9274, _9303 };
                                float param_8 = _3223_g_params.env_rotation;
                                env_col_2 *= SampleLatlong_RGBE(_9126, ls.L, param_8);
                            }
                            ls.col *= env_col_2;
                        }
                    }
                    else
                    {
                        ...
                        if (_3300 == 6u)
                        {
                            ...
                            else
                            {
                                ...
                                if (_4599 != 4294967295u)
                                {
                                    ...
                                    uint _9388[14] = { _4606.pos[0], _4606.pos[1], _4606.pos[2], _4606.pos[3], _4606.pos[4], _4606.pos[5], _4606.pos[6], _4606.pos[7], _4606.pos[8], _4606.pos[9], _4606.pos[10], _4606.pos[11], _4606.pos[12], _4606.pos[13] };
                                    uint _9359[4] = { _4606.page[0], _4606.page[1], _4606.page[2], _4606.page[3] };
                                    atlas_texture_t _9180 = { _4606.size, _4606.atlas, _9359, _9388 };
                                    float param_9 = _3223_g_params.env_rotation;
                                    env_col_3 *= SampleLatlong_RGBE(_9180, ls.L, param_9);
                                }
                                ls.col *= env_col_3;
                            }
                        }
                        else
                        {
                            ...
                            if (_3300 == 7u)
                            {
                                ...
                                uint _9426[14] = { _4726.pos[0], _4726.pos[1], _4726.pos[2], _4726.pos[3], _4726.pos[4], _4726.pos[5], _4726.pos[6], _4726.pos[7], _4726.pos[8], _4726.pos[9], _4726.pos[10], _4726.pos[11], _4726.pos[12], _4726.pos[13] };
                                uint _9397[4] = { _4726.page[0], _4726.page[1], _4726.page[2], _4726.page[3] };
                                atlas_texture_t _9189 = { _4726.size, _4726.atlas, _9397, _9426 };
                                float param_10 = _3223_g_params.env_rotation;
                                ls.col *= SampleLatlong_RGBE(_9189, ls.L, param_10);
                                ls.area = 1.0f;
                                ls.dist = 3402823346297367662189621542912.0f;
                                ls.pdf = _4709.w;
                            }
...
float D_GGX(float3 H, float alpha_x, float alpha_y)
{
    ...
    do
    {
        ...
        _8939 = 1.0f / (((((_2115 * _2115) * 3.1415927410125732421875f) * alpha_x) * alpha_y) * (((H.z * H.z) * H.z) * H.z));
        break;
    } while(false);
    return _8939;
}
...
float4 Sample_GGXSpecular_BSDF(float3 T, float3 B, float3 N, float3 I, float roughness, float anisotropic, float spec_ior, float spec_F0, float3 spec_col, float rand_u, float rand_v, inout float3 out_V)
{
    ...
    do
    {
        ...
        if ((_2566 * _2570) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            out_V = _2580;
            _8914 = float4(_2594.x * 1000000.0f, _2594.y * 1000000.0f, _2594.z * 1000000.0f, 1000000.0f);
            break;
        }
        float3 param_2 = T;
        float3 param_3 = B;
        ...
        _8914 = Evaluate_GGXSpecular_BSDF(param_14, param_15, param_16, param_17, param_18, param_19, param_20, param_21);
        break;
    } while(false);
    return _8914;
}
...
float4 Evaluate_GGXRefraction_BSDF(float3 view_dir_ts, float3 sampled_normal_ts, float3 refr_dir_ts, float roughness2, float eta, float3 refr_col)
{
    ...
    do
    {
        ...
        _8919 = float4(refr_col * (((((_2877 * _2893) * _2885) * clamp(dot(view_dir_ts, sampled_normal_ts), 0.0f, 1.0f)) * _2913) / view_dir_ts.z), (((_2877 * _2885) * clamp(dot(view_dir_ts, sampled_normal_ts), 0.0f, 1.0f)) * _2913) / view_dir_ts.z);
        break;
    } while(false);
    return _8919;
}
...
float4 Sample_GGXRefraction_BSDF(float3 T, float3 B, float3 N, float3 I, float roughness, float eta, float3 refr_col, float rand_u, float rand_v, inout float4 out_V)
{
    ...
    do
    {
        ...
        if ((_2957 * _2957) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            _8924 = float4(refr_col.x * 1000000.0f, refr_col.y * 1000000.0f, refr_col.z * 1000000.0f, 1000000.0f);
            break;
        }
        float3 param = T;
        float3 param_1 = B;
        ...
        _8924 = Evaluate_GGXRefraction_BSDF(param_8, param_9, param_10, param_11, param_12, param_13);
        break;
    } while(false);
    return _8924;
}
...
float BRDF_PrincipledDiffuse(float3 V, float3 N, float3 L, float3 H, float roughness)
{
    ...
    do
    {
        ...
        _8944 = lerp(1.0f, _2195, schlick_weight(param)) * lerp(1.0f, _2195, schlick_weight(param_1));
        break;
    } while(false);
    return _8944;
}
...
float D_GTR1(float NDotH, float a)
{
    ...
    do
    {
        if (a >= 1.0f)
        {
            _8949 = 0.3183098733425140380859375f;
            break;
        }
        float _2074 = mad(a, a, -1.0f);
        _8949 = _2074 / ((3.1415927410125732421875f * log(a * a)) * mad(_2074 * NDotH, NDotH, 1.0f));
        break;
    } while(false);
    return _8949;
}
...
float4 Sample_PrincipledClearcoat_BSDF(float3 T, float3 B, float3 N, float3 I, float clearcoat_roughness2, float clearcoat_ior, float clearcoat_F0, float rand_u, float rand_v, inout float3 out_V)
{
    ...
    do
    {
        ...
        if ((clearcoat_roughness2 * clearcoat_roughness2) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            _8929 = float4(_2794, _2794, _2794, 1000000.0f);
            break;
        }
        float3 param_2 = T;
        float3 param_3 = B;
        ...
        _8929 = Evaluate_PrincipledClearcoat_BSDF(param_14, param_15, param_16, param_17, param_18, param_19);
        break;
    } while(false);
    return _8929;
}
...
float3 ShadeSurface(int px_index, hit_data_t inter, ray_data_t ray)
{
    ...
    do
    {
        ...
        {
            float3 env_col = _3223_g_params.env_col.xyz;
            uint _4816 = asuint(_3223_g_params.env_col.w);
            if (_4816 != 4294967295u)
            {
                ...
                uint _9823[14] = { _4823.pos[0], _4823.pos[1], _4823.pos[2], _4823.pos[3], _4823.pos[4], _4823.pos[5], _4823.pos[6], _4823.pos[7], _4823.pos[8], _4823.pos[9], _4823.pos[10], _4823.pos[11], _4823.pos[12], _4823.pos[13] };
                uint _9794[4] = { _4823.page[0], _4823.page[1], _4823.page[2], _4823.page[3] };
                atlas_texture_t _9447 = { _4823.size, _4823.atlas, _9794, _9823 };
                float param = _3223_g_params.env_rotation;
                env_col *= SampleLatlong_RGBE(_9447, _4803, param);
            ...
            _8904 = float3(ray.c[0] * env_col.x, ray.c[1] * env_col.y, ray.c[2] * env_col.z);
            break;
        }
        ...
        if (inter.obj_index < 0)
        {
            ...
            _8904 = float3(ray.c[0] * lcol.x, ray.c[1] * lcol.y, ray.c[2] * lcol.z);
            break;
        }
        ...
        uint _9824 = _5249.textures[0];
        uint _9825 = _5249.textures[1];
        uint _9826 = _5249.textures[2];
        uint _9827 = _5249.textures[3];
        uint _9828 = _5249.textures[4];
        float _9829 = _5249.base_color[0];
        float _9830 = _5249.base_color[1];
        float _9831 = _5249.base_color[2];
        uint _9464 = _5249.flags;
        uint _9465 = _5249.type;
        float _9466 = _5249.tangent_rotation_or_strength;
        uint _9467 = _5249.roughness_and_anisotropic;
        float _9468 = _5249.int_ior;
        float _9469 = _5249.ext_ior;
        uint _9470 = _5249.sheen_and_sheen_tint;
        uint _9471 = _5249.tint_and_metallic;
        uint _9472 = _5249.transmission_and_transmission_roughness;
        uint _9473 = _5249.specular_and_specular_tint;
        uint _9474 = _5249.clearcoat_and_clearcoat_roughness;
        uint _9475 = _5249.normal_map_strength_unorm;
        transform_t _5306;
        ...
        if (_5227)
        {
            ...
            _9824 = _5616.textures[0];
            _9825 = _5616.textures[1];
            _9826 = _5616.textures[2];
            _9827 = _5616.textures[3];
            _9828 = _5616.textures[4];
            _9829 = _5616.base_color[0];
            _9830 = _5616.base_color[1];
            _9831 = _5616.base_color[2];
            _9464 = _5616.flags;
            _9465 = _5616.type;
            _9466 = _5616.tangent_rotation_or_strength;
            _9467 = _5616.roughness_and_anisotropic;
            _9468 = _5616.int_ior;
            _9469 = _5616.ext_ior;
            _9470 = _5616.sheen_and_sheen_tint;
            _9471 = _5616.tint_and_metallic;
            _9472 = _5616.transmission_and_transmission_roughness;
            _9473 = _5616.specular_and_specular_tint;
            _9474 = _5616.clearcoat_and_clearcoat_roughness;
            _9475 = _5616.normal_map_strength_unorm;
            plane_N = -plane_N;
            N = -N;
            B = -B;
            T = -T;
        ...
        while (_9465 == 4u)
        {
            ...
            {
                mix_val *= SampleBilinear(_9825, _5538, 0).x;
            }
            if (_5227)
            {
                _5816 = _9469 / _9468;
            ...
            if (mix_rand > _5850)
            {
                ...
                {
                    _5873.textures[_113ident] = _4512.Load(_113ident * 4 + _9827 * 80 + 0);
                }
                [unroll]
                for (int _114ident = 0; _114ident < 3; _114ident++)
                {
                    _5873.base_color[_114ident] = asfloat(_4512.Load(_114ident * 4 + _9827 * 80 + 20));
                }
                _5873.flags = _4512.Load(_9827 * 80 + 32);
                _5873.type = _4512.Load(_9827 * 80 + 36);
                _5873.tangent_rotation_or_strength = asfloat(_4512.Load(_9827 * 80 + 40));
                _5873.roughness_and_anisotropic = _4512.Load(_9827 * 80 + 44);
                _5873.int_ior = asfloat(_4512.Load(_9827 * 80 + 48));
                _5873.ext_ior = asfloat(_4512.Load(_9827 * 80 + 52));
                _5873.sheen_and_sheen_tint = _4512.Load(_9827 * 80 + 56);
                _5873.tint_and_metallic = _4512.Load(_9827 * 80 + 60);
                _5873.transmission_and_transmission_roughness = _4512.Load(_9827 * 80 + 64);
                _5873.specular_and_specular_tint = _4512.Load(_9827 * 80 + 68);
                _5873.clearcoat_and_clearcoat_roughness = _4512.Load(_9827 * 80 + 72);
                _5873.normal_map_strength_unorm = _4512.Load(_9827 * 80 + 76);
                _9824 = _5873.textures[0];
                _9825 = _5873.textures[1];
                _9826 = _5873.textures[2];
                _9827 = _5873.textures[3];
                _9828 = _5873.textures[4];
                _9829 = _5873.base_color[0];
                _9830 = _5873.base_color[1];
                _9831 = _5873.base_color[2];
                _9464 = _5873.flags;
                _9465 = _5873.type;
                _9466 = _5873.tangent_rotation_or_strength;
                _9467 = _5873.roughness_and_anisotropic;
                _9468 = _5873.int_ior;
                _9469 = _5873.ext_ior;
                _9470 = _5873.sheen_and_sheen_tint;
                _9471 = _5873.tint_and_metallic;
                _9472 = _5873.transmission_and_transmission_roughness;
                _9473 = _5873.specular_and_specular_tint;
                _9474 = _5873.clearcoat_and_clearcoat_roughness;
                _9475 = _5873.normal_map_strength_unorm;
            ...
            else
            {
                ...
                {
                    _5941.textures[_115ident] = _4512.Load(_115ident * 4 + _9828 * 80 + 0);
                }
                [unroll]
                for (int _116ident = 0; _116ident < 3; _116ident++)
                {
                    _5941.base_color[_116ident] = asfloat(_4512.Load(_116ident * 4 + _9828 * 80 + 20));
                }
                _5941.flags = _4512.Load(_9828 * 80 + 32);
                _5941.type = _4512.Load(_9828 * 80 + 36);
                _5941.tangent_rotation_or_strength = asfloat(_4512.Load(_9828 * 80 + 40));
                _5941.roughness_and_anisotropic = _4512.Load(_9828 * 80 + 44);
                _5941.int_ior = asfloat(_4512.Load(_9828 * 80 + 48));
                _5941.ext_ior = asfloat(_4512.Load(_9828 * 80 + 52));
                _5941.sheen_and_sheen_tint = _4512.Load(_9828 * 80 + 56);
                _5941.tint_and_metallic = _4512.Load(_9828 * 80 + 60);
                _5941.transmission_and_transmission_roughness = _4512.Load(_9828 * 80 + 64);
                _5941.specular_and_specular_tint = _4512.Load(_9828 * 80 + 68);
                _5941.clearcoat_and_clearcoat_roughness = _4512.Load(_9828 * 80 + 72);
                _5941.normal_map_strength_unorm = _4512.Load(_9828 * 80 + 76);
                _9824 = _5941.textures[0];
                _9825 = _5941.textures[1];
                _9826 = _5941.textures[2];
                _9827 = _5941.textures[3];
                _9828 = _5941.textures[4];
                _9829 = _5941.base_color[0];
                _9830 = _5941.base_color[1];
                _9831 = _5941.base_color[2];
                _9464 = _5941.flags;
                _9465 = _5941.type;
                _9466 = _5941.tangent_rotation_or_strength;
                _9467 = _5941.roughness_and_anisotropic;
                _9468 = _5941.int_ior;
                _9469 = _5941.ext_ior;
                _9470 = _5941.sheen_and_sheen_tint;
                _9471 = _5941.tint_and_metallic;
                _9472 = _5941.transmission_and_transmission_roughness;
                _9473 = _5941.specular_and_specular_tint;
                _9474 = _5941.clearcoat_and_clearcoat_roughness;
                _9475 = _5941.normal_map_strength_unorm;
                mix_rand /= mix_val;
            }
        }
        [branch]
        if (_9824 != 4294967295u)
        {
            float3 normals = (float3(SampleBilinear(_9824, _5538, 0).xy, 1.0f) * 2.0f) - 1.0f.xxx;
            if ((_855.Load(_9824 * 80 + 0) & 16384u) != 0u)
            {
                float3 _10183 = normals;
                _10183.z = sqrt(1.0f - dot(normals.xy, normals.xy));
                normals = _10183;
            }
            float3 _6025 = N;
            N = normalize(((T * normals.x) + (_6025 * normals.z)) + (B * normals.y));
            if ((_9475 & 65535u) != 65535u)
            {
                N = normalize(_6025 + ((N - _6025) * clamp(float(_9475 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f)));
            }
        ...
        if (_6130)
        {
            ...
            light_sample_t _9574 = { _9562, _9563, _9564, _9565, _9566, _9567 };
            light_sample_t param_33 = _9574;
            ...
            _9565 = param_33.dist;
            _9566 = param_33.pdf;
            _9567 = param_33.cast_shadow;
        }
        float _6145 = dot(N, _9563);
        float3 base_color = float3(_9829, _9830, _9831);
        [branch]
        if (_9825 != 4294967295u)
        {
            base_color *= SampleBilinear(_9825, _5538, int(get_texture_lod(texSize(_9825), _5736)), true, true).xyz;
        }
        ...
        float roughness = clamp(float(_9467 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
        [branch]
        if (_9826 != 4294967295u)
        {
            roughness *= SampleBilinear(_9826, _5538, int(get_texture_lod(texSize(_9826), _5736)), false, true).x;
        }
        ...
        {
            [branch]
            if ((_9566 > 0.0f) && (_6145 > 0.0f))
            {
                float3 param_34 = -_4803;
                float3 param_35 = N;
                float3 param_36 = _9563;
                ...
                if (_9564 > 0.0f)
                {
                    float param_39 = _9566;
                    float param_40 = _6284.w;
                    mis_weight = power_heuristic(param_39, param_40);
                }
                float3 _6312 = (_9562 * _6284.xyz) * ((mix_weight * mis_weight) / _9566);
                [branch]
                if (_9567 > 0.5f)
                {
                    ...
                    _6385.Store(_6377 * 44 + 12, asuint(_9563.x));
                    _6385.Store(_6377 * 44 + 16, asuint(_9563.y));
                    _6385.Store(_6377 * 44 + 20, asuint(_9563.z));
                    _6385.Store(_6377 * 44 + 24, asuint(_9565 - 9.9999997473787516355514526367188e-05f));
            ...
            if (_6436)
            {
                ...
                _9887 = param_51.y;
                _9888 = param_51.z;
                _9893 = ((ray.c[0] * _6458.x) * mix_weight) / _6458.w;
                _9894 = ((ray.c[1] * _6458.y) * mix_weight) / _6458.w;
                _9895 = ((ray.c[2] * _6458.z) * mix_weight) / _6458.w;
                _9595 = _6458.w;
            }
        }
        else
        {
            ...
            if (_9465 == 1u)
            {
                ...
                if (_6548 && (_6145 > 0.0f))
                {
                    ...
                    float3 param_61 = B;
                    float3 param_62 = N;
                    float3 param_63 = _9563;
                    float3 param_64 = T;
                    float3 param_65 = B;
                    float3 param_66 = N;
                    float3 param_67 = normalize(_9563 - _4803);
                    ...
                    if (_9564 > 0.0f)
                    {
                        float param_76 = _9566;
                        float param_77 = _6608.w;
                        mis_weight_1 = power_heuristic(param_76, param_77);
                    }
                    float3 _6636 = (_9562 * _6608.xyz) * ((mix_weight * mis_weight_1) / _9566);
                    [branch]
                    if (_9567 > 0.5f)
                    {
                        ...
                        _6385.Store(_6694 * 44 + 12, asuint(_9563.x));
                        _6385.Store(_6694 * 44 + 16, asuint(_9563.y));
                        _6385.Store(_6694 * 44 + 20, asuint(_9563.z));
                        _6385.Store(_6694 * 44 + 24, asuint(_9565 - 9.9999997473787516355514526367188e-05f));
                ...
                if (_6740)
                {
                    ...
                    _9887 = param_84.y;
                    _9888 = param_84.z;
                    _9893 = ((ray.c[0] * _6759.x) * mix_weight) / _6759.w;
                    _9894 = ((ray.c[1] * _6759.y) * mix_weight) / _6759.w;
                    _9895 = ((ray.c[2] * _6759.z) * mix_weight) / _6759.w;
                    _9595 = _6759.w;
                }
            }
            else
            {
                ...
                if (_9465 == 2u)
                {
                    ...
                    if (_6862 && (_6145 < 0.0f))
                    {
                        ...
                        float3 param_92 = B;
                        float3 param_93 = N;
                        float3 param_94 = _9563;
                        float3 param_95 = T;
                        float3 param_96 = B;
                        float3 param_97 = N;
                        float3 param_98 = normalize(_9563 - (_4803 * _6834));
                        ...
                        if (_9564 > 0.0f)
                        {
                            float param_105 = _9566;
                            float param_106 = _6921.w;
                            mis_weight_2 = power_heuristic(param_105, param_106);
                        }
                        float3 _6949 = (_9562 * _6921.xyz) * ((mix_weight * mis_weight_2) / _9566);
                        [branch]
                        if (_9567 > 0.5f)
                        {
                            ...
                            _6385.Store(_7008 * 44 + 12, asuint(_9563.x));
                            _6385.Store(_7008 * 44 + 16, asuint(_9563.y));
                            _6385.Store(_7008 * 44 + 20, asuint(_9563.z));
                            _6385.Store(_7008 * 44 + 24, asuint(_9565 - 9.9999997473787516355514526367188e-05f));
                    ...
                    if (_7054)
                    {
                        ...
                        _9600 = ray.ray_depth + 65536;
                        _9893 = ((ray.c[0] * _7078.x) * mix_weight) / _7078.w;
                        _9894 = ((ray.c[1] * _7078.y) * mix_weight) / _7078.w;
                        _9895 = ((ray.c[2] * _7078.z) * mix_weight) / _7078.w;
                        _9595 = _7078.w;
                    ...
                    if (_9465 == 3u)
                    {
                        ...
                        if ((_9464 & 4u) != 0u)
                        {
                            ...
                            if (_7172 != 4294967295u)
                            {
                                ...
                                uint _10000[14] = { _7179.pos[0], _7179.pos[1], _7179.pos[2], _7179.pos[3], _7179.pos[4], _7179.pos[5], _7179.pos[6], _7179.pos[7], _7179.pos[8], _7179.pos[9], _7179.pos[10], _7179.pos[11], _7179.pos[12], _7179.pos[13] };
                                uint _9971[4] = { _7179.page[0], _7179.page[1], _7179.page[2], _7179.page[3] };
                                atlas_texture_t _9765 = { _7179.size, _7179.atlas, _9971, _10000 };
                                float param_121 = _3223_g_params.env_rotation;
                                env_col_1 *= SampleLatlong_RGBE(_9765, _4803, param_121);
                            }
                        ...
                        if ((_9464 & 5u) != 0u)
                        {
                            float3 _7281 = mul(float4(_5554, 0.0f), _5306.xform).xyz;
                            float _7284 = length(_7281);
                            float _7296 = abs(dot(_4803, _7281 / _7284.xxx));
                            if (_7296 > 0.0f)
                            {
                                float param_122 = ray.pdf;
                                float param_123 = (inter.t * inter.t) / ((0.5f * _7284) * _7296);
                                mis_weight_3 = power_heuristic(param_122, param_123);
                            }
                        }
                        col += (base_color * ((mix_weight * mis_weight_3) * _9466));
                    }
                    else
                    {
                        [branch]
                        if (_9465 == 5u)
                        {
                            bool _7338 = _5771 < _3223_g_params.max_transp_depth;
                            bool _7345;
                            if (_7338)
                            {
                                _7345 = _5779 < _3223_g_params.max_total_depth;
                            }
                            else
                            {
                                _7345 = _7338;
                            ...
                            if (_7345)
                            {
                                _9600 = ray.ray_depth + 16777216;
                                _9595 = ray.pdf;
                                float3 param_124 = _4926;
                                float3 param_125 = -plane_N;
                                float3 _7362 = offset_ray(param_124, param_125);
                                _9879 = _7362.x;
                                _9880 = _7362.y;
                                _9881 = _7362.z;
                                _9886 = ray.d[0];
                        ...
                        else
                        {
                            if (_9465 == 6u)
                            {
                                float metallic = clamp(float((_9471 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                                [branch]
                                if (_9827 != 4294967295u)
                                {
                                    metallic *= SampleBilinear(_9827, _5538, int(get_texture_lod(texSize(_9827), _5736))).x;
                                }
                                float specular = clamp(float(_9473 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                                [branch]
                                if (_9828 != 4294967295u)
                                {
                                    specular *= SampleBilinear(_9828, _5538, int(get_texture_lod(texSize(_9828), _5736))).x;
                                }
                                float _7472 = clamp(float(_9474 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                                float _7480 = clamp(float((_9474 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                                float _7487 = clamp(float(_9470 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                                float3 _7509 = lerp(lerp(1.0f.xxx, tint_color, clamp(float((_9473 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * (specular * 0.07999999821186065673828125f), base_color, metallic.xxx);
                                float _7516 = (2.0f / (1.0f - sqrt(0.07999999821186065673828125f * specular))) - 1.0f;
                                float param_126 = 1.0f;
                                float param_127 = _7516;
                                float _7521 = fresnel_dielectric_cos(param_126, param_127);
                                float param_128 = dot(_4803, N);
                                float param_129 = _7516;
                                float param_130;
                                float param_131;
                                float param_132;
                                float param_133;
                                get_lobe_weights(lerp(_6189, 1.0f, _7487), lum(lerp(_7509, 1.0f.xxx, ((fresnel_dielectric_cos(param_128, param_129) - _7521) / (1.0f - _7521)).xxx)), specular, metallic, clamp(float(_9472 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), _7472, param_130, param_131, param_132, param_133);
                                float3 _7575 = lerp(1.0f.xxx, tint_color, clamp(float((_9470 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * _7487;
                                float _7578;
                                if (_5227)
                                {
                                    _7578 = _9468 / _9469;
                                ...
                                float param_134 = dot(_4803, N);
                                float param_135 = 1.0f / _7578;
                                float _7601 = fresnel_dielectric_cos(param_134, param_135);
                                float _7608 = (2.0f / (1.0f - sqrt(0.07999999821186065673828125f * _7472))) - 1.0f;
                                float param_136 = 1.0f;
                                float param_137 = _7608;
                                float _7613 = fresnel_dielectric_cos(param_136, param_137);
                                float _7617 = _7480 * _7480;
                                float _7630 = mad(roughness - 1.0f, 1.0f - clamp(float((_9472 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), 1.0f);
                                float _7634 = _7630 * _7630;
                                [branch]
                                if (_9566 > 0.0f)
                                {
                                    float3 lcol_1 = 0.0f.xxx;
                                    float bsdf_pdf = 0.0f;
                                    bool _7645 = _6145 > 0.0f;
                                    [branch]
                                    if ((param_130 > 1.0000000116860974230803549289703e-07f) && _7645)
                                    {
                                        float3 param_138 = -_4803;
                                        float3 param_139 = N;
                                        float3 param_140 = _9563;
                                        float param_141 = roughness;
                                        float3 param_142 = base_color.xyz;
                                        float3 param_143 = _7575;
                                        bool param_144 = false;
                                        float4 _7665 = Evaluate_PrincipledDiffuse_BSDF(param_138, param_139, param_140, param_141, param_142, param_143, param_144);
                                        bsdf_pdf = mad(param_130, _7665.w, bsdf_pdf);
                                        lcol_1 += (((_9562 * _6145) * (_7665 * (1.0f - metallic)).xyz) / (3.1415927410125732421875f * _9566).xxx);
                                    }
                                    float3 H;
                                    [flatten]
                                    if (_7645)
                                    {
                                        H = normalize(_9563 - _4803);
                                    }
                                    else
                                    {
                                        H = normalize(_9563 - (_4803 * _7578));
                                    }
                                    float _7711 = roughness * roughness;
                                    float _7722 = sqrt(mad(-0.89999997615814208984375f, clamp(float((_9467 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), 1.0f));
                                    float _7726 = _7711 / _7722;
                                    float _7730 = _7711 * _7722;
                                    float3 param_145 = T;
                                    float3 param_146 = B;
                                    float3 param_147 = N;
                                    float3 param_148 = -_4803;
                                    float3 _7741 = tangent_from_world(param_145, param_146, param_147, param_148);
                                    float3 param_149 = T;
                                    float3 param_150 = B;
                                    float3 param_151 = N;
                                    float3 param_152 = _9563;
                                    float3 _7752 = tangent_from_world(param_149, param_150, param_151, param_152);
                                    float3 param_153 = T;
                                    float3 param_154 = B;
                                    float3 param_155 = N;
                                    float3 param_156 = H;
                                    float3 _7762 = tangent_from_world(param_153, param_154, param_155, param_156);
                                    bool _7764 = param_131 > 0.0f;
                                    bool _7771;
                                    if (_7764)
                                    {
                                        _7771 = (_7726 * _7730) >= 1.0000000116860974230803549289703e-07f;
                                    }
                                    else
                                    {
                                        _7771 = _7764;
                                    ...
                                    if (_7771 && _7645)
                                    {
                                        float3 param_157 = _7741;
                                        float3 param_158 = _7762;
                                        float3 param_159 = _7752;
                                        float param_160 = _7726;
                                        float param_161 = _7730;
                                        float param_162 = _7516;
                                        float param_163 = _7521;
                                        float3 param_164 = _7509;
                                        float4 _7794 = Evaluate_GGXSpecular_BSDF(param_157, param_158, param_159, param_160, param_161, param_162, param_163, param_164);
                                        bsdf_pdf = mad(param_131, _7794.w, bsdf_pdf);
                                        lcol_1 += ((_9562 * _7794.xyz) / _9566.xxx);
                                    }
                                    bool _7813 = param_132 > 0.0f;
                                    bool _7820;
                                    if (_7813)
                                    {
                                        _7820 = (_7617 * _7617) >= 1.0000000116860974230803549289703e-07f;
                                    }
                                    else
                                    {
                                        _7820 = _7813;
                                    ...
                                    if (_7820 && _7645)
                                    {
                                        float3 param_165 = _7741;
                                        float3 param_166 = _7762;
                                        float3 param_167 = _7752;
                                        float param_168 = _7617;
                                        float param_169 = _7608;
                                        float param_170 = _7613;
                                        float4 _7839 = Evaluate_PrincipledClearcoat_BSDF(param_165, param_166, param_167, param_168, param_169, param_170);
                                        bsdf_pdf = mad(param_132, _7839.w, bsdf_pdf);
                                        lcol_1 += (((_9562 * 0.25f) * _7839.xyz) / _9566.xxx);
                                    }
                                    [branch]
                                    if (param_133 > 0.0f)
                                    {
                                        bool _7863 = _7601 != 0.0f;
                                        bool _7870;
                                        if (_7863)
                                        {
                                            _7870 = (_7711 * _7711) >= 1.0000000116860974230803549289703e-07f;
                                        }
                                        else
                                        {
                                            _7870 = _7863;
                                        ...
                                        if (_7870 && _7645)
                                        {
                                            float3 param_171 = _7741;
                                            float3 param_172 = _7762;
                                            float3 param_173 = _7752;
                                            float param_174 = _7711;
                                            float param_175 = _7711;
                                            float param_176 = 1.0f;
                                            float param_177 = 0.0f;
                                            float3 param_178 = 1.0f.xxx;
                                            float4 _7890 = Evaluate_GGXSpecular_BSDF(param_171, param_172, param_173, param_174, param_175, param_176, param_177, param_178);
                                            bsdf_pdf = mad(param_133 * _7601, _7890.w, bsdf_pdf);
                                            lcol_1 += ((_9562 * _7890.xyz) * (_7601 / _9566));
                                        }
                                        bool _7912 = _7601 != 1.0f;
                                        bool _7919;
                                        if (_7912)
                                        {
                                            _7919 = (_7634 * _7634) >= 1.0000000116860974230803549289703e-07f;
                                        }
                                        else
                                        {
                                            _7919 = _7912;
                                        ...
                                        if (_7919 && (_6145 < 0.0f))
                                        {
                                            float3 param_179 = _7741;
                                            float3 param_180 = _7762;
                                            float3 param_181 = _7752;
                                            float param_182 = _7634;
                                            float param_183 = _7578;
                                            float3 param_184 = base_color;
                                            float4 _7938 = Evaluate_GGXRefraction_BSDF(param_179, param_180, param_181, param_182, param_183, param_184);
                                            float _7941 = 1.0f - _7601;
                                            bsdf_pdf = mad(param_133 * _7941, _7938.w, bsdf_pdf);
                                            lcol_1 += ((_9562 * _7938.xyz) * (_7941 / _9566));
                                        }
                                    }
                                    ...
                                    if (_9567 > 0.5f)
                                    {
                                        ...
                                        float3 param_187 = _4926;
                                        float3 param_188 = _7986;
                                        float3 _7997 = offset_ray(param_187, param_188);
                                        uint _8044;
                                        _6375.InterlockedAdd(8, 1u, _8044);
                                        _6385.Store(_8044 * 44 + 0, asuint(_7997.x));
                                        _6385.Store(_8044 * 44 + 4, asuint(_7997.y));
                                        _6385.Store(_8044 * 44 + 8, asuint(_7997.z));
                                        _6385.Store(_8044 * 44 + 12, asuint(_9563.x));
                                        _6385.Store(_8044 * 44 + 16, asuint(_9563.y));
                                        _6385.Store(_8044 * 44 + 20, asuint(_9563.z));
                                        _6385.Store(_8044 * 44 + 24, asuint(_9565 - 9.9999997473787516355514526367188e-05f));
                                        _6385.Store(_8044 * 44 + 28, asuint(ray.c[0] * lcol_1.x));
                                        _6385.Store(_8044 * 44 + 32, asuint(ray.c[1] * lcol_1.y));
                                        _6385.Store(_8044 * 44 + 36, asuint(ray.c[2] * lcol_1.z));
                                        _6385.Store(_8044 * 44 + 40, uint(ray.xy));
                                    }
                                    else
                                    {
                                        col += lcol_1;
                                ...
                                {
                                    bool _8088 = _5755 < _3223_g_params.max_diff_depth;
                                    bool _8095;
                                    if (_8088)
                                    {
                                        _8095 = _5779 < _3223_g_params.max_total_depth;
                                    }
                                    else
                                    {
                                        _8095 = _8088;
                                    ...
                                    if (_8095)
                                    {
                                        ...
                                        float3 param_190 = B;
                                        float3 param_191 = N;
                                        float3 param_192 = _4803;
                                        float param_193 = roughness;
                                        float3 param_194 = base_color.xyz;
                                        float3 param_195 = _7575;
                                        bool param_196 = false;
                                        float param_197 = _6234;
                                        float param_198 = _6244;
                                        float3 param_199;
                                        float4 _8120 = Sample_PrincipledDiffuse_BSDF(param_189, param_190, param_191, param_192, param_193, param_194, param_195, param_196, param_197, param_198, param_199);
                                        float3 _8126 = _8120.xyz * (1.0f - metallic);
                                        _9600 = ray.ray_depth + 1;
                                        float3 param_200 = _4926;
                                        float3 param_201 = plane_N;
                                        float3 _8142 = offset_ray(param_200, param_201);
                                        _9879 = _8142.x;
                                        _9880 = _8142.y;
                                        _9881 = _8142.z;
                                        _9886 = param_199.x;
                                        _9887 = param_199.y;
                                        _9888 = param_199.z;
                                        _9893 = ((ray.c[0] * _8126.x) * mix_weight) / param_130;
                                        _9894 = ((ray.c[1] * _8126.y) * mix_weight) / param_130;
                                        _9895 = ((ray.c[2] * _8126.z) * mix_weight) / param_130;
                                        _9595 = _8120.w;
                                    }
                                }
                                else
                                {
                                    float _8198 = param_130 + param_131;
                                    [branch]
                                    if (mix_rand < _8198)
                                    {
                                        bool _8205 = _5760 < _3223_g_params.max_spec_depth;
                                        bool _8212;
                                        if (_8205)
                                        {
                                            _8212 = _5779 < _3223_g_params.max_total_depth;
                                        }
                                        else
                                        {
                                            _8212 = _8205;
                                        ...
                                        if (_8212)
                                        {
                                            ...
                                            float3 param_203 = B;
                                            float3 param_204 = N;
                                            float3 param_205 = _4803;
                                            float3 param_206;
                                            float4 _8239 = Sample_GGXSpecular_BSDF(param_202, param_203, param_204, param_205, roughness, clamp(float((_9467 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), _7516, _7521, _7509, _6234, _6244, param_206);
                                            float _8244 = _8239.w * param_131;
                                            _9600 = ray.ray_depth + 256;
                                            _9893 = ((ray.c[0] * _8239.x) * mix_weight) / _8244;
                                            _9894 = ((ray.c[1] * _8239.y) * mix_weight) / _8244;
                                            _9895 = ((ray.c[2] * _8239.z) * mix_weight) / _8244;
                                            _9595 = _8244;
                                            float3 param_207 = _4926;
                                            float3 param_208 = plane_N;
                                            float3 _8291 = offset_ray(param_207, param_208);
                                            _9879 = _8291.x;
                                            _9880 = _8291.y;
                                            _9881 = _8291.z;
                                            _9886 = param_206.x;
                                    ...
                                    {
                                        float _8316 = _8198 + param_132;
                                        [branch]
                                        if (mix_rand < _8316)
                                        {
                                            bool _8323 = _5760 < _3223_g_params.max_spec_depth;
                                            bool _8330;
                                            if (_8323)
                                            {
                                                _8330 = _5779 < _3223_g_params.max_total_depth;
                                            }
                                            else
                                            {
                                                _8330 = _8323;
                                            ...
                                            if (_8330)
                                            {
                                                ...
                                                float3 param_210 = B;
                                                float3 param_211 = N;
                                                float3 param_212 = _4803;
                                                float param_213 = _7617;
                                                float param_214 = _7608;
                                                float param_215 = _7613;
                                                float param_216 = _6234;
                                                float param_217 = _6244;
                                                float3 param_218;
                                                float4 _8354 = Sample_PrincipledClearcoat_BSDF(param_209, param_210, param_211, param_212, param_213, param_214, param_215, param_216, param_217, param_218);
                                                float _8359 = _8354.w * param_132;
                                                _9600 = ray.ray_depth + 256;
                                                _9893 = (((0.25f * ray.c[0]) * _8354.x) * mix_weight) / _8359;
                                                _9894 = (((0.25f * ray.c[1]) * _8354.y) * mix_weight) / _8359;
                                                _9895 = (((0.25f * ray.c[2]) * _8354.z) * mix_weight) / _8359;
                                                _9595 = _8359;
                                                float3 param_219 = _4926;
                                                float3 param_220 = plane_N;
                                                float3 _8409 = offset_ray(param_219, param_220);
                                                _9879 = _8409.x;
                                                _9880 = _8409.y;
                                                _9881 = _8409.z;
                                                _9886 = param_218.x;
                                        ...
                                        {
                                            bool _8431 = mix_rand >= _7601;
                                            bool _8438;
                                            if (_8431)
                                            {
                                                _8438 = _5765 < _3223_g_params.max_refr_depth;
                                            }
                                            else
                                            {
                                                _8438 = _8431;
                                            ...
                                            if (!_8438)
                                            {
                                                bool _8444 = mix_rand < _7601;
                                                bool _8451;
                                                if (_8444)
                                                {
                                                    _8451 = _5760 < _3223_g_params.max_spec_depth;
                                                }
                                                else
                                                {
                                                    _8451 = _8444;
                                            ...
                                            if (_8452)
                                            {
                                                _8459 = _5779 < _3223_g_params.max_total_depth;
                                            }
                                            else
                                            {
                                                _8459 = _8452;
                                            ...
                                            if (_8459)
                                            {
                                                float _8467 = mix_rand;
                                                float _8471 = (_8467 - _8316) / param_133;
                                                mix_rand = _8471;
                                                float4 F;
                                                float3 V;
                                                [branch]
                                                if (_8471 < _7601)
                                                {
                                                    ...
                                                    float3 param_222 = B;
                                                    float3 param_223 = N;
                                                    float3 param_224 = _4803;
                                                    float3 param_225;
                                                    float4 _8491 = Sample_GGXSpecular_BSDF(param_221, param_222, param_223, param_224, roughness, 0.0f, 1.0f, 0.0f, 1.0f.xxx, _6234, _6244, param_225);
                                                    V = param_225;
                                                    F = _8491;
                                                    _9600 = ray.ray_depth + 256;
                                                    float3 param_226 = _4926;
                                                    float3 param_227 = plane_N;
                                                    float3 _8502 = offset_ray(param_226, param_227);
                                                    _9879 = _8502.x;
                                                    _9880 = _8502.y;
                                                    _9881 = _8502.z;
                                                }
                                                else
                                                {
                                                    ...
                                                    float3 param_229 = B;
                                                    float3 param_230 = N;
                                                    float3 param_231 = _4803;
                                                    float param_232 = _7630;
                                                    float param_233 = _7578;
                                                    float3 param_234 = base_color;
                                                    float param_235 = _6234;
                                                    float param_236 = _6244;
                                                    float4 param_237;
                                                    float4 _8533 = Sample_GGXRefraction_BSDF(param_228, param_229, param_230, param_231, param_232, param_233, param_234, param_235, param_236, param_237);
                                                    F = _8533;
                                                    V = param_237.xyz;
                                                    _9600 = ray.ray_depth + 65536;
                                                    float3 param_238 = _4926;
                                                    float3 param_239 = -plane_N;
                                                    float3 _8547 = offset_ray(param_238, param_239);
                                                    _9879 = _8547.x;
                                                    _9880 = _8547.y;
                                                    _9881 = _8547.z;
                                                }
                                                float4 _10331 = F;
                                                float _8560 = _10331.w * param_133;
                                                float4 _10333 = _10331;
                                                _10333.w = _8560;
                                                F = _10333;
                                                _9893 = ((ray.c[0] * _10331.x) * mix_weight) / _8560;
                                                _9894 = ((ray.c[1] * _10331.y) * mix_weight) / _8560;
                                                _9895 = ((ray.c[2] * _10331.z) * mix_weight) / _8560;
                                                _9595 = _8560;
                                                _9886 = V.x;
                                                _9887 = V.y;
                                                _9888 = V.z;
        ...
        float _8620 = max(_9893, max(_9894, _9895));
        float _8633;
        if (_5779 >= _3223_g_params.termination_start_depth)
        {
            _8633 = max(0.0500000007450580596923828125f, 1.0f - _8620);
        }
        else
        {
            _8633 = 0.0f;
        }
        bool _8647 = (frac(asfloat(_3218.Load((_3223_g_params.hi + 6) * 4 + 0)) + _5742) >= _8633) && (_8620 > 0.0f);
        bool _8653;
        if (_8647)
        {
            _8653 = _9595 > 0.0f;
        ...
        if (_8653)
        {
            float _8657 = 1.0f - _8633;
            float _8659 = _9893;
            float _8660 = _8659 / _8657;
            _9893 = _8660;
            float _8665 = _9894;
            float _8666 = _8665 / _8657;
            _9894 = _8666;
            float _8671 = _9895;
            float _8672 = _8671 / _8657;
            _9895 = _8672;
            uint _8676;
            _6375.InterlockedAdd(0, 1u, _8676);
            _8684.Store(_8676 * 56 + 0, asuint(_9879));
            _8684.Store(_8676 * 56 + 4, asuint(_9880));
            _8684.Store(_8676 * 56 + 8, asuint(_9881));
            _8684.Store(_8676 * 56 + 12, asuint(_9886));
            _8684.Store(_8676 * 56 + 16, asuint(_9887));
            _8684.Store(_8676 * 56 + 20, asuint(_9888));
            _8684.Store(_8676 * 56 + 24, asuint(_9595));
            _8684.Store(_8676 * 56 + 28, asuint(_8660));
            _8684.Store(_8676 * 56 + 32, asuint(_8666));
            _8684.Store(_8676 * 56 + 36, asuint(_8672));
            _8684.Store(_8676 * 56 + 40, asuint(_5726));
            _8684.Store(_8676 * 56 + 44, asuint(ray.cone_spread));
            _8684.Store(_8676 * 56 + 48, uint(ray.xy));
            _8684.Store(_8676 * 56 + 52, uint(_9600));
        }
        _8904 = float3(ray.c[0] * col.x, ray.c[1] * col.y, ray.c[2] * col.z);
        break;
    } while(false);
    return _8904;
}
...
void comp_main()
{
    do
    {
        int _8754 = int((gl_WorkGroupID.x * 64u) + gl_LocalInvocationIndex);
        if (uint(_8754) >= _6375.Load(4))
        {
            break;
        }
        int _8770 = int(_8767.Load(_8754 * 56 + 48));
        int _8773 = (_8770 >> 16) & 65535;
        int _8777 = int(_8767.Load(_8754 * 56 + 48));
        int _8778 = _8777 & 65535;
        hit_data_t _8797;
        _8797.mask = int(_8793.Load(_8754 * 24 + 0));
        _8797.obj_index = int(_8793.Load(_8754 * 24 + 4));
        _8797.prim_index = int(_8793.Load(_8754 * 24 + 8));
        _8797.t = asfloat(_8793.Load(_8754 * 24 + 12));
        _8797.u = asfloat(_8793.Load(_8754 * 24 + 16));
        _8797.v = asfloat(_8793.Load(_8754 * 24 + 20));
        ray_data_t _8813;
        [unroll]
        for (int _119ident = 0; _119ident < 3; _119ident++)
        {
            _8813.o[_119ident] = asfloat(_8767.Load(_119ident * 4 + _8754 * 56 + 0));
        }
        [unroll]
        for (int _120ident = 0; _120ident < 3; _120ident++)
        {
            _8813.d[_120ident] = asfloat(_8767.Load(_120ident * 4 + _8754 * 56 + 12));
        }
        _8813.pdf = asfloat(_8767.Load(_8754 * 56 + 24));
        [unroll]
        for (int _121ident = 0; _121ident < 3; _121ident++)
        {
            _8813.c[_121ident] = asfloat(_8767.Load(_121ident * 4 + _8754 * 56 + 28));
        }
        _8813.cone_width = asfloat(_8767.Load(_8754 * 56 + 40));
        _8813.cone_spread = asfloat(_8767.Load(_8754 * 56 + 44));
        _8813.xy = int(_8767.Load(_8754 * 56 + 48));
        _8813.ray_depth = int(_8767.Load(_8754 * 56 + 52));
        int param = (_8778 * int(_3223_g_params.img_size.x)) + _8773;
        hit_data_t _8965 = { _8797.mask, _8797.obj_index, _8797.prim_index, _8797.t, _8797.u, _8797.v };
        hit_data_t param_1 = _8965;
        float _9003[3] = { _8813.c[0], _8813.c[1], _8813.c[2] };
        float _8996[3] = { _8813.d[0], _8813.d[1], _8813.d[2] };
        float _8989[3] = { _8813.o[0], _8813.o[1], _8813.o[2] };
        ray_data_t _8982 = { _8989, _8996, _8813.pdf, _9003, _8813.cone_width, _8813.cone_spread, _8813.xy, _8813.ray_depth };
        ray_data_t param_2 = _8982;
        float3 _8855 = ShadeSurface(param, param_1, param_2);
        int2 _8862 = int2(_8773, _8778);
        g_out_img[_8862] = float4(_8855 + g_out_img[_8862].xyz, 1.0f);
        break;
    } while(false);
}
