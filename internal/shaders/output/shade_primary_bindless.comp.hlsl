...
ByteAddressBuffer _8702 : register(t10, space0);
...
float3 ensure_valid_reflection(float3 Ng, float3 I, float3 N)
{
    ...
    do
    {
        ...
        if (_1379 && _1385)
        {
            float _10061 = (-0.5f) / _1339;
            float param_1 = mad(_10061, _1363, 1.0f);
            float _1395 = safe_sqrtf(param_1);
            float param_2 = _1364;
            float _1398 = safe_sqrtf(param_2);
            float2 _1399 = float2(_1395, _1398);
            float param_3 = mad(_10061, _1370, 1.0f);
            float _1404 = safe_sqrtf(param_3);
            float param_4 = _1371;
            float _1407 = safe_sqrtf(param_4);
            float2 _1408 = float2(_1404, _1407);
            float _10063 = -_1327;
            float _1424 = mad(2.0f * mad(_1395, _1323, _1398 * _1327), _1398, _10063);
            float _1440 = mad(2.0f * mad(_1404, _1323, _1407 * _1327), _1407, _10063);
        ...
        _8719 = (_1319 * N_new.x) + (Ng * N_new.y);
        break;
    } while(false);
    return _8719;
}
...
float3 MapToCone(float r1, float r2, float3 N, float radius)
{
    ...
    do
    {
        ...
        _8744 = (N + (param * ((radius * r) * cos(theta)))) + (param_1 * ((radius * r) * sin(theta)));
        break;
    } while(false);
    return _8744;
}
...
void SampleLightSource(float3 P, float3 T, float3 B, float3 N, int hi, float2 sample_off, inout light_sample_t ls)
{
    ...
    if (_3394 == 0u)
    {
        ...
        float3 _9827 = sampled_dir;
        float3 _3474 = ((param * _9827.x) + (param_1 * _9827.y)) + (_3431 * _9827.z);
        sampled_dir = _3474;
...
float D_GGX(float3 H, float alpha_x, float alpha_y)
{
    ...
    do
    {
        ...
        _8777 = 1.0f / (((((_2047 * _2047) * 3.1415927410125732421875f) * alpha_x) * alpha_y) * (((H.z * H.z) * H.z) * H.z));
        break;
    } while(false);
    return _8777;
}
...
float4 Sample_GGXSpecular_BSDF(float3 T, float3 B, float3 N, float3 I, float roughness, float anisotropic, float spec_ior, float spec_F0, float3 spec_col, float rand_u, float rand_v, inout float3 out_V)
{
    ...
    do
    {
        ...
        if ((_2658 * _2662) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            out_V = _2673;
            _8749 = float4(_2687.x * 1000000.0f, _2687.y * 1000000.0f, _2687.z * 1000000.0f, 1000000.0f);
            break;
        }
        float3 param_2 = T;
        float3 param_3 = B;
        ...
        _8749 = Evaluate_GGXSpecular_BSDF(param_14, param_15, param_16, param_17, param_18, param_19, param_20, param_21);
        break;
    } while(false);
    return _8749;
}
...
float4 Evaluate_GGXRefraction_BSDF(float3 view_dir_ts, float3 sampled_normal_ts, float3 refr_dir_ts, float roughness2, float eta, float3 refr_col)
{
    ...
    do
    {
        ...
        _8754 = float4(refr_col * (((((_2970 * _2986) * _2978) * clamp(dot(view_dir_ts, sampled_normal_ts), 0.0f, 1.0f)) * _3006) / view_dir_ts.z), (((_2970 * _2978) * clamp(dot(view_dir_ts, sampled_normal_ts), 0.0f, 1.0f)) * _3006) / view_dir_ts.z);
        break;
    } while(false);
    return _8754;
}
...
float4 Sample_GGXRefraction_BSDF(float3 T, float3 B, float3 N, float3 I, float roughness, float eta, float3 refr_col, float rand_u, float rand_v, inout float4 out_V)
{
    ...
    do
    {
        ...
        if ((_3050 * _3050) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            _8759 = float4(refr_col.x * 1000000.0f, refr_col.y * 1000000.0f, refr_col.z * 1000000.0f, 1000000.0f);
            break;
        }
        float3 param = T;
        float3 param_1 = B;
        ...
        _8759 = Evaluate_GGXRefraction_BSDF(param_8, param_9, param_10, param_11, param_12, param_13);
        break;
    } while(false);
    return _8759;
}
...
lobe_weights_t get_lobe_weights(float base_color_lum, float spec_color_lum, float specular, float metallic, float transmission, float clearcoat)
{
    ...
    float _8853 = (base_color_lum * _1502) * (1.0f - transmission);
    ...
    float _8855 = _1523 * _1502;
    float _8856 = _1509 * base_color_lum;
    float _1532 = _8853;
    ...
    lobe_weights_t _8861 = { _8853, _8854, _8855, _8856 };
    return _8861;
}
...
float BRDF_PrincipledDiffuse(float3 V, float3 N, float3 L, float3 H, float roughness)
{
    ...
    do
    {
        ...
        _8782 = lerp(1.0f, _2287, schlick_weight(param)) * lerp(1.0f, _2287, schlick_weight(param_1));
        break;
    } while(false);
    return _8782;
}
...
float D_GTR1(float NDotH, float a)
{
    ...
    do
    {
        if (a >= 1.0f)
        {
            _8787 = 0.3183098733425140380859375f;
            break;
        }
        float _2006 = mad(a, a, -1.0f);
        _8787 = _2006 / ((3.1415927410125732421875f * log(a * a)) * mad(_2006 * NDotH, NDotH, 1.0f));
        break;
    } while(false);
    return _8787;
}
...
float4 Sample_PrincipledClearcoat_BSDF(float3 T, float3 B, float3 N, float3 I, float clearcoat_roughness2, float clearcoat_ior, float clearcoat_F0, float rand_u, float rand_v, inout float3 out_V)
{
    ...
    do
    {
        ...
        if ((clearcoat_roughness2 * clearcoat_roughness2) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            _8772 = float4(_2887, _2887, _2887, 1000000.0f);
            break;
        }
        float3 param_2 = T;
        float3 param_3 = B;
        ...
        _8772 = Evaluate_PrincipledClearcoat_BSDF(param_14, param_15, param_16, param_17, param_18, param_19);
        break;
    } while(false);
    return _8772;
}
        ...
        else
        {
            ...
            else
            {
                ...
                if (_6400)
                {
                    ...
                    float4 _10011 = F;
                    float _6514 = _10011.w * lobe_weights.refraction;
                    float4 _10013 = _10011;
                    _10013.w = _6514;
                    F = _10013;
                    new_ray.c[0] = ((ray.c[0] * _10011.x) * mix_weight) / _6514;
                    new_ray.c[1] = ((ray.c[1] * _10011.y) * mix_weight) / _6514;
                    new_ray.c[2] = ((ray.c[2] * _10011.z) * mix_weight) / _6514;
                    new_ray.pdf = _6514;
                    new_ray.d[0] = V.x;
                    new_ray.d[1] = V.y;
                    new_ray.d[2] = V.z;
...
float3 ShadeSurface(hit_data_t inter, ray_data_t ray, inout float3 out_base_color, inout float3 out_normals)
{
    ...
    do
    {
        ...
        if (inter.mask == 0)
        {
            ...
            _8709 = float3(ray.c[0] * _6579.x, ray.c[1] * _6579.y, ray.c[2] * _6579.z);
            break;
        }
        ...
        if (inter.obj_index < 0)
        {
            ...
            _8709 = float3(ray.c[0] * _6618.x, ray.c[1] * _6618.y, ray.c[2] * _6618.z);
            break;
        }
        ...
        uint _9460 = _6661.textures[0];
        uint _9461 = _6661.textures[1];
        uint _9462 = _6661.textures[2];
        uint _9463 = _6661.textures[3];
        uint _9464 = _6661.textures[4];
        float _9465 = _6661.base_color[0];
        float _9466 = _6661.base_color[1];
        float _9467 = _6661.base_color[2];
        uint _9070 = _6661.flags;
        uint _9071 = _6661.type;
        float _9072 = _6661.tangent_rotation_or_strength;
        uint _9073 = _6661.roughness_and_anisotropic;
        float _9074 = _6661.ior;
        uint _9075 = _6661.sheen_and_sheen_tint;
        uint _9076 = _6661.tint_and_metallic;
        uint _9077 = _6661.transmission_and_transmission_roughness;
        uint _9078 = _6661.specular_and_specular_tint;
        uint _9079 = _6661.clearcoat_and_clearcoat_roughness;
        uint _9080 = _6661.normal_map_strength_unorm;
        transform_t _6716;
        ...
        float3 _9008 = _7005;
        float3 _9007 = cross(_7005, _6921);
        if (_6639)
        {
            ...
            _9460 = _7031.textures[0];
            _9461 = _7031.textures[1];
            _9462 = _7031.textures[2];
            _9463 = _7031.textures[3];
            _9464 = _7031.textures[4];
            _9465 = _7031.base_color[0];
            _9466 = _7031.base_color[1];
            _9467 = _7031.base_color[2];
            _9070 = _7031.flags;
            _9071 = _7031.type;
            _9072 = _7031.tangent_rotation_or_strength;
            _9073 = _7031.roughness_and_anisotropic;
            _9074 = _7031.ior;
            _9075 = _7031.sheen_and_sheen_tint;
            _9076 = _7031.tint_and_metallic;
            _9077 = _7031.transmission_and_transmission_roughness;
            _9078 = _7031.specular_and_specular_tint;
            _9079 = _7031.clearcoat_and_clearcoat_roughness;
            _9080 = _7031.normal_map_strength_unorm;
            _9010 = -_9010;
            _9009 = -_9009;
            _9008 = -_9008;
            _9007 = -_9007;
        }
        float3 param_3 = _9010;
        float4x4 param_4 = _6716.inv_xform;
        _9010 = TransformNormal(param_3, param_4);
        float3 param_5 = _9009;
        float4x4 param_6 = _6716.inv_xform;
        _9009 = TransformNormal(param_5, param_6);
        float3 param_7 = _9008;
        float4x4 param_8 = _6716.inv_xform;
        _9008 = TransformNormal(param_7, param_8);
        float3 param_9 = _9007;
        float4x4 param_10 = _6716.inv_xform;
        _9010 = normalize(_9010);
        _9009 = normalize(_9009);
        _9008 = normalize(_9008);
        _9007 = normalize(TransformNormal(param_9, param_10));
        ...
        while (_9071 == 4u)
        {
            ...
            {
                mix_val *= SampleBilinear(_9461, _6947, 0).x;
            }
            if (_6639)
            {
                _7275 = _7204 / _9074;
            ...
            if (_9074 != 0.0f)
            {
                float param_16 = dot(_6570, _9009);
            ...
            if (mix_rand > _7308)
            {
                ...
                {
                    _7331.textures[_80ident] = _4455.Load(_80ident * 4 + _9463 * 76 + 0);
                }
                [unroll]
                for (int _81ident = 0; _81ident < 3; _81ident++)
                {
                    _7331.base_color[_81ident] = asfloat(_4455.Load(_81ident * 4 + _9463 * 76 + 20));
                }
                _7331.flags = _4455.Load(_9463 * 76 + 32);
                _7331.type = _4455.Load(_9463 * 76 + 36);
                _7331.tangent_rotation_or_strength = asfloat(_4455.Load(_9463 * 76 + 40));
                _7331.roughness_and_anisotropic = _4455.Load(_9463 * 76 + 44);
                _7331.ior = asfloat(_4455.Load(_9463 * 76 + 48));
                _7331.sheen_and_sheen_tint = _4455.Load(_9463 * 76 + 52);
                _7331.tint_and_metallic = _4455.Load(_9463 * 76 + 56);
                _7331.transmission_and_transmission_roughness = _4455.Load(_9463 * 76 + 60);
                _7331.specular_and_specular_tint = _4455.Load(_9463 * 76 + 64);
                _7331.clearcoat_and_clearcoat_roughness = _4455.Load(_9463 * 76 + 68);
                _7331.normal_map_strength_unorm = _4455.Load(_9463 * 76 + 72);
                _9460 = _7331.textures[0];
                _9461 = _7331.textures[1];
                _9462 = _7331.textures[2];
                _9463 = _7331.textures[3];
                _9464 = _7331.textures[4];
                _9465 = _7331.base_color[0];
                _9466 = _7331.base_color[1];
                _9467 = _7331.base_color[2];
                _9070 = _7331.flags;
                _9071 = _7331.type;
                _9072 = _7331.tangent_rotation_or_strength;
                _9073 = _7331.roughness_and_anisotropic;
                _9074 = _7331.ior;
                _9075 = _7331.sheen_and_sheen_tint;
                _9076 = _7331.tint_and_metallic;
                _9077 = _7331.transmission_and_transmission_roughness;
                _9078 = _7331.specular_and_specular_tint;
                _9079 = _7331.clearcoat_and_clearcoat_roughness;
                _9080 = _7331.normal_map_strength_unorm;
            ...
            else
            {
                ...
                {
                    _7397.textures[_82ident] = _4455.Load(_82ident * 4 + _9464 * 76 + 0);
                }
                [unroll]
                for (int _83ident = 0; _83ident < 3; _83ident++)
                {
                    _7397.base_color[_83ident] = asfloat(_4455.Load(_83ident * 4 + _9464 * 76 + 20));
                }
                _7397.flags = _4455.Load(_9464 * 76 + 32);
                _7397.type = _4455.Load(_9464 * 76 + 36);
                _7397.tangent_rotation_or_strength = asfloat(_4455.Load(_9464 * 76 + 40));
                _7397.roughness_and_anisotropic = _4455.Load(_9464 * 76 + 44);
                _7397.ior = asfloat(_4455.Load(_9464 * 76 + 48));
                _7397.sheen_and_sheen_tint = _4455.Load(_9464 * 76 + 52);
                _7397.tint_and_metallic = _4455.Load(_9464 * 76 + 56);
                _7397.transmission_and_transmission_roughness = _4455.Load(_9464 * 76 + 60);
                _7397.specular_and_specular_tint = _4455.Load(_9464 * 76 + 64);
                _7397.clearcoat_and_clearcoat_roughness = _4455.Load(_9464 * 76 + 68);
                _7397.normal_map_strength_unorm = _4455.Load(_9464 * 76 + 72);
                _9460 = _7397.textures[0];
                _9461 = _7397.textures[1];
                _9462 = _7397.textures[2];
                _9463 = _7397.textures[3];
                _9464 = _7397.textures[4];
                _9465 = _7397.base_color[0];
                _9466 = _7397.base_color[1];
                _9467 = _7397.base_color[2];
                _9070 = _7397.flags;
                _9071 = _7397.type;
                _9072 = _7397.tangent_rotation_or_strength;
                _9073 = _7397.roughness_and_anisotropic;
                _9074 = _7397.ior;
                _9075 = _7397.sheen_and_sheen_tint;
                _9076 = _7397.tint_and_metallic;
                _9077 = _7397.transmission_and_transmission_roughness;
                _9078 = _7397.specular_and_specular_tint;
                _9079 = _7397.clearcoat_and_clearcoat_roughness;
                _9080 = _7397.normal_map_strength_unorm;
                mix_rand /= mix_val;
            }
        }
        [branch]
        ...
        {
            float3 normals = (float3(SampleBilinear(_9460, _6947, 0).xy, 1.0f) * 2.0f) - 1.0f.xxx;
            if ((_9460 & 33554432u) != 0u)
            {
                float3 _10032 = normals;
                _10032.z = sqrt(1.0f - dot(normals.xy, normals.xy));
                normals = _10032;
            }
            float3 _7479 = _9009;
            _9009 = normalize(((_9007 * normals.x) + (_7479 * normals.z)) + (_9008 * normals.y));
            if ((_9080 & 65535u) != 65535u)
            {
                _9009 = normalize(_7479 + ((_9009 - _7479) * clamp(float(_9080 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f)));
            }
            float3 param_18 = _9010;
            float3 param_19 = -_6570;
            float3 param_20 = _9009;
            _9009 = ensure_valid_reflection(param_18, param_19, param_20);
        }
        ...
        tangent = _7558;
        float3 _7562 = cross(_7558, _9009);
        ...
        if (_9072 != 0.0f)
        {
            ...
            float3 param_26 = _9009;
            float param_27 = _9072;
            tangent = rotate_around_axis(param_25, param_26, param_27);
        }
        float3 _7595 = normalize(cross(tangent, _9009));
        _9008 = _7595;
        _9007 = cross(_9009, _7595);
        float3 _9159 = 0.0f.xxx;
        float3 _9158 = 0.0f.xxx;
        float _9163 = 0.0f;
        float _9161 = 0.0f;
        float _9162 = 1.0f;
        ...
        if (_7617)
        {
            ...
            float3 param_29 = _9007;
            float3 param_30 = _9008;
            float3 param_31 = _9009;
            int param_32 = _7238;
            float2 param_33 = float2(_7188, _7195);
            light_sample_t _9174 = { _9158, _9159, _9160, _9161, _9162, _9163, _9164, _9165 };
            light_sample_t param_34 = _9174;
            SampleLightSource(param_28, param_29, param_30, param_31, param_32, param_33, param_34);
            _9158 = param_34.col;
            _9159 = param_34.L;
            _9160 = param_34.lp;
            _9161 = param_34.area;
            _9162 = param_34.dist_mul;
            _9163 = param_34.pdf;
            _9164 = param_34.cast_shadow;
            _9165 = param_34.from_env;
        }
        float _7645 = dot(_9009, _9159);
        float3 base_color = float3(_9465, _9466, _9467);
        [branch]
        if (_9461 != 4294967295u)
        {
            base_color *= SampleBilinear(_9461, _6947, int(get_texture_lod(texSize(_9461), _7181)), true, true).xyz;
        }
        ...
        float roughness = clamp(float(_9073 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
        [branch]
        if (_9462 != 4294967295u)
        {
            roughness *= SampleBilinear(_9462, _6947, int(get_texture_lod(texSize(_9462), _7181)), false, true).x;
        }
        ...
        {
            [branch]
            if ((_9163 > 0.0f) && (_7645 > 0.0f))
            {
                light_sample_t _9191 = { _9158, _9159, _9160, _9161, _9162, _9163, _9164, _9165 };
                surface_t _9018 = { _6606, _9007, _9008, _9009, _9010, _6947 };
                float _9696[3] = { _9690, _9691, _9692 };
                float _9661[3] = { _9655, _9656, _9657 };
                float _9626[3] = { _9620, _9621, _9622 };
                shadow_ray_t _9342 = { _9626, _9328, _9661, _9330, _9696, _9332 };
                shadow_ray_t param_35 = _9342;
                float3 _7795 = Evaluate_DiffuseNode(_9191, ray, _9018, base_color, roughness, mix_weight, param_35);
                _9620 = param_35.o[0];
                _9621 = param_35.o[1];
                _9622 = param_35.o[2];
                _9328 = param_35.depth;
                _9655 = param_35.d[0];
                _9656 = param_35.d[1];
                _9657 = param_35.d[2];
                _9330 = param_35.dist;
            ...
            if (_7809)
            {
                surface_t _9025 = { _6606, _9007, _9008, _9009, _9010, _6947 };
                float _9591[3] = { _9585, _9586, _9587 };
                float _9556[3] = { _9550, _9551, _9552 };
                float _9521[3] = { _9515, _9516, _9517 };
                ray_data_t _9241 = { _9521, _9556, _9221, _9591, _9223, _9224, _9225, _9226, _9227 };
                ray_data_t param_36 = _9241;
                Sample_DiffuseNode(ray, _9025, base_color, roughness, _7726, _7735, mix_weight, param_36);
                _9515 = param_36.o[0];
                _9516 = param_36.o[1];
                _9517 = param_36.o[2];
                _9550 = param_36.d[0];
                ...
                _9587 = param_36.c[2];
                _9223 = param_36.ior;
                _9224 = param_36.cone_width;
                _9225 = param_36.cone_spread;
                _9226 = param_36.xy;
                _9227 = param_36.depth;
            }
        }
        else
        {
            ...
            if (_9071 == 1u)
            {
                ...
                if (_7847 && (_7645 > 0.0f))
                {
                    light_sample_t _9200 = { _9158, _9159, _9160, _9161, _9162, _9163, _9164, _9165 };
                    surface_t _9032 = { _6606, _9007, _9008, _9009, _9010, _6947 };
                    float _9703[3] = { _9690, _9691, _9692 };
                    float _9668[3] = { _9655, _9656, _9657 };
                    float _9633[3] = { _9620, _9621, _9622 };
                    shadow_ray_t _9355 = { _9633, _9328, _9668, _9330, _9703, _9332 };
                    shadow_ray_t param_39 = _9355;
                    float3 _7862 = Evaluate_GlossyNode(_9200, ray, _9032, base_color, roughness, 1.5f, _7833, mix_weight, param_39);
                    _9620 = param_39.o[0];
                    _9621 = param_39.o[1];
                    _9622 = param_39.o[2];
                    _9328 = param_39.depth;
                    _9655 = param_39.d[0];
                    _9656 = param_39.d[1];
                    _9657 = param_39.d[2];
                    _9330 = param_39.dist;
                ...
                if (_7876)
                {
                    surface_t _9039 = { _6606, _9007, _9008, _9009, _9010, _6947 };
                    float _9598[3] = { _9585, _9586, _9587 };
                    float _9563[3] = { _9550, _9551, _9552 };
                    float _9528[3] = { _9515, _9516, _9517 };
                    ray_data_t _9260 = { _9528, _9563, _9221, _9598, _9223, _9224, _9225, _9226, _9227 };
                    ray_data_t param_40 = _9260;
                    Sample_GlossyNode(ray, _9039, base_color, roughness, 1.5f, _7833, _7726, _7735, mix_weight, param_40);
                    _9515 = param_40.o[0];
                    _9516 = param_40.o[1];
                    _9517 = param_40.o[2];
                    _9550 = param_40.d[0];
                    ...
                    _9587 = param_40.c[2];
                    _9223 = param_40.ior;
                    _9224 = param_40.cone_width;
                    _9225 = param_40.cone_spread;
                    _9226 = param_40.xy;
                    _9227 = param_40.depth;
                }
            }
            else
            {
                ...
                if (_9071 == 2u)
                {
                    ...
                    if (_7910 && (_7645 < 0.0f))
                    {
                        ...
                        light_sample_t _9209 = { _9158, _9159, _9160, _9161, _9162, _9163, _9164, _9165 };
                        surface_t _9046 = { _6606, _9007, _9008, _9009, _9010, _6947 };
                        float _9710[3] = { _9690, _9691, _9692 };
                        float _9675[3] = { _9655, _9656, _9657 };
                        float _9640[3] = { _9620, _9621, _9622 };
                        shadow_ray_t _9368 = { _9640, _9328, _9675, _9330, _9710, _9332 };
                        shadow_ray_t param_41 = _9368;
                        float3 _7940 = Evaluate_RefractiveNode(_9209, ray, _9046, base_color, _7900, _7918, mix_weight, param_41);
                        _9620 = param_41.o[0];
                        _9621 = param_41.o[1];
                        _9622 = param_41.o[2];
                        _9328 = param_41.depth;
                        _9655 = param_41.d[0];
                        _9656 = param_41.d[1];
                        _9657 = param_41.d[2];
                        _9330 = param_41.dist;
                    ...
                    if (_7954)
                    {
                        surface_t _9053 = { _6606, _9007, _9008, _9009, _9010, _6947 };
                        float _9605[3] = { _9585, _9586, _9587 };
                        float _9570[3] = { _9550, _9551, _9552 };
                        float _9535[3] = { _9515, _9516, _9517 };
                        ray_data_t _9279 = { _9535, _9570, _9221, _9605, _9223, _9224, _9225, _9226, _9227 };
                        ray_data_t param_42 = _9279;
                        Sample_RefractiveNode(ray, _9053, base_color, roughness, _6639, _9074, _7204, _7726, _7735, mix_weight, param_42);
                        _9515 = param_42.o[0];
                        _9516 = param_42.o[1];
                        _9517 = param_42.o[2];
                        _9550 = param_42.d[0];
                        ...
                        _9587 = param_42.c[2];
                        _9223 = param_42.ior;
                        _9224 = param_42.cone_width;
                        _9225 = param_42.cone_spread;
                        _9226 = param_42.xy;
                        _9227 = param_42.depth;
                    }
                }
                else
                {
                    ...
                    if (_9071 == 3u)
                    {
                        col += (base_color * (mix_weight * _9072));
                    }
                    else
                    {
                        [branch]
                        if (_9071 == 6u)
                        {
                            float metallic = clamp(float((_9076 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            [branch]
                            if (_9463 != 4294967295u)
                            {
                                metallic *= SampleBilinear(_9463, _6947, int(get_texture_lod(texSize(_9463), _7181))).x;
                            }
                            float specular = clamp(float(_9078 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            [branch]
                            if (_9464 != 4294967295u)
                            {
                                specular *= SampleBilinear(_9464, _6947, int(get_texture_lod(texSize(_9464), _7181))).x;
                            }
                            float _8073 = clamp(float(_9079 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float _8081 = clamp(float((_9079 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float _8089 = 2.0f * clamp(float(_9075 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float3 _8107 = lerp(1.0f.xxx, tint_color, clamp(float((_9075 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * _8089;
                            float3 _8127 = lerp(lerp(1.0f.xxx, tint_color, clamp(float((_9078 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * (specular * 0.07999999821186065673828125f), base_color, metallic.xxx);
                            ...
                            float _8150 = clamp(float((_9073 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            ...
                            float _8182 = mad(roughness - 1.0f, 1.0f - clamp(float((_9077 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), 1.0f);
                            float _8188;
                            if (_6639)
                            {
                                _8188 = _9074 / _7204;
                            ...
                            float param_47 = dot(_6570, _9009);
                            float param_48 = 1.0f / _8188;
                            float _8211 = fresnel_dielectric_cos(param_47, param_48);
                            float param_49 = dot(_6570, _9009);
                            float param_50 = _8136;
                            lobe_weights_t _8250 = get_lobe_weights(lerp(_7681, 1.0f, _8089), lum(lerp(_8127, 1.0f.xxx, ((fresnel_dielectric_cos(param_49, param_50) - _8142) / (1.0f - _8142)).xxx)), specular, metallic, clamp(float(_9077 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), _8073);
                            [branch]
                            if (_9163 > 0.0f)
                            {
                                light_sample_t _9218 = { _9158, _9159, _9160, _9161, _9162, _9163, _9164, _9165 };
                                surface_t _9060 = { _6606, _9007, _9008, _9009, _9010, _6947 };
                                diff_params_t _9410 = { base_color, _8107, roughness };
                                spec_params_t _9425 = { _8127, roughness, _8136, _8142, _8150 };
                                clearcoat_params_t _9438 = { _8081, _8161, _8167 };
                                transmission_params_t _9453 = { _8182, _9074, _8188, _8211, _6639 };
                                float _9717[3] = { _9690, _9691, _9692 };
                                float _9682[3] = { _9655, _9656, _9657 };
                                float _9647[3] = { _9620, _9621, _9622 };
                                shadow_ray_t _9381 = { _9647, _9328, _9682, _9330, _9717, _9332 };
                                shadow_ray_t param_51 = _9381;
                                float3 _8269 = Evaluate_PrincipledNode(_9218, ray, _9060, _8250, _9410, _9425, _9438, _9453, metallic, _7645, mix_weight, param_51);
                                _9620 = param_51.o[0];
                                _9621 = param_51.o[1];
                                _9622 = param_51.o[2];
                                _9328 = param_51.depth;
                                _9655 = param_51.d[0];
                                _9656 = param_51.d[1];
                                _9657 = param_51.d[2];
                                _9330 = param_51.dist;
                            ...
                            surface_t _9067 = { _6606, _9007, _9008, _9009, _9010, _6947 };
                            diff_params_t _9414 = { base_color, _8107, roughness };
                            spec_params_t _9431 = { _8127, roughness, _8136, _8142, _8150 };
                            clearcoat_params_t _9442 = { _8081, _8161, _8167 };
                            transmission_params_t _9459 = { _8182, _9074, _8188, _8211, _6639 };
                            float param_52 = mix_rand;
                            float _9612[3] = { _9585, _9586, _9587 };
                            float _9577[3] = { _9550, _9551, _9552 };
                            float _9542[3] = { _9515, _9516, _9517 };
                            ray_data_t _9298 = { _9542, _9577, _9221, _9612, _9223, _9224, _9225, _9226, _9227 };
                            ray_data_t param_53 = _9298;
                            Sample_PrincipledNode(ray, _9067, _8250, _9414, _9431, _9442, _9459, metallic, _7726, _7735, param_52, mix_weight, param_53);
                            _9515 = param_53.o[0];
                            _9516 = param_53.o[1];
                            _9517 = param_53.o[2];
                            _9550 = param_53.d[0];
                            ...
                            _9587 = param_53.c[2];
                            _9223 = param_53.ior;
                            _9224 = param_53.cone_width;
                            _9225 = param_53.cone_spread;
                            _9226 = param_53.xy;
                            _9227 = param_53.depth;
                        }
                    }
                }
            }
        }
        float _8303 = max(_9585, max(_9586, _9587));
        float _8315;
        ...
        if (_8335)
        {
            ...
            _8375.Store(_8366 * 72 + 0, asuint(_9515));
            _8375.Store(_8366 * 72 + 4, asuint(_9516));
            _8375.Store(_8366 * 72 + 8, asuint(_9517));
            _8375.Store(_8366 * 72 + 12, asuint(_9550));
            _8375.Store(_8366 * 72 + 16, asuint(_9551));
            _8375.Store(_8366 * 72 + 20, asuint(_9552));
            ...
            _8375.Store(_8366 * 72 + 40, asuint(_9223[0]));
            _8375.Store(_8366 * 72 + 44, asuint(_9223[1]));
            _8375.Store(_8366 * 72 + 48, asuint(_9223[2]));
            _8375.Store(_8366 * 72 + 52, asuint(_9223[3]));
            _8375.Store(_8366 * 72 + 56, asuint(_9224));
            _8375.Store(_8366 * 72 + 60, asuint(_9225));
            _8375.Store(_8366 * 72 + 64, uint(_9226));
            _8375.Store(_8366 * 72 + 68, uint(_9227));
        }
        [branch]
        if (max(_9690, max(_9691, _9692)) > 0.0f)
        {
            float3 _8452 = _9160 - float3(_9620, _9621, _9622);
            float _8455 = length(_8452);
            float3 _8459 = _8452 / _8455.xxx;
            float sh_dist = _8455 * _9162;
            if (_9165)
            {
                sh_dist = -sh_dist;
            }
            ...
            _8491.Store(_8483 * 48 + 0, asuint(_9620));
            _8491.Store(_8483 * 48 + 4, asuint(_9621));
            _8491.Store(_8483 * 48 + 8, asuint(_9622));
            _8491.Store(_8483 * 48 + 12, uint(_9328));
            ...
            _8491.Store(_8483 * 48 + 32, asuint(_9690));
            _8491.Store(_8483 * 48 + 36, asuint(_9691));
            _8491.Store(_8483 * 48 + 40, asuint(_9692));
            _8491.Store(_8483 * 48 + 44, uint(_9332));
        }
        _8709 = float3(ray.c[0] * col.x, ray.c[1] * col.y, ray.c[2] * col.z);
        break;
    } while(false);
    return _8709;
}
...
void comp_main()
{
    do
    {
        ...
        hit_data_t _8803 = { _8593.mask, _8593.obj_index, _8593.prim_index, _8593.t, _8593.u, _8593.v };
        hit_data_t param = _8803;
        float _8852[4] = { _8613.ior[0], _8613.ior[1], _8613.ior[2], _8613.ior[3] };
        float _8843[3] = { _8613.c[0], _8613.c[1], _8613.c[2] };
        float _8836[3] = { _8613.d[0], _8613.d[1], _8613.d[2] };
        float _8829[3] = { _8613.o[0], _8613.o[1], _8613.o[2] };
        ray_data_t _8822 = { _8829, _8836, _8613.pdf, _8843, _8852, _8613.cone_width, _8613.cone_spread, _8613.xy, _8613.depth };
        ray_data_t param_1 = _8822;
        float3 param_2 = 0.0f.xxx;
        float3 param_3 = 0.0f.xxx;
        float3 _8669 = ShadeSurface(param, param_1, param_2, param_3);
        g_out_img[int2(_8571, _8575)] = float4(_8669, 1.0f);
        break;
    } while(false);
}
