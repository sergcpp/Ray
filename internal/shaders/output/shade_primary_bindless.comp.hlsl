...
ByteAddressBuffer _8689 : register(t10, space0);
...
float3 ensure_valid_reflection(float3 Ng, float3 I, float3 N)
{
    ...
    do
    {
        ...
        if (_1320 && _1326)
        {
            float _10045 = (-0.5f) / _1280;
            float param_1 = mad(_10045, _1304, 1.0f);
            float _1336 = safe_sqrtf(param_1);
            float param_2 = _1305;
            float _1339 = safe_sqrtf(param_2);
            float2 _1340 = float2(_1336, _1339);
            float param_3 = mad(_10045, _1311, 1.0f);
            float _1345 = safe_sqrtf(param_3);
            float param_4 = _1312;
            float _1348 = safe_sqrtf(param_4);
            float2 _1349 = float2(_1345, _1348);
            float _10047 = -_1268;
            float _1365 = mad(2.0f * mad(_1336, _1264, _1339 * _1268), _1339, _10047);
            float _1381 = mad(2.0f * mad(_1345, _1264, _1348 * _1268), _1348, _10047);
        ...
        _8706 = (_1260 * N_new.x) + (Ng * N_new.y);
        break;
    } while(false);
    return _8706;
}
...
float3 MapToCone(float r1, float r2, float3 N, float radius)
{
    ...
    do
    {
        ...
        _8731 = (N + (param * ((radius * r) * cos(theta)))) + (param_1 * ((radius * r) * sin(theta)));
        break;
    } while(false);
    return _8731;
}
...
void SampleLightSource(float3 P, float3 T, float3 B, float3 N, int hi, float2 sample_off, inout light_sample_t ls)
{
    ...
    if (_3354 == 0u)
    {
        ...
        float3 _9808 = sampled_dir;
        float3 _3433 = ((param * _9808.x) + (param_1 * _9808.y)) + (_3390 * _9808.z);
        sampled_dir = _3433;
...
float D_GGX(float3 H, float alpha_x, float alpha_y)
{
    ...
    do
    {
        ...
        _8764 = 1.0f / (((((_1988 * _1988) * 3.1415927410125732421875f) * alpha_x) * alpha_y) * (((H.z * H.z) * H.z) * H.z));
        break;
    } while(false);
    return _8764;
}
...
float4 Sample_GGXSpecular_BSDF(float3 T, float3 B, float3 N, float3 I, float roughness, float anisotropic, float spec_ior, float spec_F0, float3 spec_col, float rand_u, float rand_v, inout float3 out_V)
{
    ...
    do
    {
        ...
        if ((_2599 * _2603) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            out_V = _2614;
            _8736 = float4(_2628.x * 1000000.0f, _2628.y * 1000000.0f, _2628.z * 1000000.0f, 1000000.0f);
            break;
        }
        float3 param_2 = T;
        float3 param_3 = B;
        ...
        _8736 = Evaluate_GGXSpecular_BSDF(param_14, param_15, param_16, param_17, param_18, param_19, param_20, param_21);
        break;
    } while(false);
    return _8736;
}
...
float4 Evaluate_GGXRefraction_BSDF(float3 view_dir_ts, float3 sampled_normal_ts, float3 refr_dir_ts, float roughness2, float eta, float3 refr_col)
{
    ...
    do
    {
        ...
        _8741 = float4(refr_col * (((((_2911 * _2927) * _2919) * clamp(dot(view_dir_ts, sampled_normal_ts), 0.0f, 1.0f)) * _2947) / view_dir_ts.z), (((_2911 * _2919) * clamp(dot(view_dir_ts, sampled_normal_ts), 0.0f, 1.0f)) * _2947) / view_dir_ts.z);
        break;
    } while(false);
    return _8741;
}
...
float4 Sample_GGXRefraction_BSDF(float3 T, float3 B, float3 N, float3 I, float roughness, float eta, float3 refr_col, float rand_u, float rand_v, inout float4 out_V)
{
    ...
    do
    {
        ...
        if ((_2991 * _2991) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            _8746 = float4(refr_col.x * 1000000.0f, refr_col.y * 1000000.0f, refr_col.z * 1000000.0f, 1000000.0f);
            break;
        }
        float3 param = T;
        float3 param_1 = B;
        ...
        _8746 = Evaluate_GGXRefraction_BSDF(param_8, param_9, param_10, param_11, param_12, param_13);
        break;
    } while(false);
    return _8746;
}
...
lobe_weights_t get_lobe_weights(float base_color_lum, float spec_color_lum, float specular, float metallic, float transmission, float clearcoat)
{
    ...
    float _8840 = (base_color_lum * _1443) * (1.0f - transmission);
    ...
    float _8842 = _1464 * _1443;
    float _8843 = _1450 * base_color_lum;
    float _1473 = _8840;
    ...
    lobe_weights_t _8848 = { _8840, _8841, _8842, _8843 };
    return _8848;
}
...
float BRDF_PrincipledDiffuse(float3 V, float3 N, float3 L, float3 H, float roughness)
{
    ...
    do
    {
        ...
        _8769 = lerp(1.0f, _2228, schlick_weight(param)) * lerp(1.0f, _2228, schlick_weight(param_1));
        break;
    } while(false);
    return _8769;
}
...
float D_GTR1(float NDotH, float a)
{
    ...
    do
    {
        if (a >= 1.0f)
        {
            _8774 = 0.3183098733425140380859375f;
            break;
        }
        float _1947 = mad(a, a, -1.0f);
        _8774 = _1947 / ((3.1415927410125732421875f * log(a * a)) * mad(_1947 * NDotH, NDotH, 1.0f));
        break;
    } while(false);
    return _8774;
}
...
float4 Sample_PrincipledClearcoat_BSDF(float3 T, float3 B, float3 N, float3 I, float clearcoat_roughness2, float clearcoat_ior, float clearcoat_F0, float rand_u, float rand_v, inout float3 out_V)
{
    ...
    do
    {
        ...
        if ((clearcoat_roughness2 * clearcoat_roughness2) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            _8759 = float4(_2828, _2828, _2828, 1000000.0f);
            break;
        }
        float3 param_2 = T;
        float3 param_3 = B;
        ...
        _8759 = Evaluate_PrincipledClearcoat_BSDF(param_14, param_15, param_16, param_17, param_18, param_19);
        break;
    } while(false);
    return _8759;
}
        ...
        else
        {
            ...
            else
            {
                ...
                if (_6362)
                {
                    ...
                    float4 _9992 = F;
                    float _6476 = _9992.w * lobe_weights.refraction;
                    float4 _9994 = _9992;
                    _9994.w = _6476;
                    F = _9994;
                    new_ray.c[0] = ((ray.c[0] * _9992.x) * mix_weight) / _6476;
                    new_ray.c[1] = ((ray.c[1] * _9992.y) * mix_weight) / _6476;
                    new_ray.c[2] = ((ray.c[2] * _9992.z) * mix_weight) / _6476;
                    new_ray.pdf = _6476;
                    new_ray.d[0] = V.x;
                    new_ray.d[1] = V.y;
                    new_ray.d[2] = V.z;
...
float3 ShadeSurface(hit_data_t inter, ray_data_t ray, inout float3 out_base_color, inout float3 out_normals)
{
    ...
    do
    {
        ...
        if (inter.mask == 0)
        {
            ...
            _8696 = float3(ray.c[0] * _6608.x, ray.c[1] * _6608.y, ray.c[2] * _6608.z);
            break;
        }
        ...
        if (inter.obj_index < 0)
        {
            ...
            _8696 = float3(ray.c[0] * _6648.x, ray.c[1] * _6648.y, ray.c[2] * _6648.z);
            break;
        }
        ...
        uint _9447 = _6691.textures[0];
        uint _9448 = _6691.textures[1];
        uint _9449 = _6691.textures[2];
        uint _9450 = _6691.textures[3];
        uint _9451 = _6691.textures[4];
        float _9452 = _6691.base_color[0];
        float _9453 = _6691.base_color[1];
        float _9454 = _6691.base_color[2];
        uint _9057 = _6691.flags;
        uint _9058 = _6691.type;
        float _9059 = _6691.tangent_rotation_or_strength;
        uint _9060 = _6691.roughness_and_anisotropic;
        float _9061 = _6691.ior;
        uint _9062 = _6691.sheen_and_sheen_tint;
        uint _9063 = _6691.tint_and_metallic;
        uint _9064 = _6691.transmission_and_transmission_roughness;
        uint _9065 = _6691.specular_and_specular_tint;
        uint _9066 = _6691.clearcoat_and_clearcoat_roughness;
        uint _9067 = _6691.normal_map_strength_unorm;
        transform_t _6746;
        ...
        float3 _8995 = _7035;
        float3 _8994 = cross(_7035, _6951);
        if (_6669)
        {
            ...
            _9447 = _7061.textures[0];
            _9448 = _7061.textures[1];
            _9449 = _7061.textures[2];
            _9450 = _7061.textures[3];
            _9451 = _7061.textures[4];
            _9452 = _7061.base_color[0];
            _9453 = _7061.base_color[1];
            _9454 = _7061.base_color[2];
            _9057 = _7061.flags;
            _9058 = _7061.type;
            _9059 = _7061.tangent_rotation_or_strength;
            _9060 = _7061.roughness_and_anisotropic;
            _9061 = _7061.ior;
            _9062 = _7061.sheen_and_sheen_tint;
            _9063 = _7061.tint_and_metallic;
            _9064 = _7061.transmission_and_transmission_roughness;
            _9065 = _7061.specular_and_specular_tint;
            _9066 = _7061.clearcoat_and_clearcoat_roughness;
            _9067 = _7061.normal_map_strength_unorm;
            _8997 = -_8997;
            _8996 = -_8996;
            _8995 = -_8995;
            _8994 = -_8994;
        }
        float3 param_5 = _8997;
        float4x4 param_6 = _6746.inv_xform;
        _8997 = TransformNormal(param_5, param_6);
        float3 param_7 = _8996;
        float4x4 param_8 = _6746.inv_xform;
        _8996 = TransformNormal(param_7, param_8);
        float3 param_9 = _8995;
        float4x4 param_10 = _6746.inv_xform;
        _8995 = TransformNormal(param_9, param_10);
        float3 param_11 = _8994;
        float4x4 param_12 = _6746.inv_xform;
        _8997 = normalize(_8997);
        _8996 = normalize(_8996);
        _8995 = normalize(_8995);
        _8994 = normalize(TransformNormal(param_11, param_12));
        ...
        while (_9058 == 4u)
        {
            ...
            {
                mix_val *= SampleBilinear(_9448, _6977, 0, _6598).x;
            }
            if (_6669)
            {
                _7258 = _7219 / _9061;
            ...
            if (_9061 != 0.0f)
            {
                float param_16 = dot(_6532, _8996);
            ...
            if (mix_rand > _7291)
            {
                ...
                {
                    _7314.textures[_80ident] = _4415.Load(_80ident * 4 + _9450 * 76 + 0);
                }
                [unroll]
                for (int _81ident = 0; _81ident < 3; _81ident++)
                {
                    _7314.base_color[_81ident] = asfloat(_4415.Load(_81ident * 4 + _9450 * 76 + 20));
                }
                _7314.flags = _4415.Load(_9450 * 76 + 32);
                _7314.type = _4415.Load(_9450 * 76 + 36);
                _7314.tangent_rotation_or_strength = asfloat(_4415.Load(_9450 * 76 + 40));
                _7314.roughness_and_anisotropic = _4415.Load(_9450 * 76 + 44);
                _7314.ior = asfloat(_4415.Load(_9450 * 76 + 48));
                _7314.sheen_and_sheen_tint = _4415.Load(_9450 * 76 + 52);
                _7314.tint_and_metallic = _4415.Load(_9450 * 76 + 56);
                _7314.transmission_and_transmission_roughness = _4415.Load(_9450 * 76 + 60);
                _7314.specular_and_specular_tint = _4415.Load(_9450 * 76 + 64);
                _7314.clearcoat_and_clearcoat_roughness = _4415.Load(_9450 * 76 + 68);
                _7314.normal_map_strength_unorm = _4415.Load(_9450 * 76 + 72);
                _9447 = _7314.textures[0];
                _9448 = _7314.textures[1];
                _9449 = _7314.textures[2];
                _9450 = _7314.textures[3];
                _9451 = _7314.textures[4];
                _9452 = _7314.base_color[0];
                _9453 = _7314.base_color[1];
                _9454 = _7314.base_color[2];
                _9057 = _7314.flags;
                _9058 = _7314.type;
                _9059 = _7314.tangent_rotation_or_strength;
                _9060 = _7314.roughness_and_anisotropic;
                _9061 = _7314.ior;
                _9062 = _7314.sheen_and_sheen_tint;
                _9063 = _7314.tint_and_metallic;
                _9064 = _7314.transmission_and_transmission_roughness;
                _9065 = _7314.specular_and_specular_tint;
                _9066 = _7314.clearcoat_and_clearcoat_roughness;
                _9067 = _7314.normal_map_strength_unorm;
            ...
            else
            {
                ...
                {
                    _7380.textures[_82ident] = _4415.Load(_82ident * 4 + _9451 * 76 + 0);
                }
                [unroll]
                for (int _83ident = 0; _83ident < 3; _83ident++)
                {
                    _7380.base_color[_83ident] = asfloat(_4415.Load(_83ident * 4 + _9451 * 76 + 20));
                }
                _7380.flags = _4415.Load(_9451 * 76 + 32);
                _7380.type = _4415.Load(_9451 * 76 + 36);
                _7380.tangent_rotation_or_strength = asfloat(_4415.Load(_9451 * 76 + 40));
                _7380.roughness_and_anisotropic = _4415.Load(_9451 * 76 + 44);
                _7380.ior = asfloat(_4415.Load(_9451 * 76 + 48));
                _7380.sheen_and_sheen_tint = _4415.Load(_9451 * 76 + 52);
                _7380.tint_and_metallic = _4415.Load(_9451 * 76 + 56);
                _7380.transmission_and_transmission_roughness = _4415.Load(_9451 * 76 + 60);
                _7380.specular_and_specular_tint = _4415.Load(_9451 * 76 + 64);
                _7380.clearcoat_and_clearcoat_roughness = _4415.Load(_9451 * 76 + 68);
                _7380.normal_map_strength_unorm = _4415.Load(_9451 * 76 + 72);
                _9447 = _7380.textures[0];
                _9448 = _7380.textures[1];
                _9449 = _7380.textures[2];
                _9450 = _7380.textures[3];
                _9451 = _7380.textures[4];
                _9452 = _7380.base_color[0];
                _9453 = _7380.base_color[1];
                _9454 = _7380.base_color[2];
                _9057 = _7380.flags;
                _9058 = _7380.type;
                _9059 = _7380.tangent_rotation_or_strength;
                _9060 = _7380.roughness_and_anisotropic;
                _9061 = _7380.ior;
                _9062 = _7380.sheen_and_sheen_tint;
                _9063 = _7380.tint_and_metallic;
                _9064 = _7380.transmission_and_transmission_roughness;
                _9065 = _7380.specular_and_specular_tint;
                _9066 = _7380.clearcoat_and_clearcoat_roughness;
                _9067 = _7380.normal_map_strength_unorm;
                mix_rand /= mix_val;
            }
        }
        [branch]
        ...
        {
            float3 normals = (float3(SampleBilinear(_9447, _6977, 0, _6598).xy, 1.0f) * 2.0f) - 1.0f.xxx;
            if ((_9447 & 33554432u) != 0u)
            {
                float3 _10015 = normals;
                _10015.z = sqrt(1.0f - dot(normals.xy, normals.xy));
                normals = _10015;
            }
            float3 _7463 = _8996;
            _8996 = normalize(((_8994 * normals.x) + (_7463 * normals.z)) + (_8995 * normals.y));
            if ((_9067 & 65535u) != 65535u)
            {
                _8996 = normalize(_7463 + ((_8996 - _7463) * clamp(float(_9067 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f)));
            }
            float3 param_18 = _8997;
            float3 param_19 = -_6532;
            float3 param_20 = _8996;
            _8996 = ensure_valid_reflection(param_18, param_19, param_20);
        }
        ...
        tangent = _7542;
        float3 _7546 = cross(_7542, _8996);
        ...
        if (_9059 != 0.0f)
        {
            ...
            float3 param_26 = _8996;
            float param_27 = _9059;
            tangent = rotate_around_axis(param_25, param_26, param_27);
        }
        float3 _7579 = normalize(cross(tangent, _8996));
        _8995 = _7579;
        _8994 = cross(_8996, _7579);
        float3 _9146 = 0.0f.xxx;
        float3 _9145 = 0.0f.xxx;
        float _9150 = 0.0f;
        float _9148 = 0.0f;
        float _9149 = 1.0f;
        ...
        if (_7601)
        {
            ...
            float3 param_29 = _8994;
            float3 param_30 = _8995;
            float3 param_31 = _8996;
            int param_32 = _6565;
            float2 param_33 = float2(_6572, _6579);
            light_sample_t _9161 = { _9145, _9146, _9147, _9148, _9149, _9150, _9151, _9152 };
            light_sample_t param_34 = _9161;
            SampleLightSource(param_28, param_29, param_30, param_31, param_32, param_33, param_34);
            _9145 = param_34.col;
            _9146 = param_34.L;
            _9147 = param_34.lp;
            _9148 = param_34.area;
            _9149 = param_34.dist_mul;
            _9150 = param_34.pdf;
            _9151 = param_34.cast_shadow;
            _9152 = param_34.from_env;
        }
        float _7629 = dot(_8996, _9146);
        float3 base_color = float3(_9452, _9453, _9454);
        [branch]
        if (_9448 != 4294967295u)
        {
            base_color *= SampleBilinear(_9448, _6977, int(get_texture_lod(texSize(_9448), _7211)), _6598, true, true).xyz;
        }
        ...
        float roughness = clamp(float(_9060 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
        [branch]
        if (_9449 != 4294967295u)
        {
            roughness *= SampleBilinear(_9449, _6977, int(get_texture_lod(texSize(_9449), _7211)), _6598, false, true).x;
        }
        ...
        {
            [branch]
            if ((_9150 > 0.0f) && (_7629 > 0.0f))
            {
                light_sample_t _9178 = { _9145, _9146, _9147, _9148, _9149, _9150, _9151, _9152 };
                surface_t _9005 = { _6635, _8994, _8995, _8996, _8997, _6977 };
                float _9683[3] = { _9677, _9678, _9679 };
                float _9648[3] = { _9642, _9643, _9644 };
                float _9613[3] = { _9607, _9608, _9609 };
                shadow_ray_t _9329 = { _9613, _9315, _9648, _9317, _9683, _9319 };
                shadow_ray_t param_35 = _9329;
                float3 _7781 = Evaluate_DiffuseNode(_9178, ray, _9005, base_color, roughness, mix_weight, param_35);
                _9607 = param_35.o[0];
                _9608 = param_35.o[1];
                _9609 = param_35.o[2];
                _9315 = param_35.depth;
                _9642 = param_35.d[0];
                _9643 = param_35.d[1];
                _9644 = param_35.d[2];
                _9317 = param_35.dist;
            ...
            if (_7795)
            {
                surface_t _9012 = { _6635, _8994, _8995, _8996, _8997, _6977 };
                float _9578[3] = { _9572, _9573, _9574 };
                float _9543[3] = { _9537, _9538, _9539 };
                float _9508[3] = { _9502, _9503, _9504 };
                ray_data_t _9228 = { _9508, _9543, _9208, _9578, _9210, _9211, _9212, _9213, _9214 };
                ray_data_t param_36 = _9228;
                Sample_DiffuseNode(ray, _9012, base_color, roughness, _7712, _7721, mix_weight, param_36);
                _9502 = param_36.o[0];
                _9503 = param_36.o[1];
                _9504 = param_36.o[2];
                _9537 = param_36.d[0];
                ...
                _9574 = param_36.c[2];
                _9210 = param_36.ior;
                _9211 = param_36.cone_width;
                _9212 = param_36.cone_spread;
                _9213 = param_36.xy;
                _9214 = param_36.depth;
            }
        }
        else
        {
            ...
            if (_9058 == 1u)
            {
                ...
                if (_7833 && (_7629 > 0.0f))
                {
                    light_sample_t _9187 = { _9145, _9146, _9147, _9148, _9149, _9150, _9151, _9152 };
                    surface_t _9019 = { _6635, _8994, _8995, _8996, _8997, _6977 };
                    float _9690[3] = { _9677, _9678, _9679 };
                    float _9655[3] = { _9642, _9643, _9644 };
                    float _9620[3] = { _9607, _9608, _9609 };
                    shadow_ray_t _9342 = { _9620, _9315, _9655, _9317, _9690, _9319 };
                    shadow_ray_t param_39 = _9342;
                    float3 _7848 = Evaluate_GlossyNode(_9187, ray, _9019, base_color, roughness, 1.5f, _7819, mix_weight, param_39);
                    _9607 = param_39.o[0];
                    _9608 = param_39.o[1];
                    _9609 = param_39.o[2];
                    _9315 = param_39.depth;
                    _9642 = param_39.d[0];
                    _9643 = param_39.d[1];
                    _9644 = param_39.d[2];
                    _9317 = param_39.dist;
                ...
                if (_7862)
                {
                    surface_t _9026 = { _6635, _8994, _8995, _8996, _8997, _6977 };
                    float _9585[3] = { _9572, _9573, _9574 };
                    float _9550[3] = { _9537, _9538, _9539 };
                    float _9515[3] = { _9502, _9503, _9504 };
                    ray_data_t _9247 = { _9515, _9550, _9208, _9585, _9210, _9211, _9212, _9213, _9214 };
                    ray_data_t param_40 = _9247;
                    Sample_GlossyNode(ray, _9026, base_color, roughness, 1.5f, _7819, _7712, _7721, mix_weight, param_40);
                    _9502 = param_40.o[0];
                    _9503 = param_40.o[1];
                    _9504 = param_40.o[2];
                    _9537 = param_40.d[0];
                    ...
                    _9574 = param_40.c[2];
                    _9210 = param_40.ior;
                    _9211 = param_40.cone_width;
                    _9212 = param_40.cone_spread;
                    _9213 = param_40.xy;
                    _9214 = param_40.depth;
                }
            }
            else
            {
                ...
                if (_9058 == 2u)
                {
                    ...
                    if (_7896 && (_7629 < 0.0f))
                    {
                        ...
                        light_sample_t _9196 = { _9145, _9146, _9147, _9148, _9149, _9150, _9151, _9152 };
                        surface_t _9033 = { _6635, _8994, _8995, _8996, _8997, _6977 };
                        float _9697[3] = { _9677, _9678, _9679 };
                        float _9662[3] = { _9642, _9643, _9644 };
                        float _9627[3] = { _9607, _9608, _9609 };
                        shadow_ray_t _9355 = { _9627, _9315, _9662, _9317, _9697, _9319 };
                        shadow_ray_t param_41 = _9355;
                        float3 _7926 = Evaluate_RefractiveNode(_9196, ray, _9033, base_color, _7886, _7904, mix_weight, param_41);
                        _9607 = param_41.o[0];
                        _9608 = param_41.o[1];
                        _9609 = param_41.o[2];
                        _9315 = param_41.depth;
                        _9642 = param_41.d[0];
                        _9643 = param_41.d[1];
                        _9644 = param_41.d[2];
                        _9317 = param_41.dist;
                    ...
                    if (_7940)
                    {
                        surface_t _9040 = { _6635, _8994, _8995, _8996, _8997, _6977 };
                        float _9592[3] = { _9572, _9573, _9574 };
                        float _9557[3] = { _9537, _9538, _9539 };
                        float _9522[3] = { _9502, _9503, _9504 };
                        ray_data_t _9266 = { _9522, _9557, _9208, _9592, _9210, _9211, _9212, _9213, _9214 };
                        ray_data_t param_42 = _9266;
                        Sample_RefractiveNode(ray, _9040, base_color, roughness, _6669, _9061, _7219, _7712, _7721, mix_weight, param_42);
                        _9502 = param_42.o[0];
                        _9503 = param_42.o[1];
                        _9504 = param_42.o[2];
                        _9537 = param_42.d[0];
                        ...
                        _9574 = param_42.c[2];
                        _9210 = param_42.ior;
                        _9211 = param_42.cone_width;
                        _9212 = param_42.cone_spread;
                        _9213 = param_42.xy;
                        _9214 = param_42.depth;
                    }
                }
                else
                {
                    ...
                    if (_9058 == 3u)
                    {
                        col += (base_color * (mix_weight * _9059));
                    }
                    else
                    {
                        [branch]
                        if (_9058 == 6u)
                        {
                            float metallic = clamp(float((_9063 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            [branch]
                            if (_9450 != 4294967295u)
                            {
                                metallic *= SampleBilinear(_9450, _6977, int(get_texture_lod(texSize(_9450), _7211)), _6598).x;
                            }
                            float specular = clamp(float(_9065 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            [branch]
                            if (_9451 != 4294967295u)
                            {
                                specular *= SampleBilinear(_9451, _6977, int(get_texture_lod(texSize(_9451), _7211)), _6598).x;
                            }
                            float _8061 = clamp(float(_9066 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float _8069 = clamp(float((_9066 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float _8077 = 2.0f * clamp(float(_9062 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float3 _8095 = lerp(1.0f.xxx, tint_color, clamp(float((_9062 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * _8077;
                            float3 _8115 = lerp(lerp(1.0f.xxx, tint_color, clamp(float((_9065 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * (specular * 0.07999999821186065673828125f), base_color, metallic.xxx);
                            ...
                            float _8138 = clamp(float((_9060 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            ...
                            float _8170 = mad(roughness - 1.0f, 1.0f - clamp(float((_9064 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), 1.0f);
                            float _8176;
                            if (_6669)
                            {
                                _8176 = _9061 / _7219;
                            ...
                            float param_47 = dot(_6532, _8996);
                            float param_48 = 1.0f / _8176;
                            float _8199 = fresnel_dielectric_cos(param_47, param_48);
                            float param_49 = dot(_6532, _8996);
                            float param_50 = _8124;
                            lobe_weights_t _8238 = get_lobe_weights(lerp(_7666, 1.0f, _8077), lum(lerp(_8115, 1.0f.xxx, ((fresnel_dielectric_cos(param_49, param_50) - _8130) / (1.0f - _8130)).xxx)), specular, metallic, clamp(float(_9064 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), _8061);
                            [branch]
                            if (_9150 > 0.0f)
                            {
                                light_sample_t _9205 = { _9145, _9146, _9147, _9148, _9149, _9150, _9151, _9152 };
                                surface_t _9047 = { _6635, _8994, _8995, _8996, _8997, _6977 };
                                diff_params_t _9397 = { base_color, _8095, roughness };
                                spec_params_t _9412 = { _8115, roughness, _8124, _8130, _8138 };
                                clearcoat_params_t _9425 = { _8069, _8149, _8155 };
                                transmission_params_t _9440 = { _8170, _9061, _8176, _8199, _6669 };
                                float _9704[3] = { _9677, _9678, _9679 };
                                float _9669[3] = { _9642, _9643, _9644 };
                                float _9634[3] = { _9607, _9608, _9609 };
                                shadow_ray_t _9368 = { _9634, _9315, _9669, _9317, _9704, _9319 };
                                shadow_ray_t param_51 = _9368;
                                float3 _8257 = Evaluate_PrincipledNode(_9205, ray, _9047, _8238, _9397, _9412, _9425, _9440, metallic, _7629, mix_weight, param_51);
                                _9607 = param_51.o[0];
                                _9608 = param_51.o[1];
                                _9609 = param_51.o[2];
                                _9315 = param_51.depth;
                                _9642 = param_51.d[0];
                                _9643 = param_51.d[1];
                                _9644 = param_51.d[2];
                                _9317 = param_51.dist;
                            ...
                            surface_t _9054 = { _6635, _8994, _8995, _8996, _8997, _6977 };
                            diff_params_t _9401 = { base_color, _8095, roughness };
                            spec_params_t _9418 = { _8115, roughness, _8124, _8130, _8138 };
                            clearcoat_params_t _9429 = { _8069, _8149, _8155 };
                            transmission_params_t _9446 = { _8170, _9061, _8176, _8199, _6669 };
                            float param_52 = mix_rand;
                            float _9599[3] = { _9572, _9573, _9574 };
                            float _9564[3] = { _9537, _9538, _9539 };
                            float _9529[3] = { _9502, _9503, _9504 };
                            ray_data_t _9285 = { _9529, _9564, _9208, _9599, _9210, _9211, _9212, _9213, _9214 };
                            ray_data_t param_53 = _9285;
                            Sample_PrincipledNode(ray, _9054, _8238, _9401, _9418, _9429, _9446, metallic, _7712, _7721, param_52, mix_weight, param_53);
                            _9502 = param_53.o[0];
                            _9503 = param_53.o[1];
                            _9504 = param_53.o[2];
                            _9537 = param_53.d[0];
                            ...
                            _9574 = param_53.c[2];
                            _9210 = param_53.ior;
                            _9211 = param_53.cone_width;
                            _9212 = param_53.cone_spread;
                            _9213 = param_53.xy;
                            _9214 = param_53.depth;
                        }
                    }
                }
            }
        }
        float _8291 = max(_9572, max(_9573, _9574));
        float _8303;
        ...
        if (_8323)
        {
            ...
            _8363.Store(_8354 * 72 + 0, asuint(_9502));
            _8363.Store(_8354 * 72 + 4, asuint(_9503));
            _8363.Store(_8354 * 72 + 8, asuint(_9504));
            _8363.Store(_8354 * 72 + 12, asuint(_9537));
            _8363.Store(_8354 * 72 + 16, asuint(_9538));
            _8363.Store(_8354 * 72 + 20, asuint(_9539));
            ...
            _8363.Store(_8354 * 72 + 40, asuint(_9210[0]));
            _8363.Store(_8354 * 72 + 44, asuint(_9210[1]));
            _8363.Store(_8354 * 72 + 48, asuint(_9210[2]));
            _8363.Store(_8354 * 72 + 52, asuint(_9210[3]));
            _8363.Store(_8354 * 72 + 56, asuint(_9211));
            _8363.Store(_8354 * 72 + 60, asuint(_9212));
            _8363.Store(_8354 * 72 + 64, uint(_9213));
            _8363.Store(_8354 * 72 + 68, uint(_9214));
        }
        [branch]
        if (max(_9677, max(_9678, _9679)) > 0.0f)
        {
            float3 _8440 = _9147 - float3(_9607, _9608, _9609);
            float _8443 = length(_8440);
            float3 _8447 = _8440 / _8443.xxx;
            float sh_dist = _8443 * _9149;
            if (_9152)
            {
                sh_dist = -sh_dist;
            }
            ...
            _8479.Store(_8471 * 48 + 0, asuint(_9607));
            _8479.Store(_8471 * 48 + 4, asuint(_9608));
            _8479.Store(_8471 * 48 + 8, asuint(_9609));
            _8479.Store(_8471 * 48 + 12, uint(_9315));
            ...
            _8479.Store(_8471 * 48 + 32, asuint(_9677));
            _8479.Store(_8471 * 48 + 36, asuint(_9678));
            _8479.Store(_8471 * 48 + 40, asuint(_9679));
            _8479.Store(_8471 * 48 + 44, uint(_9319));
        }
        _8696 = float3(ray.c[0] * col.x, ray.c[1] * col.y, ray.c[2] * col.z);
        break;
    } while(false);
    return _8696;
}
...
void comp_main()
{
    do
    {
        ...
        hit_data_t _8790 = { _8579.mask, _8579.obj_index, _8579.prim_index, _8579.t, _8579.u, _8579.v };
        hit_data_t param = _8790;
        float _8839[4] = { _8595.ior[0], _8595.ior[1], _8595.ior[2], _8595.ior[3] };
        float _8830[3] = { _8595.c[0], _8595.c[1], _8595.c[2] };
        float _8823[3] = { _8595.d[0], _8595.d[1], _8595.d[2] };
        float _8816[3] = { _8595.o[0], _8595.o[1], _8595.o[2] };
        ray_data_t _8809 = { _8816, _8823, _8595.pdf, _8830, _8839, _8595.cone_width, _8595.cone_spread, _8595.xy, _8595.depth };
        ray_data_t param_1 = _8809;
        float3 param_2 = 0.0f.xxx;
        float3 param_3 = 0.0f.xxx;
        float3 _8651 = ShadeSurface(param, param_1, param_2, param_3);
        g_out_img[int2((_8561 >> 16) & 65535, _8568 & 65535)] = float4(min(_8651, _3268_g_params.clamp_val.xxx), 1.0f);
        break;
    } while(false);
}
