...
ByteAddressBuffer _813 : register(t3, space0);
...
void comp_main()
{
    do
    {
        ...
        _197.Store(_77 * 24 + 0, uint(_841));
        _197.Store(_77 * 24 + 4, uint(_842));
        _197.Store(_77 * 24 + 8, uint(_201.prim_index));
        _197.Store(_77 * 24 + 12, asuint(_844));
