...
ByteAddressBuffer _9128 : register(t10, space0);
...
float2 TransformUV(float2 _uv, atlas_texture_t t, int mip_level)
{
    ...
    return mad(frac(_uv), size, float2(float(_9303[mip_level] & 65535u), float((_9306[mip_level] >> uint(16)) & 65535u))) + 1.0f.xx;
}
...
float3 Evaluate_EnvColor(ray_data_t ray, float2 tex_rand)
{
    ...
    if (_4961 != 4294967295u)
    {
        ...
        uint _9673[14] = { _4972.pos[0], _4972.pos[1], _4972.pos[2], _4972.pos[3], _4972.pos[4], _4972.pos[5], _4972.pos[6], _4972.pos[7], _4972.pos[8], _4972.pos[9], _4972.pos[10], _4972.pos[11], _4972.pos[12], _4972.pos[13] };
        uint _9644[4] = { _4972.page[0], _4972.page[1], _4972.page[2], _4972.page[3] };
        atlas_texture_t _9635 = { _4972.size, _4972.atlas, _9644, _9673 };
        float param = _3458_g_params.back_rotation;
        env_col *= SampleLatlong_RGBE(_9635, _4953, param, tex_rand);
    }
...
float3 Evaluate_LightColor(ray_data_t ray, hit_data_t inter, float2 tex_rand)
{
    ...
    if ((_5098.type_and_param0.x & 128u) != 0u)
    {
        ...
        if (_5125 != 4294967295u)
        {
            ...
            uint _9735[14] = { _5132.pos[0], _5132.pos[1], _5132.pos[2], _5132.pos[3], _5132.pos[4], _5132.pos[5], _5132.pos[6], _5132.pos[7], _5132.pos[8], _5132.pos[9], _5132.pos[10], _5132.pos[11], _5132.pos[12], _5132.pos[13] };
            uint _9706[4] = { _5132.page[0], _5132.page[1], _5132.page[2], _5132.page[3] };
            atlas_texture_t _9697 = { _5132.size, _5132.atlas, _9706, _9735 };
            float param = _3458_g_params.env_rotation;
            env_col *= SampleLatlong_RGBE(_9697, _5084, param, tex_rand);
        }
        lcol *= env_col;
    }
...
float4 SampleBilinear(uint index, float2 uvs, int lod, float2 rand, bool maybe_YCoCg, bool maybe_SRGB)
{
    ...
    uint _9311[4];
    _9311[0] = _1138.page[0];
    _9311[1] = _1138.page[1];
    _9311[2] = _1138.page[2];
    _9311[3] = _1138.page[3];
    uint _9347[14] = { _1138.pos[0], _1138.pos[1], _1138.pos[2], _1138.pos[3], _1138.pos[4], _1138.pos[5], _1138.pos[6], _1138.pos[7], _1138.pos[8], _1138.pos[9], _1138.pos[10], _1138.pos[11], _1138.pos[12], _1138.pos[13] };
    atlas_texture_t _9317 = { _1138.size, _1138.atlas, _9311, _9347 };
    uint _1211 = _1138.atlas;
    float4 res = g_atlases[NonUniformResourceIndex(_1211)].SampleLevel(_g_atlases_sampler[NonUniformResourceIndex(_1211)], float3(((TransformUV(uvs, _9317, lod) + rand) - 0.5f.xx) * 0.000118371215648949146270751953125f.xx, float((_9311[lod / 4] >> uint((lod % 4) * 8)) & 255u)), 0.0f);
    bool _1226;
    if (maybe_YCoCg)
    {
...
float3 ensure_valid_reflection(float3 Ng, float3 I, float3 N)
{
    ...
    do
    {
        ...
        if (_1511 && _1517)
        {
            float _10790 = (-0.5f) / _1471;
            float param_1 = mad(_10790, _1495, 1.0f);
            float _1527 = safe_sqrtf(param_1);
            float param_2 = _1496;
            float _1530 = safe_sqrtf(param_2);
            float2 _1531 = float2(_1527, _1530);
            float param_3 = mad(_10790, _1502, 1.0f);
            float _1536 = safe_sqrtf(param_3);
            float param_4 = _1503;
            float _1539 = safe_sqrtf(param_4);
            float2 _1540 = float2(_1536, _1539);
            float _10792 = -_1459;
            float _1556 = mad(2.0f * mad(_1527, _1455, _1530 * _1459), _1530, _10792);
            float _1572 = mad(2.0f * mad(_1536, _1455, _1539 * _1459), _1539, _10792);
        ...
        _9145 = (_1451 * N_new.x) + (Ng * N_new.y);
        break;
    } while(false);
    return _9145;
}
...
float3 MapToCone(float r1, float r2, float3 N, float radius)
{
    ...
    do
    {
        ...
        _9170 = (N + (param * ((radius * r) * cos(theta)))) + (param_1 * ((radius * r) * sin(theta)));
        break;
    } while(false);
    return _9170;
}
...
float4 Sample_EnvQTree(float y_rotation, Texture2D<float4> qtree_tex, SamplerState _qtree_tex_sampler, int qtree_levels, float rand, float rx, float ry)
{
    ...
    while (lod >= 0)
    {
        ...
        else
        {
            ...
            partial = _917;
            float2 _10477 = origin;
            _10477.x = origin.x + _step;
            origin = _10477;
        ...
        {
            float2 _10480 = origin;
            _10480.y = origin.y + _step;
            origin = _10480;
            _sample = (_sample - boundary) / (1.0f - boundary);
            index |= 2;
        }
...
void SampleLightSource(float3 P, float3 T, float3 B, float3 N, int hi, float2 sample_off, inout light_sample_t ls)
{
    ...
    if (_3540 == 0u)
    {
        ...
        float3 _10551 = sampled_dir;
        float3 _3618 = ((param * _10551.x) + (param_1 * _10551.y)) + (_3575 * _10551.z);
        sampled_dir = _3618;
            ...
            if (_3540 == 4u)
            {
                ...
                if ((_3488.type_and_param0.x & 128u) != 0u)
                {
                    ...
                    if (_3898 != 4294967295u)
                    {
                        ...
                        uint _9491[14] = { _3906.pos[0], _3906.pos[1], _3906.pos[2], _3906.pos[3], _3906.pos[4], _3906.pos[5], _3906.pos[6], _3906.pos[7], _3906.pos[8], _3906.pos[9], _3906.pos[10], _3906.pos[11], _3906.pos[12], _3906.pos[13] };
                        uint _9462[4] = { _3906.page[0], _3906.page[1], _3906.page[2], _3906.page[3] };
                        atlas_texture_t _9391 = { _3906.size, _3906.atlas, _9462, _9491 };
                        float param_10 = _3458_g_params.env_rotation;
                        env_col *= SampleLatlong_RGBE(_9391, ls.L, param_10, _3535);
                    }
                    ls.col *= env_col;
                    ls.from_env = true;
                }
                ...
                if (_3540 == 5u)
                {
                    ...
                    if ((_3488.type_and_param0.x & 128u) != 0u)
                    {
                        ...
                        if (_4142 != 4294967295u)
                        {
                            ...
                            uint _9529[14] = { _4149.pos[0], _4149.pos[1], _4149.pos[2], _4149.pos[3], _4149.pos[4], _4149.pos[5], _4149.pos[6], _4149.pos[7], _4149.pos[8], _4149.pos[9], _4149.pos[10], _4149.pos[11], _4149.pos[12], _4149.pos[13] };
                            uint _9500[4] = { _4149.page[0], _4149.page[1], _4149.page[2], _4149.page[3] };
                            atlas_texture_t _9400 = { _4149.size, _4149.atlas, _9500, _9529 };
                            float param_13 = _3458_g_params.env_rotation;
                            env_col_1 *= SampleLatlong_RGBE(_9400, ls.L, param_13, _3535);
                        }
                        ls.col *= env_col_1;
                        ls.from_env = true;
                    }
                        ...
                        else
                        {
                            ...
                            if (_3540 == 7u)
                            {
                                ...
                                if (_4870 != 4294967295u)
                                {
                                    ...
                                    uint _9614[14] = { _4877.pos[0], _4877.pos[1], _4877.pos[2], _4877.pos[3], _4877.pos[4], _4877.pos[5], _4877.pos[6], _4877.pos[7], _4877.pos[8], _4877.pos[9], _4877.pos[10], _4877.pos[11], _4877.pos[12], _4877.pos[13] };
                                    uint _9585[4] = { _4877.page[0], _4877.page[1], _4877.page[2], _4877.page[3] };
                                    atlas_texture_t _9453 = { _4877.size, _4877.atlas, _9585, _9614 };
                                    float param_20 = _3458_g_params.env_rotation;
                                    ls.col *= SampleLatlong_RGBE(_9453, ls.L, param_20, _3535);
                                }
                                ls.area = 1.0f;
                                ls.lp = P + ls.L;
                                ls.dist_mul = 3402823346297367662189621542912.0f;
...
float D_GGX(float3 H, float alpha_x, float alpha_y)
{
    ...
    do
    {
        ...
        _9203 = 1.0f / (((((_2178 * _2178) * 3.1415927410125732421875f) * alpha_x) * alpha_y) * (((H.z * H.z) * H.z) * H.z));
        break;
    } while(false);
    return _9203;
}
...
float4 Sample_GGXSpecular_BSDF(float3 T, float3 B, float3 N, float3 I, float roughness, float anisotropic, float spec_ior, float spec_F0, float3 spec_col, float rand_u, float rand_v, inout float3 out_V)
{
    ...
    do
    {
        ...
        if ((_2789 * _2793) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            out_V = _2804;
            _9175 = float4(_2818.x * 1000000.0f, _2818.y * 1000000.0f, _2818.z * 1000000.0f, 1000000.0f);
            break;
        }
        float3 param_2 = T;
        float3 param_3 = B;
        ...
        _9175 = Evaluate_GGXSpecular_BSDF(param_14, param_15, param_16, param_17, param_18, param_19, param_20, param_21);
        break;
    } while(false);
    return _9175;
}
...
float4 Evaluate_GGXRefraction_BSDF(float3 view_dir_ts, float3 sampled_normal_ts, float3 refr_dir_ts, float roughness2, float eta, float3 refr_col)
{
    ...
    do
    {
        ...
        _9180 = float4(refr_col * (((((_3101 * _3117) * _3109) * clamp(dot(view_dir_ts, sampled_normal_ts), 0.0f, 1.0f)) * _3137) / view_dir_ts.z), (((_3101 * _3109) * clamp(dot(view_dir_ts, sampled_normal_ts), 0.0f, 1.0f)) * _3137) / view_dir_ts.z);
        break;
    } while(false);
    return _9180;
}
...
float4 Sample_GGXRefraction_BSDF(float3 T, float3 B, float3 N, float3 I, float roughness, float eta, float3 refr_col, float rand_u, float rand_v, inout float4 out_V)
{
    ...
    do
    {
        ...
        if ((_3181 * _3181) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            _9185 = float4(refr_col.x * 1000000.0f, refr_col.y * 1000000.0f, refr_col.z * 1000000.0f, 1000000.0f);
            break;
        }
        float3 param = T;
        float3 param_1 = B;
        ...
        _9185 = Evaluate_GGXRefraction_BSDF(param_8, param_9, param_10, param_11, param_12, param_13);
        break;
    } while(false);
    return _9185;
}
...
lobe_weights_t get_lobe_weights(float base_color_lum, float spec_color_lum, float specular, float metallic, float transmission, float clearcoat)
{
    ...
    float _9348 = (base_color_lum * _1634) * (1.0f - transmission);
    ...
    float _9350 = _1655 * _1634;
    float _9351 = _1641 * base_color_lum;
    float _1664 = _9348;
    ...
    lobe_weights_t _9356 = { _9348, _9349, _9350, _9351 };
    return _9356;
}
...
float BRDF_PrincipledDiffuse(float3 V, float3 N, float3 L, float3 H, float roughness)
{
    ...
    do
    {
        ...
        _9208 = lerp(1.0f, _2418, schlick_weight(param)) * lerp(1.0f, _2418, schlick_weight(param_1));
        break;
    } while(false);
    return _9208;
}
...
float D_GTR1(float NDotH, float a)
{
    ...
    do
    {
        if (a >= 1.0f)
        {
            _9213 = 0.3183098733425140380859375f;
            break;
        }
        float _2137 = mad(a, a, -1.0f);
        _9213 = _2137 / ((3.1415927410125732421875f * log(a * a)) * mad(_2137 * NDotH, NDotH, 1.0f));
        break;
    } while(false);
    return _9213;
}
...
float4 Sample_PrincipledClearcoat_BSDF(float3 T, float3 B, float3 N, float3 I, float clearcoat_roughness2, float clearcoat_ior, float clearcoat_F0, float rand_u, float rand_v, inout float3 out_V)
{
    ...
    do
    {
        ...
        if ((clearcoat_roughness2 * clearcoat_roughness2) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            _9198 = float4(_3018, _3018, _3018, 1000000.0f);
            break;
        }
        float3 param_2 = T;
        float3 param_3 = B;
        ...
        _9198 = Evaluate_PrincipledClearcoat_BSDF(param_14, param_15, param_16, param_17, param_18, param_19);
        break;
    } while(false);
    return _9198;
}
        ...
        else
        {
            ...
            else
            {
                ...
                if (_6785)
                {
                    ...
                    float4 _10735 = F;
                    float _6899 = _10735.w * lobe_weights.refraction;
                    float4 _10737 = _10735;
                    _10737.w = _6899;
                    F = _10737;
                    new_ray.c[0] = ((ray.c[0] * _10735.x) * mix_weight) / _6899;
                    new_ray.c[1] = ((ray.c[1] * _10735.y) * mix_weight) / _6899;
                    new_ray.c[2] = ((ray.c[2] * _10735.z) * mix_weight) / _6899;
                    new_ray.pdf = _6899;
                    new_ray.d[0] = V.x;
                    new_ray.d[1] = V.y;
                    new_ray.d[2] = V.z;
...
float3 ShadeSurface(hit_data_t inter, ray_data_t ray, inout float3 out_base_color, inout float3 out_normals)
{
    ...
    do
    {
        ...
        if (inter.mask == 0)
        {
            ...
            _9135 = float3(ray.c[0] * _7031.x, ray.c[1] * _7031.y, ray.c[2] * _7031.z);
            break;
        }
        ...
        if (inter.obj_index < 0)
        {
            ...
            _9135 = float3(ray.c[0] * _7071.x, ray.c[1] * _7071.y, ray.c[2] * _7071.z);
            break;
        }
        ...
        uint _10190 = _7114.textures[0];
        uint _10191 = _7114.textures[1];
        uint _10192 = _7114.textures[2];
        uint _10193 = _7114.textures[3];
        uint _10194 = _7114.textures[4];
        float _10195 = _7114.base_color[0];
        float _10196 = _7114.base_color[1];
        float _10197 = _7114.base_color[2];
        uint _9800 = _7114.flags;
        uint _9801 = _7114.type;
        float _9802 = _7114.tangent_rotation_or_strength;
        uint _9803 = _7114.roughness_and_anisotropic;
        float _9804 = _7114.ior;
        uint _9805 = _7114.sheen_and_sheen_tint;
        uint _9806 = _7114.tint_and_metallic;
        uint _9807 = _7114.transmission_and_transmission_roughness;
        uint _9808 = _7114.specular_and_specular_tint;
        uint _9809 = _7114.clearcoat_and_clearcoat_roughness;
        uint _9810 = _7114.normal_map_strength_unorm;
        transform_t _7169;
        ...
        float3 _9738 = _7458;
        float3 _9737 = cross(_7458, _7374);
        if (_7092)
        {
            ...
            _10190 = _7483.textures[0];
            _10191 = _7483.textures[1];
            _10192 = _7483.textures[2];
            _10193 = _7483.textures[3];
            _10194 = _7483.textures[4];
            _10195 = _7483.base_color[0];
            _10196 = _7483.base_color[1];
            _10197 = _7483.base_color[2];
            _9800 = _7483.flags;
            _9801 = _7483.type;
            _9802 = _7483.tangent_rotation_or_strength;
            _9803 = _7483.roughness_and_anisotropic;
            _9804 = _7483.ior;
            _9805 = _7483.sheen_and_sheen_tint;
            _9806 = _7483.tint_and_metallic;
            _9807 = _7483.transmission_and_transmission_roughness;
            _9808 = _7483.specular_and_specular_tint;
            _9809 = _7483.clearcoat_and_clearcoat_roughness;
            _9810 = _7483.normal_map_strength_unorm;
            _9740 = -_9740;
            _9739 = -_9739;
            _9738 = -_9738;
            _9737 = -_9737;
        }
        float3 param_5 = _9740;
        float4x4 param_6 = _7169.inv_xform;
        _9740 = TransformNormal(param_5, param_6);
        float3 param_7 = _9739;
        float4x4 param_8 = _7169.inv_xform;
        _9739 = TransformNormal(param_7, param_8);
        float3 param_9 = _9738;
        float4x4 param_10 = _7169.inv_xform;
        _9738 = TransformNormal(param_9, param_10);
        float3 param_11 = _9737;
        float4x4 param_12 = _7169.inv_xform;
        _9740 = normalize(_9740);
        _9739 = normalize(_9739);
        _9738 = normalize(_9738);
        _9737 = normalize(TransformNormal(param_11, param_12));
        ...
        while (_9801 == 4u)
        {
            ...
            {
                mix_val *= SampleBilinear(_10191, _7400, 0, _7021).x;
            }
            if (_7092)
            {
                _7680 = _7641 / _9804;
            ...
            if (_9804 != 0.0f)
            {
                float param_16 = dot(_6955, _9739);
            ...
            if (mix_rand > _7713)
            {
                ...
                {
                    _7736.textures[_108ident] = _4697.Load(_108ident * 4 + _10193 * 76 + 0);
                }
                [unroll]
                for (int _109ident = 0; _109ident < 3; _109ident++)
                {
                    _7736.base_color[_109ident] = asfloat(_4697.Load(_109ident * 4 + _10193 * 76 + 20));
                }
                _7736.flags = _4697.Load(_10193 * 76 + 32);
                _7736.type = _4697.Load(_10193 * 76 + 36);
                _7736.tangent_rotation_or_strength = asfloat(_4697.Load(_10193 * 76 + 40));
                _7736.roughness_and_anisotropic = _4697.Load(_10193 * 76 + 44);
                _7736.ior = asfloat(_4697.Load(_10193 * 76 + 48));
                _7736.sheen_and_sheen_tint = _4697.Load(_10193 * 76 + 52);
                _7736.tint_and_metallic = _4697.Load(_10193 * 76 + 56);
                _7736.transmission_and_transmission_roughness = _4697.Load(_10193 * 76 + 60);
                _7736.specular_and_specular_tint = _4697.Load(_10193 * 76 + 64);
                _7736.clearcoat_and_clearcoat_roughness = _4697.Load(_10193 * 76 + 68);
                _7736.normal_map_strength_unorm = _4697.Load(_10193 * 76 + 72);
                _10190 = _7736.textures[0];
                _10191 = _7736.textures[1];
                _10192 = _7736.textures[2];
                _10193 = _7736.textures[3];
                _10194 = _7736.textures[4];
                _10195 = _7736.base_color[0];
                _10196 = _7736.base_color[1];
                _10197 = _7736.base_color[2];
                _9800 = _7736.flags;
                _9801 = _7736.type;
                _9802 = _7736.tangent_rotation_or_strength;
                _9803 = _7736.roughness_and_anisotropic;
                _9804 = _7736.ior;
                _9805 = _7736.sheen_and_sheen_tint;
                _9806 = _7736.tint_and_metallic;
                _9807 = _7736.transmission_and_transmission_roughness;
                _9808 = _7736.specular_and_specular_tint;
                _9809 = _7736.clearcoat_and_clearcoat_roughness;
                _9810 = _7736.normal_map_strength_unorm;
            ...
            else
            {
                ...
                {
                    _7802.textures[_110ident] = _4697.Load(_110ident * 4 + _10194 * 76 + 0);
                }
                [unroll]
                for (int _111ident = 0; _111ident < 3; _111ident++)
                {
                    _7802.base_color[_111ident] = asfloat(_4697.Load(_111ident * 4 + _10194 * 76 + 20));
                }
                _7802.flags = _4697.Load(_10194 * 76 + 32);
                _7802.type = _4697.Load(_10194 * 76 + 36);
                _7802.tangent_rotation_or_strength = asfloat(_4697.Load(_10194 * 76 + 40));
                _7802.roughness_and_anisotropic = _4697.Load(_10194 * 76 + 44);
                _7802.ior = asfloat(_4697.Load(_10194 * 76 + 48));
                _7802.sheen_and_sheen_tint = _4697.Load(_10194 * 76 + 52);
                _7802.tint_and_metallic = _4697.Load(_10194 * 76 + 56);
                _7802.transmission_and_transmission_roughness = _4697.Load(_10194 * 76 + 60);
                _7802.specular_and_specular_tint = _4697.Load(_10194 * 76 + 64);
                _7802.clearcoat_and_clearcoat_roughness = _4697.Load(_10194 * 76 + 68);
                _7802.normal_map_strength_unorm = _4697.Load(_10194 * 76 + 72);
                _10190 = _7802.textures[0];
                _10191 = _7802.textures[1];
                _10192 = _7802.textures[2];
                _10193 = _7802.textures[3];
                _10194 = _7802.textures[4];
                _10195 = _7802.base_color[0];
                _10196 = _7802.base_color[1];
                _10197 = _7802.base_color[2];
                _9800 = _7802.flags;
                _9801 = _7802.type;
                _9802 = _7802.tangent_rotation_or_strength;
                _9803 = _7802.roughness_and_anisotropic;
                _9804 = _7802.ior;
                _9805 = _7802.sheen_and_sheen_tint;
                _9806 = _7802.tint_and_metallic;
                _9807 = _7802.transmission_and_transmission_roughness;
                _9808 = _7802.specular_and_specular_tint;
                _9809 = _7802.clearcoat_and_clearcoat_roughness;
                _9810 = _7802.normal_map_strength_unorm;
                mix_rand /= mix_val;
            }
        }
        [branch]
        ...
        {
            float3 normals = (float3(SampleBilinear(_10190, _7400, 0, _7021).xy, 1.0f) * 2.0f) - 1.0f.xxx;
            if ((_1008.Load(_10190 * 80 + 0) & 16384u) != 0u)
            {
                float3 _10758 = normals;
                _10758.z = sqrt(1.0f - dot(normals.xy, normals.xy));
                normals = _10758;
            }
            float3 _7887 = _9739;
            _9739 = normalize(((_9737 * normals.x) + (_7887 * normals.z)) + (_9738 * normals.y));
            if ((_9810 & 65535u) != 65535u)
            {
                _9739 = normalize(_7887 + ((_9739 - _7887) * clamp(float(_9810 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f)));
            }
            float3 param_18 = _9740;
            float3 param_19 = -_6955;
            float3 param_20 = _9739;
            _9739 = ensure_valid_reflection(param_18, param_19, param_20);
        }
        ...
        tangent = _7966;
        float3 _7970 = cross(_7966, _9739);
        ...
        if (_9802 != 0.0f)
        {
            ...
            float3 param_26 = _9739;
            float param_27 = _9802;
            tangent = rotate_around_axis(param_25, param_26, param_27);
        }
        float3 _8003 = normalize(cross(tangent, _9739));
        _9738 = _8003;
        _9737 = cross(_9739, _8003);
        float3 _9889 = 0.0f.xxx;
        float3 _9888 = 0.0f.xxx;
        float _9893 = 0.0f;
        float _9891 = 0.0f;
        float _9892 = 1.0f;
        ...
        if (_8025)
        {
            ...
            float3 param_29 = _9737;
            float3 param_30 = _9738;
            float3 param_31 = _9739;
            int param_32 = _6988;
            float2 param_33 = float2(_6995, _7002);
            light_sample_t _9904 = { _9888, _9889, _9890, _9891, _9892, _9893, _9894, _9895 };
            light_sample_t param_34 = _9904;
            SampleLightSource(param_28, param_29, param_30, param_31, param_32, param_33, param_34);
            _9888 = param_34.col;
            _9889 = param_34.L;
            _9890 = param_34.lp;
            _9891 = param_34.area;
            _9892 = param_34.dist_mul;
            _9893 = param_34.pdf;
            _9894 = param_34.cast_shadow;
            _9895 = param_34.from_env;
        }
        float _8053 = dot(_9739, _9889);
        float3 base_color = float3(_10195, _10196, _10197);
        [branch]
        if (_10191 != 4294967295u)
        {
            base_color *= SampleBilinear(_10191, _7400, int(get_texture_lod(texSize(_10191), _7633)), _7021, true, true).xyz;
        }
        ...
        float roughness = clamp(float(_9803 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
        [branch]
        if (_10192 != 4294967295u)
        {
            roughness *= SampleBilinear(_10192, _7400, int(get_texture_lod(texSize(_10192), _7633)), _7021, false, true).x;
        }
        ...
        float _9954 = _7623;
        float _9955 = ray.cone_spread;
        int _9956 = ray.xy;
        float _9951 = 0.0f;
        float _10422 = 0.0f;
        float _10421 = 0.0f;
        float _10420 = 0.0f;
        int _10058 = ray.depth;
        int _10062 = ray.xy;
        int _9957;
        float _10060;
        float _10245;
        ...
        {
            [branch]
            if ((_9893 > 0.0f) && (_8053 > 0.0f))
            {
                light_sample_t _9921 = { _9888, _9889, _9890, _9891, _9892, _9893, _9894, _9895 };
                surface_t _9748 = { _7058, _9737, _9738, _9739, _9740, _7400 };
                float _10426[3] = { _10420, _10421, _10422 };
                float _10391[3] = { _10385, _10386, _10387 };
                float _10356[3] = { _10350, _10351, _10352 };
                shadow_ray_t _10072 = { _10356, _10058, _10391, _10060, _10426, _10062 };
                shadow_ray_t param_35 = _10072;
                float3 _8205 = Evaluate_DiffuseNode(_9921, ray, _9748, base_color, roughness, mix_weight, param_35);
                _10350 = param_35.o[0];
                _10351 = param_35.o[1];
                _10352 = param_35.o[2];
                _10058 = param_35.depth;
                _10385 = param_35.d[0];
                _10386 = param_35.d[1];
                _10387 = param_35.d[2];
                _10060 = param_35.dist;
                _10420 = param_35.c[0];
                _10421 = param_35.c[1];
                _10422 = param_35.c[2];
                _10062 = param_35.xy;
            ...
            if (_8219)
            {
                surface_t _9755 = { _7058, _9737, _9738, _9739, _9740, _7400 };
                float _10321[3] = { _10315, _10316, _10317 };
                float _10286[3] = { _10280, _10281, _10282 };
                float _10251[3] = { _10245, _10246, _10247 };
                ray_data_t _9971 = { _10251, _10286, _9951, _10321, _9953, _9954, _9955, _9956, _9957 };
                ray_data_t param_36 = _9971;
                Sample_DiffuseNode(ray, _9755, base_color, roughness, _8136, _8145, mix_weight, param_36);
                _10245 = param_36.o[0];
                _10246 = param_36.o[1];
                _10247 = param_36.o[2];
                _10280 = param_36.d[0];
                ...
                _10317 = param_36.c[2];
                _9953 = param_36.ior;
                _9954 = param_36.cone_width;
                _9955 = param_36.cone_spread;
                _9956 = param_36.xy;
                _9957 = param_36.depth;
            }
        }
        else
        {
            ...
            if (_9801 == 1u)
            {
                ...
                if (_8257 && (_8053 > 0.0f))
                {
                    light_sample_t _9930 = { _9888, _9889, _9890, _9891, _9892, _9893, _9894, _9895 };
                    surface_t _9762 = { _7058, _9737, _9738, _9739, _9740, _7400 };
                    float _10433[3] = { _10420, _10421, _10422 };
                    float _10398[3] = { _10385, _10386, _10387 };
                    float _10363[3] = { _10350, _10351, _10352 };
                    shadow_ray_t _10085 = { _10363, _10058, _10398, _10060, _10433, _10062 };
                    shadow_ray_t param_39 = _10085;
                    float3 _8272 = Evaluate_GlossyNode(_9930, ray, _9762, base_color, roughness, 1.5f, _8243, mix_weight, param_39);
                    _10350 = param_39.o[0];
                    _10351 = param_39.o[1];
                    _10352 = param_39.o[2];
                    _10058 = param_39.depth;
                    _10385 = param_39.d[0];
                    _10386 = param_39.d[1];
                    _10387 = param_39.d[2];
                    _10060 = param_39.dist;
                    _10420 = param_39.c[0];
                    _10421 = param_39.c[1];
                    _10422 = param_39.c[2];
                    _10062 = param_39.xy;
                ...
                if (_8286)
                {
                    surface_t _9769 = { _7058, _9737, _9738, _9739, _9740, _7400 };
                    float _10328[3] = { _10315, _10316, _10317 };
                    float _10293[3] = { _10280, _10281, _10282 };
                    float _10258[3] = { _10245, _10246, _10247 };
                    ray_data_t _9990 = { _10258, _10293, _9951, _10328, _9953, _9954, _9955, _9956, _9957 };
                    ray_data_t param_40 = _9990;
                    Sample_GlossyNode(ray, _9769, base_color, roughness, 1.5f, _8243, _8136, _8145, mix_weight, param_40);
                    _10245 = param_40.o[0];
                    _10246 = param_40.o[1];
                    _10247 = param_40.o[2];
                    _10280 = param_40.d[0];
                    ...
                    _10317 = param_40.c[2];
                    _9953 = param_40.ior;
                    _9954 = param_40.cone_width;
                    _9955 = param_40.cone_spread;
                    _9956 = param_40.xy;
                    _9957 = param_40.depth;
                }
            }
            else
            {
                ...
                if (_9801 == 2u)
                {
                    ...
                    if (_8320 && (_8053 < 0.0f))
                    {
                        ...
                        light_sample_t _9939 = { _9888, _9889, _9890, _9891, _9892, _9893, _9894, _9895 };
                        surface_t _9776 = { _7058, _9737, _9738, _9739, _9740, _7400 };
                        float _10440[3] = { _10420, _10421, _10422 };
                        float _10405[3] = { _10385, _10386, _10387 };
                        float _10370[3] = { _10350, _10351, _10352 };
                        shadow_ray_t _10098 = { _10370, _10058, _10405, _10060, _10440, _10062 };
                        shadow_ray_t param_41 = _10098;
                        float3 _8350 = Evaluate_RefractiveNode(_9939, ray, _9776, base_color, _8310, _8328, mix_weight, param_41);
                        _10350 = param_41.o[0];
                        _10351 = param_41.o[1];
                        _10352 = param_41.o[2];
                        _10058 = param_41.depth;
                        _10385 = param_41.d[0];
                        _10386 = param_41.d[1];
                        _10387 = param_41.d[2];
                        _10060 = param_41.dist;
                        _10420 = param_41.c[0];
                        _10421 = param_41.c[1];
                        _10422 = param_41.c[2];
                        _10062 = param_41.xy;
                    ...
                    if (_8364)
                    {
                        surface_t _9783 = { _7058, _9737, _9738, _9739, _9740, _7400 };
                        float _10335[3] = { _10315, _10316, _10317 };
                        float _10300[3] = { _10280, _10281, _10282 };
                        float _10265[3] = { _10245, _10246, _10247 };
                        ray_data_t _10009 = { _10265, _10300, _9951, _10335, _9953, _9954, _9955, _9956, _9957 };
                        ray_data_t param_42 = _10009;
                        Sample_RefractiveNode(ray, _9783, base_color, roughness, _7092, _9804, _7641, _8136, _8145, mix_weight, param_42);
                        _10245 = param_42.o[0];
                        _10246 = param_42.o[1];
                        _10247 = param_42.o[2];
                        _10280 = param_42.d[0];
                        ...
                        _10317 = param_42.c[2];
                        _9953 = param_42.ior;
                        _9954 = param_42.cone_width;
                        _9955 = param_42.cone_spread;
                        _9956 = param_42.xy;
                        _9957 = param_42.depth;
                    }
                }
                else
                {
                    ...
                    if (_9801 == 3u)
                    {
                        col += (base_color * (mix_weight * _9802));
                    }
                    else
                    {
                        [branch]
                        if (_9801 == 6u)
                        {
                            float metallic = clamp(float((_9806 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            [branch]
                            if (_10193 != 4294967295u)
                            {
                                metallic *= SampleBilinear(_10193, _7400, int(get_texture_lod(texSize(_10193), _7633)), _7021).x;
                            }
                            float specular = clamp(float(_9808 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            [branch]
                            if (_10194 != 4294967295u)
                            {
                                specular *= SampleBilinear(_10194, _7400, int(get_texture_lod(texSize(_10194), _7633)), _7021).x;
                            }
                            float _8485 = clamp(float(_9809 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float _8493 = clamp(float((_9809 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float _8501 = 2.0f * clamp(float(_9805 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float3 _8519 = lerp(1.0f.xxx, tint_color, clamp(float((_9805 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * _8501;
                            float3 _8539 = lerp(lerp(1.0f.xxx, tint_color, clamp(float((_9808 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * (specular * 0.07999999821186065673828125f), base_color, metallic.xxx);
                            ...
                            float _8562 = clamp(float((_9803 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            ...
                            float _8594 = mad(roughness - 1.0f, 1.0f - clamp(float((_9807 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), 1.0f);
                            float _8600;
                            if (_7092)
                            {
                                _8600 = _9804 / _7641;
                            ...
                            float param_47 = dot(_6955, _9739);
                            float param_48 = 1.0f / _8600;
                            float _8623 = fresnel_dielectric_cos(param_47, param_48);
                            float param_49 = dot(_6955, _9739);
                            float param_50 = _8548;
                            lobe_weights_t _8662 = get_lobe_weights(lerp(_8090, 1.0f, _8501), lum(lerp(_8539, 1.0f.xxx, ((fresnel_dielectric_cos(param_49, param_50) - _8554) / (1.0f - _8554)).xxx)), specular, metallic, clamp(float(_9807 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), _8485);
                            [branch]
                            if (_9893 > 0.0f)
                            {
                                light_sample_t _9948 = { _9888, _9889, _9890, _9891, _9892, _9893, _9894, _9895 };
                                surface_t _9790 = { _7058, _9737, _9738, _9739, _9740, _7400 };
                                diff_params_t _10140 = { base_color, _8519, roughness };
                                spec_params_t _10155 = { _8539, roughness, _8548, _8554, _8562 };
                                clearcoat_params_t _10168 = { _8493, _8573, _8579 };
                                transmission_params_t _10183 = { _8594, _9804, _8600, _8623, _7092 };
                                float _10447[3] = { _10420, _10421, _10422 };
                                float _10412[3] = { _10385, _10386, _10387 };
                                float _10377[3] = { _10350, _10351, _10352 };
                                shadow_ray_t _10111 = { _10377, _10058, _10412, _10060, _10447, _10062 };
                                shadow_ray_t param_51 = _10111;
                                float3 _8681 = Evaluate_PrincipledNode(_9948, ray, _9790, _8662, _10140, _10155, _10168, _10183, metallic, _8053, mix_weight, param_51);
                                _10350 = param_51.o[0];
                                _10351 = param_51.o[1];
                                _10352 = param_51.o[2];
                                _10058 = param_51.depth;
                                _10385 = param_51.d[0];
                                _10386 = param_51.d[1];
                                _10387 = param_51.d[2];
                                _10060 = param_51.dist;
                                _10420 = param_51.c[0];
                                _10421 = param_51.c[1];
                                _10422 = param_51.c[2];
                                _10062 = param_51.xy;
                            ...
                            surface_t _9797 = { _7058, _9737, _9738, _9739, _9740, _7400 };
                            diff_params_t _10144 = { base_color, _8519, roughness };
                            spec_params_t _10161 = { _8539, roughness, _8548, _8554, _8562 };
                            clearcoat_params_t _10172 = { _8493, _8573, _8579 };
                            transmission_params_t _10189 = { _8594, _9804, _8600, _8623, _7092 };
                            float param_52 = mix_rand;
                            float _10342[3] = { _10315, _10316, _10317 };
                            float _10307[3] = { _10280, _10281, _10282 };
                            float _10272[3] = { _10245, _10246, _10247 };
                            ray_data_t _10028 = { _10272, _10307, _9951, _10342, _9953, _9954, _9955, _9956, _9957 };
                            ray_data_t param_53 = _10028;
                            Sample_PrincipledNode(ray, _9797, _8662, _10144, _10161, _10172, _10189, metallic, _8136, _8145, param_52, mix_weight, param_53);
                            _10245 = param_53.o[0];
                            _10246 = param_53.o[1];
                            _10247 = param_53.o[2];
                            _10280 = param_53.d[0];
                            ...
                            _10317 = param_53.c[2];
                            _9953 = param_53.ior;
                            _9954 = param_53.cone_width;
                            _9955 = param_53.cone_spread;
                            _9956 = param_53.xy;
                            _9957 = param_53.depth;
                        }
                    }
                }
            }
        }
        float _8715 = max(_10315, max(_10316, _10317));
        float _8727;
        ...
        if (_8747)
        {
            ...
            _8787.Store(_8778 * 72 + 0, asuint(_10245));
            _8787.Store(_8778 * 72 + 4, asuint(_10246));
            _8787.Store(_8778 * 72 + 8, asuint(_10247));
            _8787.Store(_8778 * 72 + 12, asuint(_10280));
            _8787.Store(_8778 * 72 + 16, asuint(_10281));
            _8787.Store(_8778 * 72 + 20, asuint(_10282));
            ...
            _8787.Store(_8778 * 72 + 40, asuint(_9953[0]));
            _8787.Store(_8778 * 72 + 44, asuint(_9953[1]));
            _8787.Store(_8778 * 72 + 48, asuint(_9953[2]));
            _8787.Store(_8778 * 72 + 52, asuint(_9953[3]));
            _8787.Store(_8778 * 72 + 56, asuint(_9954));
            _8787.Store(_8778 * 72 + 60, asuint(_9955));
            _8787.Store(_8778 * 72 + 64, uint(_9956));
            _8787.Store(_8778 * 72 + 68, uint(_9957));
        }
        [branch]
        if (max(_10420, max(_10421, _10422)) > 0.0f)
        {
            float3 _8864 = _9890 - float3(_10350, _10351, _10352);
            float _8867 = length(_8864);
            float3 _8871 = _8864 / _8867.xxx;
            float sh_dist = _8867 * _9892;
            if (_9895)
            {
                sh_dist = -sh_dist;
            }
            ...
            _8903.Store(_8895 * 48 + 0, asuint(_10350));
            _8903.Store(_8895 * 48 + 4, asuint(_10351));
            _8903.Store(_8895 * 48 + 8, asuint(_10352));
            _8903.Store(_8895 * 48 + 12, uint(_10058));
            ...
            _8903.Store(_8895 * 48 + 32, asuint(_10420));
            _8903.Store(_8895 * 48 + 36, asuint(_10421));
            _8903.Store(_8895 * 48 + 40, asuint(_10422));
            _8903.Store(_8895 * 48 + 44, uint(_10062));
        }
        _9135 = float3(ray.c[0] * col.x, ray.c[1] * col.y, ray.c[2] * col.z);
        break;
    } while(false);
    return _9135;
}
...
void comp_main()
{
    do
    {
        ...
        hit_data_t _9229 = { _9003.mask, _9003.obj_index, _9003.prim_index, _9003.t, _9003.u, _9003.v };
        hit_data_t param = _9229;
        float _9278[4] = { _9019.ior[0], _9019.ior[1], _9019.ior[2], _9019.ior[3] };
        float _9269[3] = { _9019.c[0], _9019.c[1], _9019.c[2] };
        float _9262[3] = { _9019.d[0], _9019.d[1], _9019.d[2] };
        float _9255[3] = { _9019.o[0], _9019.o[1], _9019.o[2] };
        ray_data_t _9248 = { _9255, _9262, _9019.pdf, _9269, _9278, _9019.cone_width, _9019.cone_spread, _9019.xy, _9019.depth };
        ray_data_t param_1 = _9248;
        ...
        g_out_depth_normals_img[_9089] = float4(param_3, _9003.t);
        break;
    } while(false);
}
