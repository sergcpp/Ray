...
ByteAddressBuffer _9163 : register(t10, space0);
...
float2 TransformUV(float2 _uv, atlas_texture_t t, int mip_level)
{
    ...
    return mad(frac(_uv), size, float2(float(_9338[mip_level] & 65535u), float((_9341[mip_level] >> uint(16)) & 65535u))) + 1.0f.xx;
}
...
float3 Evaluate_EnvColor(ray_data_t ray)
{
    ...
    if (_5021 != 4294967295u)
    {
        ...
        uint _9708[14] = { _5032.pos[0], _5032.pos[1], _5032.pos[2], _5032.pos[3], _5032.pos[4], _5032.pos[5], _5032.pos[6], _5032.pos[7], _5032.pos[8], _5032.pos[9], _5032.pos[10], _5032.pos[11], _5032.pos[12], _5032.pos[13] };
        uint _9679[4] = { _5032.page[0], _5032.page[1], _5032.page[2], _5032.page[3] };
        atlas_texture_t _9670 = { _5032.size, _5032.atlas, _9679, _9708 };
        float param = _3539_g_params.back_rotation;
        env_col *= SampleLatlong_RGBE(_9670, _5013, param);
    }
...
float3 Evaluate_LightColor(ray_data_t ray, hit_data_t inter)
{
    ...
    if ((_5158.type_and_param0.x & 128u) != 0u)
    {
        ...
        if (_5185 != 4294967295u)
        {
            ...
            uint _9770[14] = { _5192.pos[0], _5192.pos[1], _5192.pos[2], _5192.pos[3], _5192.pos[4], _5192.pos[5], _5192.pos[6], _5192.pos[7], _5192.pos[8], _5192.pos[9], _5192.pos[10], _5192.pos[11], _5192.pos[12], _5192.pos[13] };
            uint _9741[4] = { _5192.page[0], _5192.page[1], _5192.page[2], _5192.page[3] };
            atlas_texture_t _9732 = { _5192.size, _5192.atlas, _9741, _9770 };
            float param = _3539_g_params.env_rotation;
            env_col *= SampleLatlong_RGBE(_9732, _5144, param);
        }
        lcol *= env_col;
    }
...
float4 SampleBilinear(uint index, float2 uvs, int lod, bool maybe_YCoCg, bool maybe_SRGB)
{
    ...
    uint _9346[4];
    _9346[0] = _1133.page[0];
    _9346[1] = _1133.page[1];
    _9346[2] = _1133.page[2];
    _9346[3] = _1133.page[3];
    uint _9382[14] = { _1133.pos[0], _1133.pos[1], _1133.pos[2], _1133.pos[3], _1133.pos[4], _1133.pos[5], _1133.pos[6], _1133.pos[7], _1133.pos[8], _1133.pos[9], _1133.pos[10], _1133.pos[11], _1133.pos[12], _1133.pos[13] };
    atlas_texture_t _9352 = { _1133.size, _1133.atlas, _9346, _9382 };
    uint _1203 = _1133.atlas;
    float4 res = g_atlases[NonUniformResourceIndex(_1203)].SampleLevel(_g_atlases_sampler[NonUniformResourceIndex(_1203)], float3(TransformUV(uvs, _9352, lod) * 0.000118371215648949146270751953125f.xx, float((_9346[lod / 4] >> uint((lod % 4) * 8)) & 255u)), 0.0f);
    bool _1218;
    if (maybe_YCoCg)
    {
    ...
    if (_1237)
    {
        ...
        float4 _10525 = res;
        _10525.x = _1243.x;
        float4 _10527 = _10525;
        _10527.y = _1243.y;
        float4 _10529 = _10527;
        _10529.z = _1243.z;
        res = _10529;
    }
    return res;
...
float3 ensure_valid_reflection(float3 Ng, float3 I, float3 N)
{
    ...
    do
    {
        ...
        if (_1592 && _1598)
        {
            float _10828 = (-0.5f) / _1552;
            float param_1 = mad(_10828, _1576, 1.0f);
            float _1608 = safe_sqrtf(param_1);
            float param_2 = _1577;
            float _1611 = safe_sqrtf(param_2);
            float2 _1612 = float2(_1608, _1611);
            float param_3 = mad(_10828, _1583, 1.0f);
            float _1617 = safe_sqrtf(param_3);
            float param_4 = _1584;
            float _1620 = safe_sqrtf(param_4);
            float2 _1621 = float2(_1617, _1620);
            float _10830 = -_1540;
            float _1637 = mad(2.0f * mad(_1608, _1536, _1611 * _1540), _1611, _10830);
            float _1653 = mad(2.0f * mad(_1617, _1536, _1620 * _1540), _1620, _10830);
        ...
        _9180 = (_1532 * N_new.x) + (Ng * N_new.y);
        break;
    } while(false);
    return _9180;
}
...
float3 MapToCone(float r1, float r2, float3 N, float radius)
{
    ...
    do
    {
        ...
        _9205 = (N + (param * ((radius * r) * cos(theta)))) + (param_1 * ((radius * r) * sin(theta)));
        break;
    } while(false);
    return _9205;
}
...
float4 Sample_EnvQTree(float y_rotation, Texture2D<float4> qtree_tex, SamplerState _qtree_tex_sampler, int qtree_levels, float rand, float rx, float ry)
{
    ...
    while (lod >= 0)
    {
        ...
        else
        {
            ...
            partial = _912;
            float2 _10512 = origin;
            _10512.x = origin.x + _step;
            origin = _10512;
        ...
        {
            float2 _10515 = origin;
            _10515.y = origin.y + _step;
            origin = _10515;
            _sample = (_sample - boundary) / (1.0f - boundary);
            index |= 2;
        }
...
void SampleLightSource(float3 P, float3 T, float3 B, float3 N, int hi, float2 sample_off, inout light_sample_t ls)
{
    ...
    if (_3604 == 0u)
    {
        ...
        float3 _10592 = sampled_dir;
        float3 _3682 = ((param * _10592.x) + (param_1 * _10592.y)) + (_3639 * _10592.z);
        sampled_dir = _3682;
            ...
            if (_3604 == 4u)
            {
                ...
                if ((_3570.type_and_param0.x & 128u) != 0u)
                {
                    ...
                    if (_3962 != 4294967295u)
                    {
                        ...
                        uint _9526[14] = { _3970.pos[0], _3970.pos[1], _3970.pos[2], _3970.pos[3], _3970.pos[4], _3970.pos[5], _3970.pos[6], _3970.pos[7], _3970.pos[8], _3970.pos[9], _3970.pos[10], _3970.pos[11], _3970.pos[12], _3970.pos[13] };
                        uint _9497[4] = { _3970.page[0], _3970.page[1], _3970.page[2], _3970.page[3] };
                        atlas_texture_t _9426 = { _3970.size, _3970.atlas, _9497, _9526 };
                        float param_10 = _3539_g_params.env_rotation;
                        env_col *= SampleLatlong_RGBE(_9426, ls.L, param_10);
                    }
                    ls.col *= env_col;
                    ls.from_env = true;
                }
                ...
                if (_3604 == 5u)
                {
                    ...
                    if ((_3570.type_and_param0.x & 128u) != 0u)
                    {
                        ...
                        if (_4205 != 4294967295u)
                        {
                            ...
                            uint _9564[14] = { _4212.pos[0], _4212.pos[1], _4212.pos[2], _4212.pos[3], _4212.pos[4], _4212.pos[5], _4212.pos[6], _4212.pos[7], _4212.pos[8], _4212.pos[9], _4212.pos[10], _4212.pos[11], _4212.pos[12], _4212.pos[13] };
                            uint _9535[4] = { _4212.page[0], _4212.page[1], _4212.page[2], _4212.page[3] };
                            atlas_texture_t _9435 = { _4212.size, _4212.atlas, _9535, _9564 };
                            float param_13 = _3539_g_params.env_rotation;
                            env_col_1 *= SampleLatlong_RGBE(_9435, ls.L, param_13);
                        }
                        ls.col *= env_col_1;
                        ls.from_env = true;
                    }
                        ...
                        else
                        {
                            ...
                            if (_3604 == 7u)
                            {
                                ...
                                if (_4931 != 4294967295u)
                                {
                                    ...
                                    uint _9649[14] = { _4938.pos[0], _4938.pos[1], _4938.pos[2], _4938.pos[3], _4938.pos[4], _4938.pos[5], _4938.pos[6], _4938.pos[7], _4938.pos[8], _4938.pos[9], _4938.pos[10], _4938.pos[11], _4938.pos[12], _4938.pos[13] };
                                    uint _9620[4] = { _4938.page[0], _4938.page[1], _4938.page[2], _4938.page[3] };
                                    atlas_texture_t _9488 = { _4938.size, _4938.atlas, _9620, _9649 };
                                    float param_20 = _3539_g_params.env_rotation;
                                    ls.col *= SampleLatlong_RGBE(_9488, ls.L, param_20);
                                }
                                ls.area = 1.0f;
                                ls.lp = P + ls.L;
                                ls.dist_mul = 3402823346297367662189621542912.0f;
...
float D_GGX(float3 H, float alpha_x, float alpha_y)
{
    ...
    do
    {
        ...
        _9238 = 1.0f / (((((_2259 * _2259) * 3.1415927410125732421875f) * alpha_x) * alpha_y) * (((H.z * H.z) * H.z) * H.z));
        break;
    } while(false);
    return _9238;
}
...
float4 Sample_GGXSpecular_BSDF(float3 T, float3 B, float3 N, float3 I, float roughness, float anisotropic, float spec_ior, float spec_F0, float3 spec_col, float rand_u, float rand_v, inout float3 out_V)
{
    ...
    do
    {
        ...
        if ((_2870 * _2874) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            out_V = _2885;
            _9210 = float4(_2899.x * 1000000.0f, _2899.y * 1000000.0f, _2899.z * 1000000.0f, 1000000.0f);
            break;
        }
        float3 param_2 = T;
        float3 param_3 = B;
        ...
        _9210 = Evaluate_GGXSpecular_BSDF(param_14, param_15, param_16, param_17, param_18, param_19, param_20, param_21);
        break;
    } while(false);
    return _9210;
}
...
float4 Evaluate_GGXRefraction_BSDF(float3 view_dir_ts, float3 sampled_normal_ts, float3 refr_dir_ts, float roughness2, float eta, float3 refr_col)
{
    ...
    do
    {
        ...
        _9215 = float4(refr_col * (((((_3182 * _3198) * _3190) * clamp(dot(view_dir_ts, sampled_normal_ts), 0.0f, 1.0f)) * _3218) / view_dir_ts.z), (((_3182 * _3190) * clamp(dot(view_dir_ts, sampled_normal_ts), 0.0f, 1.0f)) * _3218) / view_dir_ts.z);
        break;
    } while(false);
    return _9215;
}
...
float4 Sample_GGXRefraction_BSDF(float3 T, float3 B, float3 N, float3 I, float roughness, float eta, float3 refr_col, float rand_u, float rand_v, inout float4 out_V)
{
    ...
    do
    {
        ...
        if ((_3262 * _3262) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            _9220 = float4(refr_col.x * 1000000.0f, refr_col.y * 1000000.0f, refr_col.z * 1000000.0f, 1000000.0f);
            break;
        }
        float3 param = T;
        float3 param_1 = B;
        ...
        _9220 = Evaluate_GGXRefraction_BSDF(param_8, param_9, param_10, param_11, param_12, param_13);
        break;
    } while(false);
    return _9220;
}
...
lobe_weights_t get_lobe_weights(float base_color_lum, float spec_color_lum, float specular, float metallic, float transmission, float clearcoat)
{
    ...
    float _9383 = (base_color_lum * _1715) * (1.0f - transmission);
    ...
    float _9385 = _1736 * _1715;
    float _9386 = _1722 * base_color_lum;
    float _1745 = _9383;
    ...
    lobe_weights_t _9391 = { _9383, _9384, _9385, _9386 };
    return _9391;
}
...
float BRDF_PrincipledDiffuse(float3 V, float3 N, float3 L, float3 H, float roughness)
{
    ...
    do
    {
        ...
        _9243 = lerp(1.0f, _2499, schlick_weight(param)) * lerp(1.0f, _2499, schlick_weight(param_1));
        break;
    } while(false);
    return _9243;
}
...
float D_GTR1(float NDotH, float a)
{
    ...
    do
    {
        if (a >= 1.0f)
        {
            _9248 = 0.3183098733425140380859375f;
            break;
        }
        float _2218 = mad(a, a, -1.0f);
        _9248 = _2218 / ((3.1415927410125732421875f * log(a * a)) * mad(_2218 * NDotH, NDotH, 1.0f));
        break;
    } while(false);
    return _9248;
}
...
float4 Sample_PrincipledClearcoat_BSDF(float3 T, float3 B, float3 N, float3 I, float clearcoat_roughness2, float clearcoat_ior, float clearcoat_F0, float rand_u, float rand_v, inout float3 out_V)
{
    ...
    do
    {
        ...
        if ((clearcoat_roughness2 * clearcoat_roughness2) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            _9233 = float4(_3099, _3099, _3099, 1000000.0f);
            break;
        }
        float3 param_2 = T;
        float3 param_3 = B;
        ...
        _9233 = Evaluate_PrincipledClearcoat_BSDF(param_14, param_15, param_16, param_17, param_18, param_19);
        break;
    } while(false);
    return _9233;
}
        ...
        else
        {
            ...
            else
            {
                ...
                if (_6845)
                {
                    ...
                    float4 _10776 = F;
                    float _6959 = _10776.w * lobe_weights.refraction;
                    float4 _10778 = _10776;
                    _10778.w = _6959;
                    F = _10778;
                    new_ray.c[0] = ((ray.c[0] * _10776.x) * mix_weight) / _6959;
                    new_ray.c[1] = ((ray.c[1] * _10776.y) * mix_weight) / _6959;
                    new_ray.c[2] = ((ray.c[2] * _10776.z) * mix_weight) / _6959;
                    new_ray.pdf = _6959;
                    new_ray.d[0] = V.x;
                    new_ray.d[1] = V.y;
                    new_ray.d[2] = V.z;
...
float3 ShadeSurface(hit_data_t inter, ray_data_t ray, inout float3 out_base_color, inout float3 out_normals)
{
    ...
    do
    {
        ...
        if (inter.mask == 0)
        {
            ...
            _9170 = float3(ray.c[0] * _7024.x, ray.c[1] * _7024.y, ray.c[2] * _7024.z);
            break;
        }
        ...
        if (inter.obj_index < 0)
        {
            ...
            _9170 = float3(ray.c[0] * _7063.x, ray.c[1] * _7063.y, ray.c[2] * _7063.z);
            break;
        }
        ...
        uint _10225 = _7106.textures[0];
        uint _10226 = _7106.textures[1];
        uint _10227 = _7106.textures[2];
        uint _10228 = _7106.textures[3];
        uint _10229 = _7106.textures[4];
        float _10230 = _7106.base_color[0];
        float _10231 = _7106.base_color[1];
        float _10232 = _7106.base_color[2];
        uint _9835 = _7106.flags;
        uint _9836 = _7106.type;
        float _9837 = _7106.tangent_rotation_or_strength;
        uint _9838 = _7106.roughness_and_anisotropic;
        float _9839 = _7106.ior;
        uint _9840 = _7106.sheen_and_sheen_tint;
        uint _9841 = _7106.tint_and_metallic;
        uint _9842 = _7106.transmission_and_transmission_roughness;
        uint _9843 = _7106.specular_and_specular_tint;
        uint _9844 = _7106.clearcoat_and_clearcoat_roughness;
        uint _9845 = _7106.normal_map_strength_unorm;
        transform_t _7161;
        ...
        float3 _9773 = _7450;
        float3 _9772 = cross(_7450, _7366);
        if (_7084)
        {
            ...
            _10225 = _7475.textures[0];
            _10226 = _7475.textures[1];
            _10227 = _7475.textures[2];
            _10228 = _7475.textures[3];
            _10229 = _7475.textures[4];
            _10230 = _7475.base_color[0];
            _10231 = _7475.base_color[1];
            _10232 = _7475.base_color[2];
            _9835 = _7475.flags;
            _9836 = _7475.type;
            _9837 = _7475.tangent_rotation_or_strength;
            _9838 = _7475.roughness_and_anisotropic;
            _9839 = _7475.ior;
            _9840 = _7475.sheen_and_sheen_tint;
            _9841 = _7475.tint_and_metallic;
            _9842 = _7475.transmission_and_transmission_roughness;
            _9843 = _7475.specular_and_specular_tint;
            _9844 = _7475.clearcoat_and_clearcoat_roughness;
            _9845 = _7475.normal_map_strength_unorm;
            _9775 = -_9775;
            _9774 = -_9774;
            _9773 = -_9773;
            _9772 = -_9772;
        }
        float3 param_3 = _9775;
        float4x4 param_4 = _7161.inv_xform;
        _9775 = TransformNormal(param_3, param_4);
        float3 param_5 = _9774;
        float4x4 param_6 = _7161.inv_xform;
        _9774 = TransformNormal(param_5, param_6);
        float3 param_7 = _9773;
        float4x4 param_8 = _7161.inv_xform;
        _9773 = TransformNormal(param_7, param_8);
        float3 param_9 = _9772;
        float4x4 param_10 = _7161.inv_xform;
        _9775 = normalize(_9775);
        _9774 = normalize(_9774);
        _9773 = normalize(_9773);
        _9772 = normalize(TransformNormal(param_9, param_10));
        ...
        while (_9836 == 4u)
        {
            ...
            {
                mix_val *= SampleBilinear(_10226, _7392, 0).x;
            }
            if (_7084)
            {
                _7719 = _7648 / _9839;
            ...
            if (_9839 != 0.0f)
            {
                float param_16 = dot(_7015, _9774);
            ...
            if (mix_rand > _7752)
            {
                ...
                {
                    _7775.textures[_108ident] = _4759.Load(_108ident * 4 + _10228 * 76 + 0);
                }
                [unroll]
                for (int _109ident = 0; _109ident < 3; _109ident++)
                {
                    _7775.base_color[_109ident] = asfloat(_4759.Load(_109ident * 4 + _10228 * 76 + 20));
                }
                _7775.flags = _4759.Load(_10228 * 76 + 32);
                _7775.type = _4759.Load(_10228 * 76 + 36);
                _7775.tangent_rotation_or_strength = asfloat(_4759.Load(_10228 * 76 + 40));
                _7775.roughness_and_anisotropic = _4759.Load(_10228 * 76 + 44);
                _7775.ior = asfloat(_4759.Load(_10228 * 76 + 48));
                _7775.sheen_and_sheen_tint = _4759.Load(_10228 * 76 + 52);
                _7775.tint_and_metallic = _4759.Load(_10228 * 76 + 56);
                _7775.transmission_and_transmission_roughness = _4759.Load(_10228 * 76 + 60);
                _7775.specular_and_specular_tint = _4759.Load(_10228 * 76 + 64);
                _7775.clearcoat_and_clearcoat_roughness = _4759.Load(_10228 * 76 + 68);
                _7775.normal_map_strength_unorm = _4759.Load(_10228 * 76 + 72);
                _10225 = _7775.textures[0];
                _10226 = _7775.textures[1];
                _10227 = _7775.textures[2];
                _10228 = _7775.textures[3];
                _10229 = _7775.textures[4];
                _10230 = _7775.base_color[0];
                _10231 = _7775.base_color[1];
                _10232 = _7775.base_color[2];
                _9835 = _7775.flags;
                _9836 = _7775.type;
                _9837 = _7775.tangent_rotation_or_strength;
                _9838 = _7775.roughness_and_anisotropic;
                _9839 = _7775.ior;
                _9840 = _7775.sheen_and_sheen_tint;
                _9841 = _7775.tint_and_metallic;
                _9842 = _7775.transmission_and_transmission_roughness;
                _9843 = _7775.specular_and_specular_tint;
                _9844 = _7775.clearcoat_and_clearcoat_roughness;
                _9845 = _7775.normal_map_strength_unorm;
            ...
            else
            {
                ...
                {
                    _7841.textures[_110ident] = _4759.Load(_110ident * 4 + _10229 * 76 + 0);
                }
                [unroll]
                for (int _111ident = 0; _111ident < 3; _111ident++)
                {
                    _7841.base_color[_111ident] = asfloat(_4759.Load(_111ident * 4 + _10229 * 76 + 20));
                }
                _7841.flags = _4759.Load(_10229 * 76 + 32);
                _7841.type = _4759.Load(_10229 * 76 + 36);
                _7841.tangent_rotation_or_strength = asfloat(_4759.Load(_10229 * 76 + 40));
                _7841.roughness_and_anisotropic = _4759.Load(_10229 * 76 + 44);
                _7841.ior = asfloat(_4759.Load(_10229 * 76 + 48));
                _7841.sheen_and_sheen_tint = _4759.Load(_10229 * 76 + 52);
                _7841.tint_and_metallic = _4759.Load(_10229 * 76 + 56);
                _7841.transmission_and_transmission_roughness = _4759.Load(_10229 * 76 + 60);
                _7841.specular_and_specular_tint = _4759.Load(_10229 * 76 + 64);
                _7841.clearcoat_and_clearcoat_roughness = _4759.Load(_10229 * 76 + 68);
                _7841.normal_map_strength_unorm = _4759.Load(_10229 * 76 + 72);
                _10225 = _7841.textures[0];
                _10226 = _7841.textures[1];
                _10227 = _7841.textures[2];
                _10228 = _7841.textures[3];
                _10229 = _7841.textures[4];
                _10230 = _7841.base_color[0];
                _10231 = _7841.base_color[1];
                _10232 = _7841.base_color[2];
                _9835 = _7841.flags;
                _9836 = _7841.type;
                _9837 = _7841.tangent_rotation_or_strength;
                _9838 = _7841.roughness_and_anisotropic;
                _9839 = _7841.ior;
                _9840 = _7841.sheen_and_sheen_tint;
                _9841 = _7841.tint_and_metallic;
                _9842 = _7841.transmission_and_transmission_roughness;
                _9843 = _7841.specular_and_specular_tint;
                _9844 = _7841.clearcoat_and_clearcoat_roughness;
                _9845 = _7841.normal_map_strength_unorm;
                mix_rand /= mix_val;
            }
        }
        [branch]
        ...
        {
            float3 normals = (float3(SampleBilinear(_10225, _7392, 0).xy, 1.0f) * 2.0f) - 1.0f.xxx;
            if ((_1003.Load(_10225 * 80 + 0) & 16384u) != 0u)
            {
                float3 _10797 = normals;
                _10797.z = sqrt(1.0f - dot(normals.xy, normals.xy));
                normals = _10797;
            }
            float3 _7925 = _9774;
            _9774 = normalize(((_9772 * normals.x) + (_7925 * normals.z)) + (_9773 * normals.y));
            if ((_9845 & 65535u) != 65535u)
            {
                _9774 = normalize(_7925 + ((_9774 - _7925) * clamp(float(_9845 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f)));
            }
            float3 param_18 = _9775;
            float3 param_19 = -_7015;
            float3 param_20 = _9774;
            _9774 = ensure_valid_reflection(param_18, param_19, param_20);
        }
        ...
        tangent = _8004;
        float3 _8008 = cross(_8004, _9774);
        ...
        if (_9837 != 0.0f)
        {
            ...
            float3 param_26 = _9774;
            float param_27 = _9837;
            tangent = rotate_around_axis(param_25, param_26, param_27);
        }
        float3 _8041 = normalize(cross(tangent, _9774));
        _9773 = _8041;
        _9772 = cross(_9774, _8041);
        float3 _9924 = 0.0f.xxx;
        ...
        if (_8063)
        {
            ...
            float3 param_29 = _9772;
            float3 param_30 = _9773;
            float3 param_31 = _9774;
            int param_32 = _7682;
            float2 param_33 = float2(_7632, _7639);
            light_sample_t _9939 = { _9923, _9924, _9925, _9926, _9927, _9928, _9929, _9930 };
            light_sample_t param_34 = _9939;
            SampleLightSource(param_28, param_29, param_30, param_31, param_32, param_33, param_34);
            _9923 = param_34.col;
            _9924 = param_34.L;
            _9925 = param_34.lp;
            _9926 = param_34.area;
            _9927 = param_34.dist_mul;
            _9928 = param_34.pdf;
            _9929 = param_34.cast_shadow;
            _9930 = param_34.from_env;
        }
        float _8091 = dot(_9774, _9924);
        float3 base_color = float3(_10230, _10231, _10232);
        [branch]
        if (_10226 != 4294967295u)
        {
            base_color *= SampleBilinear(_10226, _7392, int(get_texture_lod(texSize(_10226), _7625)), true, true).xyz;
        }
        ...
        float roughness = clamp(float(_9838 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
        [branch]
        if (_10227 != 4294967295u)
        {
            roughness *= SampleBilinear(_10227, _7392, int(get_texture_lod(texSize(_10227), _7625)), false, true).x;
        }
        ...
        float _9989 = _7615;
        float _9990 = ray.cone_spread;
        int _9991 = ray.xy;
        float _9986 = 0.0f;
        float _10457 = 0.0f;
        float _10456 = 0.0f;
        float _10455 = 0.0f;
        int _10093 = ray.depth;
        int _10097 = ray.xy;
        int _9992;
        float _10095;
        float _10280;
        ...
        {
            [branch]
            if ((_9928 > 0.0f) && (_8091 > 0.0f))
            {
                light_sample_t _9956 = { _9923, _9924, _9925, _9926, _9927, _9928, _9929, _9930 };
                surface_t _9783 = { _7051, _9772, _9773, _9774, _9775, _7392 };
                float _10461[3] = { _10455, _10456, _10457 };
                float _10426[3] = { _10420, _10421, _10422 };
                float _10391[3] = { _10385, _10386, _10387 };
                shadow_ray_t _10107 = { _10391, _10093, _10426, _10095, _10461, _10097 };
                shadow_ray_t param_35 = _10107;
                float3 _8241 = Evaluate_DiffuseNode(_9956, ray, _9783, base_color, roughness, mix_weight, param_35);
                _10385 = param_35.o[0];
                _10386 = param_35.o[1];
                _10387 = param_35.o[2];
                _10093 = param_35.depth;
                _10420 = param_35.d[0];
                _10421 = param_35.d[1];
                _10422 = param_35.d[2];
                _10095 = param_35.dist;
                _10455 = param_35.c[0];
                _10456 = param_35.c[1];
                _10457 = param_35.c[2];
                _10097 = param_35.xy;
            ...
            if (_8255)
            {
                surface_t _9790 = { _7051, _9772, _9773, _9774, _9775, _7392 };
                float _10356[3] = { _10350, _10351, _10352 };
                float _10321[3] = { _10315, _10316, _10317 };
                float _10286[3] = { _10280, _10281, _10282 };
                ray_data_t _10006 = { _10286, _10321, _9986, _10356, _9988, _9989, _9990, _9991, _9992 };
                ray_data_t param_36 = _10006;
                Sample_DiffuseNode(ray, _9790, base_color, roughness, _8172, _8181, mix_weight, param_36);
                _10280 = param_36.o[0];
                _10281 = param_36.o[1];
                _10282 = param_36.o[2];
                _10315 = param_36.d[0];
                ...
                _10352 = param_36.c[2];
                _9988 = param_36.ior;
                _9989 = param_36.cone_width;
                _9990 = param_36.cone_spread;
                _9991 = param_36.xy;
                _9992 = param_36.depth;
            }
        }
        else
        {
            ...
            if (_9836 == 1u)
            {
                ...
                if (_8293 && (_8091 > 0.0f))
                {
                    light_sample_t _9965 = { _9923, _9924, _9925, _9926, _9927, _9928, _9929, _9930 };
                    surface_t _9797 = { _7051, _9772, _9773, _9774, _9775, _7392 };
                    float _10468[3] = { _10455, _10456, _10457 };
                    float _10433[3] = { _10420, _10421, _10422 };
                    float _10398[3] = { _10385, _10386, _10387 };
                    shadow_ray_t _10120 = { _10398, _10093, _10433, _10095, _10468, _10097 };
                    shadow_ray_t param_39 = _10120;
                    float3 _8308 = Evaluate_GlossyNode(_9965, ray, _9797, base_color, roughness, 1.5f, _8279, mix_weight, param_39);
                    _10385 = param_39.o[0];
                    _10386 = param_39.o[1];
                    _10387 = param_39.o[2];
                    _10093 = param_39.depth;
                    _10420 = param_39.d[0];
                    _10421 = param_39.d[1];
                    _10422 = param_39.d[2];
                    _10095 = param_39.dist;
                    _10455 = param_39.c[0];
                    _10456 = param_39.c[1];
                    _10457 = param_39.c[2];
                    _10097 = param_39.xy;
                ...
                if (_8322)
                {
                    surface_t _9804 = { _7051, _9772, _9773, _9774, _9775, _7392 };
                    float _10363[3] = { _10350, _10351, _10352 };
                    float _10328[3] = { _10315, _10316, _10317 };
                    float _10293[3] = { _10280, _10281, _10282 };
                    ray_data_t _10025 = { _10293, _10328, _9986, _10363, _9988, _9989, _9990, _9991, _9992 };
                    ray_data_t param_40 = _10025;
                    Sample_GlossyNode(ray, _9804, base_color, roughness, 1.5f, _8279, _8172, _8181, mix_weight, param_40);
                    _10280 = param_40.o[0];
                    _10281 = param_40.o[1];
                    _10282 = param_40.o[2];
                    _10315 = param_40.d[0];
                    ...
                    _10352 = param_40.c[2];
                    _9988 = param_40.ior;
                    _9989 = param_40.cone_width;
                    _9990 = param_40.cone_spread;
                    _9991 = param_40.xy;
                    _9992 = param_40.depth;
                }
            }
            else
            {
                ...
                if (_9836 == 2u)
                {
                    ...
                    if (_8356 && (_8091 < 0.0f))
                    {
                        ...
                        light_sample_t _9974 = { _9923, _9924, _9925, _9926, _9927, _9928, _9929, _9930 };
                        surface_t _9811 = { _7051, _9772, _9773, _9774, _9775, _7392 };
                        float _10475[3] = { _10455, _10456, _10457 };
                        float _10440[3] = { _10420, _10421, _10422 };
                        float _10405[3] = { _10385, _10386, _10387 };
                        shadow_ray_t _10133 = { _10405, _10093, _10440, _10095, _10475, _10097 };
                        shadow_ray_t param_41 = _10133;
                        float3 _8386 = Evaluate_RefractiveNode(_9974, ray, _9811, base_color, _8346, _8364, mix_weight, param_41);
                        _10385 = param_41.o[0];
                        _10386 = param_41.o[1];
                        _10387 = param_41.o[2];
                        _10093 = param_41.depth;
                        _10420 = param_41.d[0];
                        _10421 = param_41.d[1];
                        _10422 = param_41.d[2];
                        _10095 = param_41.dist;
                        _10455 = param_41.c[0];
                        _10456 = param_41.c[1];
                        _10457 = param_41.c[2];
                        _10097 = param_41.xy;
                    ...
                    if (_8400)
                    {
                        surface_t _9818 = { _7051, _9772, _9773, _9774, _9775, _7392 };
                        float _10370[3] = { _10350, _10351, _10352 };
                        float _10335[3] = { _10315, _10316, _10317 };
                        float _10300[3] = { _10280, _10281, _10282 };
                        ray_data_t _10044 = { _10300, _10335, _9986, _10370, _9988, _9989, _9990, _9991, _9992 };
                        ray_data_t param_42 = _10044;
                        Sample_RefractiveNode(ray, _9818, base_color, roughness, _7084, _9839, _7648, _8172, _8181, mix_weight, param_42);
                        _10280 = param_42.o[0];
                        _10281 = param_42.o[1];
                        _10282 = param_42.o[2];
                        _10315 = param_42.d[0];
                        ...
                        _10352 = param_42.c[2];
                        _9988 = param_42.ior;
                        _9989 = param_42.cone_width;
                        _9990 = param_42.cone_spread;
                        _9991 = param_42.xy;
                        _9992 = param_42.depth;
                    }
                }
                else
                {
                    ...
                    if (_9836 == 3u)
                    {
                        col += (base_color * (mix_weight * _9837));
                    }
                    else
                    {
                        [branch]
                        if (_9836 == 6u)
                        {
                            float metallic = clamp(float((_9841 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            [branch]
                            if (_10228 != 4294967295u)
                            {
                                metallic *= SampleBilinear(_10228, _7392, int(get_texture_lod(texSize(_10228), _7625))).x;
                            }
                            float specular = clamp(float(_9843 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            [branch]
                            if (_10229 != 4294967295u)
                            {
                                specular *= SampleBilinear(_10229, _7392, int(get_texture_lod(texSize(_10229), _7625))).x;
                            }
                            float _8519 = clamp(float(_9844 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float _8527 = clamp(float((_9844 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float _8535 = 2.0f * clamp(float(_9840 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float3 _8553 = lerp(1.0f.xxx, tint_color, clamp(float((_9840 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * _8535;
                            float3 _8573 = lerp(lerp(1.0f.xxx, tint_color, clamp(float((_9843 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * (specular * 0.07999999821186065673828125f), base_color, metallic.xxx);
                            ...
                            float _8596 = clamp(float((_9838 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            ...
                            float _8628 = mad(roughness - 1.0f, 1.0f - clamp(float((_9842 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), 1.0f);
                            float _8634;
                            if (_7084)
                            {
                                _8634 = _9839 / _7648;
                            ...
                            float param_47 = dot(_7015, _9774);
                            float param_48 = 1.0f / _8634;
                            float _8657 = fresnel_dielectric_cos(param_47, param_48);
                            float param_49 = dot(_7015, _9774);
                            float param_50 = _8582;
                            lobe_weights_t _8696 = get_lobe_weights(lerp(_8127, 1.0f, _8535), lum(lerp(_8573, 1.0f.xxx, ((fresnel_dielectric_cos(param_49, param_50) - _8588) / (1.0f - _8588)).xxx)), specular, metallic, clamp(float(_9842 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), _8519);
                            [branch]
                            if (_9928 > 0.0f)
                            {
                                light_sample_t _9983 = { _9923, _9924, _9925, _9926, _9927, _9928, _9929, _9930 };
                                surface_t _9825 = { _7051, _9772, _9773, _9774, _9775, _7392 };
                                diff_params_t _10175 = { base_color, _8553, roughness };
                                spec_params_t _10190 = { _8573, roughness, _8582, _8588, _8596 };
                                clearcoat_params_t _10203 = { _8527, _8607, _8613 };
                                transmission_params_t _10218 = { _8628, _9839, _8634, _8657, _7084 };
                                float _10482[3] = { _10455, _10456, _10457 };
                                float _10447[3] = { _10420, _10421, _10422 };
                                float _10412[3] = { _10385, _10386, _10387 };
                                shadow_ray_t _10146 = { _10412, _10093, _10447, _10095, _10482, _10097 };
                                shadow_ray_t param_51 = _10146;
                                float3 _8715 = Evaluate_PrincipledNode(_9983, ray, _9825, _8696, _10175, _10190, _10203, _10218, metallic, _8091, mix_weight, param_51);
                                _10385 = param_51.o[0];
                                _10386 = param_51.o[1];
                                _10387 = param_51.o[2];
                                _10093 = param_51.depth;
                                _10420 = param_51.d[0];
                                _10421 = param_51.d[1];
                                _10422 = param_51.d[2];
                                _10095 = param_51.dist;
                                _10455 = param_51.c[0];
                                _10456 = param_51.c[1];
                                _10457 = param_51.c[2];
                                _10097 = param_51.xy;
                            ...
                            surface_t _9832 = { _7051, _9772, _9773, _9774, _9775, _7392 };
                            diff_params_t _10179 = { base_color, _8553, roughness };
                            spec_params_t _10196 = { _8573, roughness, _8582, _8588, _8596 };
                            clearcoat_params_t _10207 = { _8527, _8607, _8613 };
                            transmission_params_t _10224 = { _8628, _9839, _8634, _8657, _7084 };
                            ...
                            ray_data_t _10063 = { _10307, _10342, _9986, _10377, _9988, _9989, _9990, _9991, _9992 };
                            ray_data_t param_53 = _10063;
                            Sample_PrincipledNode(ray, _9832, _8696, _10179, _10196, _10207, _10224, metallic, _8172, _8181, param_52, mix_weight, param_53);
                            _10280 = param_53.o[0];
                            _10281 = param_53.o[1];
                            _10282 = param_53.o[2];
                            _10315 = param_53.d[0];
                            ...
                            _10352 = param_53.c[2];
                            _9988 = param_53.ior;
                            _9989 = param_53.cone_width;
                            _9990 = param_53.cone_spread;
                            _9991 = param_53.xy;
                            _9992 = param_53.depth;
                        }
                    }
                }
            }
        }
        float _8749 = max(_10350, max(_10351, _10352));
        float _8761;
        ...
        if (_8781)
        {
            ...
            _8821.Store(_8812 * 72 + 0, asuint(_10280));
            _8821.Store(_8812 * 72 + 4, asuint(_10281));
            _8821.Store(_8812 * 72 + 8, asuint(_10282));
            _8821.Store(_8812 * 72 + 12, asuint(_10315));
            _8821.Store(_8812 * 72 + 16, asuint(_10316));
            _8821.Store(_8812 * 72 + 20, asuint(_10317));
            ...
            _8821.Store(_8812 * 72 + 40, asuint(_9988[0]));
            _8821.Store(_8812 * 72 + 44, asuint(_9988[1]));
            _8821.Store(_8812 * 72 + 48, asuint(_9988[2]));
            _8821.Store(_8812 * 72 + 52, asuint(_9988[3]));
            _8821.Store(_8812 * 72 + 56, asuint(_9989));
            _8821.Store(_8812 * 72 + 60, asuint(_9990));
            _8821.Store(_8812 * 72 + 64, uint(_9991));
            _8821.Store(_8812 * 72 + 68, uint(_9992));
        }
        [branch]
        if (max(_10455, max(_10456, _10457)) > 0.0f)
        {
            float3 _8898 = _9925 - float3(_10385, _10386, _10387);
            float _8901 = length(_8898);
            float3 _8905 = _8898 / _8901.xxx;
            float sh_dist = _8901 * _9927;
            if (_9930)
            {
                sh_dist = -sh_dist;
            }
            ...
            _8937.Store(_8929 * 48 + 0, asuint(_10385));
            _8937.Store(_8929 * 48 + 4, asuint(_10386));
            _8937.Store(_8929 * 48 + 8, asuint(_10387));
            _8937.Store(_8929 * 48 + 12, uint(_10093));
            ...
            _8937.Store(_8929 * 48 + 32, asuint(_10455));
            _8937.Store(_8929 * 48 + 36, asuint(_10456));
            _8937.Store(_8929 * 48 + 40, asuint(_10457));
            _8937.Store(_8929 * 48 + 44, uint(_10097));
        }
        _9170 = float3(ray.c[0] * col.x, ray.c[1] * col.y, ray.c[2] * col.z);
        break;
    } while(false);
    return _9170;
}
...
void comp_main()
{
    do
    {
        ...
        hit_data_t _9264 = { _9039.mask, _9039.obj_index, _9039.prim_index, _9039.t, _9039.u, _9039.v };
        hit_data_t param = _9264;
        float _9313[4] = { _9059.ior[0], _9059.ior[1], _9059.ior[2], _9059.ior[3] };
        float _9304[3] = { _9059.c[0], _9059.c[1], _9059.c[2] };
        float _9297[3] = { _9059.d[0], _9059.d[1], _9059.d[2] };
        float _9290[3] = { _9059.o[0], _9059.o[1], _9059.o[2] };
        ray_data_t _9283 = { _9290, _9297, _9059.pdf, _9304, _9313, _9059.cone_width, _9059.cone_spread, _9059.xy, _9059.depth };
        ray_data_t param_1 = _9283;
