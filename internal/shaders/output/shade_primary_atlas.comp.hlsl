...
ByteAddressBuffer _9116 : register(t10, space0);
...
float2 TransformUV(float2 _uv, atlas_texture_t t, int mip_level)
{
    ...
    return mad(frac(_uv), size, float2(float(_9291[mip_level] & 65535u), float((_9294[mip_level] >> uint(16)) & 65535u))) + 1.0f.xx;
}
...
float3 Evaluate_EnvColor(ray_data_t ray, float2 tex_rand)
{
    ...
    if (_4961 != 4294967295u)
    {
        ...
        uint _9661[14] = { _4972.pos[0], _4972.pos[1], _4972.pos[2], _4972.pos[3], _4972.pos[4], _4972.pos[5], _4972.pos[6], _4972.pos[7], _4972.pos[8], _4972.pos[9], _4972.pos[10], _4972.pos[11], _4972.pos[12], _4972.pos[13] };
        uint _9632[4] = { _4972.page[0], _4972.page[1], _4972.page[2], _4972.page[3] };
        atlas_texture_t _9623 = { _4972.size, _4972.atlas, _9632, _9661 };
        float param = _3458_g_params.back_rotation;
        env_col *= SampleLatlong_RGBE(_9623, _4953, param, tex_rand);
    }
...
float3 Evaluate_LightColor(ray_data_t ray, hit_data_t inter, float2 tex_rand)
{
    ...
    if ((_5098.type_and_param0.x & 128u) != 0u)
    {
        ...
        if (_5125 != 4294967295u)
        {
            ...
            uint _9723[14] = { _5132.pos[0], _5132.pos[1], _5132.pos[2], _5132.pos[3], _5132.pos[4], _5132.pos[5], _5132.pos[6], _5132.pos[7], _5132.pos[8], _5132.pos[9], _5132.pos[10], _5132.pos[11], _5132.pos[12], _5132.pos[13] };
            uint _9694[4] = { _5132.page[0], _5132.page[1], _5132.page[2], _5132.page[3] };
            atlas_texture_t _9685 = { _5132.size, _5132.atlas, _9694, _9723 };
            float param = _3458_g_params.env_rotation;
            env_col *= SampleLatlong_RGBE(_9685, _5084, param, tex_rand);
        }
        lcol *= env_col;
    }
...
float4 SampleBilinear(uint index, float2 uvs, int lod, float2 rand, bool maybe_YCoCg, bool maybe_SRGB)
{
    ...
    uint _9299[4];
    _9299[0] = _1138.page[0];
    _9299[1] = _1138.page[1];
    _9299[2] = _1138.page[2];
    _9299[3] = _1138.page[3];
    uint _9335[14] = { _1138.pos[0], _1138.pos[1], _1138.pos[2], _1138.pos[3], _1138.pos[4], _1138.pos[5], _1138.pos[6], _1138.pos[7], _1138.pos[8], _1138.pos[9], _1138.pos[10], _1138.pos[11], _1138.pos[12], _1138.pos[13] };
    atlas_texture_t _9305 = { _1138.size, _1138.atlas, _9299, _9335 };
    uint _1211 = _1138.atlas;
    float4 res = g_atlases[NonUniformResourceIndex(_1211)].SampleLevel(_g_atlases_sampler[NonUniformResourceIndex(_1211)], float3(((TransformUV(uvs, _9305, lod) + rand) - 0.5f.xx) * 0.000118371215648949146270751953125f.xx, float((_9299[lod / 4] >> uint((lod % 4) * 8)) & 255u)), 0.0f);
    bool _1226;
    if (maybe_YCoCg)
    {
    ...
    if (_1245)
    {
        ...
        float4 _10478 = res;
        _10478.x = _1251.x;
        float4 _10480 = _10478;
        _10480.y = _1251.y;
        float4 _10482 = _10480;
        _10482.z = _1251.z;
        res = _10482;
    }
    return res;
...
float3 ensure_valid_reflection(float3 Ng, float3 I, float3 N)
{
    ...
    do
    {
        ...
        if (_1511 && _1517)
        {
            float _10778 = (-0.5f) / _1471;
            float param_1 = mad(_10778, _1495, 1.0f);
            float _1527 = safe_sqrtf(param_1);
            float param_2 = _1496;
            float _1530 = safe_sqrtf(param_2);
            float2 _1531 = float2(_1527, _1530);
            float param_3 = mad(_10778, _1502, 1.0f);
            float _1536 = safe_sqrtf(param_3);
            float param_4 = _1503;
            float _1539 = safe_sqrtf(param_4);
            float2 _1540 = float2(_1536, _1539);
            float _10780 = -_1459;
            float _1556 = mad(2.0f * mad(_1527, _1455, _1530 * _1459), _1530, _10780);
            float _1572 = mad(2.0f * mad(_1536, _1455, _1539 * _1459), _1539, _10780);
        ...
        _9133 = (_1451 * N_new.x) + (Ng * N_new.y);
        break;
    } while(false);
    return _9133;
}
...
float3 MapToCone(float r1, float r2, float3 N, float radius)
{
    ...
    do
    {
        ...
        _9158 = (N + (param * ((radius * r) * cos(theta)))) + (param_1 * ((radius * r) * sin(theta)));
        break;
    } while(false);
    return _9158;
}
...
float4 Sample_EnvQTree(float y_rotation, Texture2D<float4> qtree_tex, SamplerState _qtree_tex_sampler, int qtree_levels, float rand, float rx, float ry)
{
    ...
    while (lod >= 0)
    {
        ...
        else
        {
            ...
            partial = _917;
            float2 _10465 = origin;
            _10465.x = origin.x + _step;
            origin = _10465;
        ...
        {
            float2 _10468 = origin;
            _10468.y = origin.y + _step;
            origin = _10468;
            _sample = (_sample - boundary) / (1.0f - boundary);
            index |= 2;
        }
...
void SampleLightSource(float3 P, float3 T, float3 B, float3 N, int hi, float2 sample_off, inout light_sample_t ls)
{
    ...
    if (_3540 == 0u)
    {
        ...
        float3 _10539 = sampled_dir;
        float3 _3618 = ((param * _10539.x) + (param_1 * _10539.y)) + (_3575 * _10539.z);
        sampled_dir = _3618;
            ...
            if (_3540 == 4u)
            {
                ...
                if ((_3488.type_and_param0.x & 128u) != 0u)
                {
                    ...
                    if (_3898 != 4294967295u)
                    {
                        ...
                        uint _9479[14] = { _3906.pos[0], _3906.pos[1], _3906.pos[2], _3906.pos[3], _3906.pos[4], _3906.pos[5], _3906.pos[6], _3906.pos[7], _3906.pos[8], _3906.pos[9], _3906.pos[10], _3906.pos[11], _3906.pos[12], _3906.pos[13] };
                        uint _9450[4] = { _3906.page[0], _3906.page[1], _3906.page[2], _3906.page[3] };
                        atlas_texture_t _9379 = { _3906.size, _3906.atlas, _9450, _9479 };
                        float param_10 = _3458_g_params.env_rotation;
                        env_col *= SampleLatlong_RGBE(_9379, ls.L, param_10, _3535);
                    }
                    ls.col *= env_col;
                    ls.from_env = true;
                }
                ...
                if (_3540 == 5u)
                {
                    ...
                    if ((_3488.type_and_param0.x & 128u) != 0u)
                    {
                        ...
                        if (_4142 != 4294967295u)
                        {
                            ...
                            uint _9517[14] = { _4149.pos[0], _4149.pos[1], _4149.pos[2], _4149.pos[3], _4149.pos[4], _4149.pos[5], _4149.pos[6], _4149.pos[7], _4149.pos[8], _4149.pos[9], _4149.pos[10], _4149.pos[11], _4149.pos[12], _4149.pos[13] };
                            uint _9488[4] = { _4149.page[0], _4149.page[1], _4149.page[2], _4149.page[3] };
                            atlas_texture_t _9388 = { _4149.size, _4149.atlas, _9488, _9517 };
                            float param_13 = _3458_g_params.env_rotation;
                            env_col_1 *= SampleLatlong_RGBE(_9388, ls.L, param_13, _3535);
                        }
                        ls.col *= env_col_1;
                        ls.from_env = true;
                    }
                        ...
                        else
                        {
                            ...
                            if (_3540 == 7u)
                            {
                                ...
                                if (_4870 != 4294967295u)
                                {
                                    ...
                                    uint _9602[14] = { _4877.pos[0], _4877.pos[1], _4877.pos[2], _4877.pos[3], _4877.pos[4], _4877.pos[5], _4877.pos[6], _4877.pos[7], _4877.pos[8], _4877.pos[9], _4877.pos[10], _4877.pos[11], _4877.pos[12], _4877.pos[13] };
                                    uint _9573[4] = { _4877.page[0], _4877.page[1], _4877.page[2], _4877.page[3] };
                                    atlas_texture_t _9441 = { _4877.size, _4877.atlas, _9573, _9602 };
                                    float param_20 = _3458_g_params.env_rotation;
                                    ls.col *= SampleLatlong_RGBE(_9441, ls.L, param_20, _3535);
                                }
                                ls.area = 1.0f;
                                ls.lp = P + ls.L;
                                ls.dist_mul = 3402823346297367662189621542912.0f;
...
float D_GGX(float3 H, float alpha_x, float alpha_y)
{
    ...
    do
    {
        ...
        _9191 = 1.0f / (((((_2178 * _2178) * 3.1415927410125732421875f) * alpha_x) * alpha_y) * (((H.z * H.z) * H.z) * H.z));
        break;
    } while(false);
    return _9191;
}
...
float4 Sample_GGXSpecular_BSDF(float3 T, float3 B, float3 N, float3 I, float roughness, float anisotropic, float spec_ior, float spec_F0, float3 spec_col, float rand_u, float rand_v, inout float3 out_V)
{
    ...
    do
    {
        ...
        if ((_2789 * _2793) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            out_V = _2804;
            _9163 = float4(_2818.x * 1000000.0f, _2818.y * 1000000.0f, _2818.z * 1000000.0f, 1000000.0f);
            break;
        }
        float3 param_2 = T;
        float3 param_3 = B;
        ...
        _9163 = Evaluate_GGXSpecular_BSDF(param_14, param_15, param_16, param_17, param_18, param_19, param_20, param_21);
        break;
    } while(false);
    return _9163;
}
...
float4 Evaluate_GGXRefraction_BSDF(float3 view_dir_ts, float3 sampled_normal_ts, float3 refr_dir_ts, float roughness2, float eta, float3 refr_col)
{
    ...
    do
    {
        ...
        _9168 = float4(refr_col * (((((_3101 * _3117) * _3109) * clamp(dot(view_dir_ts, sampled_normal_ts), 0.0f, 1.0f)) * _3137) / view_dir_ts.z), (((_3101 * _3109) * clamp(dot(view_dir_ts, sampled_normal_ts), 0.0f, 1.0f)) * _3137) / view_dir_ts.z);
        break;
    } while(false);
    return _9168;
}
...
float4 Sample_GGXRefraction_BSDF(float3 T, float3 B, float3 N, float3 I, float roughness, float eta, float3 refr_col, float rand_u, float rand_v, inout float4 out_V)
{
    ...
    do
    {
        ...
        if ((_3181 * _3181) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            _9173 = float4(refr_col.x * 1000000.0f, refr_col.y * 1000000.0f, refr_col.z * 1000000.0f, 1000000.0f);
            break;
        }
        float3 param = T;
        float3 param_1 = B;
        ...
        _9173 = Evaluate_GGXRefraction_BSDF(param_8, param_9, param_10, param_11, param_12, param_13);
        break;
    } while(false);
    return _9173;
}
...
lobe_weights_t get_lobe_weights(float base_color_lum, float spec_color_lum, float specular, float metallic, float transmission, float clearcoat)
{
    ...
    float _9336 = (base_color_lum * _1634) * (1.0f - transmission);
    ...
    float _9338 = _1655 * _1634;
    float _9339 = _1641 * base_color_lum;
    float _1664 = _9336;
    ...
    lobe_weights_t _9344 = { _9336, _9337, _9338, _9339 };
    return _9344;
}
...
float BRDF_PrincipledDiffuse(float3 V, float3 N, float3 L, float3 H, float roughness)
{
    ...
    do
    {
        ...
        _9196 = lerp(1.0f, _2418, schlick_weight(param)) * lerp(1.0f, _2418, schlick_weight(param_1));
        break;
    } while(false);
    return _9196;
}
...
float D_GTR1(float NDotH, float a)
{
    ...
    do
    {
        if (a >= 1.0f)
        {
            _9201 = 0.3183098733425140380859375f;
            break;
        }
        float _2137 = mad(a, a, -1.0f);
        _9201 = _2137 / ((3.1415927410125732421875f * log(a * a)) * mad(_2137 * NDotH, NDotH, 1.0f));
        break;
    } while(false);
    return _9201;
}
...
float4 Sample_PrincipledClearcoat_BSDF(float3 T, float3 B, float3 N, float3 I, float clearcoat_roughness2, float clearcoat_ior, float clearcoat_F0, float rand_u, float rand_v, inout float3 out_V)
{
    ...
    do
    {
        ...
        if ((clearcoat_roughness2 * clearcoat_roughness2) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            _9186 = float4(_3018, _3018, _3018, 1000000.0f);
            break;
        }
        float3 param_2 = T;
        float3 param_3 = B;
        ...
        _9186 = Evaluate_PrincipledClearcoat_BSDF(param_14, param_15, param_16, param_17, param_18, param_19);
        break;
    } while(false);
    return _9186;
}
        ...
        else
        {
            ...
            else
            {
                ...
                if (_6785)
                {
                    ...
                    float4 _10723 = F;
                    float _6899 = _10723.w * lobe_weights.refraction;
                    float4 _10725 = _10723;
                    _10725.w = _6899;
                    F = _10725;
                    new_ray.c[0] = ((ray.c[0] * _10723.x) * mix_weight) / _6899;
                    new_ray.c[1] = ((ray.c[1] * _10723.y) * mix_weight) / _6899;
                    new_ray.c[2] = ((ray.c[2] * _10723.z) * mix_weight) / _6899;
                    new_ray.pdf = _6899;
                    new_ray.d[0] = V.x;
                    new_ray.d[1] = V.y;
                    new_ray.d[2] = V.z;
...
float3 ShadeSurface(hit_data_t inter, ray_data_t ray, inout float3 out_base_color, inout float3 out_normals)
{
    ...
    do
    {
        ...
        if (inter.mask == 0)
        {
            ...
            _9123 = float3(ray.c[0] * _7031.x, ray.c[1] * _7031.y, ray.c[2] * _7031.z);
            break;
        }
        ...
        if (inter.obj_index < 0)
        {
            ...
            _9123 = float3(ray.c[0] * _7071.x, ray.c[1] * _7071.y, ray.c[2] * _7071.z);
            break;
        }
        ...
        uint _10178 = _7114.textures[0];
        uint _10179 = _7114.textures[1];
        uint _10180 = _7114.textures[2];
        uint _10181 = _7114.textures[3];
        uint _10182 = _7114.textures[4];
        float _10183 = _7114.base_color[0];
        float _10184 = _7114.base_color[1];
        float _10185 = _7114.base_color[2];
        uint _9788 = _7114.flags;
        uint _9789 = _7114.type;
        float _9790 = _7114.tangent_rotation_or_strength;
        uint _9791 = _7114.roughness_and_anisotropic;
        float _9792 = _7114.ior;
        uint _9793 = _7114.sheen_and_sheen_tint;
        uint _9794 = _7114.tint_and_metallic;
        uint _9795 = _7114.transmission_and_transmission_roughness;
        uint _9796 = _7114.specular_and_specular_tint;
        uint _9797 = _7114.clearcoat_and_clearcoat_roughness;
        uint _9798 = _7114.normal_map_strength_unorm;
        transform_t _7169;
        ...
        float3 _9726 = _7458;
        float3 _9725 = cross(_7458, _7374);
        if (_7092)
        {
            ...
            _10178 = _7483.textures[0];
            _10179 = _7483.textures[1];
            _10180 = _7483.textures[2];
            _10181 = _7483.textures[3];
            _10182 = _7483.textures[4];
            _10183 = _7483.base_color[0];
            _10184 = _7483.base_color[1];
            _10185 = _7483.base_color[2];
            _9788 = _7483.flags;
            _9789 = _7483.type;
            _9790 = _7483.tangent_rotation_or_strength;
            _9791 = _7483.roughness_and_anisotropic;
            _9792 = _7483.ior;
            _9793 = _7483.sheen_and_sheen_tint;
            _9794 = _7483.tint_and_metallic;
            _9795 = _7483.transmission_and_transmission_roughness;
            _9796 = _7483.specular_and_specular_tint;
            _9797 = _7483.clearcoat_and_clearcoat_roughness;
            _9798 = _7483.normal_map_strength_unorm;
            _9728 = -_9728;
            _9727 = -_9727;
            _9726 = -_9726;
            _9725 = -_9725;
        }
        float3 param_5 = _9728;
        float4x4 param_6 = _7169.inv_xform;
        _9728 = TransformNormal(param_5, param_6);
        float3 param_7 = _9727;
        float4x4 param_8 = _7169.inv_xform;
        _9727 = TransformNormal(param_7, param_8);
        float3 param_9 = _9726;
        float4x4 param_10 = _7169.inv_xform;
        _9726 = TransformNormal(param_9, param_10);
        float3 param_11 = _9725;
        float4x4 param_12 = _7169.inv_xform;
        _9728 = normalize(_9728);
        _9727 = normalize(_9727);
        _9726 = normalize(_9726);
        _9725 = normalize(TransformNormal(param_11, param_12));
        ...
        {
            float mix_val = _9790;
            if (_10179 != 4294967295u)
            {
                mix_val *= SampleBilinear(_10179, _7400, 0, _7021).x;
            }
            if (_7092)
            {
                _7680 = _7641 / _9792;
            ...
            if (_9792 != 0.0f)
            {
                float param_16 = dot(_6955, _9727);
            ...
            if (mix_rand > _7713)
            {
                ...
                {
                    _7736.textures[_108ident] = _4697.Load(_108ident * 4 + _10181 * 76 + 0);
                }
                [unroll]
                for (int _109ident = 0; _109ident < 3; _109ident++)
                {
                    _7736.base_color[_109ident] = asfloat(_4697.Load(_109ident * 4 + _10181 * 76 + 20));
                }
                _7736.flags = _4697.Load(_10181 * 76 + 32);
                _7736.type = _4697.Load(_10181 * 76 + 36);
                _7736.tangent_rotation_or_strength = asfloat(_4697.Load(_10181 * 76 + 40));
                _7736.roughness_and_anisotropic = _4697.Load(_10181 * 76 + 44);
                _7736.ior = asfloat(_4697.Load(_10181 * 76 + 48));
                _7736.sheen_and_sheen_tint = _4697.Load(_10181 * 76 + 52);
                _7736.tint_and_metallic = _4697.Load(_10181 * 76 + 56);
                _7736.transmission_and_transmission_roughness = _4697.Load(_10181 * 76 + 60);
                _7736.specular_and_specular_tint = _4697.Load(_10181 * 76 + 64);
                _7736.clearcoat_and_clearcoat_roughness = _4697.Load(_10181 * 76 + 68);
                _7736.normal_map_strength_unorm = _4697.Load(_10181 * 76 + 72);
                _10178 = _7736.textures[0];
                _10179 = _7736.textures[1];
                _10180 = _7736.textures[2];
                _10181 = _7736.textures[3];
                _10182 = _7736.textures[4];
                _10183 = _7736.base_color[0];
                _10184 = _7736.base_color[1];
                _10185 = _7736.base_color[2];
                _9788 = _7736.flags;
                _9789 = _7736.type;
                _9790 = _7736.tangent_rotation_or_strength;
                _9791 = _7736.roughness_and_anisotropic;
                _9792 = _7736.ior;
                _9793 = _7736.sheen_and_sheen_tint;
                _9794 = _7736.tint_and_metallic;
                _9795 = _7736.transmission_and_transmission_roughness;
                _9796 = _7736.specular_and_specular_tint;
                _9797 = _7736.clearcoat_and_clearcoat_roughness;
                _9798 = _7736.normal_map_strength_unorm;
            ...
            else
            {
                ...
                {
                    _7802.textures[_110ident] = _4697.Load(_110ident * 4 + _10182 * 76 + 0);
                }
                [unroll]
                for (int _111ident = 0; _111ident < 3; _111ident++)
                {
                    _7802.base_color[_111ident] = asfloat(_4697.Load(_111ident * 4 + _10182 * 76 + 20));
                }
                _7802.flags = _4697.Load(_10182 * 76 + 32);
                _7802.type = _4697.Load(_10182 * 76 + 36);
                _7802.tangent_rotation_or_strength = asfloat(_4697.Load(_10182 * 76 + 40));
                _7802.roughness_and_anisotropic = _4697.Load(_10182 * 76 + 44);
                _7802.ior = asfloat(_4697.Load(_10182 * 76 + 48));
                _7802.sheen_and_sheen_tint = _4697.Load(_10182 * 76 + 52);
                _7802.tint_and_metallic = _4697.Load(_10182 * 76 + 56);
                _7802.transmission_and_transmission_roughness = _4697.Load(_10182 * 76 + 60);
                _7802.specular_and_specular_tint = _4697.Load(_10182 * 76 + 64);
                _7802.clearcoat_and_clearcoat_roughness = _4697.Load(_10182 * 76 + 68);
                _7802.normal_map_strength_unorm = _4697.Load(_10182 * 76 + 72);
                _10178 = _7802.textures[0];
                _10179 = _7802.textures[1];
                _10180 = _7802.textures[2];
                _10181 = _7802.textures[3];
                _10182 = _7802.textures[4];
                _10183 = _7802.base_color[0];
                _10184 = _7802.base_color[1];
                _10185 = _7802.base_color[2];
                _9788 = _7802.flags;
                _9789 = _7802.type;
                _9790 = _7802.tangent_rotation_or_strength;
                _9791 = _7802.roughness_and_anisotropic;
                _9792 = _7802.ior;
                _9793 = _7802.sheen_and_sheen_tint;
                _9794 = _7802.tint_and_metallic;
                _9795 = _7802.transmission_and_transmission_roughness;
                _9796 = _7802.specular_and_specular_tint;
                _9797 = _7802.clearcoat_and_clearcoat_roughness;
                _9798 = _7802.normal_map_strength_unorm;
                mix_rand /= mix_val;
            }
        }
        [branch]
        if (_10178 != 4294967295u)
        {
            float3 normals = (float3(SampleBilinear(_10178, _7400, 0, _7021).xy, 1.0f) * 2.0f) - 1.0f.xxx;
            if ((_1008.Load(_10178 * 80 + 0) & 16384u) != 0u)
            {
                float3 _10746 = normals;
                _10746.z = sqrt(1.0f - dot(normals.xy, normals.xy));
                normals = _10746;
            }
            float3 _7887 = _9727;
            _9727 = normalize(((_9725 * normals.x) + (_7887 * normals.z)) + (_9726 * normals.y));
            if ((_9798 & 65535u) != 65535u)
            {
                _9727 = normalize(_7887 + ((_9727 - _7887) * clamp(float(_9798 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f)));
            }
            float3 param_18 = _9728;
            float3 param_19 = -_6955;
            float3 param_20 = _9727;
            _9727 = ensure_valid_reflection(param_18, param_19, param_20);
        }
        ...
        tangent = _7966;
        float3 _7970 = cross(_7966, _9727);
        ...
        if (_9790 != 0.0f)
        {
            ...
            float3 param_26 = _9727;
            float param_27 = _9790;
            tangent = rotate_around_axis(param_25, param_26, param_27);
        }
        float3 _8003 = normalize(cross(tangent, _9727));
        _9726 = _8003;
        _9725 = cross(_9727, _8003);
        float3 _9877 = 0.0f.xxx;
        float3 _9876 = 0.0f.xxx;
        float _9881 = 0.0f;
        float _9879 = 0.0f;
        float _9880 = 1.0f;
        ...
        if (_8025)
        {
            ...
            float3 param_29 = _9725;
            float3 param_30 = _9726;
            float3 param_31 = _9727;
            int param_32 = _6988;
            float2 param_33 = float2(_6995, _7002);
            light_sample_t _9892 = { _9876, _9877, _9878, _9879, _9880, _9881, _9882, _9883 };
            light_sample_t param_34 = _9892;
            SampleLightSource(param_28, param_29, param_30, param_31, param_32, param_33, param_34);
            _9876 = param_34.col;
            _9877 = param_34.L;
            _9878 = param_34.lp;
            _9879 = param_34.area;
            _9880 = param_34.dist_mul;
            _9881 = param_34.pdf;
            _9882 = param_34.cast_shadow;
            _9883 = param_34.from_env;
        }
        float _8053 = dot(_9727, _9877);
        float3 base_color = float3(_10183, _10184, _10185);
        [branch]
        if (_10179 != 4294967295u)
        {
            base_color *= SampleBilinear(_10179, _7400, int(get_texture_lod(texSize(_10179), _7633)), _7021, true, true).xyz;
        }
        ...
        float roughness = clamp(float(_9791 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
        [branch]
        if (_10180 != 4294967295u)
        {
            roughness *= SampleBilinear(_10180, _7400, int(get_texture_lod(texSize(_10180), _7633)), _7021, false, true).x;
        }
        ...
        float _9942 = _7623;
        float _9943 = ray.cone_spread;
        int _9944 = ray.xy;
        float _9939 = 0.0f;
        float _10410 = 0.0f;
        float _10409 = 0.0f;
        float _10408 = 0.0f;
        int _10046 = ray.depth;
        int _10050 = ray.xy;
        int _9945;
        float _10048;
        float _10233;
        ...
        {
            [branch]
            if ((_9881 > 0.0f) && (_8053 > 0.0f))
            {
                light_sample_t _9909 = { _9876, _9877, _9878, _9879, _9880, _9881, _9882, _9883 };
                surface_t _9736 = { _7058, _9725, _9726, _9727, _9728, _7400 };
                float _10414[3] = { _10408, _10409, _10410 };
                float _10379[3] = { _10373, _10374, _10375 };
                float _10344[3] = { _10338, _10339, _10340 };
                shadow_ray_t _10060 = { _10344, _10046, _10379, _10048, _10414, _10050 };
                shadow_ray_t param_35 = _10060;
                float3 _8205 = Evaluate_DiffuseNode(_9909, ray, _9736, base_color, roughness, mix_weight, param_35);
                _10338 = param_35.o[0];
                _10339 = param_35.o[1];
                _10340 = param_35.o[2];
                _10046 = param_35.depth;
                _10373 = param_35.d[0];
                _10374 = param_35.d[1];
                _10375 = param_35.d[2];
                _10048 = param_35.dist;
                _10408 = param_35.c[0];
                _10409 = param_35.c[1];
                _10410 = param_35.c[2];
                _10050 = param_35.xy;
            ...
            if (_8219)
            {
                surface_t _9743 = { _7058, _9725, _9726, _9727, _9728, _7400 };
                float _10309[3] = { _10303, _10304, _10305 };
                float _10274[3] = { _10268, _10269, _10270 };
                float _10239[3] = { _10233, _10234, _10235 };
                ray_data_t _9959 = { _10239, _10274, _9939, _10309, _9941, _9942, _9943, _9944, _9945 };
                ray_data_t param_36 = _9959;
                Sample_DiffuseNode(ray, _9743, base_color, roughness, _8136, _8145, mix_weight, param_36);
                _10233 = param_36.o[0];
                _10234 = param_36.o[1];
                _10235 = param_36.o[2];
                _10268 = param_36.d[0];
                ...
                _10305 = param_36.c[2];
                _9941 = param_36.ior;
                _9942 = param_36.cone_width;
                _9943 = param_36.cone_spread;
                _9944 = param_36.xy;
                _9945 = param_36.depth;
            }
        }
        else
        {
            ...
            if (_9789 == 1u)
            {
                ...
                if (_8257 && (_8053 > 0.0f))
                {
                    light_sample_t _9918 = { _9876, _9877, _9878, _9879, _9880, _9881, _9882, _9883 };
                    surface_t _9750 = { _7058, _9725, _9726, _9727, _9728, _7400 };
                    float _10421[3] = { _10408, _10409, _10410 };
                    float _10386[3] = { _10373, _10374, _10375 };
                    float _10351[3] = { _10338, _10339, _10340 };
                    shadow_ray_t _10073 = { _10351, _10046, _10386, _10048, _10421, _10050 };
                    shadow_ray_t param_39 = _10073;
                    float3 _8272 = Evaluate_GlossyNode(_9918, ray, _9750, base_color, roughness, 1.5f, _8243, mix_weight, param_39);
                    _10338 = param_39.o[0];
                    _10339 = param_39.o[1];
                    _10340 = param_39.o[2];
                    _10046 = param_39.depth;
                    _10373 = param_39.d[0];
                    _10374 = param_39.d[1];
                    _10375 = param_39.d[2];
                    _10048 = param_39.dist;
                    _10408 = param_39.c[0];
                    _10409 = param_39.c[1];
                    _10410 = param_39.c[2];
                    _10050 = param_39.xy;
                ...
                if (_8286)
                {
                    surface_t _9757 = { _7058, _9725, _9726, _9727, _9728, _7400 };
                    float _10316[3] = { _10303, _10304, _10305 };
                    float _10281[3] = { _10268, _10269, _10270 };
                    float _10246[3] = { _10233, _10234, _10235 };
                    ray_data_t _9978 = { _10246, _10281, _9939, _10316, _9941, _9942, _9943, _9944, _9945 };
                    ray_data_t param_40 = _9978;
                    Sample_GlossyNode(ray, _9757, base_color, roughness, 1.5f, _8243, _8136, _8145, mix_weight, param_40);
                    _10233 = param_40.o[0];
                    _10234 = param_40.o[1];
                    _10235 = param_40.o[2];
                    _10268 = param_40.d[0];
                    ...
                    _10305 = param_40.c[2];
                    _9941 = param_40.ior;
                    _9942 = param_40.cone_width;
                    _9943 = param_40.cone_spread;
                    _9944 = param_40.xy;
                    _9945 = param_40.depth;
                }
            }
            else
            {
                ...
                if (_9789 == 2u)
                {
                    ...
                    if (_8320 && (_8053 < 0.0f))
                    {
                        ...
                        light_sample_t _9927 = { _9876, _9877, _9878, _9879, _9880, _9881, _9882, _9883 };
                        surface_t _9764 = { _7058, _9725, _9726, _9727, _9728, _7400 };
                        float _10428[3] = { _10408, _10409, _10410 };
                        float _10393[3] = { _10373, _10374, _10375 };
                        float _10358[3] = { _10338, _10339, _10340 };
                        shadow_ray_t _10086 = { _10358, _10046, _10393, _10048, _10428, _10050 };
                        shadow_ray_t param_41 = _10086;
                        float3 _8350 = Evaluate_RefractiveNode(_9927, ray, _9764, base_color, _8310, _8328, mix_weight, param_41);
                        _10338 = param_41.o[0];
                        _10339 = param_41.o[1];
                        _10340 = param_41.o[2];
                        _10046 = param_41.depth;
                        _10373 = param_41.d[0];
                        _10374 = param_41.d[1];
                        _10375 = param_41.d[2];
                        _10048 = param_41.dist;
                        _10408 = param_41.c[0];
                        _10409 = param_41.c[1];
                        _10410 = param_41.c[2];
                        _10050 = param_41.xy;
                    ...
                    if (_8364)
                    {
                        surface_t _9771 = { _7058, _9725, _9726, _9727, _9728, _7400 };
                        float _10323[3] = { _10303, _10304, _10305 };
                        float _10288[3] = { _10268, _10269, _10270 };
                        float _10253[3] = { _10233, _10234, _10235 };
                        ray_data_t _9997 = { _10253, _10288, _9939, _10323, _9941, _9942, _9943, _9944, _9945 };
                        ray_data_t param_42 = _9997;
                        Sample_RefractiveNode(ray, _9771, base_color, roughness, _7092, _9792, _7641, _8136, _8145, mix_weight, param_42);
                        _10233 = param_42.o[0];
                        _10234 = param_42.o[1];
                        _10235 = param_42.o[2];
                        _10268 = param_42.d[0];
                        ...
                        _10305 = param_42.c[2];
                        _9941 = param_42.ior;
                        _9942 = param_42.cone_width;
                        _9943 = param_42.cone_spread;
                        _9944 = param_42.xy;
                        _9945 = param_42.depth;
                    }
                }
                else
                {
                    ...
                    if (_9789 == 3u)
                    {
                        col += (base_color * (mix_weight * _9790));
                    }
                    else
                    {
                        [branch]
                        if (_9789 == 6u)
                        {
                            float metallic = clamp(float((_9794 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            [branch]
                            if (_10181 != 4294967295u)
                            {
                                metallic *= SampleBilinear(_10181, _7400, int(get_texture_lod(texSize(_10181), _7633)), _7021).x;
                            }
                            float specular = clamp(float(_9796 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            [branch]
                            if (_10182 != 4294967295u)
                            {
                                specular *= SampleBilinear(_10182, _7400, int(get_texture_lod(texSize(_10182), _7633)), _7021).x;
                            }
                            float _8485 = clamp(float(_9797 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float _8493 = clamp(float((_9797 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float _8501 = 2.0f * clamp(float(_9793 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float3 _8519 = lerp(1.0f.xxx, tint_color, clamp(float((_9793 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * _8501;
                            float3 _8539 = lerp(lerp(1.0f.xxx, tint_color, clamp(float((_9796 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * (specular * 0.07999999821186065673828125f), base_color, metallic.xxx);
                            ...
                            float _8562 = clamp(float((_9791 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            ...
                            float _8594 = mad(roughness - 1.0f, 1.0f - clamp(float((_9795 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), 1.0f);
                            float _8600;
                            if (_7092)
                            {
                                _8600 = _9792 / _7641;
                            ...
                            float param_47 = dot(_6955, _9727);
                            float param_48 = 1.0f / _8600;
                            float _8623 = fresnel_dielectric_cos(param_47, param_48);
                            float param_49 = dot(_6955, _9727);
                            float param_50 = _8548;
                            lobe_weights_t _8662 = get_lobe_weights(lerp(_8090, 1.0f, _8501), lum(lerp(_8539, 1.0f.xxx, ((fresnel_dielectric_cos(param_49, param_50) - _8554) / (1.0f - _8554)).xxx)), specular, metallic, clamp(float(_9795 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), _8485);
                            [branch]
                            if (_9881 > 0.0f)
                            {
                                light_sample_t _9936 = { _9876, _9877, _9878, _9879, _9880, _9881, _9882, _9883 };
                                surface_t _9778 = { _7058, _9725, _9726, _9727, _9728, _7400 };
                                diff_params_t _10128 = { base_color, _8519, roughness };
                                spec_params_t _10143 = { _8539, roughness, _8548, _8554, _8562 };
                                clearcoat_params_t _10156 = { _8493, _8573, _8579 };
                                transmission_params_t _10171 = { _8594, _9792, _8600, _8623, _7092 };
                                float _10435[3] = { _10408, _10409, _10410 };
                                float _10400[3] = { _10373, _10374, _10375 };
                                float _10365[3] = { _10338, _10339, _10340 };
                                shadow_ray_t _10099 = { _10365, _10046, _10400, _10048, _10435, _10050 };
                                shadow_ray_t param_51 = _10099;
                                float3 _8681 = Evaluate_PrincipledNode(_9936, ray, _9778, _8662, _10128, _10143, _10156, _10171, metallic, _8053, mix_weight, param_51);
                                _10338 = param_51.o[0];
                                _10339 = param_51.o[1];
                                _10340 = param_51.o[2];
                                _10046 = param_51.depth;
                                _10373 = param_51.d[0];
                                _10374 = param_51.d[1];
                                _10375 = param_51.d[2];
                                _10048 = param_51.dist;
                                _10408 = param_51.c[0];
                                _10409 = param_51.c[1];
                                _10410 = param_51.c[2];
                                _10050 = param_51.xy;
                            ...
                            surface_t _9785 = { _7058, _9725, _9726, _9727, _9728, _7400 };
                            diff_params_t _10132 = { base_color, _8519, roughness };
                            spec_params_t _10149 = { _8539, roughness, _8548, _8554, _8562 };
                            clearcoat_params_t _10160 = { _8493, _8573, _8579 };
                            transmission_params_t _10177 = { _8594, _9792, _8600, _8623, _7092 };
                            float param_52 = mix_rand;
                            float _10330[3] = { _10303, _10304, _10305 };
                            float _10295[3] = { _10268, _10269, _10270 };
                            float _10260[3] = { _10233, _10234, _10235 };
                            ray_data_t _10016 = { _10260, _10295, _9939, _10330, _9941, _9942, _9943, _9944, _9945 };
                            ray_data_t param_53 = _10016;
                            Sample_PrincipledNode(ray, _9785, _8662, _10132, _10149, _10160, _10177, metallic, _8136, _8145, param_52, mix_weight, param_53);
                            _10233 = param_53.o[0];
                            _10234 = param_53.o[1];
                            _10235 = param_53.o[2];
                            _10268 = param_53.d[0];
                            ...
                            _10305 = param_53.c[2];
                            _9941 = param_53.ior;
                            _9942 = param_53.cone_width;
                            _9943 = param_53.cone_spread;
                            _9944 = param_53.xy;
                            _9945 = param_53.depth;
                        }
                    }
                }
            }
        }
        float _8715 = max(_10303, max(_10304, _10305));
        float _8727;
        ...
        if (_8747)
        {
            ...
            _8787.Store(_8778 * 72 + 0, asuint(_10233));
            _8787.Store(_8778 * 72 + 4, asuint(_10234));
            _8787.Store(_8778 * 72 + 8, asuint(_10235));
            _8787.Store(_8778 * 72 + 12, asuint(_10268));
            _8787.Store(_8778 * 72 + 16, asuint(_10269));
            _8787.Store(_8778 * 72 + 20, asuint(_10270));
            ...
            _8787.Store(_8778 * 72 + 40, asuint(_9941[0]));
            _8787.Store(_8778 * 72 + 44, asuint(_9941[1]));
            _8787.Store(_8778 * 72 + 48, asuint(_9941[2]));
            _8787.Store(_8778 * 72 + 52, asuint(_9941[3]));
            _8787.Store(_8778 * 72 + 56, asuint(_9942));
            _8787.Store(_8778 * 72 + 60, asuint(_9943));
            _8787.Store(_8778 * 72 + 64, uint(_9944));
            _8787.Store(_8778 * 72 + 68, uint(_9945));
        }
        [branch]
        if (max(_10408, max(_10409, _10410)) > 0.0f)
        {
            float3 _8864 = _9878 - float3(_10338, _10339, _10340);
            float _8867 = length(_8864);
            float3 _8871 = _8864 / _8867.xxx;
            float sh_dist = _8867 * _9880;
            if (_9883)
            {
                sh_dist = -sh_dist;
            }
            ...
            _8903.Store(_8895 * 48 + 0, asuint(_10338));
            _8903.Store(_8895 * 48 + 4, asuint(_10339));
            _8903.Store(_8895 * 48 + 8, asuint(_10340));
            _8903.Store(_8895 * 48 + 12, uint(_10046));
            ...
            _8903.Store(_8895 * 48 + 32, asuint(_10408));
            _8903.Store(_8895 * 48 + 36, asuint(_10409));
            _8903.Store(_8895 * 48 + 40, asuint(_10410));
            _8903.Store(_8895 * 48 + 44, uint(_10050));
        }
        _9123 = float3(ray.c[0] * col.x, ray.c[1] * col.y, ray.c[2] * col.z);
        break;
    } while(false);
    return _9123;
}
...
void comp_main()
{
    do
    {
        ...
        hit_data_t _9217 = { _9003.mask, _9003.obj_index, _9003.prim_index, _9003.t, _9003.u, _9003.v };
        hit_data_t param = _9217;
        float _9266[4] = { _9019.ior[0], _9019.ior[1], _9019.ior[2], _9019.ior[3] };
        float _9257[3] = { _9019.c[0], _9019.c[1], _9019.c[2] };
        float _9250[3] = { _9019.d[0], _9019.d[1], _9019.d[2] };
        float _9243[3] = { _9019.o[0], _9019.o[1], _9019.o[2] };
        ray_data_t _9236 = { _9243, _9250, _9019.pdf, _9257, _9266, _9019.cone_width, _9019.cone_spread, _9019.xy, _9019.depth };
        ray_data_t param_1 = _9236;
        float3 param_2 = 0.0f.xxx;
        float3 param_3 = 0.0f.xxx;
        float3 _9075 = ShadeSurface(param, param_1, param_2, param_3);
        g_out_img[int2((_8985 >> 16) & 65535, _8992 & 65535)] = float4(min(_9075, _3458_g_params.clamp_val.xxx), 1.0f);
        break;
    } while(false);
}
