...
ByteAddressBuffer _9149 : register(t10, space0);
...
float2 TransformUV(float2 _uv, atlas_texture_t t, int mip_level)
{
    ...
    return mad(frac(_uv), size, float2(float(_9324[mip_level] & 65535u), float((_9327[mip_level] >> uint(16)) & 65535u))) + 1.0f.xx;
}
...
float3 Evaluate_EnvColor(ray_data_t ray)
{
    ...
    if (_5020 != 4294967295u)
    {
        ...
        uint _9694[14] = { _5031.pos[0], _5031.pos[1], _5031.pos[2], _5031.pos[3], _5031.pos[4], _5031.pos[5], _5031.pos[6], _5031.pos[7], _5031.pos[8], _5031.pos[9], _5031.pos[10], _5031.pos[11], _5031.pos[12], _5031.pos[13] };
        uint _9665[4] = { _5031.page[0], _5031.page[1], _5031.page[2], _5031.page[3] };
        atlas_texture_t _9656 = { _5031.size, _5031.atlas, _9665, _9694 };
        float param = _3539_g_params.back_rotation;
        env_col *= SampleLatlong_RGBE(_9656, _5012, param);
    }
...
float3 Evaluate_LightColor(ray_data_t ray, hit_data_t inter)
{
    ...
    if ((_5157.type_and_param0.x & 128u) != 0u)
    {
        ...
        if (_5184 != 4294967295u)
        {
            ...
            uint _9756[14] = { _5191.pos[0], _5191.pos[1], _5191.pos[2], _5191.pos[3], _5191.pos[4], _5191.pos[5], _5191.pos[6], _5191.pos[7], _5191.pos[8], _5191.pos[9], _5191.pos[10], _5191.pos[11], _5191.pos[12], _5191.pos[13] };
            uint _9727[4] = { _5191.page[0], _5191.page[1], _5191.page[2], _5191.page[3] };
            atlas_texture_t _9718 = { _5191.size, _5191.atlas, _9727, _9756 };
            float param = _3539_g_params.env_rotation;
            env_col *= SampleLatlong_RGBE(_9718, _5143, param);
        }
        lcol *= env_col;
    }
...
float4 SampleBilinear(uint index, float2 uvs, int lod, bool maybe_YCoCg, bool maybe_SRGB)
{
    ...
    uint _9332[4];
    _9332[0] = _1133.page[0];
    _9332[1] = _1133.page[1];
    _9332[2] = _1133.page[2];
    _9332[3] = _1133.page[3];
    uint _9368[14] = { _1133.pos[0], _1133.pos[1], _1133.pos[2], _1133.pos[3], _1133.pos[4], _1133.pos[5], _1133.pos[6], _1133.pos[7], _1133.pos[8], _1133.pos[9], _1133.pos[10], _1133.pos[11], _1133.pos[12], _1133.pos[13] };
    atlas_texture_t _9338 = { _1133.size, _1133.atlas, _9332, _9368 };
    uint _1203 = _1133.atlas;
    float4 res = g_atlases[NonUniformResourceIndex(_1203)].SampleLevel(_g_atlases_sampler[NonUniformResourceIndex(_1203)], float3(TransformUV(uvs, _9338, lod) * 0.000118371215648949146270751953125f.xx, float((_9332[lod / 4] >> uint((lod % 4) * 8)) & 255u)), 0.0f);
    bool _1218;
    if (maybe_YCoCg)
    {
    ...
    if (_1237)
    {
        ...
        float4 _10511 = res;
        _10511.x = _1243.x;
        float4 _10513 = _10511;
        _10513.y = _1243.y;
        float4 _10515 = _10513;
        _10515.z = _1243.z;
        res = _10515;
    }
    return res;
...
float3 ensure_valid_reflection(float3 Ng, float3 I, float3 N)
{
    ...
    do
    {
        ...
        if (_1592 && _1598)
        {
            float _10814 = (-0.5f) / _1552;
            float param_1 = mad(_10814, _1576, 1.0f);
            float _1608 = safe_sqrtf(param_1);
            float param_2 = _1577;
            float _1611 = safe_sqrtf(param_2);
            float2 _1612 = float2(_1608, _1611);
            float param_3 = mad(_10814, _1583, 1.0f);
            float _1617 = safe_sqrtf(param_3);
            float param_4 = _1584;
            float _1620 = safe_sqrtf(param_4);
            float2 _1621 = float2(_1617, _1620);
            float _10816 = -_1540;
            float _1637 = mad(2.0f * mad(_1608, _1536, _1611 * _1540), _1611, _10816);
            float _1653 = mad(2.0f * mad(_1617, _1536, _1620 * _1540), _1620, _10816);
        ...
        _9166 = (_1532 * N_new.x) + (Ng * N_new.y);
        break;
    } while(false);
    return _9166;
}
...
float3 MapToCone(float r1, float r2, float3 N, float radius)
{
    ...
    do
    {
        ...
        _9191 = (N + (param * ((radius * r) * cos(theta)))) + (param_1 * ((radius * r) * sin(theta)));
        break;
    } while(false);
    return _9191;
}
...
float4 Sample_EnvQTree(float y_rotation, Texture2D<float4> qtree_tex, SamplerState _qtree_tex_sampler, int qtree_levels, float rand, float rx, float ry)
{
    ...
    while (lod >= 0)
    {
        ...
        else
        {
            ...
            partial = _912;
            float2 _10498 = origin;
            _10498.x = origin.x + _step;
            origin = _10498;
        ...
        {
            float2 _10501 = origin;
            _10501.y = origin.y + _step;
            origin = _10501;
            _sample = (_sample - boundary) / (1.0f - boundary);
            index |= 2;
        }
...
void SampleLightSource(float3 P, float3 T, float3 B, float3 N, int hi, float2 sample_off, inout light_sample_t ls)
{
    ...
    if (_3603 == 0u)
    {
        ...
        float3 _10578 = sampled_dir;
        float3 _3681 = ((param * _10578.x) + (param_1 * _10578.y)) + (_3638 * _10578.z);
        sampled_dir = _3681;
            ...
            if (_3603 == 4u)
            {
                ...
                if ((_3569.type_and_param0.x & 128u) != 0u)
                {
                    ...
                    if (_3961 != 4294967295u)
                    {
                        ...
                        uint _9512[14] = { _3969.pos[0], _3969.pos[1], _3969.pos[2], _3969.pos[3], _3969.pos[4], _3969.pos[5], _3969.pos[6], _3969.pos[7], _3969.pos[8], _3969.pos[9], _3969.pos[10], _3969.pos[11], _3969.pos[12], _3969.pos[13] };
                        uint _9483[4] = { _3969.page[0], _3969.page[1], _3969.page[2], _3969.page[3] };
                        atlas_texture_t _9412 = { _3969.size, _3969.atlas, _9483, _9512 };
                        float param_10 = _3539_g_params.env_rotation;
                        env_col *= SampleLatlong_RGBE(_9412, ls.L, param_10);
                    }
                    ls.col *= env_col;
                    ls.from_env = true;
                }
                ...
                if (_3603 == 5u)
                {
                    ...
                    if ((_3569.type_and_param0.x & 128u) != 0u)
                    {
                        ...
                        if (_4204 != 4294967295u)
                        {
                            ...
                            uint _9550[14] = { _4211.pos[0], _4211.pos[1], _4211.pos[2], _4211.pos[3], _4211.pos[4], _4211.pos[5], _4211.pos[6], _4211.pos[7], _4211.pos[8], _4211.pos[9], _4211.pos[10], _4211.pos[11], _4211.pos[12], _4211.pos[13] };
                            uint _9521[4] = { _4211.page[0], _4211.page[1], _4211.page[2], _4211.page[3] };
                            atlas_texture_t _9421 = { _4211.size, _4211.atlas, _9521, _9550 };
                            float param_13 = _3539_g_params.env_rotation;
                            env_col_1 *= SampleLatlong_RGBE(_9421, ls.L, param_13);
                        }
                        ls.col *= env_col_1;
                        ls.from_env = true;
                    }
                        ...
                        else
                        {
                            ...
                            if (_3603 == 7u)
                            {
                                ...
                                if (_4930 != 4294967295u)
                                {
                                    ...
                                    uint _9635[14] = { _4937.pos[0], _4937.pos[1], _4937.pos[2], _4937.pos[3], _4937.pos[4], _4937.pos[5], _4937.pos[6], _4937.pos[7], _4937.pos[8], _4937.pos[9], _4937.pos[10], _4937.pos[11], _4937.pos[12], _4937.pos[13] };
                                    uint _9606[4] = { _4937.page[0], _4937.page[1], _4937.page[2], _4937.page[3] };
                                    atlas_texture_t _9474 = { _4937.size, _4937.atlas, _9606, _9635 };
                                    float param_20 = _3539_g_params.env_rotation;
                                    ls.col *= SampleLatlong_RGBE(_9474, ls.L, param_20);
                                }
                                ls.area = 1.0f;
                                ls.lp = P + ls.L;
                                ls.dist_mul = 3402823346297367662189621542912.0f;
...
float D_GGX(float3 H, float alpha_x, float alpha_y)
{
    ...
    do
    {
        ...
        _9224 = 1.0f / (((((_2259 * _2259) * 3.1415927410125732421875f) * alpha_x) * alpha_y) * (((H.z * H.z) * H.z) * H.z));
        break;
    } while(false);
    return _9224;
}
...
float4 Sample_GGXSpecular_BSDF(float3 T, float3 B, float3 N, float3 I, float roughness, float anisotropic, float spec_ior, float spec_F0, float3 spec_col, float rand_u, float rand_v, inout float3 out_V)
{
    ...
    do
    {
        ...
        if ((_2870 * _2874) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            out_V = _2885;
            _9196 = float4(_2899.x * 1000000.0f, _2899.y * 1000000.0f, _2899.z * 1000000.0f, 1000000.0f);
            break;
        }
        float3 param_2 = T;
        float3 param_3 = B;
        ...
        _9196 = Evaluate_GGXSpecular_BSDF(param_14, param_15, param_16, param_17, param_18, param_19, param_20, param_21);
        break;
    } while(false);
    return _9196;
}
...
float4 Evaluate_GGXRefraction_BSDF(float3 view_dir_ts, float3 sampled_normal_ts, float3 refr_dir_ts, float roughness2, float eta, float3 refr_col)
{
    ...
    do
    {
        ...
        _9201 = float4(refr_col * (((((_3182 * _3198) * _3190) * clamp(dot(view_dir_ts, sampled_normal_ts), 0.0f, 1.0f)) * _3218) / view_dir_ts.z), (((_3182 * _3190) * clamp(dot(view_dir_ts, sampled_normal_ts), 0.0f, 1.0f)) * _3218) / view_dir_ts.z);
        break;
    } while(false);
    return _9201;
}
...
float4 Sample_GGXRefraction_BSDF(float3 T, float3 B, float3 N, float3 I, float roughness, float eta, float3 refr_col, float rand_u, float rand_v, inout float4 out_V)
{
    ...
    do
    {
        ...
        if ((_3262 * _3262) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            _9206 = float4(refr_col.x * 1000000.0f, refr_col.y * 1000000.0f, refr_col.z * 1000000.0f, 1000000.0f);
            break;
        }
        float3 param = T;
        float3 param_1 = B;
        ...
        _9206 = Evaluate_GGXRefraction_BSDF(param_8, param_9, param_10, param_11, param_12, param_13);
        break;
    } while(false);
    return _9206;
}
...
lobe_weights_t get_lobe_weights(float base_color_lum, float spec_color_lum, float specular, float metallic, float transmission, float clearcoat)
{
    ...
    float _9369 = (base_color_lum * _1715) * (1.0f - transmission);
    ...
    float _9371 = _1736 * _1715;
    float _9372 = _1722 * base_color_lum;
    float _1745 = _9369;
    ...
    lobe_weights_t _9377 = { _9369, _9370, _9371, _9372 };
    return _9377;
}
...
float BRDF_PrincipledDiffuse(float3 V, float3 N, float3 L, float3 H, float roughness)
{
    ...
    do
    {
        ...
        _9229 = lerp(1.0f, _2499, schlick_weight(param)) * lerp(1.0f, _2499, schlick_weight(param_1));
        break;
    } while(false);
    return _9229;
}
...
float D_GTR1(float NDotH, float a)
{
    ...
    do
    {
        if (a >= 1.0f)
        {
            _9234 = 0.3183098733425140380859375f;
            break;
        }
        float _2218 = mad(a, a, -1.0f);
        _9234 = _2218 / ((3.1415927410125732421875f * log(a * a)) * mad(_2218 * NDotH, NDotH, 1.0f));
        break;
    } while(false);
    return _9234;
}
...
float4 Sample_PrincipledClearcoat_BSDF(float3 T, float3 B, float3 N, float3 I, float clearcoat_roughness2, float clearcoat_ior, float clearcoat_F0, float rand_u, float rand_v, inout float3 out_V)
{
    ...
    do
    {
        ...
        if ((clearcoat_roughness2 * clearcoat_roughness2) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            _9219 = float4(_3099, _3099, _3099, 1000000.0f);
            break;
        }
        float3 param_2 = T;
        float3 param_3 = B;
        ...
        _9219 = Evaluate_PrincipledClearcoat_BSDF(param_14, param_15, param_16, param_17, param_18, param_19);
        break;
    } while(false);
    return _9219;
}
        ...
        else
        {
            ...
            else
            {
                ...
                if (_6844)
                {
                    ...
                    float4 _10762 = F;
                    float _6958 = _10762.w * lobe_weights.refraction;
                    float4 _10764 = _10762;
                    _10764.w = _6958;
                    F = _10764;
                    new_ray.c[0] = ((ray.c[0] * _10762.x) * mix_weight) / _6958;
                    new_ray.c[1] = ((ray.c[1] * _10762.y) * mix_weight) / _6958;
                    new_ray.c[2] = ((ray.c[2] * _10762.z) * mix_weight) / _6958;
                    new_ray.pdf = _6958;
                    new_ray.d[0] = V.x;
                    new_ray.d[1] = V.y;
                    new_ray.d[2] = V.z;
...
float3 ShadeSurface(hit_data_t inter, ray_data_t ray, inout float3 out_base_color, inout float3 out_normals)
{
    ...
    do
    {
        ...
        if (inter.mask == 0)
        {
            ...
            _9156 = float3(ray.c[0] * _7023.x, ray.c[1] * _7023.y, ray.c[2] * _7023.z);
            break;
        }
        ...
        if (inter.obj_index < 0)
        {
            ...
            _9156 = float3(ray.c[0] * _7062.x, ray.c[1] * _7062.y, ray.c[2] * _7062.z);
            break;
        }
        ...
        uint _10211 = _7105.textures[0];
        uint _10212 = _7105.textures[1];
        uint _10213 = _7105.textures[2];
        uint _10214 = _7105.textures[3];
        uint _10215 = _7105.textures[4];
        float _10216 = _7105.base_color[0];
        float _10217 = _7105.base_color[1];
        float _10218 = _7105.base_color[2];
        uint _9821 = _7105.flags;
        uint _9822 = _7105.type;
        float _9823 = _7105.tangent_rotation_or_strength;
        uint _9824 = _7105.roughness_and_anisotropic;
        float _9825 = _7105.ior;
        uint _9826 = _7105.sheen_and_sheen_tint;
        uint _9827 = _7105.tint_and_metallic;
        uint _9828 = _7105.transmission_and_transmission_roughness;
        uint _9829 = _7105.specular_and_specular_tint;
        uint _9830 = _7105.clearcoat_and_clearcoat_roughness;
        uint _9831 = _7105.normal_map_strength_unorm;
        transform_t _7160;
        ...
        float3 _9759 = _7449;
        float3 _9758 = cross(_7449, _7365);
        if (_7083)
        {
            ...
            _10211 = _7474.textures[0];
            _10212 = _7474.textures[1];
            _10213 = _7474.textures[2];
            _10214 = _7474.textures[3];
            _10215 = _7474.textures[4];
            _10216 = _7474.base_color[0];
            _10217 = _7474.base_color[1];
            _10218 = _7474.base_color[2];
            _9821 = _7474.flags;
            _9822 = _7474.type;
            _9823 = _7474.tangent_rotation_or_strength;
            _9824 = _7474.roughness_and_anisotropic;
            _9825 = _7474.ior;
            _9826 = _7474.sheen_and_sheen_tint;
            _9827 = _7474.tint_and_metallic;
            _9828 = _7474.transmission_and_transmission_roughness;
            _9829 = _7474.specular_and_specular_tint;
            _9830 = _7474.clearcoat_and_clearcoat_roughness;
            _9831 = _7474.normal_map_strength_unorm;
            _9761 = -_9761;
            _9760 = -_9760;
            _9759 = -_9759;
            _9758 = -_9758;
        }
        float3 param_3 = _9761;
        float4x4 param_4 = _7160.inv_xform;
        _9761 = TransformNormal(param_3, param_4);
        float3 param_5 = _9760;
        float4x4 param_6 = _7160.inv_xform;
        _9760 = TransformNormal(param_5, param_6);
        float3 param_7 = _9759;
        float4x4 param_8 = _7160.inv_xform;
        _9759 = TransformNormal(param_7, param_8);
        float3 param_9 = _9758;
        float4x4 param_10 = _7160.inv_xform;
        _9761 = normalize(_9761);
        _9760 = normalize(_9760);
        _9759 = normalize(_9759);
        _9758 = normalize(TransformNormal(param_9, param_10));
        ...
        {
            float mix_val = _9823;
            if (_10212 != 4294967295u)
            {
                mix_val *= SampleBilinear(_10212, _7391, 0).x;
            }
            if (_7083)
            {
                _7718 = _7647 / _9825;
            ...
            if (_9825 != 0.0f)
            {
                float param_16 = dot(_7014, _9760);
            ...
            if (mix_rand > _7751)
            {
                ...
                {
                    _7774.textures[_108ident] = _4758.Load(_108ident * 4 + _10214 * 76 + 0);
                }
                [unroll]
                for (int _109ident = 0; _109ident < 3; _109ident++)
                {
                    _7774.base_color[_109ident] = asfloat(_4758.Load(_109ident * 4 + _10214 * 76 + 20));
                }
                _7774.flags = _4758.Load(_10214 * 76 + 32);
                _7774.type = _4758.Load(_10214 * 76 + 36);
                _7774.tangent_rotation_or_strength = asfloat(_4758.Load(_10214 * 76 + 40));
                _7774.roughness_and_anisotropic = _4758.Load(_10214 * 76 + 44);
                _7774.ior = asfloat(_4758.Load(_10214 * 76 + 48));
                _7774.sheen_and_sheen_tint = _4758.Load(_10214 * 76 + 52);
                _7774.tint_and_metallic = _4758.Load(_10214 * 76 + 56);
                _7774.transmission_and_transmission_roughness = _4758.Load(_10214 * 76 + 60);
                _7774.specular_and_specular_tint = _4758.Load(_10214 * 76 + 64);
                _7774.clearcoat_and_clearcoat_roughness = _4758.Load(_10214 * 76 + 68);
                _7774.normal_map_strength_unorm = _4758.Load(_10214 * 76 + 72);
                _10211 = _7774.textures[0];
                _10212 = _7774.textures[1];
                _10213 = _7774.textures[2];
                _10214 = _7774.textures[3];
                _10215 = _7774.textures[4];
                _10216 = _7774.base_color[0];
                _10217 = _7774.base_color[1];
                _10218 = _7774.base_color[2];
                _9821 = _7774.flags;
                _9822 = _7774.type;
                _9823 = _7774.tangent_rotation_or_strength;
                _9824 = _7774.roughness_and_anisotropic;
                _9825 = _7774.ior;
                _9826 = _7774.sheen_and_sheen_tint;
                _9827 = _7774.tint_and_metallic;
                _9828 = _7774.transmission_and_transmission_roughness;
                _9829 = _7774.specular_and_specular_tint;
                _9830 = _7774.clearcoat_and_clearcoat_roughness;
                _9831 = _7774.normal_map_strength_unorm;
            ...
            else
            {
                ...
                {
                    _7840.textures[_110ident] = _4758.Load(_110ident * 4 + _10215 * 76 + 0);
                }
                [unroll]
                for (int _111ident = 0; _111ident < 3; _111ident++)
                {
                    _7840.base_color[_111ident] = asfloat(_4758.Load(_111ident * 4 + _10215 * 76 + 20));
                }
                _7840.flags = _4758.Load(_10215 * 76 + 32);
                _7840.type = _4758.Load(_10215 * 76 + 36);
                _7840.tangent_rotation_or_strength = asfloat(_4758.Load(_10215 * 76 + 40));
                _7840.roughness_and_anisotropic = _4758.Load(_10215 * 76 + 44);
                _7840.ior = asfloat(_4758.Load(_10215 * 76 + 48));
                _7840.sheen_and_sheen_tint = _4758.Load(_10215 * 76 + 52);
                _7840.tint_and_metallic = _4758.Load(_10215 * 76 + 56);
                _7840.transmission_and_transmission_roughness = _4758.Load(_10215 * 76 + 60);
                _7840.specular_and_specular_tint = _4758.Load(_10215 * 76 + 64);
                _7840.clearcoat_and_clearcoat_roughness = _4758.Load(_10215 * 76 + 68);
                _7840.normal_map_strength_unorm = _4758.Load(_10215 * 76 + 72);
                _10211 = _7840.textures[0];
                _10212 = _7840.textures[1];
                _10213 = _7840.textures[2];
                _10214 = _7840.textures[3];
                _10215 = _7840.textures[4];
                _10216 = _7840.base_color[0];
                _10217 = _7840.base_color[1];
                _10218 = _7840.base_color[2];
                _9821 = _7840.flags;
                _9822 = _7840.type;
                _9823 = _7840.tangent_rotation_or_strength;
                _9824 = _7840.roughness_and_anisotropic;
                _9825 = _7840.ior;
                _9826 = _7840.sheen_and_sheen_tint;
                _9827 = _7840.tint_and_metallic;
                _9828 = _7840.transmission_and_transmission_roughness;
                _9829 = _7840.specular_and_specular_tint;
                _9830 = _7840.clearcoat_and_clearcoat_roughness;
                _9831 = _7840.normal_map_strength_unorm;
                mix_rand /= mix_val;
            }
        }
        [branch]
        if (_10211 != 4294967295u)
        {
            float3 normals = (float3(SampleBilinear(_10211, _7391, 0).xy, 1.0f) * 2.0f) - 1.0f.xxx;
            if ((_1003.Load(_10211 * 80 + 0) & 16384u) != 0u)
            {
                float3 _10783 = normals;
                _10783.z = sqrt(1.0f - dot(normals.xy, normals.xy));
                normals = _10783;
            }
            float3 _7924 = _9760;
            _9760 = normalize(((_9758 * normals.x) + (_7924 * normals.z)) + (_9759 * normals.y));
            if ((_9831 & 65535u) != 65535u)
            {
                _9760 = normalize(_7924 + ((_9760 - _7924) * clamp(float(_9831 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f)));
            }
            float3 param_18 = _9761;
            float3 param_19 = -_7014;
            float3 param_20 = _9760;
            _9760 = ensure_valid_reflection(param_18, param_19, param_20);
        }
        ...
        tangent = _8003;
        float3 _8007 = cross(_8003, _9760);
        ...
        if (_9823 != 0.0f)
        {
            ...
            float3 param_26 = _9760;
            float param_27 = _9823;
            tangent = rotate_around_axis(param_25, param_26, param_27);
        }
        float3 _8040 = normalize(cross(tangent, _9760));
        _9759 = _8040;
        _9758 = cross(_9760, _8040);
        float3 _9910 = 0.0f.xxx;
        float3 _9909 = 0.0f.xxx;
        float _9914 = 0.0f;
        float _9912 = 0.0f;
        float _9913 = 1.0f;
        ...
        if (_8062)
        {
            ...
            float3 param_29 = _9758;
            float3 param_30 = _9759;
            float3 param_31 = _9760;
            int param_32 = _7681;
            float2 param_33 = float2(_7631, _7638);
            light_sample_t _9925 = { _9909, _9910, _9911, _9912, _9913, _9914, _9915, _9916 };
            light_sample_t param_34 = _9925;
            SampleLightSource(param_28, param_29, param_30, param_31, param_32, param_33, param_34);
            _9909 = param_34.col;
            _9910 = param_34.L;
            _9911 = param_34.lp;
            _9912 = param_34.area;
            _9913 = param_34.dist_mul;
            _9914 = param_34.pdf;
            _9915 = param_34.cast_shadow;
            _9916 = param_34.from_env;
        }
        float _8090 = dot(_9760, _9910);
        float3 base_color = float3(_10216, _10217, _10218);
        [branch]
        if (_10212 != 4294967295u)
        {
            base_color *= SampleBilinear(_10212, _7391, int(get_texture_lod(texSize(_10212), _7624)), true, true).xyz;
        }
        ...
        float roughness = clamp(float(_9824 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
        [branch]
        if (_10213 != 4294967295u)
        {
            roughness *= SampleBilinear(_10213, _7391, int(get_texture_lod(texSize(_10213), _7624)), false, true).x;
        }
        ...
        float _9975 = _7614;
        float _9976 = ray.cone_spread;
        int _9977 = ray.xy;
        float _9972 = 0.0f;
        float _10443 = 0.0f;
        float _10442 = 0.0f;
        float _10441 = 0.0f;
        int _10079 = ray.depth;
        int _10083 = ray.xy;
        int _9978;
        float _10081;
        float _10266;
        ...
        {
            [branch]
            if ((_9914 > 0.0f) && (_8090 > 0.0f))
            {
                light_sample_t _9942 = { _9909, _9910, _9911, _9912, _9913, _9914, _9915, _9916 };
                surface_t _9769 = { _7050, _9758, _9759, _9760, _9761, _7391 };
                float _10447[3] = { _10441, _10442, _10443 };
                float _10412[3] = { _10406, _10407, _10408 };
                float _10377[3] = { _10371, _10372, _10373 };
                shadow_ray_t _10093 = { _10377, _10079, _10412, _10081, _10447, _10083 };
                shadow_ray_t param_35 = _10093;
                float3 _8240 = Evaluate_DiffuseNode(_9942, ray, _9769, base_color, roughness, mix_weight, param_35);
                _10371 = param_35.o[0];
                _10372 = param_35.o[1];
                _10373 = param_35.o[2];
                _10079 = param_35.depth;
                _10406 = param_35.d[0];
                _10407 = param_35.d[1];
                _10408 = param_35.d[2];
                _10081 = param_35.dist;
                _10441 = param_35.c[0];
                _10442 = param_35.c[1];
                _10443 = param_35.c[2];
                _10083 = param_35.xy;
            ...
            if (_8254)
            {
                surface_t _9776 = { _7050, _9758, _9759, _9760, _9761, _7391 };
                float _10342[3] = { _10336, _10337, _10338 };
                float _10307[3] = { _10301, _10302, _10303 };
                float _10272[3] = { _10266, _10267, _10268 };
                ray_data_t _9992 = { _10272, _10307, _9972, _10342, _9974, _9975, _9976, _9977, _9978 };
                ray_data_t param_36 = _9992;
                Sample_DiffuseNode(ray, _9776, base_color, roughness, _8171, _8180, mix_weight, param_36);
                _10266 = param_36.o[0];
                _10267 = param_36.o[1];
                _10268 = param_36.o[2];
                _10301 = param_36.d[0];
                ...
                _10338 = param_36.c[2];
                _9974 = param_36.ior;
                _9975 = param_36.cone_width;
                _9976 = param_36.cone_spread;
                _9977 = param_36.xy;
                _9978 = param_36.depth;
            }
        }
        else
        {
            ...
            if (_9822 == 1u)
            {
                ...
                if (_8292 && (_8090 > 0.0f))
                {
                    light_sample_t _9951 = { _9909, _9910, _9911, _9912, _9913, _9914, _9915, _9916 };
                    surface_t _9783 = { _7050, _9758, _9759, _9760, _9761, _7391 };
                    float _10454[3] = { _10441, _10442, _10443 };
                    float _10419[3] = { _10406, _10407, _10408 };
                    float _10384[3] = { _10371, _10372, _10373 };
                    shadow_ray_t _10106 = { _10384, _10079, _10419, _10081, _10454, _10083 };
                    shadow_ray_t param_39 = _10106;
                    float3 _8307 = Evaluate_GlossyNode(_9951, ray, _9783, base_color, roughness, 1.5f, _8278, mix_weight, param_39);
                    _10371 = param_39.o[0];
                    _10372 = param_39.o[1];
                    _10373 = param_39.o[2];
                    _10079 = param_39.depth;
                    _10406 = param_39.d[0];
                    _10407 = param_39.d[1];
                    _10408 = param_39.d[2];
                    _10081 = param_39.dist;
                    _10441 = param_39.c[0];
                    _10442 = param_39.c[1];
                    _10443 = param_39.c[2];
                    _10083 = param_39.xy;
                ...
                if (_8321)
                {
                    surface_t _9790 = { _7050, _9758, _9759, _9760, _9761, _7391 };
                    float _10349[3] = { _10336, _10337, _10338 };
                    float _10314[3] = { _10301, _10302, _10303 };
                    float _10279[3] = { _10266, _10267, _10268 };
                    ray_data_t _10011 = { _10279, _10314, _9972, _10349, _9974, _9975, _9976, _9977, _9978 };
                    ray_data_t param_40 = _10011;
                    Sample_GlossyNode(ray, _9790, base_color, roughness, 1.5f, _8278, _8171, _8180, mix_weight, param_40);
                    _10266 = param_40.o[0];
                    _10267 = param_40.o[1];
                    _10268 = param_40.o[2];
                    _10301 = param_40.d[0];
                    ...
                    _10338 = param_40.c[2];
                    _9974 = param_40.ior;
                    _9975 = param_40.cone_width;
                    _9976 = param_40.cone_spread;
                    _9977 = param_40.xy;
                    _9978 = param_40.depth;
                }
            }
            else
            {
                ...
                if (_9822 == 2u)
                {
                    ...
                    if (_8355 && (_8090 < 0.0f))
                    {
                        ...
                        light_sample_t _9960 = { _9909, _9910, _9911, _9912, _9913, _9914, _9915, _9916 };
                        surface_t _9797 = { _7050, _9758, _9759, _9760, _9761, _7391 };
                        float _10461[3] = { _10441, _10442, _10443 };
                        float _10426[3] = { _10406, _10407, _10408 };
                        float _10391[3] = { _10371, _10372, _10373 };
                        shadow_ray_t _10119 = { _10391, _10079, _10426, _10081, _10461, _10083 };
                        shadow_ray_t param_41 = _10119;
                        float3 _8385 = Evaluate_RefractiveNode(_9960, ray, _9797, base_color, _8345, _8363, mix_weight, param_41);
                        _10371 = param_41.o[0];
                        _10372 = param_41.o[1];
                        _10373 = param_41.o[2];
                        _10079 = param_41.depth;
                        _10406 = param_41.d[0];
                        _10407 = param_41.d[1];
                        _10408 = param_41.d[2];
                        _10081 = param_41.dist;
                        _10441 = param_41.c[0];
                        _10442 = param_41.c[1];
                        _10443 = param_41.c[2];
                        _10083 = param_41.xy;
                    ...
                    if (_8399)
                    {
                        surface_t _9804 = { _7050, _9758, _9759, _9760, _9761, _7391 };
                        float _10356[3] = { _10336, _10337, _10338 };
                        float _10321[3] = { _10301, _10302, _10303 };
                        float _10286[3] = { _10266, _10267, _10268 };
                        ray_data_t _10030 = { _10286, _10321, _9972, _10356, _9974, _9975, _9976, _9977, _9978 };
                        ray_data_t param_42 = _10030;
                        Sample_RefractiveNode(ray, _9804, base_color, roughness, _7083, _9825, _7647, _8171, _8180, mix_weight, param_42);
                        _10266 = param_42.o[0];
                        _10267 = param_42.o[1];
                        _10268 = param_42.o[2];
                        _10301 = param_42.d[0];
                        ...
                        _10338 = param_42.c[2];
                        _9974 = param_42.ior;
                        _9975 = param_42.cone_width;
                        _9976 = param_42.cone_spread;
                        _9977 = param_42.xy;
                        _9978 = param_42.depth;
                    }
                }
                else
                {
                    ...
                    if (_9822 == 3u)
                    {
                        col += (base_color * (mix_weight * _9823));
                    }
                    else
                    {
                        [branch]
                        if (_9822 == 6u)
                        {
                            float metallic = clamp(float((_9827 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            [branch]
                            if (_10214 != 4294967295u)
                            {
                                metallic *= SampleBilinear(_10214, _7391, int(get_texture_lod(texSize(_10214), _7624))).x;
                            }
                            float specular = clamp(float(_9829 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            [branch]
                            if (_10215 != 4294967295u)
                            {
                                specular *= SampleBilinear(_10215, _7391, int(get_texture_lod(texSize(_10215), _7624))).x;
                            }
                            float _8518 = clamp(float(_9830 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float _8526 = clamp(float((_9830 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float _8534 = 2.0f * clamp(float(_9826 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float3 _8552 = lerp(1.0f.xxx, tint_color, clamp(float((_9826 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * _8534;
                            float3 _8572 = lerp(lerp(1.0f.xxx, tint_color, clamp(float((_9829 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * (specular * 0.07999999821186065673828125f), base_color, metallic.xxx);
                            ...
                            float _8595 = clamp(float((_9824 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            ...
                            float _8627 = mad(roughness - 1.0f, 1.0f - clamp(float((_9828 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), 1.0f);
                            float _8633;
                            if (_7083)
                            {
                                _8633 = _9825 / _7647;
                            ...
                            float param_47 = dot(_7014, _9760);
                            float param_48 = 1.0f / _8633;
                            float _8656 = fresnel_dielectric_cos(param_47, param_48);
                            float param_49 = dot(_7014, _9760);
                            float param_50 = _8581;
                            lobe_weights_t _8695 = get_lobe_weights(lerp(_8126, 1.0f, _8534), lum(lerp(_8572, 1.0f.xxx, ((fresnel_dielectric_cos(param_49, param_50) - _8587) / (1.0f - _8587)).xxx)), specular, metallic, clamp(float(_9828 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), _8518);
                            [branch]
                            if (_9914 > 0.0f)
                            {
                                light_sample_t _9969 = { _9909, _9910, _9911, _9912, _9913, _9914, _9915, _9916 };
                                surface_t _9811 = { _7050, _9758, _9759, _9760, _9761, _7391 };
                                diff_params_t _10161 = { base_color, _8552, roughness };
                                spec_params_t _10176 = { _8572, roughness, _8581, _8587, _8595 };
                                clearcoat_params_t _10189 = { _8526, _8606, _8612 };
                                transmission_params_t _10204 = { _8627, _9825, _8633, _8656, _7083 };
                                float _10468[3] = { _10441, _10442, _10443 };
                                float _10433[3] = { _10406, _10407, _10408 };
                                float _10398[3] = { _10371, _10372, _10373 };
                                shadow_ray_t _10132 = { _10398, _10079, _10433, _10081, _10468, _10083 };
                                shadow_ray_t param_51 = _10132;
                                float3 _8714 = Evaluate_PrincipledNode(_9969, ray, _9811, _8695, _10161, _10176, _10189, _10204, metallic, _8090, mix_weight, param_51);
                                _10371 = param_51.o[0];
                                _10372 = param_51.o[1];
                                _10373 = param_51.o[2];
                                _10079 = param_51.depth;
                                _10406 = param_51.d[0];
                                _10407 = param_51.d[1];
                                _10408 = param_51.d[2];
                                _10081 = param_51.dist;
                                _10441 = param_51.c[0];
                                _10442 = param_51.c[1];
                                _10443 = param_51.c[2];
                                _10083 = param_51.xy;
                            ...
                            surface_t _9818 = { _7050, _9758, _9759, _9760, _9761, _7391 };
                            diff_params_t _10165 = { base_color, _8552, roughness };
                            spec_params_t _10182 = { _8572, roughness, _8581, _8587, _8595 };
                            clearcoat_params_t _10193 = { _8526, _8606, _8612 };
                            transmission_params_t _10210 = { _8627, _9825, _8633, _8656, _7083 };
                            float param_52 = mix_rand;
                            float _10363[3] = { _10336, _10337, _10338 };
                            float _10328[3] = { _10301, _10302, _10303 };
                            float _10293[3] = { _10266, _10267, _10268 };
                            ray_data_t _10049 = { _10293, _10328, _9972, _10363, _9974, _9975, _9976, _9977, _9978 };
                            ray_data_t param_53 = _10049;
                            Sample_PrincipledNode(ray, _9818, _8695, _10165, _10182, _10193, _10210, metallic, _8171, _8180, param_52, mix_weight, param_53);
                            _10266 = param_53.o[0];
                            _10267 = param_53.o[1];
                            _10268 = param_53.o[2];
                            _10301 = param_53.d[0];
                            ...
                            _10338 = param_53.c[2];
                            _9974 = param_53.ior;
                            _9975 = param_53.cone_width;
                            _9976 = param_53.cone_spread;
                            _9977 = param_53.xy;
                            _9978 = param_53.depth;
                        }
                    }
                }
            }
        }
        float _8748 = max(_10336, max(_10337, _10338));
        float _8760;
        ...
        if (_8780)
        {
            ...
            _8820.Store(_8811 * 72 + 0, asuint(_10266));
            _8820.Store(_8811 * 72 + 4, asuint(_10267));
            _8820.Store(_8811 * 72 + 8, asuint(_10268));
            _8820.Store(_8811 * 72 + 12, asuint(_10301));
            _8820.Store(_8811 * 72 + 16, asuint(_10302));
            _8820.Store(_8811 * 72 + 20, asuint(_10303));
            ...
            _8820.Store(_8811 * 72 + 40, asuint(_9974[0]));
            _8820.Store(_8811 * 72 + 44, asuint(_9974[1]));
            _8820.Store(_8811 * 72 + 48, asuint(_9974[2]));
            _8820.Store(_8811 * 72 + 52, asuint(_9974[3]));
            _8820.Store(_8811 * 72 + 56, asuint(_9975));
            _8820.Store(_8811 * 72 + 60, asuint(_9976));
            _8820.Store(_8811 * 72 + 64, uint(_9977));
            _8820.Store(_8811 * 72 + 68, uint(_9978));
        }
        [branch]
        if (max(_10441, max(_10442, _10443)) > 0.0f)
        {
            float3 _8897 = _9911 - float3(_10371, _10372, _10373);
            float _8900 = length(_8897);
            float3 _8904 = _8897 / _8900.xxx;
            float sh_dist = _8900 * _9913;
            if (_9916)
            {
                sh_dist = -sh_dist;
            }
            ...
            _8936.Store(_8928 * 48 + 0, asuint(_10371));
            _8936.Store(_8928 * 48 + 4, asuint(_10372));
            _8936.Store(_8928 * 48 + 8, asuint(_10373));
            _8936.Store(_8928 * 48 + 12, uint(_10079));
            ...
            _8936.Store(_8928 * 48 + 32, asuint(_10441));
            _8936.Store(_8928 * 48 + 36, asuint(_10442));
            _8936.Store(_8928 * 48 + 40, asuint(_10443));
            _8936.Store(_8928 * 48 + 44, uint(_10083));
        }
        _9156 = float3(ray.c[0] * col.x, ray.c[1] * col.y, ray.c[2] * col.z);
        break;
    } while(false);
    return _9156;
}
...
void comp_main()
{
    do
    {
        ...
        hit_data_t _9250 = { _9036.mask, _9036.obj_index, _9036.prim_index, _9036.t, _9036.u, _9036.v };
        hit_data_t param = _9250;
        float _9299[4] = { _9052.ior[0], _9052.ior[1], _9052.ior[2], _9052.ior[3] };
        float _9290[3] = { _9052.c[0], _9052.c[1], _9052.c[2] };
        float _9283[3] = { _9052.d[0], _9052.d[1], _9052.d[2] };
        float _9276[3] = { _9052.o[0], _9052.o[1], _9052.o[2] };
        ray_data_t _9269 = { _9276, _9283, _9052.pdf, _9290, _9299, _9052.cone_width, _9052.cone_spread, _9052.xy, _9052.depth };
        ray_data_t param_1 = _9269;
        float3 param_2 = 0.0f.xxx;
        float3 param_3 = 0.0f.xxx;
        float3 _9108 = ShadeSurface(param, param_1, param_2, param_3);
        g_out_img[int2((_9018 >> 16) & 65535, _9025 & 65535)] = float4(min(_9108, _3539_g_params.clamp_val.xxx), 1.0f);
        break;
    } while(false);
}
