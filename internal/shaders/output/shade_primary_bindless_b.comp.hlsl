...
ByteAddressBuffer _8699 : register(t10, space0);
...
float3 ensure_valid_reflection(float3 Ng, float3 I, float3 N)
{
    ...
    do
    {
        ...
        if (_1320 && _1326)
        {
            float _10055 = (-0.5f) / _1280;
            float param_1 = mad(_10055, _1304, 1.0f);
            float _1336 = safe_sqrtf(param_1);
            float param_2 = _1305;
            float _1339 = safe_sqrtf(param_2);
            float2 _1340 = float2(_1336, _1339);
            float param_3 = mad(_10055, _1311, 1.0f);
            float _1345 = safe_sqrtf(param_3);
            float param_4 = _1312;
            float _1348 = safe_sqrtf(param_4);
            float2 _1349 = float2(_1345, _1348);
            float _10057 = -_1268;
            float _1365 = mad(2.0f * mad(_1336, _1264, _1339 * _1268), _1339, _10057);
            float _1381 = mad(2.0f * mad(_1345, _1264, _1348 * _1268), _1348, _10057);
        ...
        _8716 = (_1260 * N_new.x) + (Ng * N_new.y);
        break;
    } while(false);
    return _8716;
}
...
float3 MapToCone(float r1, float r2, float3 N, float radius)
{
    ...
    do
    {
        ...
        _8741 = (N + (param * ((radius * r) * cos(theta)))) + (param_1 * ((radius * r) * sin(theta)));
        break;
    } while(false);
    return _8741;
}
...
void SampleLightSource(float3 P, float3 T, float3 B, float3 N, int hi, float2 sample_off, inout light_sample_t ls)
{
    ...
    if (_3354 == 0u)
    {
        ...
        float3 _9818 = sampled_dir;
        float3 _3433 = ((param * _9818.x) + (param_1 * _9818.y)) + (_3390 * _9818.z);
        sampled_dir = _3433;
...
float D_GGX(float3 H, float alpha_x, float alpha_y)
{
    ...
    do
    {
        ...
        _8774 = 1.0f / (((((_1988 * _1988) * 3.1415927410125732421875f) * alpha_x) * alpha_y) * (((H.z * H.z) * H.z) * H.z));
        break;
    } while(false);
    return _8774;
}
...
float4 Sample_GGXSpecular_BSDF(float3 T, float3 B, float3 N, float3 I, float roughness, float anisotropic, float spec_ior, float spec_F0, float3 spec_col, float rand_u, float rand_v, inout float3 out_V)
{
    ...
    do
    {
        ...
        if ((_2599 * _2603) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            out_V = _2614;
            _8746 = float4(_2628.x * 1000000.0f, _2628.y * 1000000.0f, _2628.z * 1000000.0f, 1000000.0f);
            break;
        }
        float3 param_2 = T;
        float3 param_3 = B;
        ...
        _8746 = Evaluate_GGXSpecular_BSDF(param_14, param_15, param_16, param_17, param_18, param_19, param_20, param_21);
        break;
    } while(false);
    return _8746;
}
...
float4 Evaluate_GGXRefraction_BSDF(float3 view_dir_ts, float3 sampled_normal_ts, float3 refr_dir_ts, float roughness2, float eta, float3 refr_col)
{
    ...
    do
    {
        ...
        _8751 = float4(refr_col * (((((_2911 * _2927) * _2919) * clamp(dot(view_dir_ts, sampled_normal_ts), 0.0f, 1.0f)) * _2947) / view_dir_ts.z), (((_2911 * _2919) * clamp(dot(view_dir_ts, sampled_normal_ts), 0.0f, 1.0f)) * _2947) / view_dir_ts.z);
        break;
    } while(false);
    return _8751;
}
...
float4 Sample_GGXRefraction_BSDF(float3 T, float3 B, float3 N, float3 I, float roughness, float eta, float3 refr_col, float rand_u, float rand_v, inout float4 out_V)
{
    ...
    do
    {
        ...
        if ((_2991 * _2991) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            _8756 = float4(refr_col.x * 1000000.0f, refr_col.y * 1000000.0f, refr_col.z * 1000000.0f, 1000000.0f);
            break;
        }
        float3 param = T;
        float3 param_1 = B;
        ...
        _8756 = Evaluate_GGXRefraction_BSDF(param_8, param_9, param_10, param_11, param_12, param_13);
        break;
    } while(false);
    return _8756;
}
...
lobe_weights_t get_lobe_weights(float base_color_lum, float spec_color_lum, float specular, float metallic, float transmission, float clearcoat)
{
    ...
    float _8850 = (base_color_lum * _1443) * (1.0f - transmission);
    ...
    float _8852 = _1464 * _1443;
    float _8853 = _1450 * base_color_lum;
    float _1473 = _8850;
    ...
    lobe_weights_t _8858 = { _8850, _8851, _8852, _8853 };
    return _8858;
}
...
float BRDF_PrincipledDiffuse(float3 V, float3 N, float3 L, float3 H, float roughness)
{
    ...
    do
    {
        ...
        _8779 = lerp(1.0f, _2228, schlick_weight(param)) * lerp(1.0f, _2228, schlick_weight(param_1));
        break;
    } while(false);
    return _8779;
}
...
float D_GTR1(float NDotH, float a)
{
    ...
    do
    {
        if (a >= 1.0f)
        {
            _8784 = 0.3183098733425140380859375f;
            break;
        }
        float _1947 = mad(a, a, -1.0f);
        _8784 = _1947 / ((3.1415927410125732421875f * log(a * a)) * mad(_1947 * NDotH, NDotH, 1.0f));
        break;
    } while(false);
    return _8784;
}
...
float4 Sample_PrincipledClearcoat_BSDF(float3 T, float3 B, float3 N, float3 I, float clearcoat_roughness2, float clearcoat_ior, float clearcoat_F0, float rand_u, float rand_v, inout float3 out_V)
{
    ...
    do
    {
        ...
        if ((clearcoat_roughness2 * clearcoat_roughness2) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            _8769 = float4(_2828, _2828, _2828, 1000000.0f);
            break;
        }
        float3 param_2 = T;
        float3 param_3 = B;
        ...
        _8769 = Evaluate_PrincipledClearcoat_BSDF(param_14, param_15, param_16, param_17, param_18, param_19);
        break;
    } while(false);
    return _8769;
}
        ...
        else
        {
            ...
            else
            {
                ...
                if (_6362)
                {
                    ...
                    float4 _10002 = F;
                    float _6476 = _10002.w * lobe_weights.refraction;
                    float4 _10004 = _10002;
                    _10004.w = _6476;
                    F = _10004;
                    new_ray.c[0] = ((ray.c[0] * _10002.x) * mix_weight) / _6476;
                    new_ray.c[1] = ((ray.c[1] * _10002.y) * mix_weight) / _6476;
                    new_ray.c[2] = ((ray.c[2] * _10002.z) * mix_weight) / _6476;
                    new_ray.pdf = _6476;
                    new_ray.d[0] = V.x;
                    new_ray.d[1] = V.y;
                    new_ray.d[2] = V.z;
...
float3 ShadeSurface(hit_data_t inter, ray_data_t ray, inout float3 out_base_color, inout float3 out_normals)
{
    ...
    do
    {
        ...
        if (inter.mask == 0)
        {
            ...
            _8706 = float3(ray.c[0] * _6608.x, ray.c[1] * _6608.y, ray.c[2] * _6608.z);
            break;
        }
        ...
        if (inter.obj_index < 0)
        {
            ...
            _8706 = float3(ray.c[0] * _6648.x, ray.c[1] * _6648.y, ray.c[2] * _6648.z);
            break;
        }
        ...
        uint _9457 = _6691.textures[0];
        uint _9458 = _6691.textures[1];
        uint _9459 = _6691.textures[2];
        uint _9460 = _6691.textures[3];
        uint _9461 = _6691.textures[4];
        float _9462 = _6691.base_color[0];
        float _9463 = _6691.base_color[1];
        float _9464 = _6691.base_color[2];
        uint _9067 = _6691.flags;
        uint _9068 = _6691.type;
        float _9069 = _6691.tangent_rotation_or_strength;
        uint _9070 = _6691.roughness_and_anisotropic;
        float _9071 = _6691.ior;
        uint _9072 = _6691.sheen_and_sheen_tint;
        uint _9073 = _6691.tint_and_metallic;
        uint _9074 = _6691.transmission_and_transmission_roughness;
        uint _9075 = _6691.specular_and_specular_tint;
        uint _9076 = _6691.clearcoat_and_clearcoat_roughness;
        uint _9077 = _6691.normal_map_strength_unorm;
        transform_t _6746;
        ...
        float3 _9005 = _7035;
        float3 _9004 = cross(_7035, _6951);
        if (_6669)
        {
            ...
            _9457 = _7061.textures[0];
            _9458 = _7061.textures[1];
            _9459 = _7061.textures[2];
            _9460 = _7061.textures[3];
            _9461 = _7061.textures[4];
            _9462 = _7061.base_color[0];
            _9463 = _7061.base_color[1];
            _9464 = _7061.base_color[2];
            _9067 = _7061.flags;
            _9068 = _7061.type;
            _9069 = _7061.tangent_rotation_or_strength;
            _9070 = _7061.roughness_and_anisotropic;
            _9071 = _7061.ior;
            _9072 = _7061.sheen_and_sheen_tint;
            _9073 = _7061.tint_and_metallic;
            _9074 = _7061.transmission_and_transmission_roughness;
            _9075 = _7061.specular_and_specular_tint;
            _9076 = _7061.clearcoat_and_clearcoat_roughness;
            _9077 = _7061.normal_map_strength_unorm;
            _9007 = -_9007;
            _9006 = -_9006;
            _9005 = -_9005;
            _9004 = -_9004;
        ...
        _9005 = TransformNormal(param_9, param_10);
        float3 param_11 = _9004;
        float4x4 param_12 = _6746.inv_xform;
        _9007 = normalize(_9007);
        _9006 = normalize(_9006);
        _9005 = normalize(_9005);
        _9004 = normalize(TransformNormal(param_11, param_12));
        ...
        while (_9068 == 4u)
        {
            ...
            {
                mix_val *= SampleBilinear(_9458, _6977, 0, _6598).x;
            }
            if (_6669)
            {
                _7258 = _7219 / _9071;
            ...
            if (_9071 != 0.0f)
            {
                float param_16 = dot(_6532, _9006);
            ...
            if (mix_rand > _7291)
            {
                ...
                {
                    _7314.textures[_80ident] = _4415.Load(_80ident * 4 + _9460 * 76 + 0);
                }
                [unroll]
                for (int _81ident = 0; _81ident < 3; _81ident++)
                {
                    _7314.base_color[_81ident] = asfloat(_4415.Load(_81ident * 4 + _9460 * 76 + 20));
                }
                _7314.flags = _4415.Load(_9460 * 76 + 32);
                _7314.type = _4415.Load(_9460 * 76 + 36);
                _7314.tangent_rotation_or_strength = asfloat(_4415.Load(_9460 * 76 + 40));
                _7314.roughness_and_anisotropic = _4415.Load(_9460 * 76 + 44);
                _7314.ior = asfloat(_4415.Load(_9460 * 76 + 48));
                _7314.sheen_and_sheen_tint = _4415.Load(_9460 * 76 + 52);
                _7314.tint_and_metallic = _4415.Load(_9460 * 76 + 56);
                _7314.transmission_and_transmission_roughness = _4415.Load(_9460 * 76 + 60);
                _7314.specular_and_specular_tint = _4415.Load(_9460 * 76 + 64);
                _7314.clearcoat_and_clearcoat_roughness = _4415.Load(_9460 * 76 + 68);
                _7314.normal_map_strength_unorm = _4415.Load(_9460 * 76 + 72);
                _9457 = _7314.textures[0];
                _9458 = _7314.textures[1];
                _9459 = _7314.textures[2];
                _9460 = _7314.textures[3];
                _9461 = _7314.textures[4];
                _9462 = _7314.base_color[0];
                _9463 = _7314.base_color[1];
                _9464 = _7314.base_color[2];
                _9067 = _7314.flags;
                _9068 = _7314.type;
                _9069 = _7314.tangent_rotation_or_strength;
                _9070 = _7314.roughness_and_anisotropic;
                _9071 = _7314.ior;
                _9072 = _7314.sheen_and_sheen_tint;
                _9073 = _7314.tint_and_metallic;
                _9074 = _7314.transmission_and_transmission_roughness;
                _9075 = _7314.specular_and_specular_tint;
                _9076 = _7314.clearcoat_and_clearcoat_roughness;
                _9077 = _7314.normal_map_strength_unorm;
            ...
            else
            {
                ...
                {
                    _7380.textures[_82ident] = _4415.Load(_82ident * 4 + _9461 * 76 + 0);
                }
                [unroll]
                for (int _83ident = 0; _83ident < 3; _83ident++)
                {
                    _7380.base_color[_83ident] = asfloat(_4415.Load(_83ident * 4 + _9461 * 76 + 20));
                }
                _7380.flags = _4415.Load(_9461 * 76 + 32);
                _7380.type = _4415.Load(_9461 * 76 + 36);
                _7380.tangent_rotation_or_strength = asfloat(_4415.Load(_9461 * 76 + 40));
                _7380.roughness_and_anisotropic = _4415.Load(_9461 * 76 + 44);
                _7380.ior = asfloat(_4415.Load(_9461 * 76 + 48));
                _7380.sheen_and_sheen_tint = _4415.Load(_9461 * 76 + 52);
                _7380.tint_and_metallic = _4415.Load(_9461 * 76 + 56);
                _7380.transmission_and_transmission_roughness = _4415.Load(_9461 * 76 + 60);
                _7380.specular_and_specular_tint = _4415.Load(_9461 * 76 + 64);
                _7380.clearcoat_and_clearcoat_roughness = _4415.Load(_9461 * 76 + 68);
                _7380.normal_map_strength_unorm = _4415.Load(_9461 * 76 + 72);
                _9457 = _7380.textures[0];
                _9458 = _7380.textures[1];
                _9459 = _7380.textures[2];
                _9460 = _7380.textures[3];
                _9461 = _7380.textures[4];
                _9462 = _7380.base_color[0];
                _9463 = _7380.base_color[1];
                _9464 = _7380.base_color[2];
                _9067 = _7380.flags;
                _9068 = _7380.type;
                _9069 = _7380.tangent_rotation_or_strength;
                _9070 = _7380.roughness_and_anisotropic;
                _9071 = _7380.ior;
                _9072 = _7380.sheen_and_sheen_tint;
                _9073 = _7380.tint_and_metallic;
                _9074 = _7380.transmission_and_transmission_roughness;
                _9075 = _7380.specular_and_specular_tint;
                _9076 = _7380.clearcoat_and_clearcoat_roughness;
                _9077 = _7380.normal_map_strength_unorm;
                mix_rand /= mix_val;
            }
        }
        [branch]
        if (_9457 != 4294967295u)
        {
            float3 normals = (float3(SampleBilinear(_9457, _6977, 0, _6598).xy, 1.0f) * 2.0f) - 1.0f.xxx;
            if ((_9457 & 33554432u) != 0u)
            {
                float3 _10025 = normals;
                _10025.z = sqrt(1.0f - dot(normals.xy, normals.xy));
                normals = _10025;
            }
            float3 _7463 = _9006;
            _9006 = normalize(((_9004 * normals.x) + (_7463 * normals.z)) + (_9005 * normals.y));
            if ((_9077 & 65535u) != 65535u)
            {
                _9006 = normalize(_7463 + ((_9006 - _7463) * clamp(float(_9077 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f)));
            }
            float3 param_18 = _9007;
            float3 param_19 = -_6532;
            float3 param_20 = _9006;
            _9006 = ensure_valid_reflection(param_18, param_19, param_20);
        }
        ...
        tangent = _7542;
        float3 _7546 = cross(_7542, _9006);
        ...
        if (_9069 != 0.0f)
        {
            ...
            float3 param_26 = _9006;
            float param_27 = _9069;
            tangent = rotate_around_axis(param_25, param_26, param_27);
        }
        float3 _7579 = normalize(cross(tangent, _9006));
        _9005 = _7579;
        _9004 = cross(_9006, _7579);
        float3 _9156 = 0.0f.xxx;
        float3 _9155 = 0.0f.xxx;
        float _9160 = 0.0f;
        float _9158 = 0.0f;
        float _9159 = 1.0f;
        ...
        if (_7601)
        {
            ...
            float3 param_29 = _9004;
            float3 param_30 = _9005;
            float3 param_31 = _9006;
            int param_32 = _6565;
            float2 param_33 = float2(_6572, _6579);
            light_sample_t _9171 = { _9155, _9156, _9157, _9158, _9159, _9160, _9161, _9162 };
            light_sample_t param_34 = _9171;
            SampleLightSource(param_28, param_29, param_30, param_31, param_32, param_33, param_34);
            _9155 = param_34.col;
            _9156 = param_34.L;
            _9157 = param_34.lp;
            _9158 = param_34.area;
            _9159 = param_34.dist_mul;
            _9160 = param_34.pdf;
            _9161 = param_34.cast_shadow;
            _9162 = param_34.from_env;
        }
        float _7629 = dot(_9006, _9156);
        float3 base_color = float3(_9462, _9463, _9464);
        [branch]
        if (_9458 != 4294967295u)
        {
            base_color *= SampleBilinear(_9458, _6977, int(get_texture_lod(texSize(_9458), _7211)), _6598, true, true).xyz;
        }
        ...
        float roughness = clamp(float(_9070 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
        [branch]
        if (_9459 != 4294967295u)
        {
            roughness *= SampleBilinear(_9459, _6977, int(get_texture_lod(texSize(_9459), _7211)), _6598, false, true).x;
        }
        ...
        {
            [branch]
            if ((_9160 > 0.0f) && (_7629 > 0.0f))
            {
                light_sample_t _9188 = { _9155, _9156, _9157, _9158, _9159, _9160, _9161, _9162 };
                surface_t _9015 = { _6635, _9004, _9005, _9006, _9007, _6977 };
                float _9693[3] = { _9687, _9688, _9689 };
                float _9658[3] = { _9652, _9653, _9654 };
                float _9623[3] = { _9617, _9618, _9619 };
                shadow_ray_t _9339 = { _9623, _9325, _9658, _9327, _9693, _9329 };
                shadow_ray_t param_35 = _9339;
                float3 _7781 = Evaluate_DiffuseNode(_9188, ray, _9015, base_color, roughness, mix_weight, param_35);
                _9617 = param_35.o[0];
                _9618 = param_35.o[1];
                _9619 = param_35.o[2];
                _9325 = param_35.depth;
                _9652 = param_35.d[0];
                _9653 = param_35.d[1];
                _9654 = param_35.d[2];
                _9327 = param_35.dist;
            ...
            if (_7795)
            {
                surface_t _9022 = { _6635, _9004, _9005, _9006, _9007, _6977 };
                float _9588[3] = { _9582, _9583, _9584 };
                float _9553[3] = { _9547, _9548, _9549 };
                float _9518[3] = { _9512, _9513, _9514 };
                ray_data_t _9238 = { _9518, _9553, _9218, _9588, _9220, _9221, _9222, _9223, _9224 };
                ray_data_t param_36 = _9238;
                Sample_DiffuseNode(ray, _9022, base_color, roughness, _7712, _7721, mix_weight, param_36);
                _9512 = param_36.o[0];
                _9513 = param_36.o[1];
                _9514 = param_36.o[2];
                _9547 = param_36.d[0];
                ...
                _9584 = param_36.c[2];
                _9220 = param_36.ior;
                _9221 = param_36.cone_width;
                _9222 = param_36.cone_spread;
                _9223 = param_36.xy;
                _9224 = param_36.depth;
            }
        }
        else
        {
            ...
            if (_9068 == 1u)
            {
                ...
                if (_7833 && (_7629 > 0.0f))
                {
                    light_sample_t _9197 = { _9155, _9156, _9157, _9158, _9159, _9160, _9161, _9162 };
                    surface_t _9029 = { _6635, _9004, _9005, _9006, _9007, _6977 };
                    float _9700[3] = { _9687, _9688, _9689 };
                    float _9665[3] = { _9652, _9653, _9654 };
                    float _9630[3] = { _9617, _9618, _9619 };
                    shadow_ray_t _9352 = { _9630, _9325, _9665, _9327, _9700, _9329 };
                    shadow_ray_t param_39 = _9352;
                    float3 _7848 = Evaluate_GlossyNode(_9197, ray, _9029, base_color, roughness, 1.5f, _7819, mix_weight, param_39);
                    _9617 = param_39.o[0];
                    _9618 = param_39.o[1];
                    _9619 = param_39.o[2];
                    _9325 = param_39.depth;
                    _9652 = param_39.d[0];
                    _9653 = param_39.d[1];
                    _9654 = param_39.d[2];
                    _9327 = param_39.dist;
                ...
                if (_7862)
                {
                    surface_t _9036 = { _6635, _9004, _9005, _9006, _9007, _6977 };
                    float _9595[3] = { _9582, _9583, _9584 };
                    float _9560[3] = { _9547, _9548, _9549 };
                    float _9525[3] = { _9512, _9513, _9514 };
                    ray_data_t _9257 = { _9525, _9560, _9218, _9595, _9220, _9221, _9222, _9223, _9224 };
                    ray_data_t param_40 = _9257;
                    Sample_GlossyNode(ray, _9036, base_color, roughness, 1.5f, _7819, _7712, _7721, mix_weight, param_40);
                    _9512 = param_40.o[0];
                    _9513 = param_40.o[1];
                    _9514 = param_40.o[2];
                    _9547 = param_40.d[0];
                    ...
                    _9584 = param_40.c[2];
                    _9220 = param_40.ior;
                    _9221 = param_40.cone_width;
                    _9222 = param_40.cone_spread;
                    _9223 = param_40.xy;
                    _9224 = param_40.depth;
                }
            }
            else
            {
                ...
                if (_9068 == 2u)
                {
                    ...
                    if (_7896 && (_7629 < 0.0f))
                    {
                        ...
                        light_sample_t _9206 = { _9155, _9156, _9157, _9158, _9159, _9160, _9161, _9162 };
                        surface_t _9043 = { _6635, _9004, _9005, _9006, _9007, _6977 };
                        float _9707[3] = { _9687, _9688, _9689 };
                        float _9672[3] = { _9652, _9653, _9654 };
                        float _9637[3] = { _9617, _9618, _9619 };
                        shadow_ray_t _9365 = { _9637, _9325, _9672, _9327, _9707, _9329 };
                        shadow_ray_t param_41 = _9365;
                        float3 _7926 = Evaluate_RefractiveNode(_9206, ray, _9043, base_color, _7886, _7904, mix_weight, param_41);
                        _9617 = param_41.o[0];
                        _9618 = param_41.o[1];
                        _9619 = param_41.o[2];
                        _9325 = param_41.depth;
                        _9652 = param_41.d[0];
                        _9653 = param_41.d[1];
                        _9654 = param_41.d[2];
                        _9327 = param_41.dist;
                    ...
                    if (_7940)
                    {
                        surface_t _9050 = { _6635, _9004, _9005, _9006, _9007, _6977 };
                        float _9602[3] = { _9582, _9583, _9584 };
                        float _9567[3] = { _9547, _9548, _9549 };
                        float _9532[3] = { _9512, _9513, _9514 };
                        ray_data_t _9276 = { _9532, _9567, _9218, _9602, _9220, _9221, _9222, _9223, _9224 };
                        ray_data_t param_42 = _9276;
                        Sample_RefractiveNode(ray, _9050, base_color, roughness, _6669, _9071, _7219, _7712, _7721, mix_weight, param_42);
                        _9512 = param_42.o[0];
                        _9513 = param_42.o[1];
                        _9514 = param_42.o[2];
                        _9547 = param_42.d[0];
                        ...
                        _9584 = param_42.c[2];
                        _9220 = param_42.ior;
                        _9221 = param_42.cone_width;
                        _9222 = param_42.cone_spread;
                        _9223 = param_42.xy;
                        _9224 = param_42.depth;
                    }
                }
                else
                {
                    ...
                    if (_9068 == 3u)
                    {
                        col += (base_color * (mix_weight * _9069));
                    }
                    else
                    {
                        [branch]
                        if (_9068 == 6u)
                        {
                            float metallic = clamp(float((_9073 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            [branch]
                            if (_9460 != 4294967295u)
                            {
                                metallic *= SampleBilinear(_9460, _6977, int(get_texture_lod(texSize(_9460), _7211)), _6598).x;
                            }
                            float specular = clamp(float(_9075 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            [branch]
                            if (_9461 != 4294967295u)
                            {
                                specular *= SampleBilinear(_9461, _6977, int(get_texture_lod(texSize(_9461), _7211)), _6598).x;
                            }
                            float _8061 = clamp(float(_9076 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float _8069 = clamp(float((_9076 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float _8077 = 2.0f * clamp(float(_9072 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float3 _8095 = lerp(1.0f.xxx, tint_color, clamp(float((_9072 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * _8077;
                            float3 _8115 = lerp(lerp(1.0f.xxx, tint_color, clamp(float((_9075 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * (specular * 0.07999999821186065673828125f), base_color, metallic.xxx);
                            ...
                            float _8138 = clamp(float((_9070 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            ...
                            float _8170 = mad(roughness - 1.0f, 1.0f - clamp(float((_9074 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), 1.0f);
                            float _8176;
                            if (_6669)
                            {
                                _8176 = _9071 / _7219;
                            ...
                            float param_47 = dot(_6532, _9006);
                            float param_48 = 1.0f / _8176;
                            float _8199 = fresnel_dielectric_cos(param_47, param_48);
                            float param_49 = dot(_6532, _9006);
                            float param_50 = _8124;
                            lobe_weights_t _8238 = get_lobe_weights(lerp(_7666, 1.0f, _8077), lum(lerp(_8115, 1.0f.xxx, ((fresnel_dielectric_cos(param_49, param_50) - _8130) / (1.0f - _8130)).xxx)), specular, metallic, clamp(float(_9074 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), _8061);
                            [branch]
                            if (_9160 > 0.0f)
                            {
                                light_sample_t _9215 = { _9155, _9156, _9157, _9158, _9159, _9160, _9161, _9162 };
                                surface_t _9057 = { _6635, _9004, _9005, _9006, _9007, _6977 };
                                diff_params_t _9407 = { base_color, _8095, roughness };
                                spec_params_t _9422 = { _8115, roughness, _8124, _8130, _8138 };
                                clearcoat_params_t _9435 = { _8069, _8149, _8155 };
                                transmission_params_t _9450 = { _8170, _9071, _8176, _8199, _6669 };
                                float _9714[3] = { _9687, _9688, _9689 };
                                float _9679[3] = { _9652, _9653, _9654 };
                                float _9644[3] = { _9617, _9618, _9619 };
                                shadow_ray_t _9378 = { _9644, _9325, _9679, _9327, _9714, _9329 };
                                shadow_ray_t param_51 = _9378;
                                float3 _8257 = Evaluate_PrincipledNode(_9215, ray, _9057, _8238, _9407, _9422, _9435, _9450, metallic, _7629, mix_weight, param_51);
                                _9617 = param_51.o[0];
                                _9618 = param_51.o[1];
                                _9619 = param_51.o[2];
                                _9325 = param_51.depth;
                                _9652 = param_51.d[0];
                                _9653 = param_51.d[1];
                                _9654 = param_51.d[2];
                                _9327 = param_51.dist;
                            ...
                            surface_t _9064 = { _6635, _9004, _9005, _9006, _9007, _6977 };
                            diff_params_t _9411 = { base_color, _8095, roughness };
                            spec_params_t _9428 = { _8115, roughness, _8124, _8130, _8138 };
                            clearcoat_params_t _9439 = { _8069, _8149, _8155 };
                            transmission_params_t _9456 = { _8170, _9071, _8176, _8199, _6669 };
                            float param_52 = mix_rand;
                            float _9609[3] = { _9582, _9583, _9584 };
                            float _9574[3] = { _9547, _9548, _9549 };
                            float _9539[3] = { _9512, _9513, _9514 };
                            ray_data_t _9295 = { _9539, _9574, _9218, _9609, _9220, _9221, _9222, _9223, _9224 };
                            ray_data_t param_53 = _9295;
                            Sample_PrincipledNode(ray, _9064, _8238, _9411, _9428, _9439, _9456, metallic, _7712, _7721, param_52, mix_weight, param_53);
                            _9512 = param_53.o[0];
                            _9513 = param_53.o[1];
                            _9514 = param_53.o[2];
                            _9547 = param_53.d[0];
                            ...
                            _9584 = param_53.c[2];
                            _9220 = param_53.ior;
                            _9221 = param_53.cone_width;
                            _9222 = param_53.cone_spread;
                            _9223 = param_53.xy;
                            _9224 = param_53.depth;
                        }
                    }
                }
            }
        }
        float _8291 = max(_9582, max(_9583, _9584));
        float _8303;
        ...
        if (_8323)
        {
            ...
            _8363.Store(_8354 * 72 + 0, asuint(_9512));
            _8363.Store(_8354 * 72 + 4, asuint(_9513));
            _8363.Store(_8354 * 72 + 8, asuint(_9514));
            _8363.Store(_8354 * 72 + 12, asuint(_9547));
            _8363.Store(_8354 * 72 + 16, asuint(_9548));
            _8363.Store(_8354 * 72 + 20, asuint(_9549));
            ...
            _8363.Store(_8354 * 72 + 40, asuint(_9220[0]));
            _8363.Store(_8354 * 72 + 44, asuint(_9220[1]));
            _8363.Store(_8354 * 72 + 48, asuint(_9220[2]));
            _8363.Store(_8354 * 72 + 52, asuint(_9220[3]));
            _8363.Store(_8354 * 72 + 56, asuint(_9221));
            _8363.Store(_8354 * 72 + 60, asuint(_9222));
            _8363.Store(_8354 * 72 + 64, uint(_9223));
            _8363.Store(_8354 * 72 + 68, uint(_9224));
        }
        [branch]
        if (max(_9687, max(_9688, _9689)) > 0.0f)
        {
            float3 _8440 = _9157 - float3(_9617, _9618, _9619);
            float _8443 = length(_8440);
            float3 _8447 = _8440 / _8443.xxx;
            float sh_dist = _8443 * _9159;
            if (_9162)
            {
                sh_dist = -sh_dist;
            }
            ...
            _8479.Store(_8471 * 48 + 0, asuint(_9617));
            _8479.Store(_8471 * 48 + 4, asuint(_9618));
            _8479.Store(_8471 * 48 + 8, asuint(_9619));
            _8479.Store(_8471 * 48 + 12, uint(_9325));
            ...
            _8479.Store(_8471 * 48 + 32, asuint(_9687));
            _8479.Store(_8471 * 48 + 36, asuint(_9688));
            _8479.Store(_8471 * 48 + 40, asuint(_9689));
            _8479.Store(_8471 * 48 + 44, uint(_9329));
        }
        _8706 = float3(ray.c[0] * col.x, ray.c[1] * col.y, ray.c[2] * col.z);
        break;
    } while(false);
    return _8706;
}
...
void comp_main()
{
    do
    {
        ...
        hit_data_t _8800 = { _8579.mask, _8579.obj_index, _8579.prim_index, _8579.t, _8579.u, _8579.v };
        hit_data_t param = _8800;
        float _8849[4] = { _8595.ior[0], _8595.ior[1], _8595.ior[2], _8595.ior[3] };
        float _8840[3] = { _8595.c[0], _8595.c[1], _8595.c[2] };
        float _8833[3] = { _8595.d[0], _8595.d[1], _8595.d[2] };
        float _8826[3] = { _8595.o[0], _8595.o[1], _8595.o[2] };
        ray_data_t _8819 = { _8826, _8833, _8595.pdf, _8840, _8849, _8595.cone_width, _8595.cone_spread, _8595.xy, _8595.depth };
        ray_data_t param_1 = _8819;
