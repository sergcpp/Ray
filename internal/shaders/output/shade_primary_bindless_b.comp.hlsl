...
void SampleLightSource(float3 P, float3 T, float3 B, float3 N, int hi, float2 sample_off, inout light_sample_t ls)
{
    ...
    if (_3394 == 0u)
    {
        ...
        float3 _3474 = ((param * _9837.x) + (param_1 * _9837.y)) + (_3431 * _9837.z);
        sampled_dir = _3474;
        ...
        else
        {
            ...
            else
            {
                ...
                if (_6400)
                {
                    ...
                    float4 _10021 = F;
                    float _6514 = _10021.w * lobe_weights.refraction;
                    float4 _10023 = _10021;
                    _10023.w = _6514;
                    F = _10023;
                    new_ray.c[0] = ((ray.c[0] * _10021.x) * mix_weight) / _6514;
                    new_ray.c[1] = ((ray.c[1] * _10021.y) * mix_weight) / _6514;
                    new_ray.c[2] = ((ray.c[2] * _10021.z) * mix_weight) / _6514;
                    new_ray.pdf = _6514;
                    new_ray.d[0] = V.x;
                    new_ray.d[1] = V.y;
                    new_ray.d[2] = V.z;
...
float3 ShadeSurface(hit_data_t inter, ray_data_t ray, inout float3 out_base_color, inout float3 out_normals)
{
    ...
    do
    {
        ...
        if (inter.mask == 0)
        {
            ...
            _8719 = float3(ray.c[0] * _6579.x, ray.c[1] * _6579.y, ray.c[2] * _6579.z);
            break;
        }
        ...
        if (inter.obj_index < 0)
        {
            ...
            _8719 = float3(ray.c[0] * _6618.x, ray.c[1] * _6618.y, ray.c[2] * _6618.z);
            break;
        }
        ...
        uint _9470 = _6661.textures[0];
        uint _9471 = _6661.textures[1];
        uint _9472 = _6661.textures[2];
        uint _9473 = _6661.textures[3];
        uint _9474 = _6661.textures[4];
        float _9475 = _6661.base_color[0];
        float _9476 = _6661.base_color[1];
        float _9477 = _6661.base_color[2];
        uint _9080 = _6661.flags;
        uint _9081 = _6661.type;
        float _9082 = _6661.tangent_rotation_or_strength;
        uint _9083 = _6661.roughness_and_anisotropic;
        float _9084 = _6661.ior;
        uint _9085 = _6661.sheen_and_sheen_tint;
        uint _9086 = _6661.tint_and_metallic;
        uint _9087 = _6661.transmission_and_transmission_roughness;
        uint _9088 = _6661.specular_and_specular_tint;
        uint _9089 = _6661.clearcoat_and_clearcoat_roughness;
        uint _9090 = _6661.normal_map_strength_unorm;
        transform_t _6716;
        ...
        float3 _9018 = _7005;
        float3 _9017 = cross(_7005, _6921);
        if (_6639)
        {
            ...
            _9470 = _7031.textures[0];
            _9471 = _7031.textures[1];
            _9472 = _7031.textures[2];
            _9473 = _7031.textures[3];
            _9474 = _7031.textures[4];
            _9475 = _7031.base_color[0];
            _9476 = _7031.base_color[1];
            _9477 = _7031.base_color[2];
            _9080 = _7031.flags;
            _9081 = _7031.type;
            _9082 = _7031.tangent_rotation_or_strength;
            _9083 = _7031.roughness_and_anisotropic;
            _9084 = _7031.ior;
            _9085 = _7031.sheen_and_sheen_tint;
            _9086 = _7031.tint_and_metallic;
            _9087 = _7031.transmission_and_transmission_roughness;
            _9088 = _7031.specular_and_specular_tint;
            _9089 = _7031.clearcoat_and_clearcoat_roughness;
            _9090 = _7031.normal_map_strength_unorm;
            _9020 = -_9020;
            _9019 = -_9019;
            _9018 = -_9018;
            _9017 = -_9017;
        ...
        while (_9081 == 4u)
        {
            ...
            {
                mix_val *= SampleBilinear(_9471, _6947, 0).x;
            }
            if (_6639)
            {
                _7275 = _7204 / _9084;
            ...
            if (_9084 != 0.0f)
            {
                float param_16 = dot(_6570, _9019);
            ...
            if (mix_rand > _7308)
            {
                ...
                {
                    _7331.textures[_80ident] = _4455.Load(_80ident * 4 + _9473 * 76 + 0);
                }
                [unroll]
                for (int _81ident = 0; _81ident < 3; _81ident++)
                {
                    _7331.base_color[_81ident] = asfloat(_4455.Load(_81ident * 4 + _9473 * 76 + 20));
                }
                _7331.flags = _4455.Load(_9473 * 76 + 32);
                _7331.type = _4455.Load(_9473 * 76 + 36);
                _7331.tangent_rotation_or_strength = asfloat(_4455.Load(_9473 * 76 + 40));
                _7331.roughness_and_anisotropic = _4455.Load(_9473 * 76 + 44);
                _7331.ior = asfloat(_4455.Load(_9473 * 76 + 48));
                _7331.sheen_and_sheen_tint = _4455.Load(_9473 * 76 + 52);
                _7331.tint_and_metallic = _4455.Load(_9473 * 76 + 56);
                _7331.transmission_and_transmission_roughness = _4455.Load(_9473 * 76 + 60);
                _7331.specular_and_specular_tint = _4455.Load(_9473 * 76 + 64);
                _7331.clearcoat_and_clearcoat_roughness = _4455.Load(_9473 * 76 + 68);
                _7331.normal_map_strength_unorm = _4455.Load(_9473 * 76 + 72);
                _9470 = _7331.textures[0];
                _9471 = _7331.textures[1];
                _9472 = _7331.textures[2];
                _9473 = _7331.textures[3];
                _9474 = _7331.textures[4];
                _9475 = _7331.base_color[0];
                _9476 = _7331.base_color[1];
                _9477 = _7331.base_color[2];
                _9080 = _7331.flags;
                _9081 = _7331.type;
                _9082 = _7331.tangent_rotation_or_strength;
                _9083 = _7331.roughness_and_anisotropic;
                _9084 = _7331.ior;
                _9085 = _7331.sheen_and_sheen_tint;
                _9086 = _7331.tint_and_metallic;
                _9087 = _7331.transmission_and_transmission_roughness;
                _9088 = _7331.specular_and_specular_tint;
                _9089 = _7331.clearcoat_and_clearcoat_roughness;
                _9090 = _7331.normal_map_strength_unorm;
            ...
            else
            {
                ...
                {
                    _7397.textures[_82ident] = _4455.Load(_82ident * 4 + _9474 * 76 + 0);
                }
                [unroll]
                for (int _83ident = 0; _83ident < 3; _83ident++)
                {
                    _7397.base_color[_83ident] = asfloat(_4455.Load(_83ident * 4 + _9474 * 76 + 20));
                }
                _7397.flags = _4455.Load(_9474 * 76 + 32);
                _7397.type = _4455.Load(_9474 * 76 + 36);
                _7397.tangent_rotation_or_strength = asfloat(_4455.Load(_9474 * 76 + 40));
                _7397.roughness_and_anisotropic = _4455.Load(_9474 * 76 + 44);
                _7397.ior = asfloat(_4455.Load(_9474 * 76 + 48));
                _7397.sheen_and_sheen_tint = _4455.Load(_9474 * 76 + 52);
                _7397.tint_and_metallic = _4455.Load(_9474 * 76 + 56);
                _7397.transmission_and_transmission_roughness = _4455.Load(_9474 * 76 + 60);
                _7397.specular_and_specular_tint = _4455.Load(_9474 * 76 + 64);
                _7397.clearcoat_and_clearcoat_roughness = _4455.Load(_9474 * 76 + 68);
                _7397.normal_map_strength_unorm = _4455.Load(_9474 * 76 + 72);
                _9470 = _7397.textures[0];
                _9471 = _7397.textures[1];
                _9472 = _7397.textures[2];
                _9473 = _7397.textures[3];
                _9474 = _7397.textures[4];
                _9475 = _7397.base_color[0];
                _9476 = _7397.base_color[1];
                _9477 = _7397.base_color[2];
                _9080 = _7397.flags;
                _9081 = _7397.type;
                _9082 = _7397.tangent_rotation_or_strength;
                _9083 = _7397.roughness_and_anisotropic;
                _9084 = _7397.ior;
                _9085 = _7397.sheen_and_sheen_tint;
                _9086 = _7397.tint_and_metallic;
                _9087 = _7397.transmission_and_transmission_roughness;
                _9088 = _7397.specular_and_specular_tint;
                _9089 = _7397.clearcoat_and_clearcoat_roughness;
                _9090 = _7397.normal_map_strength_unorm;
                mix_rand /= mix_val;
            }
        }
        [branch]
        ...
        {
            float3 normals = (float3(SampleBilinear(_9470, _6947, 0).xy, 1.0f) * 2.0f) - 1.0f.xxx;
            ...
            float3 _7479 = _9019;
            _9019 = normalize(((_9017 * normals.x) + (_7479 * normals.z)) + (_9018 * normals.y));
            if ((_9090 & 65535u) != 65535u)
            {
                _9019 = normalize(_7479 + ((_9019 - _7479) * clamp(float(_9090 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f)));
            }
        ...
        tangent = _7558;
        float3 _7562 = cross(_7558, _9019);
        ...
        float3 _7595 = normalize(cross(tangent, _9019));
        _9018 = _7595;
        _9017 = cross(_9019, _7595);
        ...
        float _7645 = dot(_9019, _9169);
        float3 base_color = float3(_9475, _9476, _9477);
        [branch]
        if (_9471 != 4294967295u)
        {
            base_color *= SampleBilinear(_9471, _6947, int(get_texture_lod(texSize(_9471), _7181)), true, true).xyz;
        }
        ...
        {
            roughness *= SampleBilinear(_9472, _6947, int(get_texture_lod(texSize(_9472), _7181)), false, true).x;
        }
        ...
        {
            [branch]
            if ((_9173 > 0.0f) && (_7645 > 0.0f))
            {
                light_sample_t _9201 = { _9168, _9169, _9170, _9171, _9172, _9173, _9174, _9175 };
                surface_t _9028 = { _6606, _9017, _9018, _9019, _9020, _6947 };
                ...
                float3 _7795 = Evaluate_DiffuseNode(_9201, ray, _9028, base_color, roughness, mix_weight, param_35);
                _9630 = param_35.o[0];
                _9631 = param_35.o[1];
                _9632 = param_35.o[2];
            ...
            if (_7809)
            {
                surface_t _9035 = { _6606, _9017, _9018, _9019, _9020, _6947 };
                ...
                Sample_DiffuseNode(ray, _9035, base_color, roughness, _7726, _7735, mix_weight, param_36);
                _9525 = param_36.o[0];
                _9526 = param_36.o[1];
                _9527 = param_36.o[2];
                _9560 = param_36.d[0];
        ...
        else
        {
            ...
            if (_9081 == 1u)
            {
                ...
                if (_7847 && (_7645 > 0.0f))
                {
                    ...
                    surface_t _9042 = { _6606, _9017, _9018, _9019, _9020, _6947 };
                    ...
                    float3 _7862 = Evaluate_GlossyNode(_9210, ray, _9042, base_color, roughness, 1.5f, _7833, mix_weight, param_39);
                    _9630 = param_39.o[0];
                    _9631 = param_39.o[1];
                    _9632 = param_39.o[2];
                ...
                if (_7876)
                {
                    surface_t _9049 = { _6606, _9017, _9018, _9019, _9020, _6947 };
                    ...
                    Sample_GlossyNode(ray, _9049, base_color, roughness, 1.5f, _7833, _7726, _7735, mix_weight, param_40);
                    _9525 = param_40.o[0];
                    _9526 = param_40.o[1];
                    _9527 = param_40.o[2];
                    _9560 = param_40.d[0];
            ...
            else
            {
                ...
                if (_9081 == 2u)
                {
                    ...
                    if (_7910 && (_7645 < 0.0f))
                    {
                        ...
                        surface_t _9056 = { _6606, _9017, _9018, _9019, _9020, _6947 };
                        ...
                        float3 _7940 = Evaluate_RefractiveNode(_9219, ray, _9056, base_color, _7900, _7918, mix_weight, param_41);
                        _9630 = param_41.o[0];
                        _9631 = param_41.o[1];
                        _9632 = param_41.o[2];
                    ...
                    if (_7954)
                    {
                        surface_t _9063 = { _6606, _9017, _9018, _9019, _9020, _6947 };
                        ...
                        Sample_RefractiveNode(ray, _9063, base_color, roughness, _6639, _9084, _7204, _7726, _7735, mix_weight, param_42);
                        _9525 = param_42.o[0];
                        _9526 = param_42.o[1];
                        _9527 = param_42.o[2];
                        _9560 = param_42.d[0];
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (_9081 == 6u)
                        {
                            ...
                            {
                                metallic *= SampleBilinear(_9473, _6947, int(get_texture_lod(texSize(_9473), _7181))).x;
                            }
                            float specular = clamp(float(_9088 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            [branch]
                            if (_9474 != 4294967295u)
                            {
                                specular *= SampleBilinear(_9474, _6947, int(get_texture_lod(texSize(_9474), _7181))).x;
                            }
                            float _8073 = clamp(float(_9089 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float _8081 = clamp(float((_9089 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float _8089 = 2.0f * clamp(float(_9085 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float3 _8107 = lerp(1.0f.xxx, tint_color, clamp(float((_9085 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * _8089;
                            float3 _8127 = lerp(lerp(1.0f.xxx, tint_color, clamp(float((_9088 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * (specular * 0.07999999821186065673828125f), base_color, metallic.xxx);
                            ...
                            float _8150 = clamp(float((_9083 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            ...
                            float _8182 = mad(roughness - 1.0f, 1.0f - clamp(float((_9087 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), 1.0f);
                            float _8188;
                            if (_6639)
                            {
                                _8188 = _9084 / _7204;
                            ...
                            float param_47 = dot(_6570, _9019);
                            float param_48 = 1.0f / _8188;
                            float _8211 = fresnel_dielectric_cos(param_47, param_48);
                            float param_49 = dot(_6570, _9019);
                            float param_50 = _8136;
                            lobe_weights_t _8250 = get_lobe_weights(lerp(_7681, 1.0f, _8089), lum(lerp(_8127, 1.0f.xxx, ((fresnel_dielectric_cos(param_49, param_50) - _8142) / (1.0f - _8142)).xxx)), specular, metallic, clamp(float(_9087 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), _8073);
                            [branch]
                            if (_9173 > 0.0f)
                            {
                                light_sample_t _9228 = { _9168, _9169, _9170, _9171, _9172, _9173, _9174, _9175 };
                                surface_t _9070 = { _6606, _9017, _9018, _9019, _9020, _6947 };
                                diff_params_t _9420 = { base_color, _8107, roughness };
                                spec_params_t _9435 = { _8127, roughness, _8136, _8142, _8150 };
                                clearcoat_params_t _9448 = { _8081, _8161, _8167 };
                                transmission_params_t _9463 = { _8182, _9084, _8188, _8211, _6639 };
                                ...
                                float3 _8269 = Evaluate_PrincipledNode(_9228, ray, _9070, _8250, _9420, _9435, _9448, _9463, metallic, _7645, mix_weight, param_51);
                                _9630 = param_51.o[0];
                                _9631 = param_51.o[1];
                                _9632 = param_51.o[2];
                            ...
                            surface_t _9077 = { _6606, _9017, _9018, _9019, _9020, _6947 };
                            diff_params_t _9424 = { base_color, _8107, roughness };
                            spec_params_t _9441 = { _8127, roughness, _8136, _8142, _8150 };
                            clearcoat_params_t _9452 = { _8081, _8161, _8167 };
                            transmission_params_t _9469 = { _8182, _9084, _8188, _8211, _6639 };
                            ...
                            Sample_PrincipledNode(ray, _9077, _8250, _9424, _9441, _9452, _9469, metallic, _7726, _7735, param_52, mix_weight, param_53);
                            _9525 = param_53.o[0];
                            _9526 = param_53.o[1];
                            _9527 = param_53.o[2];
                            _9560 = param_53.d[0];
        ...
        float _8303 = max(_9595, max(_9596, _9597));
        float _8315;
        ...
        if (_8335)
        {
            ...
            _8375.Store(_8366 * 72 + 0, asuint(_9525));
            _8375.Store(_8366 * 72 + 4, asuint(_9526));
            _8375.Store(_8366 * 72 + 8, asuint(_9527));
            _8375.Store(_8366 * 72 + 12, asuint(_9560));
            _8375.Store(_8366 * 72 + 16, asuint(_9561));
            _8375.Store(_8366 * 72 + 20, asuint(_9562));
            ...
            _8375.Store(_8366 * 72 + 40, asuint(_9233[0]));
            _8375.Store(_8366 * 72 + 44, asuint(_9233[1]));
            _8375.Store(_8366 * 72 + 48, asuint(_9233[2]));
            _8375.Store(_8366 * 72 + 52, asuint(_9233[3]));
            _8375.Store(_8366 * 72 + 56, asuint(_9234));
            _8375.Store(_8366 * 72 + 60, asuint(_9235));
            _8375.Store(_8366 * 72 + 64, uint(_9236));
            _8375.Store(_8366 * 72 + 68, uint(_9237));
        }
        [branch]
        if (max(_9700, max(_9701, _9702)) > 0.0f)
        {
            float3 _8452 = _9170 - float3(_9630, _9631, _9632);
            float _8455 = length(_8452);
            float3 _8459 = _8452 / _8455.xxx;
            float sh_dist = _8455 * _9172;
            if (_9175)
            {
                sh_dist = -sh_dist;
            }
            ...
            _8491.Store(_8483 * 48 + 0, asuint(_9630));
            _8491.Store(_8483 * 48 + 4, asuint(_9631));
            _8491.Store(_8483 * 48 + 8, asuint(_9632));
            _8491.Store(_8483 * 48 + 12, uint(_9338));
            ...
            _8491.Store(_8483 * 48 + 32, asuint(_9700));
            _8491.Store(_8483 * 48 + 36, asuint(_9701));
            _8491.Store(_8483 * 48 + 40, asuint(_9702));
            _8491.Store(_8483 * 48 + 44, uint(_9342));
        }
...
void comp_main()
{
    do
    {
        ...
        hit_data_t _8813 = { _8593.mask, _8593.obj_index, _8593.prim_index, _8593.t, _8593.u, _8593.v };
        hit_data_t param = _8813;
        float _8862[4] = { _8613.ior[0], _8613.ior[1], _8613.ior[2], _8613.ior[3] };
        float _8853[3] = { _8613.c[0], _8613.c[1], _8613.c[2] };
        float _8846[3] = { _8613.d[0], _8613.d[1], _8613.d[2] };
        float _8839[3] = { _8613.o[0], _8613.o[1], _8613.o[2] };
        ray_data_t _8832 = { _8839, _8846, _8613.pdf, _8853, _8862, _8613.cone_width, _8613.cone_spread, _8613.xy, _8613.depth };
