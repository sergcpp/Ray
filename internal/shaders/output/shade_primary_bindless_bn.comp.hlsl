...
ByteAddressBuffer _8724 : register(t10, space0);
...
float3 ensure_valid_reflection(float3 Ng, float3 I, float3 N)
{
    ...
    do
    {
        ...
        if (_1379 && _1385)
        {
            float _10083 = (-0.5f) / _1339;
            float param_1 = mad(_10083, _1363, 1.0f);
            float _1395 = safe_sqrtf(param_1);
            float param_2 = _1364;
            float _1398 = safe_sqrtf(param_2);
            float2 _1399 = float2(_1395, _1398);
            float param_3 = mad(_10083, _1370, 1.0f);
            float _1404 = safe_sqrtf(param_3);
            float param_4 = _1371;
            float _1407 = safe_sqrtf(param_4);
            float2 _1408 = float2(_1404, _1407);
            float _10085 = -_1327;
            float _1424 = mad(2.0f * mad(_1395, _1323, _1398 * _1327), _1398, _10085);
            float _1440 = mad(2.0f * mad(_1404, _1323, _1407 * _1327), _1407, _10085);
        ...
        _8741 = (_1319 * N_new.x) + (Ng * N_new.y);
        break;
    } while(false);
    return _8741;
}
...
float3 MapToCone(float r1, float r2, float3 N, float radius)
{
    ...
    do
    {
        ...
        _8766 = (N + (param * ((radius * r) * cos(theta)))) + (param_1 * ((radius * r) * sin(theta)));
        break;
    } while(false);
    return _8766;
}
...
void SampleLightSource(float3 P, float3 T, float3 B, float3 N, int hi, float2 sample_off, inout light_sample_t ls)
{
    ...
    if (_3394 == 0u)
    {
        ...
        float3 _9849 = sampled_dir;
        float3 _3474 = ((param * _9849.x) + (param_1 * _9849.y)) + (_3431 * _9849.z);
        sampled_dir = _3474;
...
float D_GGX(float3 H, float alpha_x, float alpha_y)
{
    ...
    do
    {
        ...
        _8799 = 1.0f / (((((_2047 * _2047) * 3.1415927410125732421875f) * alpha_x) * alpha_y) * (((H.z * H.z) * H.z) * H.z));
        break;
    } while(false);
    return _8799;
}
...
float4 Sample_GGXSpecular_BSDF(float3 T, float3 B, float3 N, float3 I, float roughness, float anisotropic, float spec_ior, float spec_F0, float3 spec_col, float rand_u, float rand_v, inout float3 out_V)
{
    ...
    do
    {
        ...
        if ((_2658 * _2662) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            out_V = _2673;
            _8771 = float4(_2687.x * 1000000.0f, _2687.y * 1000000.0f, _2687.z * 1000000.0f, 1000000.0f);
            break;
        }
        float3 param_2 = T;
        float3 param_3 = B;
        ...
        _8771 = Evaluate_GGXSpecular_BSDF(param_14, param_15, param_16, param_17, param_18, param_19, param_20, param_21);
        break;
    } while(false);
    return _8771;
}
...
float4 Evaluate_GGXRefraction_BSDF(float3 view_dir_ts, float3 sampled_normal_ts, float3 refr_dir_ts, float roughness2, float eta, float3 refr_col)
{
    ...
    do
    {
        ...
        _8776 = float4(refr_col * (((((_2970 * _2986) * _2978) * clamp(dot(view_dir_ts, sampled_normal_ts), 0.0f, 1.0f)) * _3006) / view_dir_ts.z), (((_2970 * _2978) * clamp(dot(view_dir_ts, sampled_normal_ts), 0.0f, 1.0f)) * _3006) / view_dir_ts.z);
        break;
    } while(false);
    return _8776;
}
...
float4 Sample_GGXRefraction_BSDF(float3 T, float3 B, float3 N, float3 I, float roughness, float eta, float3 refr_col, float rand_u, float rand_v, inout float4 out_V)
{
    ...
    do
    {
        ...
        if ((_3050 * _3050) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            _8781 = float4(refr_col.x * 1000000.0f, refr_col.y * 1000000.0f, refr_col.z * 1000000.0f, 1000000.0f);
            break;
        }
        float3 param = T;
        float3 param_1 = B;
        ...
        _8781 = Evaluate_GGXRefraction_BSDF(param_8, param_9, param_10, param_11, param_12, param_13);
        break;
    } while(false);
    return _8781;
}
...
lobe_weights_t get_lobe_weights(float base_color_lum, float spec_color_lum, float specular, float metallic, float transmission, float clearcoat)
{
    ...
    float _8875 = (base_color_lum * _1502) * (1.0f - transmission);
    ...
    float _8877 = _1523 * _1502;
    float _8878 = _1509 * base_color_lum;
    float _1532 = _8875;
    ...
    lobe_weights_t _8883 = { _8875, _8876, _8877, _8878 };
    return _8883;
}
...
float BRDF_PrincipledDiffuse(float3 V, float3 N, float3 L, float3 H, float roughness)
{
    ...
    do
    {
        ...
        _8804 = lerp(1.0f, _2287, schlick_weight(param)) * lerp(1.0f, _2287, schlick_weight(param_1));
        break;
    } while(false);
    return _8804;
}
...
float D_GTR1(float NDotH, float a)
{
    ...
    do
    {
        if (a >= 1.0f)
        {
            _8809 = 0.3183098733425140380859375f;
            break;
        }
        float _2006 = mad(a, a, -1.0f);
        _8809 = _2006 / ((3.1415927410125732421875f * log(a * a)) * mad(_2006 * NDotH, NDotH, 1.0f));
        break;
    } while(false);
    return _8809;
}
...
float4 Sample_PrincipledClearcoat_BSDF(float3 T, float3 B, float3 N, float3 I, float clearcoat_roughness2, float clearcoat_ior, float clearcoat_F0, float rand_u, float rand_v, inout float3 out_V)
{
    ...
    do
    {
        ...
        if ((clearcoat_roughness2 * clearcoat_roughness2) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            _8794 = float4(_2887, _2887, _2887, 1000000.0f);
            break;
        }
        float3 param_2 = T;
        float3 param_3 = B;
        ...
        _8794 = Evaluate_PrincipledClearcoat_BSDF(param_14, param_15, param_16, param_17, param_18, param_19);
        break;
    } while(false);
    return _8794;
}
        ...
        else
        {
            ...
            else
            {
                ...
                if (_6400)
                {
                    ...
                    float4 _10033 = F;
                    float _6514 = _10033.w * lobe_weights.refraction;
                    float4 _10035 = _10033;
                    _10035.w = _6514;
                    F = _10035;
                    new_ray.c[0] = ((ray.c[0] * _10033.x) * mix_weight) / _6514;
                    new_ray.c[1] = ((ray.c[1] * _10033.y) * mix_weight) / _6514;
                    new_ray.c[2] = ((ray.c[2] * _10033.z) * mix_weight) / _6514;
                    new_ray.pdf = _6514;
                    new_ray.d[0] = V.x;
                    new_ray.d[1] = V.y;
                    new_ray.d[2] = V.z;
...
float3 ShadeSurface(hit_data_t inter, ray_data_t ray, inout float3 out_base_color, inout float3 out_normals)
{
    ...
    do
    {
        ...
        if (inter.mask == 0)
        {
            ...
            _8731 = float3(ray.c[0] * _6579.x, ray.c[1] * _6579.y, ray.c[2] * _6579.z);
            break;
        }
        ...
        if (inter.obj_index < 0)
        {
            ...
            _8731 = float3(ray.c[0] * _6618.x, ray.c[1] * _6618.y, ray.c[2] * _6618.z);
            break;
        }
        ...
        uint _9482 = _6661.textures[0];
        uint _9483 = _6661.textures[1];
        uint _9484 = _6661.textures[2];
        uint _9485 = _6661.textures[3];
        uint _9486 = _6661.textures[4];
        float _9487 = _6661.base_color[0];
        float _9488 = _6661.base_color[1];
        float _9489 = _6661.base_color[2];
        uint _9092 = _6661.flags;
        uint _9093 = _6661.type;
        float _9094 = _6661.tangent_rotation_or_strength;
        uint _9095 = _6661.roughness_and_anisotropic;
        float _9096 = _6661.ior;
        uint _9097 = _6661.sheen_and_sheen_tint;
        uint _9098 = _6661.tint_and_metallic;
        uint _9099 = _6661.transmission_and_transmission_roughness;
        uint _9100 = _6661.specular_and_specular_tint;
        uint _9101 = _6661.clearcoat_and_clearcoat_roughness;
        uint _9102 = _6661.normal_map_strength_unorm;
        transform_t _6716;
        ...
        float3 _9030 = _7005;
        float3 _9029 = cross(_7005, _6921);
        if (_6639)
        {
            ...
            _9482 = _7031.textures[0];
            _9483 = _7031.textures[1];
            _9484 = _7031.textures[2];
            _9485 = _7031.textures[3];
            _9486 = _7031.textures[4];
            _9487 = _7031.base_color[0];
            _9488 = _7031.base_color[1];
            _9489 = _7031.base_color[2];
            _9092 = _7031.flags;
            _9093 = _7031.type;
            _9094 = _7031.tangent_rotation_or_strength;
            _9095 = _7031.roughness_and_anisotropic;
            _9096 = _7031.ior;
            _9097 = _7031.sheen_and_sheen_tint;
            _9098 = _7031.tint_and_metallic;
            _9099 = _7031.transmission_and_transmission_roughness;
            _9100 = _7031.specular_and_specular_tint;
            _9101 = _7031.clearcoat_and_clearcoat_roughness;
            _9102 = _7031.normal_map_strength_unorm;
            _9032 = -_9032;
            _9031 = -_9031;
            _9030 = -_9030;
            _9029 = -_9029;
        }
        float3 param_3 = _9032;
        float4x4 param_4 = _6716.inv_xform;
        _9032 = TransformNormal(param_3, param_4);
        float3 param_5 = _9031;
        float4x4 param_6 = _6716.inv_xform;
        _9031 = TransformNormal(param_5, param_6);
        float3 param_7 = _9030;
        float4x4 param_8 = _6716.inv_xform;
        _9030 = TransformNormal(param_7, param_8);
        float3 param_9 = _9029;
        float4x4 param_10 = _6716.inv_xform;
        _9032 = normalize(_9032);
        _9031 = normalize(_9031);
        _9030 = normalize(_9030);
        _9029 = normalize(TransformNormal(param_9, param_10));
        ...
        while (_9093 == 4u)
        {
            ...
            {
                mix_val *= SampleBilinear(_9483, _6947, 0).x;
            }
            if (_6639)
            {
                _7275 = _7204 / _9096;
            ...
            if (_9096 != 0.0f)
            {
                float param_16 = dot(_6570, _9031);
            ...
            if (mix_rand > _7308)
            {
                ...
                {
                    _7331.textures[_80ident] = _4455.Load(_80ident * 4 + _9485 * 76 + 0);
                }
                [unroll]
                for (int _81ident = 0; _81ident < 3; _81ident++)
                {
                    _7331.base_color[_81ident] = asfloat(_4455.Load(_81ident * 4 + _9485 * 76 + 20));
                }
                _7331.flags = _4455.Load(_9485 * 76 + 32);
                _7331.type = _4455.Load(_9485 * 76 + 36);
                _7331.tangent_rotation_or_strength = asfloat(_4455.Load(_9485 * 76 + 40));
                _7331.roughness_and_anisotropic = _4455.Load(_9485 * 76 + 44);
                _7331.ior = asfloat(_4455.Load(_9485 * 76 + 48));
                _7331.sheen_and_sheen_tint = _4455.Load(_9485 * 76 + 52);
                _7331.tint_and_metallic = _4455.Load(_9485 * 76 + 56);
                _7331.transmission_and_transmission_roughness = _4455.Load(_9485 * 76 + 60);
                _7331.specular_and_specular_tint = _4455.Load(_9485 * 76 + 64);
                _7331.clearcoat_and_clearcoat_roughness = _4455.Load(_9485 * 76 + 68);
                _7331.normal_map_strength_unorm = _4455.Load(_9485 * 76 + 72);
                _9482 = _7331.textures[0];
                _9483 = _7331.textures[1];
                _9484 = _7331.textures[2];
                _9485 = _7331.textures[3];
                _9486 = _7331.textures[4];
                _9487 = _7331.base_color[0];
                _9488 = _7331.base_color[1];
                _9489 = _7331.base_color[2];
                _9092 = _7331.flags;
                _9093 = _7331.type;
                _9094 = _7331.tangent_rotation_or_strength;
                _9095 = _7331.roughness_and_anisotropic;
                _9096 = _7331.ior;
                _9097 = _7331.sheen_and_sheen_tint;
                _9098 = _7331.tint_and_metallic;
                _9099 = _7331.transmission_and_transmission_roughness;
                _9100 = _7331.specular_and_specular_tint;
                _9101 = _7331.clearcoat_and_clearcoat_roughness;
                _9102 = _7331.normal_map_strength_unorm;
            ...
            else
            {
                ...
                {
                    _7397.textures[_82ident] = _4455.Load(_82ident * 4 + _9486 * 76 + 0);
                }
                [unroll]
                for (int _83ident = 0; _83ident < 3; _83ident++)
                {
                    _7397.base_color[_83ident] = asfloat(_4455.Load(_83ident * 4 + _9486 * 76 + 20));
                }
                _7397.flags = _4455.Load(_9486 * 76 + 32);
                _7397.type = _4455.Load(_9486 * 76 + 36);
                _7397.tangent_rotation_or_strength = asfloat(_4455.Load(_9486 * 76 + 40));
                _7397.roughness_and_anisotropic = _4455.Load(_9486 * 76 + 44);
                _7397.ior = asfloat(_4455.Load(_9486 * 76 + 48));
                _7397.sheen_and_sheen_tint = _4455.Load(_9486 * 76 + 52);
                _7397.tint_and_metallic = _4455.Load(_9486 * 76 + 56);
                _7397.transmission_and_transmission_roughness = _4455.Load(_9486 * 76 + 60);
                _7397.specular_and_specular_tint = _4455.Load(_9486 * 76 + 64);
                _7397.clearcoat_and_clearcoat_roughness = _4455.Load(_9486 * 76 + 68);
                _7397.normal_map_strength_unorm = _4455.Load(_9486 * 76 + 72);
                _9482 = _7397.textures[0];
                _9483 = _7397.textures[1];
                _9484 = _7397.textures[2];
                _9485 = _7397.textures[3];
                _9486 = _7397.textures[4];
                _9487 = _7397.base_color[0];
                _9488 = _7397.base_color[1];
                _9489 = _7397.base_color[2];
                _9092 = _7397.flags;
                _9093 = _7397.type;
                _9094 = _7397.tangent_rotation_or_strength;
                _9095 = _7397.roughness_and_anisotropic;
                _9096 = _7397.ior;
                _9097 = _7397.sheen_and_sheen_tint;
                _9098 = _7397.tint_and_metallic;
                _9099 = _7397.transmission_and_transmission_roughness;
                _9100 = _7397.specular_and_specular_tint;
                _9101 = _7397.clearcoat_and_clearcoat_roughness;
                _9102 = _7397.normal_map_strength_unorm;
                mix_rand /= mix_val;
            }
        }
        [branch]
        ...
        {
            float3 normals = (float3(SampleBilinear(_9482, _6947, 0).xy, 1.0f) * 2.0f) - 1.0f.xxx;
            if ((_9482 & 33554432u) != 0u)
            {
                float3 _10054 = normals;
                _10054.z = sqrt(1.0f - dot(normals.xy, normals.xy));
                normals = _10054;
            }
            float3 _7479 = _9031;
            _9031 = normalize(((_9029 * normals.x) + (_7479 * normals.z)) + (_9030 * normals.y));
            if ((_9102 & 65535u) != 65535u)
            {
                _9031 = normalize(_7479 + ((_9031 - _7479) * clamp(float(_9102 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f)));
            }
            float3 param_18 = _9032;
            float3 param_19 = -_6570;
            float3 param_20 = _9031;
            _9031 = ensure_valid_reflection(param_18, param_19, param_20);
        }
        ...
        tangent = _7558;
        float3 _7562 = cross(_7558, _9031);
        ...
        if (_9094 != 0.0f)
        {
            ...
            float3 param_26 = _9031;
            float param_27 = _9094;
            tangent = rotate_around_axis(param_25, param_26, param_27);
        }
        float3 _7595 = normalize(cross(tangent, _9031));
        _9030 = _7595;
        _9029 = cross(_9031, _7595);
        float3 _9181 = 0.0f.xxx;
        float3 _9180 = 0.0f.xxx;
        float _9185 = 0.0f;
        float _9183 = 0.0f;
        float _9184 = 1.0f;
        ...
        if (_7617)
        {
            ...
            float3 param_29 = _9029;
            float3 param_30 = _9030;
            float3 param_31 = _9031;
            int param_32 = _7238;
            float2 param_33 = float2(_7188, _7195);
            light_sample_t _9196 = { _9180, _9181, _9182, _9183, _9184, _9185, _9186, _9187 };
            light_sample_t param_34 = _9196;
            SampleLightSource(param_28, param_29, param_30, param_31, param_32, param_33, param_34);
            _9180 = param_34.col;
            _9181 = param_34.L;
            _9182 = param_34.lp;
            _9183 = param_34.area;
            _9184 = param_34.dist_mul;
            _9185 = param_34.pdf;
            _9186 = param_34.cast_shadow;
            _9187 = param_34.from_env;
        }
        float _7645 = dot(_9031, _9181);
        float3 base_color = float3(_9487, _9488, _9489);
        [branch]
        if (_9483 != 4294967295u)
        {
            base_color *= SampleBilinear(_9483, _6947, int(get_texture_lod(texSize(_9483), _7181)), true, true).xyz;
        }
        ...
        float roughness = clamp(float(_9095 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
        [branch]
        if (_9484 != 4294967295u)
        {
            roughness *= SampleBilinear(_9484, _6947, int(get_texture_lod(texSize(_9484), _7181)), false, true).x;
        }
        ...
        {
            [branch]
            if ((_9185 > 0.0f) && (_7645 > 0.0f))
            {
                light_sample_t _9213 = { _9180, _9181, _9182, _9183, _9184, _9185, _9186, _9187 };
                surface_t _9040 = { _6606, _9029, _9030, _9031, _9032, _6947 };
                float _9718[3] = { _9712, _9713, _9714 };
                float _9683[3] = { _9677, _9678, _9679 };
                float _9648[3] = { _9642, _9643, _9644 };
                shadow_ray_t _9364 = { _9648, _9350, _9683, _9352, _9718, _9354 };
                shadow_ray_t param_35 = _9364;
                float3 _7795 = Evaluate_DiffuseNode(_9213, ray, _9040, base_color, roughness, mix_weight, param_35);
                _9642 = param_35.o[0];
                _9643 = param_35.o[1];
                _9644 = param_35.o[2];
                _9350 = param_35.depth;
                _9677 = param_35.d[0];
                _9678 = param_35.d[1];
                _9679 = param_35.d[2];
                _9352 = param_35.dist;
            ...
            if (_7809)
            {
                surface_t _9047 = { _6606, _9029, _9030, _9031, _9032, _6947 };
                float _9613[3] = { _9607, _9608, _9609 };
                float _9578[3] = { _9572, _9573, _9574 };
                float _9543[3] = { _9537, _9538, _9539 };
                ray_data_t _9263 = { _9543, _9578, _9243, _9613, _9245, _9246, _9247, _9248, _9249 };
                ray_data_t param_36 = _9263;
                Sample_DiffuseNode(ray, _9047, base_color, roughness, _7726, _7735, mix_weight, param_36);
                _9537 = param_36.o[0];
                _9538 = param_36.o[1];
                _9539 = param_36.o[2];
                _9572 = param_36.d[0];
                ...
                _9609 = param_36.c[2];
                _9245 = param_36.ior;
                _9246 = param_36.cone_width;
                _9247 = param_36.cone_spread;
                _9248 = param_36.xy;
                _9249 = param_36.depth;
            }
        }
        else
        {
            ...
            if (_9093 == 1u)
            {
                ...
                if (_7847 && (_7645 > 0.0f))
                {
                    light_sample_t _9222 = { _9180, _9181, _9182, _9183, _9184, _9185, _9186, _9187 };
                    surface_t _9054 = { _6606, _9029, _9030, _9031, _9032, _6947 };
                    float _9725[3] = { _9712, _9713, _9714 };
                    float _9690[3] = { _9677, _9678, _9679 };
                    float _9655[3] = { _9642, _9643, _9644 };
                    shadow_ray_t _9377 = { _9655, _9350, _9690, _9352, _9725, _9354 };
                    shadow_ray_t param_39 = _9377;
                    float3 _7862 = Evaluate_GlossyNode(_9222, ray, _9054, base_color, roughness, 1.5f, _7833, mix_weight, param_39);
                    _9642 = param_39.o[0];
                    _9643 = param_39.o[1];
                    _9644 = param_39.o[2];
                    _9350 = param_39.depth;
                    _9677 = param_39.d[0];
                    _9678 = param_39.d[1];
                    _9679 = param_39.d[2];
                    _9352 = param_39.dist;
                ...
                if (_7876)
                {
                    surface_t _9061 = { _6606, _9029, _9030, _9031, _9032, _6947 };
                    float _9620[3] = { _9607, _9608, _9609 };
                    float _9585[3] = { _9572, _9573, _9574 };
                    float _9550[3] = { _9537, _9538, _9539 };
                    ray_data_t _9282 = { _9550, _9585, _9243, _9620, _9245, _9246, _9247, _9248, _9249 };
                    ray_data_t param_40 = _9282;
                    Sample_GlossyNode(ray, _9061, base_color, roughness, 1.5f, _7833, _7726, _7735, mix_weight, param_40);
                    _9537 = param_40.o[0];
                    _9538 = param_40.o[1];
                    _9539 = param_40.o[2];
                    _9572 = param_40.d[0];
                    ...
                    _9609 = param_40.c[2];
                    _9245 = param_40.ior;
                    _9246 = param_40.cone_width;
                    _9247 = param_40.cone_spread;
                    _9248 = param_40.xy;
                    _9249 = param_40.depth;
                }
            }
            else
            {
                ...
                if (_9093 == 2u)
                {
                    ...
                    if (_7910 && (_7645 < 0.0f))
                    {
                        ...
                        light_sample_t _9231 = { _9180, _9181, _9182, _9183, _9184, _9185, _9186, _9187 };
                        surface_t _9068 = { _6606, _9029, _9030, _9031, _9032, _6947 };
                        float _9732[3] = { _9712, _9713, _9714 };
                        float _9697[3] = { _9677, _9678, _9679 };
                        float _9662[3] = { _9642, _9643, _9644 };
                        shadow_ray_t _9390 = { _9662, _9350, _9697, _9352, _9732, _9354 };
                        shadow_ray_t param_41 = _9390;
                        float3 _7940 = Evaluate_RefractiveNode(_9231, ray, _9068, base_color, _7900, _7918, mix_weight, param_41);
                        _9642 = param_41.o[0];
                        _9643 = param_41.o[1];
                        _9644 = param_41.o[2];
                        _9350 = param_41.depth;
                        _9677 = param_41.d[0];
                        _9678 = param_41.d[1];
                        _9679 = param_41.d[2];
                        _9352 = param_41.dist;
                    ...
                    if (_7954)
                    {
                        surface_t _9075 = { _6606, _9029, _9030, _9031, _9032, _6947 };
                        float _9627[3] = { _9607, _9608, _9609 };
                        float _9592[3] = { _9572, _9573, _9574 };
                        float _9557[3] = { _9537, _9538, _9539 };
                        ray_data_t _9301 = { _9557, _9592, _9243, _9627, _9245, _9246, _9247, _9248, _9249 };
                        ray_data_t param_42 = _9301;
                        Sample_RefractiveNode(ray, _9075, base_color, roughness, _6639, _9096, _7204, _7726, _7735, mix_weight, param_42);
                        _9537 = param_42.o[0];
                        _9538 = param_42.o[1];
                        _9539 = param_42.o[2];
                        _9572 = param_42.d[0];
                        ...
                        _9609 = param_42.c[2];
                        _9245 = param_42.ior;
                        _9246 = param_42.cone_width;
                        _9247 = param_42.cone_spread;
                        _9248 = param_42.xy;
                        _9249 = param_42.depth;
                    }
                }
                else
                {
                    ...
                    if (_9093 == 3u)
                    {
                        col += (base_color * (mix_weight * _9094));
                    }
                    else
                    {
                        [branch]
                        if (_9093 == 6u)
                        {
                            float metallic = clamp(float((_9098 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            [branch]
                            if (_9485 != 4294967295u)
                            {
                                metallic *= SampleBilinear(_9485, _6947, int(get_texture_lod(texSize(_9485), _7181))).x;
                            }
                            float specular = clamp(float(_9100 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            [branch]
                            if (_9486 != 4294967295u)
                            {
                                specular *= SampleBilinear(_9486, _6947, int(get_texture_lod(texSize(_9486), _7181))).x;
                            }
                            float _8073 = clamp(float(_9101 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float _8081 = clamp(float((_9101 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float _8089 = 2.0f * clamp(float(_9097 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float3 _8107 = lerp(1.0f.xxx, tint_color, clamp(float((_9097 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * _8089;
                            float3 _8127 = lerp(lerp(1.0f.xxx, tint_color, clamp(float((_9100 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * (specular * 0.07999999821186065673828125f), base_color, metallic.xxx);
                            ...
                            float _8150 = clamp(float((_9095 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            ...
                            float _8182 = mad(roughness - 1.0f, 1.0f - clamp(float((_9099 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), 1.0f);
                            float _8188;
                            if (_6639)
                            {
                                _8188 = _9096 / _7204;
                            ...
                            float param_47 = dot(_6570, _9031);
                            float param_48 = 1.0f / _8188;
                            float _8211 = fresnel_dielectric_cos(param_47, param_48);
                            float param_49 = dot(_6570, _9031);
                            float param_50 = _8136;
                            lobe_weights_t _8250 = get_lobe_weights(lerp(_7681, 1.0f, _8089), lum(lerp(_8127, 1.0f.xxx, ((fresnel_dielectric_cos(param_49, param_50) - _8142) / (1.0f - _8142)).xxx)), specular, metallic, clamp(float(_9099 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), _8073);
                            [branch]
                            if (_9185 > 0.0f)
                            {
                                light_sample_t _9240 = { _9180, _9181, _9182, _9183, _9184, _9185, _9186, _9187 };
                                surface_t _9082 = { _6606, _9029, _9030, _9031, _9032, _6947 };
                                diff_params_t _9432 = { base_color, _8107, roughness };
                                spec_params_t _9447 = { _8127, roughness, _8136, _8142, _8150 };
                                clearcoat_params_t _9460 = { _8081, _8161, _8167 };
                                transmission_params_t _9475 = { _8182, _9096, _8188, _8211, _6639 };
                                float _9739[3] = { _9712, _9713, _9714 };
                                float _9704[3] = { _9677, _9678, _9679 };
                                float _9669[3] = { _9642, _9643, _9644 };
                                shadow_ray_t _9403 = { _9669, _9350, _9704, _9352, _9739, _9354 };
                                shadow_ray_t param_51 = _9403;
                                float3 _8269 = Evaluate_PrincipledNode(_9240, ray, _9082, _8250, _9432, _9447, _9460, _9475, metallic, _7645, mix_weight, param_51);
                                _9642 = param_51.o[0];
                                _9643 = param_51.o[1];
                                _9644 = param_51.o[2];
                                _9350 = param_51.depth;
                                _9677 = param_51.d[0];
                                _9678 = param_51.d[1];
                                _9679 = param_51.d[2];
                                _9352 = param_51.dist;
                            ...
                            surface_t _9089 = { _6606, _9029, _9030, _9031, _9032, _6947 };
                            diff_params_t _9436 = { base_color, _8107, roughness };
                            spec_params_t _9453 = { _8127, roughness, _8136, _8142, _8150 };
                            clearcoat_params_t _9464 = { _8081, _8161, _8167 };
                            transmission_params_t _9481 = { _8182, _9096, _8188, _8211, _6639 };
                            float param_52 = mix_rand;
                            float _9634[3] = { _9607, _9608, _9609 };
                            float _9599[3] = { _9572, _9573, _9574 };
                            float _9564[3] = { _9537, _9538, _9539 };
                            ray_data_t _9320 = { _9564, _9599, _9243, _9634, _9245, _9246, _9247, _9248, _9249 };
                            ray_data_t param_53 = _9320;
                            Sample_PrincipledNode(ray, _9089, _8250, _9436, _9453, _9464, _9481, metallic, _7726, _7735, param_52, mix_weight, param_53);
                            _9537 = param_53.o[0];
                            _9538 = param_53.o[1];
                            _9539 = param_53.o[2];
                            _9572 = param_53.d[0];
                            ...
                            _9609 = param_53.c[2];
                            _9245 = param_53.ior;
                            _9246 = param_53.cone_width;
                            _9247 = param_53.cone_spread;
                            _9248 = param_53.xy;
                            _9249 = param_53.depth;
                        }
                    }
                }
            }
        }
        float _8303 = max(_9607, max(_9608, _9609));
        float _8315;
        ...
        if (_8335)
        {
            ...
            _8375.Store(_8366 * 72 + 0, asuint(_9537));
            _8375.Store(_8366 * 72 + 4, asuint(_9538));
            _8375.Store(_8366 * 72 + 8, asuint(_9539));
            _8375.Store(_8366 * 72 + 12, asuint(_9572));
            _8375.Store(_8366 * 72 + 16, asuint(_9573));
            _8375.Store(_8366 * 72 + 20, asuint(_9574));
            ...
            _8375.Store(_8366 * 72 + 40, asuint(_9245[0]));
            _8375.Store(_8366 * 72 + 44, asuint(_9245[1]));
            _8375.Store(_8366 * 72 + 48, asuint(_9245[2]));
            _8375.Store(_8366 * 72 + 52, asuint(_9245[3]));
            _8375.Store(_8366 * 72 + 56, asuint(_9246));
            _8375.Store(_8366 * 72 + 60, asuint(_9247));
            _8375.Store(_8366 * 72 + 64, uint(_9248));
            _8375.Store(_8366 * 72 + 68, uint(_9249));
        }
        [branch]
        if (max(_9712, max(_9713, _9714)) > 0.0f)
        {
            float3 _8452 = _9182 - float3(_9642, _9643, _9644);
            float _8455 = length(_8452);
            float3 _8459 = _8452 / _8455.xxx;
            float sh_dist = _8455 * _9184;
            if (_9187)
            {
                sh_dist = -sh_dist;
            }
            ...
            _8491.Store(_8483 * 48 + 0, asuint(_9642));
            _8491.Store(_8483 * 48 + 4, asuint(_9643));
            _8491.Store(_8483 * 48 + 8, asuint(_9644));
            _8491.Store(_8483 * 48 + 12, uint(_9350));
            ...
            _8491.Store(_8483 * 48 + 32, asuint(_9712));
            _8491.Store(_8483 * 48 + 36, asuint(_9713));
            _8491.Store(_8483 * 48 + 40, asuint(_9714));
            _8491.Store(_8483 * 48 + 44, uint(_9354));
        }
        _8731 = float3(ray.c[0] * col.x, ray.c[1] * col.y, ray.c[2] * col.z);
        break;
    } while(false);
    return _8731;
}
...
void comp_main()
{
    do
    {
        ...
        hit_data_t _8825 = { _8593.mask, _8593.obj_index, _8593.prim_index, _8593.t, _8593.u, _8593.v };
        hit_data_t param = _8825;
        float _8874[4] = { _8613.ior[0], _8613.ior[1], _8613.ior[2], _8613.ior[3] };
        float _8865[3] = { _8613.c[0], _8613.c[1], _8613.c[2] };
        float _8858[3] = { _8613.d[0], _8613.d[1], _8613.d[2] };
        float _8851[3] = { _8613.o[0], _8613.o[1], _8613.o[2] };
        ray_data_t _8844 = { _8851, _8858, _8613.pdf, _8865, _8874, _8613.cone_width, _8613.cone_spread, _8613.xy, _8613.depth };
        ray_data_t param_1 = _8844;
        ...
        g_out_base_color_img[_8678] = float4(param_2, 0.0f);
