...
ByteAddressBuffer _8701 : register(t10, space0);
...
float3 ensure_valid_reflection(float3 Ng, float3 I, float3 N)
{
    ...
    do
    {
        ...
        if (_1320 && _1326)
        {
            float _10057 = (-0.5f) / _1280;
            float param_1 = mad(_10057, _1304, 1.0f);
            float _1336 = safe_sqrtf(param_1);
            float param_2 = _1305;
            float _1339 = safe_sqrtf(param_2);
            float2 _1340 = float2(_1336, _1339);
            float param_3 = mad(_10057, _1311, 1.0f);
            float _1345 = safe_sqrtf(param_3);
            float param_4 = _1312;
            float _1348 = safe_sqrtf(param_4);
            float2 _1349 = float2(_1345, _1348);
            float _10059 = -_1268;
            float _1365 = mad(2.0f * mad(_1336, _1264, _1339 * _1268), _1339, _10059);
            float _1381 = mad(2.0f * mad(_1345, _1264, _1348 * _1268), _1348, _10059);
        ...
        _8718 = (_1260 * N_new.x) + (Ng * N_new.y);
        break;
    } while(false);
    return _8718;
}
...
float3 MapToCone(float r1, float r2, float3 N, float radius)
{
    ...
    do
    {
        ...
        _8743 = (N + (param * ((radius * r) * cos(theta)))) + (param_1 * ((radius * r) * sin(theta)));
        break;
    } while(false);
    return _8743;
}
...
void SampleLightSource(float3 P, float3 T, float3 B, float3 N, int hi, float2 sample_off, inout light_sample_t ls)
{
    ...
    if (_3354 == 0u)
    {
        ...
        float3 _9820 = sampled_dir;
        float3 _3433 = ((param * _9820.x) + (param_1 * _9820.y)) + (_3390 * _9820.z);
        sampled_dir = _3433;
...
float D_GGX(float3 H, float alpha_x, float alpha_y)
{
    ...
    do
    {
        ...
        _8776 = 1.0f / (((((_1988 * _1988) * 3.1415927410125732421875f) * alpha_x) * alpha_y) * (((H.z * H.z) * H.z) * H.z));
        break;
    } while(false);
    return _8776;
}
...
float4 Sample_GGXSpecular_BSDF(float3 T, float3 B, float3 N, float3 I, float roughness, float anisotropic, float spec_ior, float spec_F0, float3 spec_col, float rand_u, float rand_v, inout float3 out_V)
{
    ...
    do
    {
        ...
        if ((_2599 * _2603) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            out_V = _2614;
            _8748 = float4(_2628.x * 1000000.0f, _2628.y * 1000000.0f, _2628.z * 1000000.0f, 1000000.0f);
            break;
        }
        float3 param_2 = T;
        float3 param_3 = B;
...
float4 Evaluate_GGXRefraction_BSDF(float3 view_dir_ts, float3 sampled_normal_ts, float3 refr_dir_ts, float roughness2, float eta, float3 refr_col)
{
    ...
    do
    {
        ...
        _8753 = float4(refr_col * (((((_2911 * _2927) * _2919) * clamp(dot(view_dir_ts, sampled_normal_ts), 0.0f, 1.0f)) * _2947) / view_dir_ts.z), (((_2911 * _2919) * clamp(dot(view_dir_ts, sampled_normal_ts), 0.0f, 1.0f)) * _2947) / view_dir_ts.z);
        break;
    } while(false);
    return _8753;
}
...
lobe_weights_t get_lobe_weights(float base_color_lum, float spec_color_lum, float specular, float metallic, float transmission, float clearcoat)
{
    ...
    float _8852 = (base_color_lum * _1443) * (1.0f - transmission);
    ...
    float _8854 = _1464 * _1443;
    float _8855 = _1450 * base_color_lum;
    float _1473 = _8852;
    ...
    lobe_weights_t _8860 = { _8852, _8853, _8854, _8855 };
    return _8860;
}
...
float BRDF_PrincipledDiffuse(float3 V, float3 N, float3 L, float3 H, float roughness)
{
    ...
    do
    {
        ...
        _8781 = lerp(1.0f, _2228, schlick_weight(param)) * lerp(1.0f, _2228, schlick_weight(param_1));
        break;
    } while(false);
    return _8781;
}
...
float D_GTR1(float NDotH, float a)
{
    ...
    do
    {
        if (a >= 1.0f)
        {
            _8786 = 0.3183098733425140380859375f;
            break;
        }
        float _1947 = mad(a, a, -1.0f);
        _8786 = _1947 / ((3.1415927410125732421875f * log(a * a)) * mad(_1947 * NDotH, NDotH, 1.0f));
        break;
    } while(false);
    return _8786;
}
...
float4 Sample_PrincipledClearcoat_BSDF(float3 T, float3 B, float3 N, float3 I, float clearcoat_roughness2, float clearcoat_ior, float clearcoat_F0, float rand_u, float rand_v, inout float3 out_V)
{
    ...
    do
    {
        ...
        if ((clearcoat_roughness2 * clearcoat_roughness2) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            _8771 = float4(_2828, _2828, _2828, 1000000.0f);
            break;
        }
        float3 param_2 = T;
        float3 param_3 = B;
        ...
        _8771 = Evaluate_PrincipledClearcoat_BSDF(param_14, param_15, param_16, param_17, param_18, param_19);
        break;
    } while(false);
    return _8771;
}
        ...
        else
        {
            ...
            else
            {
                ...
                if (_6362)
                {
                    ...
                    float4 _10004 = F;
                    float _6476 = _10004.w * lobe_weights.refraction;
                    float4 _10006 = _10004;
                    _10006.w = _6476;
                    F = _10006;
                    new_ray.c[0] = ((ray.c[0] * _10004.x) * mix_weight) / _6476;
                    new_ray.c[1] = ((ray.c[1] * _10004.y) * mix_weight) / _6476;
                    new_ray.c[2] = ((ray.c[2] * _10004.z) * mix_weight) / _6476;
                    new_ray.pdf = _6476;
                    new_ray.d[0] = V.x;
                    new_ray.d[1] = V.y;
                    new_ray.d[2] = V.z;
...
float3 ShadeSurface(hit_data_t inter, ray_data_t ray, inout float3 out_base_color, inout float3 out_normals)
{
    ...
    do
    {
        ...
        if (inter.mask == 0)
        {
            ...
            _8708 = float3(ray.c[0] * _6608.x, ray.c[1] * _6608.y, ray.c[2] * _6608.z);
            break;
        }
        ...
        if (inter.obj_index < 0)
        {
            ...
            _8708 = float3(ray.c[0] * _6648.x, ray.c[1] * _6648.y, ray.c[2] * _6648.z);
            break;
        }
        ...
        uint _9459 = _6691.textures[0];
        uint _9460 = _6691.textures[1];
        uint _9461 = _6691.textures[2];
        uint _9462 = _6691.textures[3];
        uint _9463 = _6691.textures[4];
        float _9464 = _6691.base_color[0];
        float _9465 = _6691.base_color[1];
        float _9466 = _6691.base_color[2];
        uint _9069 = _6691.flags;
        uint _9070 = _6691.type;
        float _9071 = _6691.tangent_rotation_or_strength;
        uint _9072 = _6691.roughness_and_anisotropic;
        float _9073 = _6691.ior;
        uint _9074 = _6691.sheen_and_sheen_tint;
        uint _9075 = _6691.tint_and_metallic;
        uint _9076 = _6691.transmission_and_transmission_roughness;
        uint _9077 = _6691.specular_and_specular_tint;
        uint _9078 = _6691.clearcoat_and_clearcoat_roughness;
        uint _9079 = _6691.normal_map_strength_unorm;
        transform_t _6746;
        ...
        float3 _9007 = _7035;
        float3 _9006 = cross(_7035, _6951);
        if (_6669)
        {
            ...
            _9459 = _7061.textures[0];
            _9460 = _7061.textures[1];
            _9461 = _7061.textures[2];
            _9462 = _7061.textures[3];
            _9463 = _7061.textures[4];
            _9464 = _7061.base_color[0];
            _9465 = _7061.base_color[1];
            _9466 = _7061.base_color[2];
            _9069 = _7061.flags;
            _9070 = _7061.type;
            _9071 = _7061.tangent_rotation_or_strength;
            _9072 = _7061.roughness_and_anisotropic;
            _9073 = _7061.ior;
            _9074 = _7061.sheen_and_sheen_tint;
            _9075 = _7061.tint_and_metallic;
            _9076 = _7061.transmission_and_transmission_roughness;
            _9077 = _7061.specular_and_specular_tint;
            _9078 = _7061.clearcoat_and_clearcoat_roughness;
            _9079 = _7061.normal_map_strength_unorm;
            _9009 = -_9009;
            _9008 = -_9008;
            _9007 = -_9007;
            _9006 = -_9006;
        ...
        _9007 = TransformNormal(param_9, param_10);
        float3 param_11 = _9006;
        float4x4 param_12 = _6746.inv_xform;
        _9009 = normalize(_9009);
        _9008 = normalize(_9008);
        _9007 = normalize(_9007);
        _9006 = normalize(TransformNormal(param_11, param_12));
        ...
        while (_9070 == 4u)
        {
            ...
            {
                mix_val *= SampleBilinear(_9460, _6977, 0, _6598).x;
            }
            if (_6669)
            {
                _7258 = _7219 / _9073;
            ...
            if (_9073 != 0.0f)
            {
                float param_16 = dot(_6532, _9008);
            ...
            if (mix_rand > _7291)
            {
                ...
                {
                    _7314.textures[_80ident] = _4415.Load(_80ident * 4 + _9462 * 76 + 0);
                }
                [unroll]
                for (int _81ident = 0; _81ident < 3; _81ident++)
                {
                    _7314.base_color[_81ident] = asfloat(_4415.Load(_81ident * 4 + _9462 * 76 + 20));
                }
                _7314.flags = _4415.Load(_9462 * 76 + 32);
                _7314.type = _4415.Load(_9462 * 76 + 36);
                _7314.tangent_rotation_or_strength = asfloat(_4415.Load(_9462 * 76 + 40));
                _7314.roughness_and_anisotropic = _4415.Load(_9462 * 76 + 44);
                _7314.ior = asfloat(_4415.Load(_9462 * 76 + 48));
                _7314.sheen_and_sheen_tint = _4415.Load(_9462 * 76 + 52);
                _7314.tint_and_metallic = _4415.Load(_9462 * 76 + 56);
                _7314.transmission_and_transmission_roughness = _4415.Load(_9462 * 76 + 60);
                _7314.specular_and_specular_tint = _4415.Load(_9462 * 76 + 64);
                _7314.clearcoat_and_clearcoat_roughness = _4415.Load(_9462 * 76 + 68);
                _7314.normal_map_strength_unorm = _4415.Load(_9462 * 76 + 72);
                _9459 = _7314.textures[0];
                _9460 = _7314.textures[1];
                _9461 = _7314.textures[2];
                _9462 = _7314.textures[3];
                _9463 = _7314.textures[4];
                _9464 = _7314.base_color[0];
                _9465 = _7314.base_color[1];
                _9466 = _7314.base_color[2];
                _9069 = _7314.flags;
                _9070 = _7314.type;
                _9071 = _7314.tangent_rotation_or_strength;
                _9072 = _7314.roughness_and_anisotropic;
                _9073 = _7314.ior;
                _9074 = _7314.sheen_and_sheen_tint;
                _9075 = _7314.tint_and_metallic;
                _9076 = _7314.transmission_and_transmission_roughness;
                _9077 = _7314.specular_and_specular_tint;
                _9078 = _7314.clearcoat_and_clearcoat_roughness;
                _9079 = _7314.normal_map_strength_unorm;
            ...
            else
            {
                ...
                {
                    _7380.textures[_82ident] = _4415.Load(_82ident * 4 + _9463 * 76 + 0);
                }
                [unroll]
                for (int _83ident = 0; _83ident < 3; _83ident++)
                {
                    _7380.base_color[_83ident] = asfloat(_4415.Load(_83ident * 4 + _9463 * 76 + 20));
                }
                _7380.flags = _4415.Load(_9463 * 76 + 32);
                _7380.type = _4415.Load(_9463 * 76 + 36);
                _7380.tangent_rotation_or_strength = asfloat(_4415.Load(_9463 * 76 + 40));
                _7380.roughness_and_anisotropic = _4415.Load(_9463 * 76 + 44);
                _7380.ior = asfloat(_4415.Load(_9463 * 76 + 48));
                _7380.sheen_and_sheen_tint = _4415.Load(_9463 * 76 + 52);
                _7380.tint_and_metallic = _4415.Load(_9463 * 76 + 56);
                _7380.transmission_and_transmission_roughness = _4415.Load(_9463 * 76 + 60);
                _7380.specular_and_specular_tint = _4415.Load(_9463 * 76 + 64);
                _7380.clearcoat_and_clearcoat_roughness = _4415.Load(_9463 * 76 + 68);
                _7380.normal_map_strength_unorm = _4415.Load(_9463 * 76 + 72);
                _9459 = _7380.textures[0];
                _9460 = _7380.textures[1];
                _9461 = _7380.textures[2];
                _9462 = _7380.textures[3];
                _9463 = _7380.textures[4];
                _9464 = _7380.base_color[0];
                _9465 = _7380.base_color[1];
                _9466 = _7380.base_color[2];
                _9069 = _7380.flags;
                _9070 = _7380.type;
                _9071 = _7380.tangent_rotation_or_strength;
                _9072 = _7380.roughness_and_anisotropic;
                _9073 = _7380.ior;
                _9074 = _7380.sheen_and_sheen_tint;
                _9075 = _7380.tint_and_metallic;
                _9076 = _7380.transmission_and_transmission_roughness;
                _9077 = _7380.specular_and_specular_tint;
                _9078 = _7380.clearcoat_and_clearcoat_roughness;
                _9079 = _7380.normal_map_strength_unorm;
                mix_rand /= mix_val;
            }
        }
        [branch]
        ...
        {
            float3 normals = (float3(SampleBilinear(_9459, _6977, 0, _6598).xy, 1.0f) * 2.0f) - 1.0f.xxx;
            if ((_9459 & 33554432u) != 0u)
            {
                float3 _10027 = normals;
                _10027.z = sqrt(1.0f - dot(normals.xy, normals.xy));
                normals = _10027;
            }
            float3 _7463 = _9008;
            _9008 = normalize(((_9006 * normals.x) + (_7463 * normals.z)) + (_9007 * normals.y));
            if ((_9079 & 65535u) != 65535u)
            {
                _9008 = normalize(_7463 + ((_9008 - _7463) * clamp(float(_9079 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f)));
            }
            float3 param_18 = _9009;
            float3 param_19 = -_6532;
            float3 param_20 = _9008;
            _9008 = ensure_valid_reflection(param_18, param_19, param_20);
        }
        ...
        tangent = _7542;
        float3 _7546 = cross(_7542, _9008);
        ...
        if (_9071 != 0.0f)
        {
            ...
            float3 param_26 = _9008;
            float param_27 = _9071;
            tangent = rotate_around_axis(param_25, param_26, param_27);
        }
        float3 _7579 = normalize(cross(tangent, _9008));
        _9007 = _7579;
        _9006 = cross(_9008, _7579);
        ...
        if (_7601)
        {
            ...
            float3 param_29 = _9006;
            float3 param_30 = _9007;
            float3 param_31 = _9008;
            int param_32 = _6565;
            float2 param_33 = float2(_6572, _6579);
            light_sample_t _9173 = { _9157, _9158, _9159, _9160, _9161, _9162, _9163, _9164 };
            light_sample_t param_34 = _9173;
            SampleLightSource(param_28, param_29, param_30, param_31, param_32, param_33, param_34);
            _9157 = param_34.col;
            _9158 = param_34.L;
            _9159 = param_34.lp;
            _9160 = param_34.area;
            _9161 = param_34.dist_mul;
            _9162 = param_34.pdf;
            _9163 = param_34.cast_shadow;
            _9164 = param_34.from_env;
        }
        float _7629 = dot(_9008, _9158);
        float3 base_color = float3(_9464, _9465, _9466);
        [branch]
        if (_9460 != 4294967295u)
        {
            base_color *= SampleBilinear(_9460, _6977, int(get_texture_lod(texSize(_9460), _7211)), _6598, true, true).xyz;
        }
        ...
        float roughness = clamp(float(_9072 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
        [branch]
        if (_9461 != 4294967295u)
        {
            roughness *= SampleBilinear(_9461, _6977, int(get_texture_lod(texSize(_9461), _7211)), _6598, false, true).x;
        }
        ...
        {
            [branch]
            if ((_9162 > 0.0f) && (_7629 > 0.0f))
            {
                light_sample_t _9190 = { _9157, _9158, _9159, _9160, _9161, _9162, _9163, _9164 };
                surface_t _9017 = { _6635, _9006, _9007, _9008, _9009, _6977 };
                float _9695[3] = { _9689, _9690, _9691 };
                float _9660[3] = { _9654, _9655, _9656 };
                float _9625[3] = { _9619, _9620, _9621 };
                shadow_ray_t _9341 = { _9625, _9327, _9660, _9329, _9695, _9331 };
                shadow_ray_t param_35 = _9341;
                float3 _7781 = Evaluate_DiffuseNode(_9190, ray, _9017, base_color, roughness, mix_weight, param_35);
                _9619 = param_35.o[0];
                _9620 = param_35.o[1];
                _9621 = param_35.o[2];
                _9327 = param_35.depth;
                _9654 = param_35.d[0];
                _9655 = param_35.d[1];
                _9656 = param_35.d[2];
                _9329 = param_35.dist;
            ...
            if (_7795)
            {
                surface_t _9024 = { _6635, _9006, _9007, _9008, _9009, _6977 };
                float _9590[3] = { _9584, _9585, _9586 };
                float _9555[3] = { _9549, _9550, _9551 };
                float _9520[3] = { _9514, _9515, _9516 };
                ray_data_t _9240 = { _9520, _9555, _9220, _9590, _9222, _9223, _9224, _9225, _9226 };
                ray_data_t param_36 = _9240;
                Sample_DiffuseNode(ray, _9024, base_color, roughness, _7712, _7721, mix_weight, param_36);
                _9514 = param_36.o[0];
                _9515 = param_36.o[1];
                _9516 = param_36.o[2];
                _9549 = param_36.d[0];
                ...
                _9586 = param_36.c[2];
                _9222 = param_36.ior;
                _9223 = param_36.cone_width;
                _9224 = param_36.cone_spread;
                _9225 = param_36.xy;
                _9226 = param_36.depth;
            }
        }
        else
        {
            ...
            if (_9070 == 1u)
            {
                ...
                if (_7833 && (_7629 > 0.0f))
                {
                    light_sample_t _9199 = { _9157, _9158, _9159, _9160, _9161, _9162, _9163, _9164 };
                    surface_t _9031 = { _6635, _9006, _9007, _9008, _9009, _6977 };
                    float _9702[3] = { _9689, _9690, _9691 };
                    float _9667[3] = { _9654, _9655, _9656 };
                    float _9632[3] = { _9619, _9620, _9621 };
                    shadow_ray_t _9354 = { _9632, _9327, _9667, _9329, _9702, _9331 };
                    shadow_ray_t param_39 = _9354;
                    float3 _7848 = Evaluate_GlossyNode(_9199, ray, _9031, base_color, roughness, 1.5f, _7819, mix_weight, param_39);
                    _9619 = param_39.o[0];
                    _9620 = param_39.o[1];
                    _9621 = param_39.o[2];
                    _9327 = param_39.depth;
                    _9654 = param_39.d[0];
                    _9655 = param_39.d[1];
                    _9656 = param_39.d[2];
                    _9329 = param_39.dist;
                ...
                if (_7862)
                {
                    surface_t _9038 = { _6635, _9006, _9007, _9008, _9009, _6977 };
                    float _9597[3] = { _9584, _9585, _9586 };
                    float _9562[3] = { _9549, _9550, _9551 };
                    float _9527[3] = { _9514, _9515, _9516 };
                    ray_data_t _9259 = { _9527, _9562, _9220, _9597, _9222, _9223, _9224, _9225, _9226 };
                    ray_data_t param_40 = _9259;
                    Sample_GlossyNode(ray, _9038, base_color, roughness, 1.5f, _7819, _7712, _7721, mix_weight, param_40);
                    _9514 = param_40.o[0];
                    _9515 = param_40.o[1];
                    _9516 = param_40.o[2];
                    _9549 = param_40.d[0];
                    ...
                    _9586 = param_40.c[2];
                    _9222 = param_40.ior;
                    _9223 = param_40.cone_width;
                    _9224 = param_40.cone_spread;
                    _9225 = param_40.xy;
                    _9226 = param_40.depth;
                }
            }
            else
            {
                ...
                if (_9070 == 2u)
                {
                    ...
                    if (_7896 && (_7629 < 0.0f))
                    {
                        ...
                        light_sample_t _9208 = { _9157, _9158, _9159, _9160, _9161, _9162, _9163, _9164 };
                        surface_t _9045 = { _6635, _9006, _9007, _9008, _9009, _6977 };
                        float _9709[3] = { _9689, _9690, _9691 };
                        float _9674[3] = { _9654, _9655, _9656 };
                        float _9639[3] = { _9619, _9620, _9621 };
                        shadow_ray_t _9367 = { _9639, _9327, _9674, _9329, _9709, _9331 };
                        shadow_ray_t param_41 = _9367;
                        float3 _7926 = Evaluate_RefractiveNode(_9208, ray, _9045, base_color, _7886, _7904, mix_weight, param_41);
                        _9619 = param_41.o[0];
                        _9620 = param_41.o[1];
                        _9621 = param_41.o[2];
                        _9327 = param_41.depth;
                        _9654 = param_41.d[0];
                        _9655 = param_41.d[1];
                        _9656 = param_41.d[2];
                        _9329 = param_41.dist;
                    ...
                    if (_7940)
                    {
                        surface_t _9052 = { _6635, _9006, _9007, _9008, _9009, _6977 };
                        float _9604[3] = { _9584, _9585, _9586 };
                        float _9569[3] = { _9549, _9550, _9551 };
                        float _9534[3] = { _9514, _9515, _9516 };
                        ray_data_t _9278 = { _9534, _9569, _9220, _9604, _9222, _9223, _9224, _9225, _9226 };
                        ray_data_t param_42 = _9278;
                        Sample_RefractiveNode(ray, _9052, base_color, roughness, _6669, _9073, _7219, _7712, _7721, mix_weight, param_42);
                        _9514 = param_42.o[0];
                        _9515 = param_42.o[1];
                        _9516 = param_42.o[2];
                        _9549 = param_42.d[0];
                        ...
                        _9586 = param_42.c[2];
                        _9222 = param_42.ior;
                        _9223 = param_42.cone_width;
                        _9224 = param_42.cone_spread;
                        _9225 = param_42.xy;
                        _9226 = param_42.depth;
                    }
                }
                else
                {
                    ...
                    if (_9070 == 3u)
                    {
                        col += (base_color * (mix_weight * _9071));
                    }
                    else
                    {
                        [branch]
                        if (_9070 == 6u)
                        {
                            float metallic = clamp(float((_9075 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            [branch]
                            if (_9462 != 4294967295u)
                            {
                                metallic *= SampleBilinear(_9462, _6977, int(get_texture_lod(texSize(_9462), _7211)), _6598).x;
                            }
                            float specular = clamp(float(_9077 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            [branch]
                            if (_9463 != 4294967295u)
                            {
                                specular *= SampleBilinear(_9463, _6977, int(get_texture_lod(texSize(_9463), _7211)), _6598).x;
                            }
                            float _8061 = clamp(float(_9078 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float _8069 = clamp(float((_9078 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float _8077 = 2.0f * clamp(float(_9074 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float3 _8095 = lerp(1.0f.xxx, tint_color, clamp(float((_9074 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * _8077;
                            float3 _8115 = lerp(lerp(1.0f.xxx, tint_color, clamp(float((_9077 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * (specular * 0.07999999821186065673828125f), base_color, metallic.xxx);
                            ...
                            float _8138 = clamp(float((_9072 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            ...
                            float _8170 = mad(roughness - 1.0f, 1.0f - clamp(float((_9076 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), 1.0f);
                            float _8176;
                            if (_6669)
                            {
                                _8176 = _9073 / _7219;
                            ...
                            float param_47 = dot(_6532, _9008);
                            float param_48 = 1.0f / _8176;
                            float _8199 = fresnel_dielectric_cos(param_47, param_48);
                            float param_49 = dot(_6532, _9008);
                            float param_50 = _8124;
                            lobe_weights_t _8238 = get_lobe_weights(lerp(_7666, 1.0f, _8077), lum(lerp(_8115, 1.0f.xxx, ((fresnel_dielectric_cos(param_49, param_50) - _8130) / (1.0f - _8130)).xxx)), specular, metallic, clamp(float(_9076 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), _8061);
                            [branch]
                            if (_9162 > 0.0f)
                            {
                                light_sample_t _9217 = { _9157, _9158, _9159, _9160, _9161, _9162, _9163, _9164 };
                                surface_t _9059 = { _6635, _9006, _9007, _9008, _9009, _6977 };
                                diff_params_t _9409 = { base_color, _8095, roughness };
                                spec_params_t _9424 = { _8115, roughness, _8124, _8130, _8138 };
                                clearcoat_params_t _9437 = { _8069, _8149, _8155 };
                                transmission_params_t _9452 = { _8170, _9073, _8176, _8199, _6669 };
                                float _9716[3] = { _9689, _9690, _9691 };
                                float _9681[3] = { _9654, _9655, _9656 };
                                float _9646[3] = { _9619, _9620, _9621 };
                                shadow_ray_t _9380 = { _9646, _9327, _9681, _9329, _9716, _9331 };
                                shadow_ray_t param_51 = _9380;
                                float3 _8257 = Evaluate_PrincipledNode(_9217, ray, _9059, _8238, _9409, _9424, _9437, _9452, metallic, _7629, mix_weight, param_51);
                                _9619 = param_51.o[0];
                                _9620 = param_51.o[1];
                                _9621 = param_51.o[2];
                                _9327 = param_51.depth;
                                _9654 = param_51.d[0];
                                _9655 = param_51.d[1];
                                _9656 = param_51.d[2];
                                _9329 = param_51.dist;
                            ...
                            surface_t _9066 = { _6635, _9006, _9007, _9008, _9009, _6977 };
                            diff_params_t _9413 = { base_color, _8095, roughness };
                            spec_params_t _9430 = { _8115, roughness, _8124, _8130, _8138 };
                            clearcoat_params_t _9441 = { _8069, _8149, _8155 };
                            transmission_params_t _9458 = { _8170, _9073, _8176, _8199, _6669 };
                            float param_52 = mix_rand;
                            float _9611[3] = { _9584, _9585, _9586 };
                            float _9576[3] = { _9549, _9550, _9551 };
                            float _9541[3] = { _9514, _9515, _9516 };
                            ray_data_t _9297 = { _9541, _9576, _9220, _9611, _9222, _9223, _9224, _9225, _9226 };
                            ray_data_t param_53 = _9297;
                            Sample_PrincipledNode(ray, _9066, _8238, _9413, _9430, _9441, _9458, metallic, _7712, _7721, param_52, mix_weight, param_53);
                            _9514 = param_53.o[0];
                            _9515 = param_53.o[1];
                            _9516 = param_53.o[2];
                            _9549 = param_53.d[0];
                            ...
                            _9586 = param_53.c[2];
                            _9222 = param_53.ior;
                            _9223 = param_53.cone_width;
                            _9224 = param_53.cone_spread;
                            _9225 = param_53.xy;
                            _9226 = param_53.depth;
                        }
                    }
                }
            }
        }
        float _8291 = max(_9584, max(_9585, _9586));
        float _8303;
        ...
        if (_8323)
        {
            ...
            _8363.Store(_8354 * 72 + 0, asuint(_9514));
            _8363.Store(_8354 * 72 + 4, asuint(_9515));
            _8363.Store(_8354 * 72 + 8, asuint(_9516));
            _8363.Store(_8354 * 72 + 12, asuint(_9549));
            _8363.Store(_8354 * 72 + 16, asuint(_9550));
            _8363.Store(_8354 * 72 + 20, asuint(_9551));
            ...
            _8363.Store(_8354 * 72 + 40, asuint(_9222[0]));
            _8363.Store(_8354 * 72 + 44, asuint(_9222[1]));
            _8363.Store(_8354 * 72 + 48, asuint(_9222[2]));
            _8363.Store(_8354 * 72 + 52, asuint(_9222[3]));
            _8363.Store(_8354 * 72 + 56, asuint(_9223));
            _8363.Store(_8354 * 72 + 60, asuint(_9224));
            _8363.Store(_8354 * 72 + 64, uint(_9225));
            _8363.Store(_8354 * 72 + 68, uint(_9226));
        }
        [branch]
        if (max(_9689, max(_9690, _9691)) > 0.0f)
        {
            float3 _8440 = _9159 - float3(_9619, _9620, _9621);
            float _8443 = length(_8440);
            float3 _8447 = _8440 / _8443.xxx;
            float sh_dist = _8443 * _9161;
            if (_9164)
            {
                sh_dist = -sh_dist;
            }
            ...
            _8479.Store(_8471 * 48 + 0, asuint(_9619));
            _8479.Store(_8471 * 48 + 4, asuint(_9620));
            _8479.Store(_8471 * 48 + 8, asuint(_9621));
            _8479.Store(_8471 * 48 + 12, uint(_9327));
            ...
            _8479.Store(_8471 * 48 + 32, asuint(_9689));
            _8479.Store(_8471 * 48 + 36, asuint(_9690));
            _8479.Store(_8471 * 48 + 40, asuint(_9691));
            _8479.Store(_8471 * 48 + 44, uint(_9331));
        }
        _8708 = float3(ray.c[0] * col.x, ray.c[1] * col.y, ray.c[2] * col.z);
        break;
    } while(false);
    return _8708;
}
...
void comp_main()
{
    do
    {
        ...
        hit_data_t _8802 = { _8579.mask, _8579.obj_index, _8579.prim_index, _8579.t, _8579.u, _8579.v };
        hit_data_t param = _8802;
        float _8851[4] = { _8595.ior[0], _8595.ior[1], _8595.ior[2], _8595.ior[3] };
        float _8842[3] = { _8595.c[0], _8595.c[1], _8595.c[2] };
        float _8835[3] = { _8595.d[0], _8595.d[1], _8595.d[2] };
        float _8828[3] = { _8595.o[0], _8595.o[1], _8595.o[2] };
        ray_data_t _8821 = { _8828, _8835, _8595.pdf, _8842, _8851, _8595.cone_width, _8595.cone_spread, _8595.xy, _8595.depth };
        ray_data_t param_1 = _8821;
