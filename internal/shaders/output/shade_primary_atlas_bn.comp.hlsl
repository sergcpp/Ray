...
ByteAddressBuffer _9138 : register(t10, space0);
...
float2 TransformUV(float2 _uv, atlas_texture_t t, int mip_level)
{
    ...
    return mad(frac(_uv), size, float2(float(_9313[mip_level] & 65535u), float((_9316[mip_level] >> uint(16)) & 65535u))) + 1.0f.xx;
}
...
float3 Evaluate_EnvColor(ray_data_t ray, float2 tex_rand)
{
    ...
    if (_4961 != 4294967295u)
    {
        ...
        uint _9683[14] = { _4972.pos[0], _4972.pos[1], _4972.pos[2], _4972.pos[3], _4972.pos[4], _4972.pos[5], _4972.pos[6], _4972.pos[7], _4972.pos[8], _4972.pos[9], _4972.pos[10], _4972.pos[11], _4972.pos[12], _4972.pos[13] };
        uint _9654[4] = { _4972.page[0], _4972.page[1], _4972.page[2], _4972.page[3] };
        atlas_texture_t _9645 = { _4972.size, _4972.atlas, _9654, _9683 };
        float param = _3458_g_params.back_rotation;
        env_col *= SampleLatlong_RGBE(_9645, _4953, param, tex_rand);
    }
...
float3 Evaluate_LightColor(ray_data_t ray, hit_data_t inter, float2 tex_rand)
{
    ...
    if ((_5098.type_and_param0.x & 128u) != 0u)
    {
        ...
        if (_5125 != 4294967295u)
        {
            ...
            uint _9745[14] = { _5132.pos[0], _5132.pos[1], _5132.pos[2], _5132.pos[3], _5132.pos[4], _5132.pos[5], _5132.pos[6], _5132.pos[7], _5132.pos[8], _5132.pos[9], _5132.pos[10], _5132.pos[11], _5132.pos[12], _5132.pos[13] };
            uint _9716[4] = { _5132.page[0], _5132.page[1], _5132.page[2], _5132.page[3] };
            atlas_texture_t _9707 = { _5132.size, _5132.atlas, _9716, _9745 };
            float param = _3458_g_params.env_rotation;
            env_col *= SampleLatlong_RGBE(_9707, _5084, param, tex_rand);
        }
        lcol *= env_col;
    }
...
float4 SampleBilinear(uint index, float2 uvs, int lod, float2 rand, bool maybe_YCoCg, bool maybe_SRGB)
{
    ...
    uint _9321[4];
    _9321[0] = _1138.page[0];
    _9321[1] = _1138.page[1];
    _9321[2] = _1138.page[2];
    _9321[3] = _1138.page[3];
    uint _9357[14] = { _1138.pos[0], _1138.pos[1], _1138.pos[2], _1138.pos[3], _1138.pos[4], _1138.pos[5], _1138.pos[6], _1138.pos[7], _1138.pos[8], _1138.pos[9], _1138.pos[10], _1138.pos[11], _1138.pos[12], _1138.pos[13] };
    atlas_texture_t _9327 = { _1138.size, _1138.atlas, _9321, _9357 };
    uint _1211 = _1138.atlas;
    float4 res = g_atlases[NonUniformResourceIndex(_1211)].SampleLevel(_g_atlases_sampler[NonUniformResourceIndex(_1211)], float3(((TransformUV(uvs, _9327, lod) + rand) - 0.5f.xx) * 0.000118371215648949146270751953125f.xx, float((_9321[lod / 4] >> uint((lod % 4) * 8)) & 255u)), 0.0f);
    bool _1226;
    if (maybe_YCoCg)
    {
...
float3 ensure_valid_reflection(float3 Ng, float3 I, float3 N)
{
    ...
    do
    {
        ...
        if (_1511 && _1517)
        {
            float _10800 = (-0.5f) / _1471;
            float param_1 = mad(_10800, _1495, 1.0f);
            float _1527 = safe_sqrtf(param_1);
            float param_2 = _1496;
            float _1530 = safe_sqrtf(param_2);
            float2 _1531 = float2(_1527, _1530);
            float param_3 = mad(_10800, _1502, 1.0f);
            float _1536 = safe_sqrtf(param_3);
            float param_4 = _1503;
            float _1539 = safe_sqrtf(param_4);
            float2 _1540 = float2(_1536, _1539);
            float _10802 = -_1459;
            float _1556 = mad(2.0f * mad(_1527, _1455, _1530 * _1459), _1530, _10802);
            float _1572 = mad(2.0f * mad(_1536, _1455, _1539 * _1459), _1539, _10802);
        ...
        _9155 = (_1451 * N_new.x) + (Ng * N_new.y);
        break;
    } while(false);
    return _9155;
}
...
float3 MapToCone(float r1, float r2, float3 N, float radius)
{
    ...
    do
    {
        ...
        _9180 = (N + (param * ((radius * r) * cos(theta)))) + (param_1 * ((radius * r) * sin(theta)));
        break;
    } while(false);
    return _9180;
}
...
float4 Sample_EnvQTree(float y_rotation, Texture2D<float4> qtree_tex, SamplerState _qtree_tex_sampler, int qtree_levels, float rand, float rx, float ry)
{
    ...
    while (lod >= 0)
    {
        ...
        else
        {
            ...
            partial = _917;
            float2 _10487 = origin;
            _10487.x = origin.x + _step;
            origin = _10487;
        ...
        {
            float2 _10490 = origin;
            _10490.y = origin.y + _step;
            origin = _10490;
            _sample = (_sample - boundary) / (1.0f - boundary);
            index |= 2;
        }
...
void SampleLightSource(float3 P, float3 T, float3 B, float3 N, int hi, float2 sample_off, inout light_sample_t ls)
{
    ...
    if (_3540 == 0u)
    {
        ...
        float3 _10561 = sampled_dir;
        float3 _3618 = ((param * _10561.x) + (param_1 * _10561.y)) + (_3575 * _10561.z);
        sampled_dir = _3618;
            ...
            if (_3540 == 4u)
            {
                ...
                if ((_3488.type_and_param0.x & 128u) != 0u)
                {
                    ...
                    if (_3898 != 4294967295u)
                    {
                        ...
                        uint _9501[14] = { _3906.pos[0], _3906.pos[1], _3906.pos[2], _3906.pos[3], _3906.pos[4], _3906.pos[5], _3906.pos[6], _3906.pos[7], _3906.pos[8], _3906.pos[9], _3906.pos[10], _3906.pos[11], _3906.pos[12], _3906.pos[13] };
                        uint _9472[4] = { _3906.page[0], _3906.page[1], _3906.page[2], _3906.page[3] };
                        atlas_texture_t _9401 = { _3906.size, _3906.atlas, _9472, _9501 };
                        float param_10 = _3458_g_params.env_rotation;
                        env_col *= SampleLatlong_RGBE(_9401, ls.L, param_10, _3535);
                    }
                    ls.col *= env_col;
                    ls.from_env = true;
                }
                ...
                if (_3540 == 5u)
                {
                    ...
                    if ((_3488.type_and_param0.x & 128u) != 0u)
                    {
                        ...
                        if (_4142 != 4294967295u)
                        {
                            ...
                            uint _9539[14] = { _4149.pos[0], _4149.pos[1], _4149.pos[2], _4149.pos[3], _4149.pos[4], _4149.pos[5], _4149.pos[6], _4149.pos[7], _4149.pos[8], _4149.pos[9], _4149.pos[10], _4149.pos[11], _4149.pos[12], _4149.pos[13] };
                            uint _9510[4] = { _4149.page[0], _4149.page[1], _4149.page[2], _4149.page[3] };
                            atlas_texture_t _9410 = { _4149.size, _4149.atlas, _9510, _9539 };
                            float param_13 = _3458_g_params.env_rotation;
                            env_col_1 *= SampleLatlong_RGBE(_9410, ls.L, param_13, _3535);
                        }
                        ls.col *= env_col_1;
                        ls.from_env = true;
                    }
                        ...
                        else
                        {
                            ...
                            if (_3540 == 7u)
                            {
                                ...
                                if (_4870 != 4294967295u)
                                {
                                    ...
                                    uint _9624[14] = { _4877.pos[0], _4877.pos[1], _4877.pos[2], _4877.pos[3], _4877.pos[4], _4877.pos[5], _4877.pos[6], _4877.pos[7], _4877.pos[8], _4877.pos[9], _4877.pos[10], _4877.pos[11], _4877.pos[12], _4877.pos[13] };
                                    uint _9595[4] = { _4877.page[0], _4877.page[1], _4877.page[2], _4877.page[3] };
                                    atlas_texture_t _9463 = { _4877.size, _4877.atlas, _9595, _9624 };
                                    float param_20 = _3458_g_params.env_rotation;
                                    ls.col *= SampleLatlong_RGBE(_9463, ls.L, param_20, _3535);
                                }
                                ls.area = 1.0f;
                                ls.lp = P + ls.L;
                                ls.dist_mul = 3402823346297367662189621542912.0f;
...
float D_GGX(float3 H, float alpha_x, float alpha_y)
{
    ...
    do
    {
        ...
        _9213 = 1.0f / (((((_2178 * _2178) * 3.1415927410125732421875f) * alpha_x) * alpha_y) * (((H.z * H.z) * H.z) * H.z));
        break;
    } while(false);
    return _9213;
}
...
float4 Sample_GGXSpecular_BSDF(float3 T, float3 B, float3 N, float3 I, float roughness, float anisotropic, float spec_ior, float spec_F0, float3 spec_col, float rand_u, float rand_v, inout float3 out_V)
{
    ...
    do
    {
        ...
        if ((_2789 * _2793) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            out_V = _2804;
            _9185 = float4(_2818.x * 1000000.0f, _2818.y * 1000000.0f, _2818.z * 1000000.0f, 1000000.0f);
            break;
        }
        float3 param_2 = T;
        float3 param_3 = B;
        ...
        _9185 = Evaluate_GGXSpecular_BSDF(param_14, param_15, param_16, param_17, param_18, param_19, param_20, param_21);
        break;
    } while(false);
    return _9185;
}
...
float4 Evaluate_GGXRefraction_BSDF(float3 view_dir_ts, float3 sampled_normal_ts, float3 refr_dir_ts, float roughness2, float eta, float3 refr_col)
{
    ...
    do
    {
        ...
        _9190 = float4(refr_col * (((((_3101 * _3117) * _3109) * clamp(dot(view_dir_ts, sampled_normal_ts), 0.0f, 1.0f)) * _3137) / view_dir_ts.z), (((_3101 * _3109) * clamp(dot(view_dir_ts, sampled_normal_ts), 0.0f, 1.0f)) * _3137) / view_dir_ts.z);
        break;
    } while(false);
    return _9190;
}
...
float4 Sample_GGXRefraction_BSDF(float3 T, float3 B, float3 N, float3 I, float roughness, float eta, float3 refr_col, float rand_u, float rand_v, inout float4 out_V)
{
    ...
    do
    {
        ...
        if ((_3181 * _3181) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            _9195 = float4(refr_col.x * 1000000.0f, refr_col.y * 1000000.0f, refr_col.z * 1000000.0f, 1000000.0f);
            break;
        }
        float3 param = T;
        float3 param_1 = B;
        ...
        _9195 = Evaluate_GGXRefraction_BSDF(param_8, param_9, param_10, param_11, param_12, param_13);
        break;
    } while(false);
    return _9195;
}
...
lobe_weights_t get_lobe_weights(float base_color_lum, float spec_color_lum, float specular, float metallic, float transmission, float clearcoat)
{
    ...
    float _9358 = (base_color_lum * _1634) * (1.0f - transmission);
    ...
    float _9360 = _1655 * _1634;
    float _9361 = _1641 * base_color_lum;
    float _1664 = _9358;
    ...
    lobe_weights_t _9366 = { _9358, _9359, _9360, _9361 };
    return _9366;
}
...
float BRDF_PrincipledDiffuse(float3 V, float3 N, float3 L, float3 H, float roughness)
{
    ...
    do
    {
        ...
        _9218 = lerp(1.0f, _2418, schlick_weight(param)) * lerp(1.0f, _2418, schlick_weight(param_1));
        break;
    } while(false);
    return _9218;
}
...
float D_GTR1(float NDotH, float a)
{
    ...
    do
    {
        if (a >= 1.0f)
        {
            _9223 = 0.3183098733425140380859375f;
            break;
        }
        float _2137 = mad(a, a, -1.0f);
        _9223 = _2137 / ((3.1415927410125732421875f * log(a * a)) * mad(_2137 * NDotH, NDotH, 1.0f));
        break;
    } while(false);
    return _9223;
}
...
float4 Sample_PrincipledClearcoat_BSDF(float3 T, float3 B, float3 N, float3 I, float clearcoat_roughness2, float clearcoat_ior, float clearcoat_F0, float rand_u, float rand_v, inout float3 out_V)
{
    ...
    do
    {
        ...
        if ((clearcoat_roughness2 * clearcoat_roughness2) < 1.0000000116860974230803549289703e-07f)
        {
            ...
            _9208 = float4(_3018, _3018, _3018, 1000000.0f);
            break;
        }
        float3 param_2 = T;
        float3 param_3 = B;
        ...
        _9208 = Evaluate_PrincipledClearcoat_BSDF(param_14, param_15, param_16, param_17, param_18, param_19);
        break;
    } while(false);
    return _9208;
}
        ...
        else
        {
            ...
            else
            {
                ...
                if (_6785)
                {
                    ...
                    float4 _10745 = F;
                    float _6899 = _10745.w * lobe_weights.refraction;
                    float4 _10747 = _10745;
                    _10747.w = _6899;
                    F = _10747;
                    new_ray.c[0] = ((ray.c[0] * _10745.x) * mix_weight) / _6899;
                    new_ray.c[1] = ((ray.c[1] * _10745.y) * mix_weight) / _6899;
                    new_ray.c[2] = ((ray.c[2] * _10745.z) * mix_weight) / _6899;
                    new_ray.pdf = _6899;
                    new_ray.d[0] = V.x;
                    new_ray.d[1] = V.y;
                    new_ray.d[2] = V.z;
...
float3 ShadeSurface(hit_data_t inter, ray_data_t ray, inout float3 out_base_color, inout float3 out_normals)
{
    ...
    do
    {
        ...
        if (inter.mask == 0)
        {
            ...
            _9145 = float3(ray.c[0] * _7031.x, ray.c[1] * _7031.y, ray.c[2] * _7031.z);
            break;
        }
        ...
        if (inter.obj_index < 0)
        {
            ...
            _9145 = float3(ray.c[0] * _7071.x, ray.c[1] * _7071.y, ray.c[2] * _7071.z);
            break;
        }
        ...
        uint _10200 = _7114.textures[0];
        uint _10201 = _7114.textures[1];
        uint _10202 = _7114.textures[2];
        uint _10203 = _7114.textures[3];
        uint _10204 = _7114.textures[4];
        float _10205 = _7114.base_color[0];
        float _10206 = _7114.base_color[1];
        float _10207 = _7114.base_color[2];
        uint _9810 = _7114.flags;
        uint _9811 = _7114.type;
        float _9812 = _7114.tangent_rotation_or_strength;
        uint _9813 = _7114.roughness_and_anisotropic;
        float _9814 = _7114.ior;
        uint _9815 = _7114.sheen_and_sheen_tint;
        uint _9816 = _7114.tint_and_metallic;
        uint _9817 = _7114.transmission_and_transmission_roughness;
        uint _9818 = _7114.specular_and_specular_tint;
        uint _9819 = _7114.clearcoat_and_clearcoat_roughness;
        uint _9820 = _7114.normal_map_strength_unorm;
        transform_t _7169;
        ...
        float3 _9748 = _7458;
        float3 _9747 = cross(_7458, _7374);
        if (_7092)
        {
            ...
            _10200 = _7483.textures[0];
            _10201 = _7483.textures[1];
            _10202 = _7483.textures[2];
            _10203 = _7483.textures[3];
            _10204 = _7483.textures[4];
            _10205 = _7483.base_color[0];
            _10206 = _7483.base_color[1];
            _10207 = _7483.base_color[2];
            _9810 = _7483.flags;
            _9811 = _7483.type;
            _9812 = _7483.tangent_rotation_or_strength;
            _9813 = _7483.roughness_and_anisotropic;
            _9814 = _7483.ior;
            _9815 = _7483.sheen_and_sheen_tint;
            _9816 = _7483.tint_and_metallic;
            _9817 = _7483.transmission_and_transmission_roughness;
            _9818 = _7483.specular_and_specular_tint;
            _9819 = _7483.clearcoat_and_clearcoat_roughness;
            _9820 = _7483.normal_map_strength_unorm;
            _9750 = -_9750;
            _9749 = -_9749;
            _9748 = -_9748;
            _9747 = -_9747;
        }
        float3 param_5 = _9750;
        float4x4 param_6 = _7169.inv_xform;
        _9750 = TransformNormal(param_5, param_6);
        float3 param_7 = _9749;
        float4x4 param_8 = _7169.inv_xform;
        _9749 = TransformNormal(param_7, param_8);
        float3 param_9 = _9748;
        float4x4 param_10 = _7169.inv_xform;
        _9748 = TransformNormal(param_9, param_10);
        float3 param_11 = _9747;
        float4x4 param_12 = _7169.inv_xform;
        _9750 = normalize(_9750);
        _9749 = normalize(_9749);
        _9748 = normalize(_9748);
        _9747 = normalize(TransformNormal(param_11, param_12));
        ...
        while (_9811 == 4u)
        {
            ...
            {
                mix_val *= SampleBilinear(_10201, _7400, 0, _7021).x;
            }
            if (_7092)
            {
                _7680 = _7641 / _9814;
            ...
            if (_9814 != 0.0f)
            {
                float param_16 = dot(_6955, _9749);
            ...
            if (mix_rand > _7713)
            {
                ...
                {
                    _7736.textures[_108ident] = _4697.Load(_108ident * 4 + _10203 * 76 + 0);
                }
                [unroll]
                for (int _109ident = 0; _109ident < 3; _109ident++)
                {
                    _7736.base_color[_109ident] = asfloat(_4697.Load(_109ident * 4 + _10203 * 76 + 20));
                }
                _7736.flags = _4697.Load(_10203 * 76 + 32);
                _7736.type = _4697.Load(_10203 * 76 + 36);
                _7736.tangent_rotation_or_strength = asfloat(_4697.Load(_10203 * 76 + 40));
                _7736.roughness_and_anisotropic = _4697.Load(_10203 * 76 + 44);
                _7736.ior = asfloat(_4697.Load(_10203 * 76 + 48));
                _7736.sheen_and_sheen_tint = _4697.Load(_10203 * 76 + 52);
                _7736.tint_and_metallic = _4697.Load(_10203 * 76 + 56);
                _7736.transmission_and_transmission_roughness = _4697.Load(_10203 * 76 + 60);
                _7736.specular_and_specular_tint = _4697.Load(_10203 * 76 + 64);
                _7736.clearcoat_and_clearcoat_roughness = _4697.Load(_10203 * 76 + 68);
                _7736.normal_map_strength_unorm = _4697.Load(_10203 * 76 + 72);
                _10200 = _7736.textures[0];
                _10201 = _7736.textures[1];
                _10202 = _7736.textures[2];
                _10203 = _7736.textures[3];
                _10204 = _7736.textures[4];
                _10205 = _7736.base_color[0];
                _10206 = _7736.base_color[1];
                _10207 = _7736.base_color[2];
                _9810 = _7736.flags;
                _9811 = _7736.type;
                _9812 = _7736.tangent_rotation_or_strength;
                _9813 = _7736.roughness_and_anisotropic;
                _9814 = _7736.ior;
                _9815 = _7736.sheen_and_sheen_tint;
                _9816 = _7736.tint_and_metallic;
                _9817 = _7736.transmission_and_transmission_roughness;
                _9818 = _7736.specular_and_specular_tint;
                _9819 = _7736.clearcoat_and_clearcoat_roughness;
                _9820 = _7736.normal_map_strength_unorm;
            ...
            else
            {
                ...
                {
                    _7802.textures[_110ident] = _4697.Load(_110ident * 4 + _10204 * 76 + 0);
                }
                [unroll]
                for (int _111ident = 0; _111ident < 3; _111ident++)
                {
                    _7802.base_color[_111ident] = asfloat(_4697.Load(_111ident * 4 + _10204 * 76 + 20));
                }
                _7802.flags = _4697.Load(_10204 * 76 + 32);
                _7802.type = _4697.Load(_10204 * 76 + 36);
                _7802.tangent_rotation_or_strength = asfloat(_4697.Load(_10204 * 76 + 40));
                _7802.roughness_and_anisotropic = _4697.Load(_10204 * 76 + 44);
                _7802.ior = asfloat(_4697.Load(_10204 * 76 + 48));
                _7802.sheen_and_sheen_tint = _4697.Load(_10204 * 76 + 52);
                _7802.tint_and_metallic = _4697.Load(_10204 * 76 + 56);
                _7802.transmission_and_transmission_roughness = _4697.Load(_10204 * 76 + 60);
                _7802.specular_and_specular_tint = _4697.Load(_10204 * 76 + 64);
                _7802.clearcoat_and_clearcoat_roughness = _4697.Load(_10204 * 76 + 68);
                _7802.normal_map_strength_unorm = _4697.Load(_10204 * 76 + 72);
                _10200 = _7802.textures[0];
                _10201 = _7802.textures[1];
                _10202 = _7802.textures[2];
                _10203 = _7802.textures[3];
                _10204 = _7802.textures[4];
                _10205 = _7802.base_color[0];
                _10206 = _7802.base_color[1];
                _10207 = _7802.base_color[2];
                _9810 = _7802.flags;
                _9811 = _7802.type;
                _9812 = _7802.tangent_rotation_or_strength;
                _9813 = _7802.roughness_and_anisotropic;
                _9814 = _7802.ior;
                _9815 = _7802.sheen_and_sheen_tint;
                _9816 = _7802.tint_and_metallic;
                _9817 = _7802.transmission_and_transmission_roughness;
                _9818 = _7802.specular_and_specular_tint;
                _9819 = _7802.clearcoat_and_clearcoat_roughness;
                _9820 = _7802.normal_map_strength_unorm;
                mix_rand /= mix_val;
            }
        }
        [branch]
        ...
        {
            float3 normals = (float3(SampleBilinear(_10200, _7400, 0, _7021).xy, 1.0f) * 2.0f) - 1.0f.xxx;
            if ((_1008.Load(_10200 * 80 + 0) & 16384u) != 0u)
            {
                float3 _10768 = normals;
                _10768.z = sqrt(1.0f - dot(normals.xy, normals.xy));
                normals = _10768;
            }
            float3 _7887 = _9749;
            _9749 = normalize(((_9747 * normals.x) + (_7887 * normals.z)) + (_9748 * normals.y));
            if ((_9820 & 65535u) != 65535u)
            {
                _9749 = normalize(_7887 + ((_9749 - _7887) * clamp(float(_9820 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f)));
            }
            float3 param_18 = _9750;
            float3 param_19 = -_6955;
            float3 param_20 = _9749;
            _9749 = ensure_valid_reflection(param_18, param_19, param_20);
        }
        ...
        tangent = _7966;
        float3 _7970 = cross(_7966, _9749);
        ...
        if (_9812 != 0.0f)
        {
            ...
            float3 param_26 = _9749;
            float param_27 = _9812;
            tangent = rotate_around_axis(param_25, param_26, param_27);
        }
        float3 _8003 = normalize(cross(tangent, _9749));
        _9748 = _8003;
        _9747 = cross(_9749, _8003);
        float3 _9899 = 0.0f.xxx;
        ...
        if (_8025)
        {
            ...
            float3 param_29 = _9747;
            float3 param_30 = _9748;
            float3 param_31 = _9749;
            int param_32 = _6988;
            float2 param_33 = float2(_6995, _7002);
            light_sample_t _9914 = { _9898, _9899, _9900, _9901, _9902, _9903, _9904, _9905 };
            light_sample_t param_34 = _9914;
            SampleLightSource(param_28, param_29, param_30, param_31, param_32, param_33, param_34);
            _9898 = param_34.col;
            _9899 = param_34.L;
            _9900 = param_34.lp;
            _9901 = param_34.area;
            _9902 = param_34.dist_mul;
            _9903 = param_34.pdf;
            _9904 = param_34.cast_shadow;
            _9905 = param_34.from_env;
        }
        float _8053 = dot(_9749, _9899);
        float3 base_color = float3(_10205, _10206, _10207);
        [branch]
        if (_10201 != 4294967295u)
        {
            base_color *= SampleBilinear(_10201, _7400, int(get_texture_lod(texSize(_10201), _7633)), _7021, true, true).xyz;
        }
        ...
        float roughness = clamp(float(_9813 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
        [branch]
        if (_10202 != 4294967295u)
        {
            roughness *= SampleBilinear(_10202, _7400, int(get_texture_lod(texSize(_10202), _7633)), _7021, false, true).x;
        }
        ...
        float _9964 = _7623;
        float _9965 = ray.cone_spread;
        int _9966 = ray.xy;
        float _9961 = 0.0f;
        float _10432 = 0.0f;
        float _10431 = 0.0f;
        float _10430 = 0.0f;
        int _10068 = ray.depth;
        int _10072 = ray.xy;
        int _9967;
        float _10070;
        float _10255;
        ...
        {
            [branch]
            if ((_9903 > 0.0f) && (_8053 > 0.0f))
            {
                light_sample_t _9931 = { _9898, _9899, _9900, _9901, _9902, _9903, _9904, _9905 };
                surface_t _9758 = { _7058, _9747, _9748, _9749, _9750, _7400 };
                float _10436[3] = { _10430, _10431, _10432 };
                float _10401[3] = { _10395, _10396, _10397 };
                float _10366[3] = { _10360, _10361, _10362 };
                shadow_ray_t _10082 = { _10366, _10068, _10401, _10070, _10436, _10072 };
                shadow_ray_t param_35 = _10082;
                float3 _8205 = Evaluate_DiffuseNode(_9931, ray, _9758, base_color, roughness, mix_weight, param_35);
                _10360 = param_35.o[0];
                _10361 = param_35.o[1];
                _10362 = param_35.o[2];
                _10068 = param_35.depth;
                _10395 = param_35.d[0];
                _10396 = param_35.d[1];
                _10397 = param_35.d[2];
                _10070 = param_35.dist;
                _10430 = param_35.c[0];
                _10431 = param_35.c[1];
                _10432 = param_35.c[2];
                _10072 = param_35.xy;
            ...
            if (_8219)
            {
                surface_t _9765 = { _7058, _9747, _9748, _9749, _9750, _7400 };
                float _10331[3] = { _10325, _10326, _10327 };
                float _10296[3] = { _10290, _10291, _10292 };
                float _10261[3] = { _10255, _10256, _10257 };
                ray_data_t _9981 = { _10261, _10296, _9961, _10331, _9963, _9964, _9965, _9966, _9967 };
                ray_data_t param_36 = _9981;
                Sample_DiffuseNode(ray, _9765, base_color, roughness, _8136, _8145, mix_weight, param_36);
                _10255 = param_36.o[0];
                _10256 = param_36.o[1];
                _10257 = param_36.o[2];
                _10290 = param_36.d[0];
                ...
                _10327 = param_36.c[2];
                _9963 = param_36.ior;
                _9964 = param_36.cone_width;
                _9965 = param_36.cone_spread;
                _9966 = param_36.xy;
                _9967 = param_36.depth;
            }
        }
        else
        {
            ...
            if (_9811 == 1u)
            {
                ...
                if (_8257 && (_8053 > 0.0f))
                {
                    light_sample_t _9940 = { _9898, _9899, _9900, _9901, _9902, _9903, _9904, _9905 };
                    surface_t _9772 = { _7058, _9747, _9748, _9749, _9750, _7400 };
                    float _10443[3] = { _10430, _10431, _10432 };
                    float _10408[3] = { _10395, _10396, _10397 };
                    float _10373[3] = { _10360, _10361, _10362 };
                    shadow_ray_t _10095 = { _10373, _10068, _10408, _10070, _10443, _10072 };
                    shadow_ray_t param_39 = _10095;
                    float3 _8272 = Evaluate_GlossyNode(_9940, ray, _9772, base_color, roughness, 1.5f, _8243, mix_weight, param_39);
                    _10360 = param_39.o[0];
                    _10361 = param_39.o[1];
                    _10362 = param_39.o[2];
                    _10068 = param_39.depth;
                    _10395 = param_39.d[0];
                    _10396 = param_39.d[1];
                    _10397 = param_39.d[2];
                    _10070 = param_39.dist;
                    _10430 = param_39.c[0];
                    _10431 = param_39.c[1];
                    _10432 = param_39.c[2];
                    _10072 = param_39.xy;
                ...
                if (_8286)
                {
                    surface_t _9779 = { _7058, _9747, _9748, _9749, _9750, _7400 };
                    float _10338[3] = { _10325, _10326, _10327 };
                    float _10303[3] = { _10290, _10291, _10292 };
                    float _10268[3] = { _10255, _10256, _10257 };
                    ray_data_t _10000 = { _10268, _10303, _9961, _10338, _9963, _9964, _9965, _9966, _9967 };
                    ray_data_t param_40 = _10000;
                    Sample_GlossyNode(ray, _9779, base_color, roughness, 1.5f, _8243, _8136, _8145, mix_weight, param_40);
                    _10255 = param_40.o[0];
                    _10256 = param_40.o[1];
                    _10257 = param_40.o[2];
                    _10290 = param_40.d[0];
                    ...
                    _10327 = param_40.c[2];
                    _9963 = param_40.ior;
                    _9964 = param_40.cone_width;
                    _9965 = param_40.cone_spread;
                    _9966 = param_40.xy;
                    _9967 = param_40.depth;
                }
            }
            else
            {
                ...
                if (_9811 == 2u)
                {
                    ...
                    if (_8320 && (_8053 < 0.0f))
                    {
                        ...
                        light_sample_t _9949 = { _9898, _9899, _9900, _9901, _9902, _9903, _9904, _9905 };
                        surface_t _9786 = { _7058, _9747, _9748, _9749, _9750, _7400 };
                        float _10450[3] = { _10430, _10431, _10432 };
                        float _10415[3] = { _10395, _10396, _10397 };
                        float _10380[3] = { _10360, _10361, _10362 };
                        shadow_ray_t _10108 = { _10380, _10068, _10415, _10070, _10450, _10072 };
                        shadow_ray_t param_41 = _10108;
                        float3 _8350 = Evaluate_RefractiveNode(_9949, ray, _9786, base_color, _8310, _8328, mix_weight, param_41);
                        _10360 = param_41.o[0];
                        _10361 = param_41.o[1];
                        _10362 = param_41.o[2];
                        _10068 = param_41.depth;
                        _10395 = param_41.d[0];
                        _10396 = param_41.d[1];
                        _10397 = param_41.d[2];
                        _10070 = param_41.dist;
                        _10430 = param_41.c[0];
                        _10431 = param_41.c[1];
                        _10432 = param_41.c[2];
                        _10072 = param_41.xy;
                    ...
                    if (_8364)
                    {
                        surface_t _9793 = { _7058, _9747, _9748, _9749, _9750, _7400 };
                        float _10345[3] = { _10325, _10326, _10327 };
                        float _10310[3] = { _10290, _10291, _10292 };
                        float _10275[3] = { _10255, _10256, _10257 };
                        ray_data_t _10019 = { _10275, _10310, _9961, _10345, _9963, _9964, _9965, _9966, _9967 };
                        ray_data_t param_42 = _10019;
                        Sample_RefractiveNode(ray, _9793, base_color, roughness, _7092, _9814, _7641, _8136, _8145, mix_weight, param_42);
                        _10255 = param_42.o[0];
                        _10256 = param_42.o[1];
                        _10257 = param_42.o[2];
                        _10290 = param_42.d[0];
                        ...
                        _10327 = param_42.c[2];
                        _9963 = param_42.ior;
                        _9964 = param_42.cone_width;
                        _9965 = param_42.cone_spread;
                        _9966 = param_42.xy;
                        _9967 = param_42.depth;
                    }
                }
                else
                {
                    ...
                    if (_9811 == 3u)
                    {
                        col += (base_color * (mix_weight * _9812));
                    }
                    else
                    {
                        [branch]
                        if (_9811 == 6u)
                        {
                            float metallic = clamp(float((_9816 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            [branch]
                            if (_10203 != 4294967295u)
                            {
                                metallic *= SampleBilinear(_10203, _7400, int(get_texture_lod(texSize(_10203), _7633)), _7021).x;
                            }
                            float specular = clamp(float(_9818 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            [branch]
                            if (_10204 != 4294967295u)
                            {
                                specular *= SampleBilinear(_10204, _7400, int(get_texture_lod(texSize(_10204), _7633)), _7021).x;
                            }
                            float _8485 = clamp(float(_9819 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float _8493 = clamp(float((_9819 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float _8501 = 2.0f * clamp(float(_9815 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            float3 _8519 = lerp(1.0f.xxx, tint_color, clamp(float((_9815 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * _8501;
                            float3 _8539 = lerp(lerp(1.0f.xxx, tint_color, clamp(float((_9818 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f).xxx) * (specular * 0.07999999821186065673828125f), base_color, metallic.xxx);
                            ...
                            float _8562 = clamp(float((_9813 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f);
                            ...
                            float _8594 = mad(roughness - 1.0f, 1.0f - clamp(float((_9817 >> uint(16)) & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), 1.0f);
                            float _8600;
                            if (_7092)
                            {
                                _8600 = _9814 / _7641;
                            ...
                            float param_47 = dot(_6955, _9749);
                            float param_48 = 1.0f / _8600;
                            float _8623 = fresnel_dielectric_cos(param_47, param_48);
                            float param_49 = dot(_6955, _9749);
                            float param_50 = _8548;
                            lobe_weights_t _8662 = get_lobe_weights(lerp(_8090, 1.0f, _8501), lum(lerp(_8539, 1.0f.xxx, ((fresnel_dielectric_cos(param_49, param_50) - _8554) / (1.0f - _8554)).xxx)), specular, metallic, clamp(float(_9817 & 65535u) * 1.525902189314365386962890625e-05f, 0.0f, 1.0f), _8485);
                            [branch]
                            if (_9903 > 0.0f)
                            {
                                light_sample_t _9958 = { _9898, _9899, _9900, _9901, _9902, _9903, _9904, _9905 };
                                surface_t _9800 = { _7058, _9747, _9748, _9749, _9750, _7400 };
                                diff_params_t _10150 = { base_color, _8519, roughness };
                                spec_params_t _10165 = { _8539, roughness, _8548, _8554, _8562 };
                                clearcoat_params_t _10178 = { _8493, _8573, _8579 };
                                transmission_params_t _10193 = { _8594, _9814, _8600, _8623, _7092 };
                                float _10457[3] = { _10430, _10431, _10432 };
                                float _10422[3] = { _10395, _10396, _10397 };
                                float _10387[3] = { _10360, _10361, _10362 };
                                shadow_ray_t _10121 = { _10387, _10068, _10422, _10070, _10457, _10072 };
                                shadow_ray_t param_51 = _10121;
                                float3 _8681 = Evaluate_PrincipledNode(_9958, ray, _9800, _8662, _10150, _10165, _10178, _10193, metallic, _8053, mix_weight, param_51);
                                _10360 = param_51.o[0];
                                _10361 = param_51.o[1];
                                _10362 = param_51.o[2];
                                _10068 = param_51.depth;
                                _10395 = param_51.d[0];
                                _10396 = param_51.d[1];
                                _10397 = param_51.d[2];
                                _10070 = param_51.dist;
                                _10430 = param_51.c[0];
                                _10431 = param_51.c[1];
                                _10432 = param_51.c[2];
                                _10072 = param_51.xy;
                            ...
                            surface_t _9807 = { _7058, _9747, _9748, _9749, _9750, _7400 };
                            diff_params_t _10154 = { base_color, _8519, roughness };
                            spec_params_t _10171 = { _8539, roughness, _8548, _8554, _8562 };
                            clearcoat_params_t _10182 = { _8493, _8573, _8579 };
                            transmission_params_t _10199 = { _8594, _9814, _8600, _8623, _7092 };
                            float param_52 = mix_rand;
                            float _10352[3] = { _10325, _10326, _10327 };
                            float _10317[3] = { _10290, _10291, _10292 };
                            float _10282[3] = { _10255, _10256, _10257 };
                            ray_data_t _10038 = { _10282, _10317, _9961, _10352, _9963, _9964, _9965, _9966, _9967 };
                            ray_data_t param_53 = _10038;
                            Sample_PrincipledNode(ray, _9807, _8662, _10154, _10171, _10182, _10199, metallic, _8136, _8145, param_52, mix_weight, param_53);
                            _10255 = param_53.o[0];
                            _10256 = param_53.o[1];
                            _10257 = param_53.o[2];
                            _10290 = param_53.d[0];
                            ...
                            _10327 = param_53.c[2];
                            _9963 = param_53.ior;
                            _9964 = param_53.cone_width;
                            _9965 = param_53.cone_spread;
                            _9966 = param_53.xy;
                            _9967 = param_53.depth;
                        }
                    }
                }
            }
        }
        float _8715 = max(_10325, max(_10326, _10327));
        float _8727;
        ...
        if (_8747)
        {
            ...
            _8787.Store(_8778 * 72 + 0, asuint(_10255));
            _8787.Store(_8778 * 72 + 4, asuint(_10256));
            _8787.Store(_8778 * 72 + 8, asuint(_10257));
            _8787.Store(_8778 * 72 + 12, asuint(_10290));
            _8787.Store(_8778 * 72 + 16, asuint(_10291));
            _8787.Store(_8778 * 72 + 20, asuint(_10292));
            ...
            _8787.Store(_8778 * 72 + 40, asuint(_9963[0]));
            _8787.Store(_8778 * 72 + 44, asuint(_9963[1]));
            _8787.Store(_8778 * 72 + 48, asuint(_9963[2]));
            _8787.Store(_8778 * 72 + 52, asuint(_9963[3]));
            _8787.Store(_8778 * 72 + 56, asuint(_9964));
            _8787.Store(_8778 * 72 + 60, asuint(_9965));
            _8787.Store(_8778 * 72 + 64, uint(_9966));
            _8787.Store(_8778 * 72 + 68, uint(_9967));
        }
        [branch]
        if (max(_10430, max(_10431, _10432)) > 0.0f)
        {
            float3 _8864 = _9900 - float3(_10360, _10361, _10362);
            float _8867 = length(_8864);
            float3 _8871 = _8864 / _8867.xxx;
            float sh_dist = _8867 * _9902;
            if (_9905)
            {
                sh_dist = -sh_dist;
            }
            ...
            _8903.Store(_8895 * 48 + 0, asuint(_10360));
            _8903.Store(_8895 * 48 + 4, asuint(_10361));
            _8903.Store(_8895 * 48 + 8, asuint(_10362));
            _8903.Store(_8895 * 48 + 12, uint(_10068));
            ...
            _8903.Store(_8895 * 48 + 32, asuint(_10430));
            _8903.Store(_8895 * 48 + 36, asuint(_10431));
            _8903.Store(_8895 * 48 + 40, asuint(_10432));
            _8903.Store(_8895 * 48 + 44, uint(_10072));
        }
        _9145 = float3(ray.c[0] * col.x, ray.c[1] * col.y, ray.c[2] * col.z);
        break;
    } while(false);
    return _9145;
}
...
void comp_main()
{
    do
    {
        ...
        hit_data_t _9239 = { _9003.mask, _9003.obj_index, _9003.prim_index, _9003.t, _9003.u, _9003.v };
        hit_data_t param = _9239;
        float _9288[4] = { _9019.ior[0], _9019.ior[1], _9019.ior[2], _9019.ior[3] };
        float _9279[3] = { _9019.c[0], _9019.c[1], _9019.c[2] };
        float _9272[3] = { _9019.d[0], _9019.d[1], _9019.d[2] };
        float _9265[3] = { _9019.o[0], _9019.o[1], _9019.o[2] };
        ray_data_t _9258 = { _9265, _9272, _9019.pdf, _9279, _9288, _9019.cone_width, _9019.cone_spread, _9019.xy, _9019.depth };
        ray_data_t param_1 = _9258;
