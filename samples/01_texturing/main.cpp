...
int main() {
    ...
    mat_desc3.multiple_importance = true; // Use NEE for this lightsource
    ...
    // Save image
    WriteTGA(pixels.ptr, pixels.pitch, IMG_W, IMG_H, 3, "01_texturing.tga");
    printf("Image saved as samples/01_texturing.tga\n");
